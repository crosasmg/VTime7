...
Public Class Interm_buds
	...
	'%Add: Añade una nueva instancia de la clase Interm_bud a la colección
	...
	'% Find: se buscan las metas de producción para un intermediario
	Public Function Find(ByVal lintIntermed As Integer, ByVal lintCurrency As Integer, ByVal lstrType_infor As String, ByVal lstrPeriodtyp As String, ByVal lintPeriodnum As Integer, ByVal ldtmEffecdate As Date) As Boolean
		...
		'+Definición de parámetros para stored procedure 'insudb.reaInterm_bud_a'
		'**+ Information read on February 05,2001 2:47:06p.m.
		'+Información leída el 05/02/2001 2:47:06 PM
...
Find_Err: 
	...
	'% valWinBranchProdPar: Permite validar si un valor determinado existe la colección,
...
valWinBranchProdPar_err: 
	...
	'% valDupTwoCol: Permite validar si un valor determinado existe en la colección
	'%               tomando en cuenta el ramo producto.
