...
Public Class Fund_values
	...
	'% Find: Esta función se encarga de buscar todos los Valores nominales pertenecientes a un Fondo.
    Public Function Find(ByVal nFunds As Integer, Optional ByVal nCurrency As Integer = 0) As Boolean
        ...
        '+ Definición de parámetros para stored procedure 'insudb.reaFund_values'
        '+ Información leída el 09/04/2001 08:59:33 AM
...
Find_Err:
    ...
    Public Function FindFounds(ByVal ldtmEffecdate As Date, Optional ByVal lblnFind As Boolean = False) As Boolean
        ...
        If ldtmEffecdate <> mdtmEffecdate Or lblnFind Then
            ...
            '+ Definición de parámetros para stored procedure 'insudb.reaFund_value_1'
...
FindFounds_Err:
	...
	'% FindDateMax: Selecciona la última fecha de modificación de Fund_values
	Public Function FindDateMax(Optional ByVal nFunds As Integer = 0, Optional ByVal ldtmDate As Date = #12:00:00 AM#) As Date
		...
		'+ Definición de parámetros para stored procedure 'insudb.valFund_value'
		'+ Información leída el 09/04/2001 11:21:06
	...
	'% Update : Permite actualizar los registros de la colección en la tabla de valores nominales de fondo "Fund_value".
