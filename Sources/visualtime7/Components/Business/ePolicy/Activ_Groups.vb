Option Strict Off
Option Explicit On
Public Class Activ_Groups
	Implements System.Collections.IEnumerable
	'%-------------------------------------------------------%'
	'% $Workfile:: Activ_Groups.cls                         $%'
	'% $Author:: Nvaplat41                                  $%'
	'% $Date:: 9/10/03 19.01                                $%'
	'% $Revision:: 10                                       $%'
	'%-------------------------------------------------------%'
	...
	Public Function Add(ByVal objClass As Activ_Group) As Activ_Group
		'create a new object
		If objClass Is Nothing Then
			objClass = New Activ_Group
		End If
		
		With objClass
			mCol.Add(objClass, .sCertype & .nBranch & .nProduct & .nPolicy & .nGroup & .nSpeciality & .dEffecdate.ToString("yyyyMMdd"))
		End With
	...
	Public Function Find(ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal dEffecdate As Date) As Boolean
		Dim lrecReaActiv_Group_a As eRemoteDB.Execute
		...
		lrecReaActiv_Group_a = New eRemoteDB.Execute
		With lrecReaActiv_Group_a
			.StoredProcedure = "ReaActiv_Group_a"
			...
			If .Run Then
				Find = True
				Do While Not .EOF
					lclsActiv_Group = New Activ_Group
					lclsActiv_Group.sCertype = .FieldToClass("sCertype")
					lclsActiv_Group.nBranch = .FieldToClass("nBranch")
					lclsActiv_Group.nProduct = .FieldToClass("nProduct")
					lclsActiv_Group.nPolicy = .FieldToClass("nPolicy")
					lclsActiv_Group.nGroup = .FieldToClass("nGroup")
					lclsActiv_Group.nSpeciality = .FieldToClass("nSpeciality")
					lclsActiv_Group.nPercent = .FieldToClass("nPercent")
					Call Add(lclsActiv_Group)
...
Find_Err: 
		...
		lrecReaActiv_Group_a = Nothing
		On Error GoTo 0
	End Function
	
	Default Public ReadOnly Property Item(ByVal vntIndexKey As Object) As Activ_Group
		Get
