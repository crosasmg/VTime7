...
Public Class tran_ways
	...
	Private mcoltran_way As Collection
	...
	'%Parámetros:
	'%    lclstran_way -
	Public Function Add(ByRef lclstran_way As tran_way) As tran_way
		
		'**-set the properties passed into the method


		mcoltran_way.Add(lclstran_way)
	...
	'**%Objective: Function that makes the search in the table 'tran_way'.
	'**%Parameters:
	...
	'%Objetivo: Función que realiza la busqueda en la tabla 'tran_way'.
	'%Parámetros:
	...
	Public Function Find(ByVal sCertype As String, ByVal nBranch As Short, ByVal nProduct As Short, ByVal nPolicy As Integer, ByVal nCertif As Integer, ByVal dEffecdate As Date) As Boolean
		...
		Dim lclstran_wayItem As tran_way
		

        lclstran_way = New eRemoteDB.Execute
		
		'+ Define all parameters for the stored procedures 'insudb.reatran_way'. Generated on 06/07/2004 04:02:42 p.m.
		With lclstran_way
			.StoredProcedure = "reatran_way_a"
			...
			If .Run(True) Then
				Do While Not .EOF
					lclstran_wayItem = New tran_way
					lclstran_wayItem.sCertype = sCertype
					lclstran_wayItem.nBranch = nBranch
					lclstran_wayItem.nProduct = nProduct
					lclstran_wayItem.nPolicy = nPolicy
					lclstran_wayItem.nCertif = nCertif
					lclstran_wayItem.nWay = .FieldToClass("nWay")
					lclstran_wayItem.sName_licen = .FieldToClass("sName_licen")
					lclstran_wayItem.sDescript = .FieldToClass("sDescript")
					lclstran_wayItem.nNotenum = .FieldToClass("nNoteNum")
					Call Add(lclstran_wayItem)
					lclstran_wayItem = Nothing
					.RNext()
				Loop 
				Find = True
				.RCloseRec()
	...
	'%Parámetros:
	'%    vIndexKey -
	Default Public ReadOnly Property Item(ByVal vIndexKey As Object) As tran_way
		Get


			Item = mcoltran_way.Item(vIndexKey)
    ...
    '
    'NewEnum = mcoltran_way._NewEnum
    '
    'Exit Property
    'ErrorHandler: '
    'ProcError("tran_ways.NewEnum()")
    'End Get
    'End Property
	
	Public Function GetEnumerator() As System.Collections.IEnumerator Implements System.Collections.IEnumerable.GetEnumerator
				GetEnumerator = mcoltran_way.GetEnumerator
	End Function
