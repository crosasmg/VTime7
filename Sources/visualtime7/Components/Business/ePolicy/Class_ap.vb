...
Public Class Class_ap
	...
	Public nClass_ap As Integer
	
	'% InsValAP004: Realiza la validación puntual de los campos a actualizar en la ventana AP004
	Public Function InsValAP004Upd(ByVal sCodispl As String, ByVal sAction As String, ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nCertif As Double, ByVal sClient As String, ByVal nModulec As Integer, ByVal nCover As Integer, ByVal dEffecdate As Date) As String
		Dim lclsErrors As eFunctions.Errors
        Dim lstrErrorAll As String = String.Empty
		Dim lrecAP004 As eRemoteDB.Execute
		
		On Error GoTo InsValAP004Upd_Err
		
		lrecAP004 = New eRemoteDB.Execute
		With lrecAP004
			.StoredProcedure = "INSAP004PKG.INSVALAP004UPD"
			...
			End If
		End With
		'UPGRADE_NOTE: Object lrecAP004 may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
		lrecAP004 = Nothing
		...
		If Len(lstrErrorAll) > 0 Then
			...
			With lclsErrors
				...
				InsValAP004Upd = .Confirm
			End With
		End If
		
InsValAP004Upd_Err: 
		If Err.Number Then
			InsValAP004Upd = "InsValAP004Upd: " & Err.Description
		End If
	...
	'%InsPostAP004Upd: Se realiza la actualización de los datos en la ventana AP004
	Public Function InsPostAP004Upd(ByVal sAction As String, ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nCertif As Double, ByVal sClient As String, ByVal nModulec As Integer, ByVal nCover As Integer, ByVal dEffecdate As Date, ByVal nClass_ap As Integer, ByVal nUsercode As Integer) As Boolean
		Dim lrecAP004 As eRemoteDB.Execute
		
		On Error GoTo InsPostAP004Upd_Err
		
		lrecAP004 = New eRemoteDB.Execute
		With lrecAP004
			.StoredProcedure = "INSAP004PKG.INSPOSTAP004UPD"
			.Parameters.Add("sAction", UCase(sAction), eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbVarChar, 10, 0, 0, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			.Parameters.Add("sCertype", sCertype, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbVarChar, 1, 0, 0, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
...
InsPostAP004Upd_Err: 
		If Err.Number Then
			InsPostAP004Upd = False
		End If
		On Error GoTo 0
	End Function
	
	'%InsPostAP004: Se realiza la actualización de los datos en la ventana AP004
	Public Function InsPostAP004(ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nCertif As Double, ByVal dEffecdate As Date, ByVal nUsercode As Integer) As Boolean
		Dim lrecAP004 As eRemoteDB.Execute
		
		On Error GoTo InsPostAP004_Err
		
		lrecAP004 = New eRemoteDB.Execute
		With lrecAP004
			.StoredProcedure = "INSAP004PKG.INSPOSTAP004"
			.Parameters.Add("sCertype", sCertype, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbVarChar, 1, 0, 0, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			.Parameters.Add("nBranch", nBranch, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbInteger, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			.Parameters.Add("nProduct", nProduct, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbInteger, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			.Parameters.Add("nPolicy", nPolicy, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbDouble, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
