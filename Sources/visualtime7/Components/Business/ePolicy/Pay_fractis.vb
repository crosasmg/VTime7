...
Public Class Pay_fractis
	...
	'% Función para insertar la frecuencia  de pagos permitidos
	'-----------------------------------------------------------
	...
	Public Function Find(ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal dEffecdate As Date) As Boolean
		...
		'+ Definición de parámetros para stored procedure 'insudb.reaRoles_Client'
		'+ Información leída el 06/11/2000 01:35:45 PM
