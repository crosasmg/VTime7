...
Public Class ValPolicySeq
    ...
    '- Se define la variable que contiene temporalmente el N� de p�liza en la CA001_K
    Public mlngPolicy As Double

    '- Descripci�n de la tabla de datos particulares
    Public mstrTabName As String

    Public mstrsPolitype As String

    '   Se define la variable que contiene la transacci�n que se ejecuta en cierto momento.
    ...
    '+ Variables utilizadas para la ejecuci�n de procesos de la forma CA041
    Public pstrType_prop As String '-(pstrType_prop): contiene si la p�liza es normal o si es cobertura provisional.
    Public pdtmMaximum_da As Date '-(pdtmMaximum_da): contiene la fecha m�xima de permanencia.

    Public dtmEffecdate As Date

    '- Se define la variable para almacenar la cadena que se quiera luego mostrar desde las p�ginas
    Public sString As String

    '- Se define la variable para almacenar si la transacci�n esta con o sin contenido
    Public sContent As String

    '-Variables para la validaci�n de pago de primera prima
    Private mdblFirstPremium As Double
    Private mdblnPremprop As Double

    '-Variable que contiene el ramo t�cnico del producto
    Public sBrancht As String
    Public nProdClas As Double

    '-Variable que contiene �a fecha de inicio de la p�liza
    ...
    Public Function insPostCA004(ByVal sHolder As String, ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nCertif As Double, ByVal dEffecdate As Date, ByVal sPolitype As String, ByVal nTransaction As Integer, ByVal sTitularC As String, ByVal sFreq As String, ByVal nPayfreq As Integer, ByVal nQuota As Integer, ByVal sIndexType As String, ByVal sIndexApl As String, ByVal sNoNull As String, ByVal dStartdate As Date, ByVal dExpirDate As Date, ByVal dIssuedat As Date, ByVal dReqDate As Date, ByVal nCopies As Integer, ByVal nIndexRate As Double, ByVal nDaysNull As Integer, ByVal sDeclarative As String, ByVal sFracti As String, ByVal sRenewalAut As String, ByVal sDirTyp As String, ByVal nWaypay As Integer, ByVal nBill_day As Integer, ByVal nCod_Agree As Integer, ByVal nUsercode As Integer, ByVal nSendAddr As Integer, ByVal sInsubank As String, ByVal sNopayroll As String, ByVal sExemption As String, ByVal nSpecialbusiness As Integer, Optional ByVal sLeg As String = "", Optional ByVal nDays_quot As Integer = 0, Optional ByVal sBill_Ind As String = "", Optional ByVal nDuration As Integer = 0, Optional ByVal nOrigin As Integer = 0, Optional ByVal nAFP_Commiss As Double = 0, Optional ByVal nAFP_Comm_Curr As Integer = 0, Optional ByVal sDirTyp_old As String = "", Optional ByVal nCollector As Integer = 0, Optional ByVal sFracReceip As String = "", Optional ByVal nGroup_agree As Integer = 0, Optional ByVal sCumul_code As String = "", Optional ByVal nRepInsured As Integer = 0, Optional ByVal sRetarif As String = "", Optional ByVal sReceipt_ind As String = "", Optional ByVal nTerm_grace As Integer = 0, Optional ByVal dTariffdate As Date = #12:00:00 AM#, Optional ByVal nDepreciationtable As Integer = 0, Optional ByVal sInd_Multiannual As String = "2", Optional ByVal sIndqsamevalue As String = "2", Optional ByVal sInd_IFI As String = "2", Optional ByVal nType_amend As Double = 0, Optional ByVal nExtraday As Integer = eRemoteDB.Constants.intNull, Optional ByVal nFormPay As Integer = 0, Optional ByVal nPromissory_Note As Integer = 0) As Boolean
        ...
        Dim nSumValorBienes As Double = 0
        Dim lclsPolicyWin As ePolicy.Policy_Win

        lrecInsPostCA004 = New eRemoteDB.Execute

        '+Definici�n de par�metros para stored procedure 'InsPostCA004'
        '+Informaci�n le�da el 23/04/2003
        With lrecInsPostCA004
            ...
            .Parameters.Add("nSpecialbusiness", IIf(nSpecialbusiness = 0, eRemoteDB.Constants.intNull, nSpecialbusiness), eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbInteger, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
            ...
            .Parameters.Add("nDepreciationtable", nDepreciationtable, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbInteger, 2, 0, 0, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
            .Parameters.Add("sInd_Multiannual", sInd_Multiannual, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbVarchar, 1, 0, 0, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
            .Parameters.Add("sIndqsamevalue", sIndqsamevalue, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbVarchar, 1, 0, 0, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
            .Parameters.Add("sInd_IFI", sInd_IFI, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbVarchar, 1, 0, 0, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
            .Parameters.Add("nExtraday", nExtraday, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbInteger, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
            .Parameters.Add("nFormPay", nFormPay, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbInteger, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
            .Parameters.Add("nPromissory_Note", nPromissory_Note, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbInteger, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)

            insPostCA004 = .Run(False)
            If insPostCA004 Then
                lclsPolicy.Find(sCertype, nBranch, nProduct, nPolicy)
                lclsPolicyWin = New ePolicy.Policy_Win
                With lclsPolicyWin
                    If sInd_Multiannual = "1" And nDepreciationtable <> 0 And ((lclsPolicy.sPolitype = "2" And nCertif > 0) Or lclsPolicy.sPolitype = "1") Then
                        insPostCA004 = .Add_PolicyWin(sCertype, nBranch, nProduct, nPolicy, nCertif, dEffecdate, nUsercode, "CA054", "3")
                        insPostCA004 = .Add_PolicyWin(sCertype, nBranch, nProduct, nPolicy, nCertif, dEffecdate, nUsercode, "CA014", "3")
                        ...
                        If lclsAuto.Find(sCertype, nBranch, nProduct, nPolicy, nCertif, dEffecdate) Then
                            If lclsAuto.nVeh_valor > 0 Then
                                lclsDepreciatedCapital.CalculateDepreciatedCapitalByCoverage(sCertype, nBranch, nProduct, nPolicy, nCertif, lclsCertificat.nGroup, dEffecdate, "AU_VEH_NOX2", lclsAuto.nVeh_valor, nType_amend, dStartdate, nTransaction)
                            End If
                        End If
                        If lcolPropertys.Find(sCertype, nBranch, nProduct, nPolicy, nCertif, dEffecdate) Then
                            ...
                            Next
                            lclsDepreciatedCapital.CalculateDepreciatedCapitalByCoverage(sCertype, nBranch, nProduct, nPolicy, nCertif, lclsCertificat.nGroup, dEffecdate, "CA_C_BA", nSumValorBienes, nType_amend, dEffecdate, nTransaction)
                        End If
                    End If
                End With
            End If
...
InsPostCA004_Err:
    ...
    '% insPostCA003: Se realiza la actualizaci�n de los datos
            ...
            ElseIf lclsCertificat.sDirind = "2" Then
                ...
                With lclsPolicy
                    If .Find(sCertype, nBranch, nProduct, nPolicy, True) Then
                        ...
                        '+ Si se trata de una re-emisi�n o de re-impresi�n se cambia el estado de la p�liza
...
insPostCA003_Err:
    ...
    Public Function insValCA003(ByVal sCodispl As String, ByVal sBank As String, ByVal sClient As String, ByVal nBankext As Integer, ByVal sAccount As String, ByVal nTyp_Account As Integer, ByVal nTyp_crecard As Integer, ByVal dDateExpir As Date, ByVal sBankauth As String, ByVal sCred_card As String, ByVal nWay_pay As Integer, ByVal sDirind As String, ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nCertif As Double) As String
        ...
        With lclsErrors
            '+ Si la v�a de pago no es PAC/Transbank o es PAC/Transbank pero la v�a de cobro es
            ...
            Else
                ...
                If sBank = "1" Then
                    ...
                    '+ Validando campos para N�mero de Cuenta
                    ...
                    Else
                        ...
                        'Nota: Esta condicion se comento para corregir el error 176 CORPVIDA
                        'If CStr(lclsProduct.sBrancht) <> "1" Then

                        If nBankext > 0 Then
                            lclsDirDebit = New ePolicy.DirDebit
                            If lclsDirDebit.Find_Valsbankaut(sCertype, nBranch, nProduct, nPolicy, nCertif, sBankauth, nBankext) Then
                ...
                Else
                    ...
                    If IsDate(dDateExpir) And dDateExpir <> eRemoteDB.Constants.dtmNull Then
                        ...
                        '+ La fecha de vencimiento debe ser mayor a la fecha del d�a
...
insValCA003_Err:
    ...
    Public Function insValCA004(ByVal sCodispl As String, ByVal dIssuedat As Date, ByVal dPropodat As Date, ByVal sClient As String, ByVal dExpirdat As Date, ByVal dStartdate As Date, ByVal sFreq As String, ByVal nPayfreq As Integer, ByVal nQuota As Integer, ByVal nIndexApl As Integer, ByVal nIndexType As Integer, ByVal nIndexRate As Double, ByVal nTransaction As Integer, ByVal nCertif As Double, ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal sPoltype As String, ByVal dEffecdate As Date, ByVal nMainAction As Integer, ByVal nHolder As Integer, ByVal nCod_Agree As Integer, ByVal nWaypay As Integer, ByVal sDirTyp As String, ByVal nBill_day As Integer, ByVal nSendAddr As Integer, ByVal nOrigin As Integer, ByVal nAFP_Commiss As Double, ByVal nAFP_Comm_Curr As Integer, ByVal nDepreciationtable As Integer, ByVal sInd_Multiannual As String, ByVal chksInd_IFI As String, ByVal nExtraday As Integer, ByVal nFormPay As Integer, ByVal nPromissory_Note As Integer) As String
        ...
        '+ Se invoca el SP para validar los campos de la transacci�n
        ...
        With lrecinsvalCA004
            ...
            .Parameters.Add("nDepreciationtable", IIf(nDepreciationtable = 0, eRemoteDB.Constants.intNull, nDepreciationtable), eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbInteger, 2, 0, 0, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
            .Parameters.Add("sInd_Multiannual", sInd_Multiannual, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbVarchar, 1, 0, 0, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
            .Parameters.Add("chksInd_IFI", chksInd_IFI, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbVarchar, 1, 0, 0, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
            .Parameters.Add("nExtraday", nExtraday, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbInteger, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
            .Parameters.Add("nFormPay", nFormPay, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbInteger, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
            .Parameters.Add("nPromissory_Note", nPromissory_Note, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbInteger, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
...
insvalCA004_Err:
    ...
    Public Function inspostCA006(ByVal sCertype As String, ByVal nProduct As Integer, ByVal nBranch As Integer, ByVal nPolicy As Double, ByVal nCertif As Double, ByVal dEffecdate As Date, ByVal nUsercode As Integer, ByVal sColtimre As String, ByVal sColinvot As String, ByVal sColReint As String, ByVal nQ_Certif As Integer, ByVal nTariff As Integer, ByVal sTyp_Clause As String, ByVal sTyp_Discxp As String, ByVal sDocuTyp As String, ByVal sTyp_module As String, ByVal nTransactio As Integer, ByVal nClaim_notice As Integer, ByVal sColtpres As String, Optional ByVal sMassive As String = "", Optional ByVal sRepPrintCov As String = "", Optional ByVal nTypeExc As Integer = 0) As Boolean
        ...
        With lclsRemote
            ...
            .Parameters.Add("nTypeExc", nTypeExc, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbNumeric, 22, 0, 3, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
...
inspostCA006_Err:
    ...
    '% insValCA011: Realiza la validaci�n de los campos a actualizar en la ventana CA011
    Public Function insValCA011(ByVal lstrCodispl As String, ByVal sAction As String, ByVal nGroup As Integer, ByVal sDescription As String, ByVal nParticip As Double, ByVal sStatregt As String, ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal dEffecdate As Date) As String
        ...
        ' + Si el c�digo de GRUPO est� vac�o o es NULO y existe infomaci�n en los dem�s campos - error # 1084
        ...
        ' + Si el c�digo de GRUPO est� vac�o o es NULO se registra el error # 10152
        If nGroup = eRemoteDB.Constants.intNull Then
            Call lobjErrors.ErrorMessage(lstrCodispl, 10152)
            ' + Si el c�digo de GRUPO es igual "0" se registra el error # 55876
        ElseIf nGroup = 0 Then
            Call lobjErrors.ErrorMessage(lstrCodispl, 55876)
        End If

        ' + Si se est� eliminando no pueden existir registros asociados al certificado - Error # 3135
        If sAction = "Delete" Then
            ...
            End If
        End If
        ' + Si se est� registrando (a�adiendo) un grupo, �ste NO DEBE ESTAR REGISTRADO EN EL
        ' + ARCHIVO DE P�LIZAS COLECTIVAS - ERROR 3133
        If sAction = "Add" Then
            If nGroup <> eRemoteDB.Constants.intNull Then
        ...
        ' + Se muestra el siguiente error en caso que el GRUPO est� lleno y la DESCRIPCI�N est� vac�a
        ' + ARCHIVO DE P�LIZAS COLECTIVAS - ERROR 3134
        If nGroup <> eRemoteDB.Constants.intNull Then
...
insValCA011_Err:
    ...
    '% insPostCA011: Se realiza la actualizaci�n de los datos
    Public Function insPostCA011(ByVal Action As String, ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nCertif As Double, ByVal dEffecdate As Date, ByVal nGroup As Integer, ByVal sDescript As String, ByVal nParticip As Double, ByVal sStatregt As String, ByVal nUsercode As Integer, ByVal nPriorGroup As Integer) As Boolean
        ...
        With lclsGroups
            ...
            Select Case Action
                ...
                Case "Update"
                    '+ Si el grupo que se est� modificando anteriormente se encontraba en estado ACTIVO (1)
                    '+ no puede ser cambiado a EN PROCESO DE INSTALACI�N (2) - ACM - 24/02/2001
...
insPostCA011_Err:
    ...
    Public Function insValCA048(ByVal sCodispl As String, ByVal sReverMod As String, ByVal nWait_code As Integer, ByVal nTransaction As Integer) As String
        ...
        '+Si hay motivos para revertir la p�liza, pero no se revierte
        '+se advierte que modificaci�n no ser� exitosa
...
insValCA048_Err:
    ...
    Public Function insValCA050(ByVal sCodispl As String, ByVal sDetailedEntryPrinted As String, ByVal nWait_code As Integer, _
                                ByVal nTransaction As Integer, Optional ByVal sCertype As String = eRemoteDB.Constants.strNull, Optional ByVal nBranch As Integer = eRemoteDB.Constants.intNull, _
                                Optional ByVal nProduct As Integer = eRemoteDB.Constants.intNull, Optional ByVal nPolicy As Double = eRemoteDB.Constants.dblNull, Optional ByVal nCertif As Double = eRemoteDB.Constants.dblNull, _
                                Optional ByVal dEffecdate As Date = eRemoteDB.Constants.dtmNull) As String
        Dim lclsError As eFunctions.Errors
        ...
        '+Si hay motivos para revertir la p�liza, pero no se revierte
        '+se advierte que modificaci�n no ser� exitosa
        '        If sDetailedEntryPrinted <> "1" And (nTransaction = Constantes.PolTransac.clngPolicyProposal Or _
        '                                            nTransaction = Constantes.PolTransac.clngPropQuotConvertion) And nWait_code = 4 Then
        '      Call lclsError.ErrorMessage(sCodispl, 197805)
        '     End If

        If nWait_code = eRemoteDB.Constants.intNull And (nTransaction = Constantes.PolTransac.clngCertifIssue Or _
                                                         (nTransaction = Constantes.PolTransac.clngRecuperation And nCertif > 0) Or _
                                                         nTransaction = Constantes.PolTransac.clngCertifReissue) Then
            Dim lclsPolicyWin As ePolicy.Policy_Win
            lclsPolicyWin = New ePolicy.Policy_Win

            If lclsPolicyWin.Find_Codispl(sCertype, nBranch, nProduct, nPolicy, nCertif, dEffecdate, "VI701") Then
                ...
                If lclsLife.Find(sCertype, nBranch, nProduct, nPolicy, nCertif, dEffecdate) Then
                    If lclsLife.sCreditnum = vbNullString Then
                        Call lclsError.ErrorMessage(sCodispl, 9000035)
                    End If
                End If
                lclsLife = Nothing
            End If
...
insValCA050_Err:
    ...
    '% valFieldDate: Esta funci�n se encarga de validar los campo tipo fecha
...
DateType_Amend_Err:
    ...
    '% insvalCA006: esta funci�n realiza las validaciones de la Informaci�n General del Colectivo
    Public Function insvalCA006(ByVal sCertype As String, ByVal nProduct As Integer, ByVal nBranch As Integer, ByVal nPolicy As Double, ByVal nCertif As Double, ByVal sCodispl As String, ByVal sColtimre As String, ByVal sColinvot As String, ByVal sColReint As String, ByVal sTyp_module As String, ByVal sTyp_Clause As String, ByVal sTyp_Discxp As String, ByVal sDocuTyp As String, ByVal nQ_Certif As Integer, ByVal dEffecdate As Date, ByVal nTypeExc As Integer) As String
        Dim lstrErrorAll As String = String.Empty
        Dim lclsErrors As eFunctions.Errors
...
insvalCA006_Err:
    ...
    Public Function insValAU001(ByVal sCodispl As String, ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nCertif As Double, ByVal dEffecdate As Date, Optional ByVal nValGroup As Integer = 0, Optional ByVal nValSituation As Integer = 0, Optional ByVal nTransaction As Integer = 0, Optional ByVal sRegister As String = "", Optional ByVal sDigit As String = "", Optional ByVal sVehcode As String = "", Optional ByVal nVehType As Integer = 0, Optional ByVal nYear As Integer = 0, Optional ByVal sLicence As String = "", Optional ByVal sMotor As String = "", Optional ByVal sChassis As String = "", Optional ByVal nCapital As Double = 0, Optional ByVal nCollectedPrem As Double = 0, Optional ByVal nUse As Integer = 0) As String
        ...
        lstrErrors = insValAU001DB(sCertype, nBranch, nProduct, nPolicy, nCertif, dEffecdate, nValGroup, nValSituation, nTransaction, sRegister, sDigit, sVehcode, nVehType, nYear, sLicence, sMotor, sChassis, nCapital, nCollectedPrem, nUse)
...
InsValAU001_Err:
    ...
    Public Function insValAU001DB(ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nCertif As Double, ByVal dEffecdate As Date, ByVal nValGroup As Integer, ByVal nValSituation As Integer, ByVal nTransaction As Integer, ByVal sRegister As String, ByVal sDigit As String, ByVal sVehcode As String, ByVal nVehType As Integer, ByVal nYear As Integer, ByVal sLicence As String, ByVal sMotor As String, ByVal sChassis As String, ByVal nCapital As Double, Optional ByVal nCollectedPrem As Double = 0, Optional ByVal nUse As Short = 0) As String
        ...
        With lrecInsValAU001
            ...
            .Parameters.Add("sMassive", "2", eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbVarchar, 1, 0, 0, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
...
InsValAU001DB_Err:
    ...
    Public Function insPostAU001(ByVal sCodispl As String, ByVal sPoltype As String, ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nCertif As Double, ByVal dEffecdate As Date, ByVal nUsercode As Integer, Optional ByVal sLicense_ty As String = "", Optional ByVal sRegist As String = "", Optional ByVal sChassis As String = "", Optional ByVal sMotor As String = "", Optional ByVal sColor As String = "", Optional ByVal sVehcode As String = "", Optional ByVal nYear As Integer = 0, Optional ByVal nValGroup As Integer = 0, Optional ByVal nValSituation As Integer = 0, Optional ByVal nAutoZone As Double = 0, Optional ByVal nCapital As Double = 0, Optional ByVal nTransactio As Integer = 0, Optional ByVal nVehplace As Integer = 0, Optional ByVal nVehpma As Integer = 0, Optional ByVal nDeduc As Double = 0, Optional ByVal dLastClaim As Date = #12:00:00 AM#, Optional ByVal nVestatus As Integer = 0, Optional ByVal nVehType As Integer = 0, Optional ByVal dStartdate As Date = #12:00:00 AM#, Optional ByVal nVeh_valor As Double = 0, Optional ByVal sDigit As String = "", Optional ByVal sRelapsing As String = "", Optional ByVal sN_infrac As String = "", Optional ByVal sReturn As String = "", Optional ByVal nLic_special As Integer = 0, Optional ByVal nCollectedPrem As Double = 0, Optional ByVal sEngine As String = "", Optional ByVal sHybridVehicle As Char = "", Optional ByVal sClient_Dealer As String = "", Optional ByVal sClient_Seller As String = "", Optional ByVal nGroupVeh As Integer = 0, Optional ByVal nType_amend As Double = 0, Optional ByVal nAgenDealer As Integer = 0) As Boolean
        ...
        Dim lclsCertificat As ePolicy.Certificat = New ePolicy.Certificat()
        Dim lclsProperty As ePolicy.Propertys = New ePolicy.Propertys()
        Dim bDepreciatedCapital As Boolean = False
        'Dim sLicense_ty_old   As String
        'Dim sRegist_old       As String
        Dim bProperty As Boolean = False
        lclsAuto = New ePolicy.Automobile
        ...
        If lclsAuto.nVeh_valor <> nVeh_valor Then
            bProperty = True
        End If        
        ...
        With lclsAuto
            ...
            .sEngine = sEngine
            .sHybridVehicle = sHybridVehicle
            .sClient_Dealer = sClient_Dealer
            .sClient_Seller = sClient_Seller
            ...
            Else
                If lclsCertificat.sInd_Multiannual = "1" Then
                    lclsDepreciatedCapital.CalculateDepreciatedCapitalByCoverage(sCertype, nBranch, nProduct, nPolicy, nCertif, nValGroup, dEffecdate, "AU_VEH_NOX2", nVeh_valor, nType_amend, dStartdate, nTransactio)
                End If
                lclsPolicyWin = New ePolicy.Policy_Win
                Call lclsPolicyWin.Add_PolicyWin(sCertype, nBranch, nProduct, nPolicy, nCertif, dEffecdate, nUsercode, "AU001", "2")
            End If
        End With
        If lclsProperty.Find(sCertype, nBranch, nProduct, nPolicy, nCertif, dEffecdate) Then
            If bProperty Then
                lclsPolicyWin = New ePolicy.Policy_Win
                Call lclsPolicyWin.Add_PolicyWin(sCertype, nBranch, nProduct, nPolicy, nCertif, dEffecdate, nUsercode, "CA010", "3")
            End If
        End If
insPostAU001_Err:
        If Err.Number Then
...
Optional nOffice_Associated As Integer = eRemoteDB.Constants.intNull, Optional nOfficeAgen_Associated As Integer = eRemoteDB.Constants.intNull, Optional nAgency_Associated As Integer = eRemoteDB.Constants.intNull, Optional nBranch_Associated As Integer = eRemoteDB.Constants.intNull, Optional nProduct_Associated As Integer = eRemoteDB.Constants.intNull, Optional nPolicy_Associated As Double = eRemoteDB.Constants.intNull, Optional nCertif_Associated As Double = eRemoteDB.Constants.intNull, Optional nTypeAccount As Integer = eRemoteDB.Constants.intNull, Optional sProcess_num As String = eRemoteDB.Constants.strNull, Optional nPolicy_Transfer As Double = eRemoteDB.Constants.intNull, Optional nCertif_transfer As Double = eRemoteDB.Constants.intNull, Optional ByVal sCodbranch_Transfer As String = "") As Boolean
    ...
    Public Function InsTransaction(ByVal nTransaction As Integer, ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nPolicydest As Double, ByVal nCertif As Double, ByVal dEffecdate As Date, ByVal nOffice As Integer, ByVal sBussityp As String, ByVal sPolitype As String, ByVal dLedgerDate As Date, ByVal dNulldate As Date, ByVal dLastChange As Date, ByVal nAgency As Integer, ByVal nOfficeAgen As Integer, ByVal nSellChannel As Integer, ByVal nType_amend As Integer, ByVal nServ_order As Double, ByVal dFer As Date, ByVal nQuotProp As Integer, ByVal nUsercode As Integer, ByVal nDigit As Integer, ByVal nProp_reg As Integer, ByVal nRenewalnum As Integer, ByVal sCodispl As String, Optional ByVal sClient As String = "", Optional ByVal nFolio As Double = 0, Optional ByVal nCod_saapv As Double = -32768, Optional ByVal nInstitution As Double = -32768, Optional nOffice_Associated As Integer = eRemoteDB.Constants.intNull, Optional nOfficeAgen_Associated As Integer = eRemoteDB.Constants.intNull, Optional nAgency_Associated As Integer = eRemoteDB.Constants.intNull, Optional nBranch_Associated As Integer = eRemoteDB.Constants.intNull, Optional nProduct_Associated As Integer = eRemoteDB.Constants.intNull, Optional nPolicy_Associated As Double = eRemoteDB.Constants.intNull, Optional nCertif_Associated As Double = eRemoteDB.Constants.intNull, Optional nTypeAccount As Integer = eRemoteDB.Constants.intNull, Optional sProcess_num As String = eRemoteDB.Constants.strNull, Optional nPolicy_Transfer As Double = eRemoteDB.Constants.intNull, Optional nCertif_transfer As Double = eRemoteDB.Constants.intNull, Optional ByVal sCodbranch_Transfer As String = "") As Boolean
        ...
        With lrecInsTransaction
            ...
            .Parameters.Add("nCod_saapv", nCod_saapv, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbDouble, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
            .Parameters.Add("nInstitution", nInstitution, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbDouble, 22, 0, 5, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)

            .Parameters.Add("nOffice_Associated", nOffice_Associated, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbInteger, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
            .Parameters.Add("nOfficeAgen_Associated", nOfficeAgen_Associated, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbInteger, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
            .Parameters.Add("nAgency_Associated", nAgency_Associated, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbInteger, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
            .Parameters.Add("nBranch_Associated", nBranch_Associated, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbInteger, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
            .Parameters.Add("nProduct_Associated", nProduct_Associated, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbInteger, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
            .Parameters.Add("nPolicy_Associated", nPolicy_Associated, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbDouble, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
            .Parameters.Add("nCertif_Associated", nCertif_Associated, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbDouble, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)

            .Parameters.Add("nTypeAccount", nTypeAccount, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbDouble, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
            .Parameters.Add("sProcess_num", sProcess_num, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbVarchar, 50, 0, 0, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)

            .Parameters.Add("nPolicy_Transfer", nPolicy_Transfer, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbDouble, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
            .Parameters.Add("nCertif_transfer", nCertif_transfer, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbDouble, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
            .Parameters.Add("sCodbranch_Transfer", sCodbranch_Transfer, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbVarchar, 10, 0, 0, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
...
InsTransaction_Err:
    ...
    Private Function insPolicy_CA001(ByVal nTransaction As Integer, ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nCertif As Double, ByVal nUsercode As Integer, ByVal dEffecdate As Date, ByVal nOffice As Integer, ByVal sBussityp As String, ByVal sPolitype As String, ByVal dNulldate As Date, ByVal nAgency As Integer, ByVal nOfficeAgen As Integer, ByRef lclsPolicy As Policy) As Boolean
        ...
        With lclsPolicy
            ...
            '+Si se trata de la emision de una cotizaci�n o solicitud se guarda el n�mero
            '+en otro campo
            ...
            '+Se asigna el valor del usuario de la modificaci�n
            ...
            '+Asignaci�n del par�metro estado de la p�liza como en captura imcompleta s�lo si se est� emitiendo
            .sStatus_pol = IIf(nTransaction <> Constantes.PolTransac.clngPolicyIssue, .sStatus_pol, "3")

            '+ Se asigna la fecha de efecto solo cuando corresponda a una emisi�n
            ...
            '+ Si la transaci�n es Emisi�n, Cotizaci�n o Propuesta de p�liza o certificado
            If nTransaction = Constantes.PolTransac.clngPolicyIssue Or nTransaction = Constantes.PolTransac.clngPolicyProposal Or nTransaction = Constantes.PolTransac.clngPolicyQuotation Then
                ...
                If lclsProduct.Find(nBranch, nProduct, dEffecdate) Then
                    ...
                    Else
                        ...
                        .nNotice = lclsProduct.nCancnoti
                    End If
                    '+Se Recupera el ramo tecnico de la transaci�n
            ...
            '+Asignaci�n del par�metro Sucursal
            .nOffice = nOffice

            '+Asignaci�n del par�metro Propietaria
            .nOffice_own = nOffice

            '+Asignaci�n del par�metro tipo de p�liza
            .sBussityp = sBussityp

            '+Asignaci�n del par�metro tipo de p�liza
            .sPolitype = sPolitype

            '+Asignaci�n del par�metro de n�mero de la Agencia
            .nAgency = nAgency

            '+Asignaci�n del par�metro de n�mero de la Oficina
            ...
            '+Se inicializa el C�digo de Anulaci�n con ceros
...
insPolicy_Ca001_Err:
    ...
    '%insCertificat_ca001: Esta rutina se encarga de realizar la actualizaci�n en la
    '%                     tabla 'certificat'
    Private Function InsCertificat_CA001(ByVal nTransaction As String, ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nCertif As Double, ByVal nUsercode As Integer, ByVal dEffecdate As String, ByVal nSellChannel As Integer, ByVal dFer As Date, ByVal nPol_quot As Double, ByVal nDigit As Integer, ByVal nProp_reg As Integer, ByVal nRenewalnum As Integer) As Boolean
        ...
        '- Variable de tipo booleana que especifica si es la primera vez que se ejecuta esta funci�n
        ...
        With lclsCertificat
            ...
            '+Asignaci�n del par�metro fecha de efecto
            ...
            '+Asignaci�n del par�metro fecha de efecto de la p�liza
            '+Se asigna la fecha de efecto solo cuando corresponda a una emisi�n
            ...
            '+ Si corresponde a un re-emisi�n
            ...
            '+Asignaci�n del par�metro estado del certificado
            .sStatusva = "3"

            '+Asignaci�n del par�metro Indicador de reaseguro
            .sReinsura = "2"

            '+Se inicializa el C�digo de Anulaci�n con ceros
            .nNullcode = eRemoteDB.Constants.intNull

            '+Se inicializa el C�digo del canal de venta
            .nSellChannel = nSellChannel

            '+Se inicializa el C�digo del canal de venta
            .dFer = dFer
            '+ Se asigna el valor a la p�liza asociada a la cotizaci�n en tratamiento
            .nPol_quot = nPol_quot
            '+ Si se trata de una Cotizaci�n/propuesta de poliza/certificado
            '+ propuesta de modificaci�n/renovacion de poliza/certificado,
            '+ cotizaci�n de modificacion/renocaci�n de poliza certificado
...
insParticularData_Err:
    ...
    '% insConvertion2: Convierte las solicitudes a cotizaciones de p�liza
...
insConvertion2_Err:
    ...
    '% insreaParticularTable: lee el nombre de la tabla particular de la p�liza
...
insreaParticularTable_Err:
    ...
    Public Sub insValCA026(ByVal nTransaction As Integer, ByVal lstrCodispl As String, ByVal dEffecdate As Date, ByVal dExpDate As Date, ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nCertif As Double, ByVal lobjErrorsCA001 As Object)
        Dim lclsCertificat As ePolicy.Certificat
        Dim lclsPolicy As ePolicy.Policy
    ...
    '% insValCA017A: Validaci�n Cuotas del Recibo
...
InsValCA017aDB_Err:
    ...
    'insValCA041: Esta funci�n realiza las validaciones de la Informaci�n General del Colectivo
    Public Function insValCA041(ByVal sCodispl As String, ByVal sSel As String, ByVal ncount As Integer, ByVal sExchange As String, ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal sCurrency As String, ByVal nCertif As Double, ByVal dEffecdate As Date) As String
        ...
        Do While Len(sSel) > 0 And Not bLast
            ...
            Else
                '+ Se trata al �ltimo elemento de la cadena o la cadena tra�a s�lo un elemento
                lintSel = CInt(sSel)
                lintCurrency = CInt(sCurrency)
                bLast = True
            End If

            '+ Se valida que no exista cobertura ni recibo asociado a la p�liza/certif con la moneda si
            '+ esta se elimin�
            If lintSel = eRemoteDB.Constants.intNull Or lintSel = 2 Then
                lblnError = False

                If insReaCover_curr(sCertype, nBranch, nProduct, nPolicy, lintCurrency, nCertif) Then
                    lblnError = True
                ElseIf insReaPremium_curr(lintCurrency, sCertype, nBranch, nProduct, nPolicy, nCertif) Then
                    lblnError = True
                End If
        ...
        Call lclsPolicy.Find(sCertype, nBranch, nProduct, nPolicy)
        '+ Se valida que el n�mero de monedas seleccionadas no exceda al m�ximo permitido
        If lclsProduct.Find(nBranch, nProduct, dEffecdate) Then
            'If ncount > lclsProduct.nQmaxcurr And (lclsPolicy.sPolitype = "1" Or nCertif <> 0) Then
            If ncount > lclsProduct.nQmaxcurr Then
...
insValCA041_Err:
    ...
    Public Function insReaCover_curr(ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nCurrency As Integer, ByVal nCertif As Double) As Boolean
        Dim lclsPolicy As ePolicy.Policy
        ...
        If lclsPolicy.Find(sCertype, nBranch, nProduct, nPolicy) Then
            If Not lclsCover.LoadCurr(lclsPolicy.sCertype, lclsPolicy.nBranch, lclsPolicy.nProduct, lclsPolicy.nPolicy, nCertif, lclsPolicy.dStartdate, nCurrency, lclsPolicy.sTyp_module, lclsPolicy.sPolitype) Then
...
insReaCover_curr_Err:
    ...
    Public Function insReaPremium_curr(ByVal nCurrency As Integer, ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nCertif As Double) As Boolean
        Dim lclsPolicy As ePolicy.Policy
        ...
        If lclsPolicy.Find(sCertype, nBranch, nProduct, nPolicy) Then
            ...
            If Not lclsPremium.LoadCurr(sCertype, nBranch, nProduct, nPolicy, nCurrency, nCertif) Then
...
insReaPremium_curr_Err:
    ...
    '% InsVAlIN010: Realiza la validaci�n de los campos a actualizar en la ventana IN010
    Public Function InsValIN010(ByVal sCodispl As String, Optional ByVal sCertype As String = "", Optional ByVal nBranch As Integer = 0, Optional ByVal nProduct As Integer = 0, Optional ByVal nPolicy As Double = 0, Optional ByVal nArticle As Integer = 0, Optional ByVal nDetailArt As Integer = 0, Optional ByVal nConstCat As Integer = 0, Optional ByVal nFloor_quan As Integer = 0, Optional ByVal nIndPeriod As Integer = 0, Optional ByVal nDep_prem As Double = 0, Optional ByVal nDecla_freq As Integer = 0, Optional ByVal nDecla_type As Integer = 0) As String
        ...
        '+Se verifica que el campo Actividad tenga un valor y  que sea v�lido.
        ...
        '+Se verifica la Categor�a de la Construcci�n
        If nConstCat = eRemoteDB.Constants.intNull Or nConstCat = 0 Then
            Call lobjErrors.ErrorMessage(sCodispl, 3505)
        End If

        '+Se verifica que el campo N�mero de Plantas tenga un valor y sea num�rico.
        ...
        '+Se verifica que el campo Per�odo de Indemnizaci�n sea num�rico.
        ...
        '+Se verifica que el campo % Prima de Dep�sito tenga un valor y sea num�rico.
...
InsValIN010_Err:
    ...
    '% insPostIN010: Se realiza la actualizaci�n de los datos en la ventana IN010
...
InsPostIN010_Err:
    ...
    '% insValCA013A: Realiza la validaci�n de los campos a actualizar en la ventana CA013A
    Public Function insValCA013A(ByVal sCodispl As String, ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nGroup As Integer, ByVal dEffecdate As Date, ByVal sTyp_module As String) As String
        ...
        '+Definici�n de par�metros para stored procedure 'InsCA013pkg.InsValCA013Upd'
        '+Informaci�n le�da el 24/04/2003
...
InsValCA013A_Err:
    ...
    Public Function insPostCA013A(ByVal nTransaction As String, ByVal sExists As String, ByVal sSelected As String, ByVal sModulec As String, ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nGroup As Integer, ByVal dEffecdate As Date, ByVal dNulldate As Date, ByVal sTyp_module As String, ByVal nUsercode As Integer, ByVal npremirat As Double, ByVal styp_rat As String, Optional ByVal bPuntual As Boolean = False) As Boolean
        ...
        '+ Definici�n de store procedure insPostca013a al 07-27-2002 16:29:40
...
insPostCA013A_Err:
    ...
    '% insPostCA041: Realiza la acutalizaci�n de la tabla "Sum_insur"
    Public Function insPostCA041(ByVal nTransaction As Integer, ByVal sSel As String, ByVal sExist As String, ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nCertif As Double, ByVal dEffecdate As Date, ByVal nUsercode As Integer, ByVal sCurrency As String) As Boolean
        ...
        Do While Len(sSel) > 0 And Not bLast
            ...
            End If
            '+ Si el proceso es emisi�n, recuperaci�n, solicitud o cotizaci�n
...
insPostCA041_Err:
    ...
    '%cotizaciones o solicitudes a p�liza
...
insConvertion_Err:
    ...
    '%insValCA047: Esta funci�n realiza las validaciones de Informaci�n del pr�stamo/hipoteca.
...
insValCA047_Err:
    ...
    '%insPostCA047: se actualizan los datos correspondiente a la Fecha m�xima de permanencia
...
insPostCA047_Err:
    ...
    '% InsValVI001: Realiza la validaci�n de los campos a actualizar en la ventana VI001
    Public Function InsValVI001(ByVal sCodispl As String, Optional ByVal sCertype As String = "", Optional ByVal nBranch As Integer = 0, Optional ByVal nProduct As Integer = 0, Optional ByVal nPolicy As Double = 0, Optional ByVal nCertif As Double = 0, Optional ByVal dEffecdate As Date = #12:00:00 AM#, Optional ByVal sValGroup As String = "", Optional ByVal nValSituation As Integer = 0, Optional ByVal nTypDurins As Integer = 0, Optional ByVal nInsur_time As Integer = 0, Optional ByVal nPernunmi As Double = 0, Optional ByVal nCapital As Double = 0, Optional ByVal nCapital_ca As Double = 0, Optional ByVal dExpirdat As Date = #12:00:00 AM#, Optional ByVal nTypDurpay As Integer = 0, Optional ByVal nPay_time As Integer = 0, Optional ByVal dDate_pay As Date = #12:00:00 AM#, Optional ByVal nRentamount As Integer = 0, Optional ByVal nCurrrent As Integer = 0, Optional ByVal nTransaction As Integer = 0) As String
        ...
        Dim lclsProduct As eProduct.Product
        Dim lclsCertificat As Certificat
        'Dim lcolSituation As ePolicy.Situations
        ...
        With lobjErrors
            '+Validaci�n del campo grupo colectivo
            If nCertif <> 0 Then
                ...
                '+Validaci�n del campo Situaci�n del riesgo.
                If lclsSituation.insReaSituation(sCertype, nBranch, nProduct, nPolicy) Then
                    lblnSituation = True
                End If
                If (nValSituation = 0 Or nValSituation = eRemoteDB.intNull) And lblnSituation Then
                    .ErrorMessage(sCodispl, 13983)
                Else
                    'se valida que la situacion de riesgo pertenezca al convenio de la poliza, 
                    If lclsSituation.FindSituationData(sCertype, nBranch, nProduct, nPolicy, nValSituation) Then
                        Dim nCod_AgreeAUX As Integer

                        Call lclsCertificat.Find(sCertype, nBranch, nProduct, nPolicy, nCertif)

                        nCod_AgreeAUX = lclsCertificat.nCod_Agree
                        If nCod_AgreeAUX = eRemoteDB.Constants.intNull Then
                            nCod_AgreeAUX = 0
                        End If

                        If lclsSituation.ncod_Agree <> nCod_AgreeAUX Then
                            .ErrorMessage(sCodispl, 12)
                        End If
                    End If
                End If
            ...
            '+Se verifica que el indicador de duraci�n este con informaci�n
            If nTypDurins = eRemoteDB.Constants.intNull Or nTypDurins = 0 Then
                .ErrorMessage(sCodispl, 60167)
            Else
                '+Se verifica el indicador de duraci�n del seguro para saber que campos deben estar llenos del
                '+del frame de duraci�n/Seguro
                ...
                '+del frame de duraci�n/Pagos
                If nTypDurpay = eRemoteDB.Constants.intNull Or nTypDurpay = 0 Then
                    .ErrorMessage(sCodispl, 60180)
                Else
                    '+Se verifica el indicador de duraci�n del pago para saber que campos deben estar llenos del
                    '+del frame de duraci�n/Pagos
                    If nTypDurpay <> CDbl("4") And nTypDurpay <> CDbl("5") And nTypDurpay <> CDbl("6") Then
                        '+ Validaciones sobre la duraci�n de los pagos del seguro
            ...
            '+ La fecha hasta del seguro y de los pagos debe estar dentro de las fecha vigentes para la p�liza
            If lclsCertificat.Find(sCertype, nBranch, nProduct, nPolicy, nCertif) Then
                If dExpirdat <> eRemoteDB.Constants.dtmNull Then
                ...
                If dDate_pay <> eRemoteDB.Constants.dtmNull Then
                    ...
                    End If
                End If
                '+ Se valida que la duraci�n de la p�liza se mayor o idual a la duraci�n m�nima
                '+ establecida en el dise�ador de productos
                    ...
                    If mintMinDurIns > 0 Then
                        Select Case nTypDurins
                            Case 1, 2 '+ Anual, Edad alcanzada
                                .ErrorMessage(sCodispl, 80180, , , " por el producto (" & mintMinDurIns & " A�os).")
                            Case 8 '+ Meses
                                .ErrorMessage(sCodispl, 80180, , , " por el producto (" & mintMinDurIns & " Meses).")
                            Case 9 '+ D�as
                                .ErrorMessage(sCodispl, 80180, , , " por el producto (" & mintMinDurIns & " D�as).")
                        End Select
                    Else
                        If nTypDurins = 1 Then
                            .ErrorMessage(sCodispl, 80181, , , " (" & nInsur_time & " A�os).")
                        End If
                    End If
                End If
            End If
...
InsValVI001_Err:
    ...
    '%InsPostVI001: Se realiza la actualizaci�n de los datos en la ventana VI001
    Public Function insPostVI001(ByVal sAction As String, ByVal sCodispl As String, Optional ByVal sCertype As String = "", Optional ByVal nBranch As Integer = 0, Optional ByVal nProduct As Integer = 0, Optional ByVal nPolicy As Double = 0, Optional ByVal nCertif As Double = 0, Optional ByVal dEffecdate As Date = #12:00:00 AM#, Optional ByVal nUsercode As Integer = 0, Optional ByVal nCapital As Double = 0, Optional ByVal nPernunmi As Double = 0, Optional ByVal nTypDurins As Integer = 0, Optional ByVal nInsur_time As Integer = 0, Optional ByVal sPoltype As String = "", Optional ByVal nValGroup As Integer = 0, Optional ByVal nValSituation As Integer = 0, Optional ByVal dExpirdat As Date = #12:00:00 AM#, Optional ByVal nRentamount As Double = 0, Optional ByVal nCurrrent As Integer = 0, Optional ByVal nCount_insu As Integer = 0, Optional ByVal nPerc_cap As Double = 0, Optional ByVal nTypDurpay As Integer = 0, Optional ByVal nPay_time As Integer = 0, Optional ByVal dDate_pay As Date = #12:00:00 AM#) As Boolean
        ...
        '+
        '+ Definici�n de store procedure reaVeh_allow_v al 05-07-2002 09:46:35
        '+
...
insPostVI001_Err:
    ...
    '% insValCA016A: Realiza la validaci�n del frame de recargos y descuentos
    '------------------------------------------------------------
...
insValCA016A_Err:
    ...
    '% insreaPolicy_quotprop: retorna las cotizaciones pendientes de una p�liza
    Private Function insreaPolicy_quotprop(ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nCertif As Double, ByVal nQuotProp As Integer, ByVal nStatquota As Certificat.Stat_quot, ByVal objError As eFunctions.Errors) As Boolean
        ...
        '+Definici�n de par�metros para stored procedure 'reapolicy_quotprop'
        '+Informaci�n le�da el 20/11/2001
...
ReaPolicy_QuotProp_Err:
    ...
    '% AddQuotProp: se genera la cotizaci�n/propuesta de modificaci�n/renovaci�n
    Private Function AddQuotProp(ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nCertif As Double, ByVal nProponum As Double, ByVal dEffecdate As Date, ByVal dLedgetdat As Date, ByVal nType_amend As Integer, ByVal nServ_order As Double, ByVal dFer As Date, ByVal nTransaction As Integer, ByVal nUsercode As Integer) As Boolean
        ...
        '+Definici�n de par�metros para stored procedure 'creQuotPropPolicy'
        '+Informaci�n le�da el 11/12/2001
    ...
    Public Function insValAM002Upd(ByVal sAction As String, ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal dEffecdate As Date, ByVal nTariff As Integer, ByVal nGroup As Integer, ByVal nRole As Integer, ByVal nAgeIni As Integer, ByVal nAgeEnd As Integer, ByVal nGroup_comp As Integer, ByVal nPremium As Double, ByVal nGroupDed As Double, ByVal nModulec As Integer, ByVal nCover As Integer, Optional ByVal nCapital As Double = 0) As String
        ...
        With lobjError
            ...
            If Not lblnError Then
                '+ Validaci�n del campo: Edad inicial.
                If nAgeIni < 0 Then
                    .ErrorMessage("AM002", 10247)
                    lblnError = True
                End If

                '+ Validaci�n del campo: Edad final.
                If nAgeEnd <= 0 Then
                    .ErrorMessage("AM002", 10248)
                    lblnError = True
                End If

                '+ Validaci�n de que la edad final sea mayor que la edad inicial.
                ...
                '+ Validaci�n del campo: Composici�n de grupo.
                ...
                If Not lblnError Then
                    If sAction = "Add" Then
                        ...
                        '+ Validaci�n del rango de edades.
                ...
                '+ Validaci�n del campo: Suma asegurada.
                If nCapital <= 0 Then
                    .ErrorMessage("AM002", 11431)
                End If

                '+ Validaci�n del campo: Prima.
...
insValAM002Upd_Err:
    ...
    Public Function insValAM002(ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nCertif As Double, ByVal dEffecdate As Date, ByVal sPolitype As String, ByVal sDefaulti As String, ByVal nTariff As Integer, ByVal nGroup As Integer, ByVal nRole As Integer, Optional ByVal sWait_type As String = "1", Optional ByVal nWait_quan As Short = 0) As String
        ...
        With lobjError
            ...
            If Not lblnError Then
                '+ Validaci�n del campo: Por defecto (solo para cuando se trate de p�liza matriz).
                If sPolitype <> "1" And nCertif = 0 Then
                    lclsTar_am_pol = New eBranches.Tar_am_pol
                    '+ Si la tarifa est� seleccionado por defecto.
                    If sDefaulti = "1" Then
                        '+ Debe indicar informaci�n del detalle de la tarifa.
            ...
            '+ Si se indica tipo de plazo de espera, se debe indicar la cantidad
            If sWait_type <> "1" And _
                (nWait_quan = eRemoteDB.Constants.intNull Or _
                 nWait_quan = 0) Then
                .ErrorMessage("AM002", 9000050)
                lblnError = True
            End If
...
insValAM002_Err:
    ...
    Public Function insPostAM002(ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nCertif As Double, ByVal dEffecdate As Date, ByVal nTariff As Integer, ByVal nGroup As Integer, ByVal nRole As Integer, ByVal sDefaulti As String, ByVal nTransaction As Integer, ByVal dNulldate As Date, ByVal nUsercode As Integer, ByVal nModulec As Integer, ByVal nCover As Integer, Optional ByVal sWait_type As String = "1", Optional ByVal nWait_quan As Short = 0) As Boolean
        ...
        '+ Si la p�liza es matriz o individual
        If nCertif <= 0 Then
...
insPostAM002_Err:
    ...
    Public Function insPostAM002Upd(ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nCertif As Double, ByVal nTariff As Integer, ByVal sDefaulti As String, ByVal nGroup As Integer, ByVal nRole As Integer, ByVal dEffecdate As Date, ByVal nAge_init As Integer, ByVal nAge_end As Integer, ByVal nGroup_comp As Integer, ByVal dNulldate As Date, ByVal nPremium As Double, ByVal nUsercode As Integer, ByVal nTransaction As Integer, ByVal sAction As String, ByVal nGroupDed As Double, ByVal nModulec As Integer, ByVal nCover As Integer, Optional ByVal nCapital As Double = 0) As Boolean
        ...
        '+ Se verifica que exista informaci�n en tar_am_bas (maestro de las tarifas)
        ...
        If insPostAM002Upd Then
            '+ Se actualiza la informaci�n de tar_am_pol (detalle de las tarifas).
            insPostAM002Upd = lclsTar_am_pol.insCreUpdTar_am_pol(sAction, nTransaction, sCertype, nBranch, nProduct, nPolicy, dEffecdate, dNulldate, nTariff, nRole, nGroup, nAge_init, nAge_end, nGroup_comp, nPremium, nUsercode, nGroupDed, nModulec, nCover, nCapital)
        End If
...
insPostAM002Upd_Err:
    ...
    '%insValAM003Upd: valida la informaci�n almacenada en la ventana AM003
    Public Function insValAM003Upd(ByVal sAction As String, ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nCertif As Double, ByVal nGroup As Integer, ByVal nModulec As Integer, ByVal nCover As Integer, ByVal nTariff As Integer, ByVal nRole As Integer, ByVal sClient As String, ByVal sIllness As String, ByVal nPay_Concep As Integer, ByVal nPrestac As Integer, ByVal nDed_Type As Integer, ByVal nDed_Percen As Double, ByVal nDed_Amount As Double, ByVal nDed_Quanti As Integer, ByVal nLimit As Double, ByVal nLimit_exe As Double, ByVal nLimitH As Double, ByVal nIndem_rate As Double, ByVal nTyplim As Integer, ByVal ncount As Integer, ByVal sCaren_type As String, ByVal nCaren_Dur As Integer, ByVal NDED_QUANTI_2 As Integer, ByVal NINDEM_RATE_2 As Double, ByVal NLIMIT_2 As Double, ByVal NTYPLIM_2 As Integer, ByVal NCOUNT_2 As Integer, ByVal NLIMIT_EXE_2 As Double, ByVal NPUNISH_2 As Double, ByVal SOTHERLIM As String, ByVal dEffecdate As Date) As String
        ...
        With lobjErrors
            '+ Valida que la tarifa se haya inclu�do y no se haya borrado su contenido del campo
            If nTariff <= 0 Then
                .ErrorMessage("AM003", 3550)
            End If

            '+ Valida que la cobertura se haya inclu�do y no se haya borrado su contenido
            If nCover <= 0 Then
                .ErrorMessage("AM003", 3552)
            End If

            '+ Valida que el concepto se haya inclu�do.
            If nPay_Concep <= 0 Then
                .ErrorMessage("AM003", 100136)
            End If

            '+ Valida que la prestaci�n se haya inclu�do.
            If nPrestac <= 0 Then
                .ErrorMessage("AM003", 100137)
            End If

            '+ Se valida que la combinaci�n Concepto-prestaci�n sean �nicos.
            ...
            '+Se valida el campo "Duraci�n de la carencia"
            ...
            Else
                ...
                If nDed_Type <> 1 Then
                    '+ Se debe agregar informaci�n de los campos del deducible
            ...
            '+Se valida que el campo "D�as" sea mayor que cero.
            '        If nDed_Quanti <= 0 Then
            '+ Si el concepto coresponde a Habitaci�n-cuartos
            '            If nPay_Concep = 12 Then
            '                .ErrorMessage "AM003", 3749, , LeftAling, "D�as: "
            '            End If
            '        End If

            '+ Se efect�an las validaciones del campo "%Indemnizar". Se valida que el campo no est� vacio
            ...
            '+Se valida que el campo "L�mite" sea mayor que cero.
            If nLimit > 0 Then
                '+ Si el Monto es mayor al l�mite cobertura
            ...
            If SOTHERLIM = "1" Then
                ...
                Else
                    ...
                    If nDed_Type > 0 Then
                        ...
                        If nDed_Type <> 1 Then
                            ...
                            If nDed_Percen <= 0 And nDed_Amount <= 0 And NDED_QUANTI_2 <= 0 Then
                                .ErrorMessage("AM003", 38038, , eFunctions.Errors.TextAlign.LeftAling, "L�mite parte 2: ")
                            Else
                                If nDed_Percen > 0 And nDed_Amount > 0 And NDED_QUANTI_2 > 0 Then
                                    .ErrorMessage("AM003", 3556, , eFunctions.Errors.TextAlign.LeftAling, "L�mite parte 2: ")
                                Else
                        ...
                        Else
                            ...
                            If nDed_Percen > 0 Or nDed_Amount > 0 Or NDED_QUANTI_2 > 0 Then
                                .ErrorMessage("AM003", 3555, , eFunctions.Errors.TextAlign.LeftAling, "L�mite parte 2: ")
                            End If
                        End If
                    End If
                    ...
                    '+ Si el concepto coresponde a Habitaci�n-cuartos
                    '              If nPay_Concep = 12 Then
                    '                .ErrorMessage "AM003", 3749, , LeftAling, "L�mite parte 2 - D�as: "
                    '              End If
                    '            End If

                    '+ Se efect�an las validaciones del campo "%Indemnizar". Se valida que el campo no est� vacio
                    If NINDEM_RATE_2 <= 0 Then
                        .ErrorMessage("AM003", 3557, , eFunctions.Errors.TextAlign.LeftAling, "L�mite parte 2: ")
                    Else
                        '+ Se valida que el campo este comprendido entre 0 y 100
                        If NINDEM_RATE_2 <= 0 Or NINDEM_RATE_2 > 100 Then
                            .ErrorMessage("AM003", 3558, , eFunctions.Errors.TextAlign.LeftAling, "L�mite parte 2: ")
                        End If
                    End If
                    ...
                    If NLIMIT_2 > 0 Then
                        ...
                        If nDed_Amount > NLIMIT_2 Then
                            .ErrorMessage("AM003", 38036, , eFunctions.Errors.TextAlign.LeftAling, "L�mite parte 2: ")
                        End If
                    End If
                    ...
                    If NTYPLIM_2 = 7 Then
                        If NCOUNT_2 <= 0 Then
                            .ErrorMessage("AM003", 55701, , eFunctions.Errors.TextAlign.LeftAling, "L�mite parte 2: ")
                        End If
                    End If
                End If
            End If
...
insValAM003Upd_Err:
    ...
    '%insValAM003: valida la informaci�n almacenada en la ventana AM003
    Public Function insValAM003(ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nCertif As Double, ByVal dEffecdate As Date, ByVal nTariff As Integer, ByVal nCover As Integer) As String
        ...
        With lobjErrors
            ...
            '+ Se verifica si existe informaci�n
            ...
            If Not lblnError Then
                '+Se valida que la suma de los l�mites de los conceptos no sean superior al l�mite de la cobertura.
                lclsTab_am_bil = New eBranches.Tab_Am_Bil
...
insPostAM003Upd_Err:
    ...
    Public Function insPostAM003(ByVal nTransaction As Integer, ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nCertif As Double, ByVal dEffecdate As Date, ByVal dNulldate As Date, ByVal nUsercode As Integer) As Boolean
        ...
        '+ Se elimina la informaci�n del maestro cuando no existe informaci�n en el detalle.
        ...
        '+ Se verifica si existe informaci�n en el sistema
...
reaVeh_allow_v_Err:
    ...
    '%InsValRelapsing: Revisa si el automovil est� asugurado en alguna otra poliza sin importar el
    ...
    Public Function InsValRelapsing(ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nCertif As Double, ByVal dEffecdate As Date, ByVal sVehcode As String, ByVal nYear As Integer, ByVal sRegist As String) As Boolean
        ...
        '+ Definici�n de store procedure InsValRelapsing al 28-01-2003
...
InsValRelapsing_Err:
    ...
    Public Function insValCA017(ByVal sCodispl As String, ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal dEffecdate As Date, ByVal nReceipt As Double, ByVal sList As String, ByVal nPremium As Double) As String
        Dim lrecInsValCA017 As eRemoteDB.Execute
        Dim lobjErrors As eFunctions.Errors
        Dim lstrError As String = String.Empty
        '+Definici�n de par�metros para stored procedure 'InsCA017pkg.InsValCA017Upd'
        '+Informaci�n le�da el 24/04/2003
...
RefreshSequence_Err:
    ...
    '%InsValVI7001: Esta funci�n realiza la validaci�n de los campos a actualizar en la ventana VI7001.
    ...
    Public Function InsValVI7001(ByVal sCodispl As String, ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nCertif As Double, ByVal dEffecdate As Date, ByVal sValGroup As String, ByVal sValSituation As String, ByVal sIndSecure As String, ByVal sIndPay As String, ByVal nInsurTimeAge As Integer, ByVal nInsurTimeAgeLimit As Integer, ByVal nInsurPayTimeAge As Integer, ByVal nInsurPayTimeAgeLimit As Integer, ByVal nAge As Integer, ByVal nAge_reinsu As Integer, ByVal nAge_limit As Integer, ByVal nCapital As Double, ByVal nCapitalCalc As Double, Optional ByVal nSaving_pct As Integer = 0, Optional ByVal nDisc_save_pct As Integer = 0, Optional ByVal nDisc_unit_pct As Integer = 0, Optional ByVal nIndex_table As Integer = 0, Optional ByVal nWarrn_table As Integer = 0, Optional ByVal nPremDeal As Double = 0, Optional ByVal nIntwarr As Double = 0, Optional ByVal nOption As Integer = 0, Optional ByVal nTransaction As Integer = 0, Optional ByVal nTypDurpay As Integer = 0, Optional ByVal nPay_time As Integer = 0) As String
        ...
        '+ Se obtiene el plan asociado a la p�liza/certificado.
        Call lclsTab_Activelife.Find(nBranch, nProduct, nModulec, eRemoteDB.Constants.intNull, dEffecdate)
        ...
        '+ Prima seg�n frecuencia de pago: Si este campo est� lleno, debe ser mayor o igual a la
        '+ prima m�nima definida para el producto
        ...
        '+Se valida que seg�n el indicador que est� encendido en el archivo para la duraci�n del seguro o para la duraci�n de los pagos del
        '+est�n, se deban llenar ciertos campos del frame de duraci�n/pagos o duraci�n/seguro (Siempre uno de los indicadores estar� encendido)

        '+Se verifica el indicador de duraci�n de los pagos del seguro para saber que campos deben estar llenos del
        '+del frame de duraci�n/Seguro

        If sIndSecure <> "-1" And sIndSecure <> "1" Then

            '+Si devuelve que el indicador de seguro expresa n�mero de a�os entonces el campo a�os deber� estar lleno
        ...
        Select Case sIndPay
            ...
            Case "3"
                ...
                Else
                    ...
                    '+Si est� lleno debe ser mayor a la edad-real
        ...
        '+Se valida que en el frame de Edad, el campo edad real est� lleno

        If nAge = eRemoteDB.Constants.intNull Then
            lobjErrors.ErrorMessage(sCodispl, 3953)
        Else

            '+ Si es vida, se verifica que la edad del asegurado est� entre el rango de edades
            '+ de contrataci�n definidas para el producto
        ...
        '+Se valida que en el frame de Edad, el campo edad actuarial est� lleno

        If nAge_reinsu = eRemoteDB.Constants.intNull Then
            lobjErrors.ErrorMessage(sCodispl, 3954)
        Else

            '+De estar lleno, debe ser menor que la edad alcanzada del frame de duraci�n/seguro
        ...
        '+Se valida que en el frame de Edad, si el campo edad m�ximo est� lleno sea menor a la edad alcanzada del frame
        '+duraci�n/seguro-edad alcanzada
        ...
        '+De estar lleno el campo del frame de edad, edad m�xima, �ste debe ser mayor a la edad real

        If nAge_limit < nAge Then
            lobjErrors.ErrorMessage(sCodispl, 3601)
        End If

        '+Se valida la duraci�n/Pagos
        If nTypDurpay = eRemoteDB.Constants.intNull Or nTypDurpay = 0 Then
        ...
        '+Se validan los campos prima total y nCapital del frame C�lculo de prima y c�lculo de nCapital
...
ErrorHandler:
    ...
    '%Objetivo: Se realiza la actualizaci�n de los datos en la ventana VI7001
    Public Function InsPostVI7001(ByVal sAction As String, ByVal sCodispl As String, Optional ByVal sCertype As String = "", Optional ByVal nBranch As Integer = 0, Optional ByVal nProduct As Integer = 0, Optional ByVal nPolicy As Double = 0, Optional ByVal nCertif As Double = 0, Optional ByVal dEffecdate As Date = #12:00:00 AM#, Optional ByVal nUsercode As Integer = 0, Optional ByVal nAge As Integer = 0, Optional ByVal nAge_limit As Integer = 0, Optional ByVal nAge_reinsu As Integer = 0, Optional ByVal nCapital As Double = 0, Optional ByVal nCapitalCalc As Double = 0, Optional ByVal nInsurTimeAge As Integer = 0, Optional ByVal nInsurTimeAgeLimit As Integer = 0, Optional ByVal nInsurPayTimeAge As Integer = 0, Optional ByVal nInsurPayTimeAgeLimit As Integer = 0, Optional ByVal sPduraind As String = "", Optional ByVal sIduraind As String = "", Optional ByVal sIndSecure As String = "", Optional ByVal nPay_time As Integer = 0, Optional ByVal sIndPay As String = "", Optional ByVal nInsur_time As Integer = 0, Optional ByVal sPoltype As String = "", Optional ByVal nValGroup As Integer = 0, Optional ByVal nValSituation As Integer = 0, Optional ByVal nPremium_ca As Double = 0, Optional ByVal nSaving_pct As Integer = 0, Optional ByVal nDisc_save_pct As Integer = 0, Optional ByVal nDisc_unit_pct As Integer = 0, Optional ByVal nIndex_table As Integer = 0, Optional ByVal nWarrn_table As Integer = 0, Optional ByVal nOption As Integer = 0, Optional ByVal nPremiumbas As Double = 0, Optional ByVal nModulec As Integer = 0, Optional ByVal nPremDeal As Double = 0, Optional ByVal nPremDeal_anu As Double = 0, Optional ByVal nPremMin As Double = 0, Optional ByVal nIntwarr As Double = 0, Optional ByVal nTransaction As Integer = 0, Optional ByVal nTypDurins As Integer = 0, Optional ByVal nTypDurpay As Integer = 0) As Boolean
        ...
        With lclsLife
            ...
            '+ Modificaci�n de fecha de vencimiento para
            '+ duraci�n de seguro Libre
            If .sIduraind = "4" Then
                ...
                'Actualizaci�n dexpirdat a policy
            ...
            '+Se actualiza el grupo y la situaci�n a certificat
...
InsPostVI7001_Err:
    ...
    '% GenPolTransac: Obtiene la transacci�n general que se est� ejecutando
    ...
    '%PolicyIsNeed: Indica si el campo p�liza es obligatorio seg�n la transacci�n
    ...
    '%CertifIsNeed: Indica si el campo p�liza es obligatorio seg�n la transacci�n
    ...
    '%PropQuotIsNeed: Indica si el campo p�liza es obligatorio seg�n la transacci�n
    ...
    '%GetPolCertype: Obtiene el valor SCERTYPE seg�n la transacci�n
    ...
    '% InsValStatusPol: Valida el estado actual de la p�liza
    Private Function InsValStatusPol(ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nCertif As Double, ByVal nTransaction As Constantes.PolTransac, ByVal nGenTransac As Constantes.eGenPolTransac, ByVal sStatusva As String) As Integer
        ...
        '+Si la p�liza est� saldada o prorrogada entonces solamente puede ser consultada
        If sStatusva = "7" And nGenTransac <> Constantes.eGenPolTransac.clngQuery Then

            llngErrornum = 3971

            '+Si la transacci�n es recuperaci�n se valida que la p�liza/certificado este incompleta
        ElseIf nTransaction = Constantes.PolTransac.clngRecuperation Then
            ...
            '+Si la transacci�n es modificaci�n o re-emisi�n se valida que la p�liza/certificado
            '+este v�lida
        ElseIf nGenTransac = Constantes.eGenPolTransac.clngAmend Or nGenTransac = Constantes.eGenPolTransac.clngAmendPropQuot Or nTransaction = Constantes.PolTransac.clngPolicyReissue Or nTransaction = Constantes.PolTransac.clngCertifReissue Then
            ...
            If sStatusva <> "1" And sStatusva <> "4" And sStatusva <> "5" Then
                ...
                '+Se v�lida si la p�liza/certificado est� anulado
                If sStatusva = "6" Then
                    llngErrornum = 3098
                Else
                    If nCertif = 0 Then
                ...
                End If
            Else
                '+Si la transacci�n es re-emisi�n se valida que la p�liza no tenga movimientos posteriores
                '+a la emisi�n
                If nTransaction = Constantes.PolTransac.clngPolicyReissue Or nTransaction = Constantes.PolTransac.clngCertifReissue Then
            ...
            '+Si es reimpresi�n se valida que la p�liza este impresa
    ...
    '% InsValCA001: Esta rutina realiza las validaciones de los campos de la p�gina.
    '               CA001_K.aspx - Tratamiento de p�lizas
    Public Function InsValCA001(ByVal sCodispl As String, ByVal nTransaction As Integer, ByVal dEffecdate As Date, ByVal nOffice As Integer, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nPolicydest As Double, ByVal nCertif As Double, ByVal sPolitype As String, ByVal dLedgerDate As Date, ByVal nUsercode As String, ByVal dExpDate As Date, ByVal nAgency As Integer, ByVal nOfficeAgen As Integer, ByVal nSellChannel As Integer, ByVal nType_amend As Integer, ByVal nServ_order As Double, ByVal nPropQuot As Double, ByVal nDigit As Integer, ByVal nProp_reg As Integer, Optional ByVal nFolio As Double = 0, Optional ByVal nCod_saapv_aux As Double = -32768, Optional ByVal nInstitution_aux As Double = -32768, Optional ByVal nOffice_Associated As Integer = eRemoteDB.Constants.intNull, Optional ByVal nOfficeAgen_Associated As Integer = eRemoteDB.Constants.intNull, Optional ByVal nAgency_Associated As Integer = eRemoteDB.Constants.intNull, Optional ByVal nBranch_Associated As Integer = eRemoteDB.Constants.intNull, Optional ByVal nProduct_Associated As Integer = eRemoteDB.Constants.intNull, Optional ByVal nPolicy_Associated As Double = eRemoteDB.Constants.intNull, Optional ByVal nCertif_Associated As Double = eRemoteDB.Constants.intNull, Optional ByVal sProcess_num As String = eRemoteDB.Constants.strNull, Optional ByVal nPolicy_Transfer As Double = eRemoteDB.Constants.intNull, Optional ByVal NTYPEACCOUNT As Double = eRemoteDB.Constants.intNull) As String
        ...
        With lrecinsvalCA001
            ...
            .Parameters.Add("nProp_reg", nProp_reg, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbInteger, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
            .Parameters.Add("nFolio", nFolio, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbDouble, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
            .Parameters.Add("nCod_saapv_aux", nCod_saapv_aux, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbDouble, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
            .Parameters.Add("nInstitution_aux", nInstitution_aux, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbDouble, 22, 0, 5, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
...
insvalCA001_Err:
    ...
    Private Function ReaPropQuotPremium(ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nCertif As Double) As Boolean
        ...
        '+Definici�n de par�metros para stored procedure 'ReaPropQuotPremium'
        '+Informaci�n le�da el 21/03/2003
...
ReaPolicy_QuotProp_Err:
    ...
    '% insPostCA851: se realizan la actualizaci�n de los campos de la forma CA851
    Public Function insPostCA851(ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nCertif As Double, ByVal nAFP_Commiss As Double, ByVal dEffecdate As Date, ByVal nWaypay As Integer, ByVal sDirTyp As String, ByVal nBill_day As Integer, ByVal nOrigin As Integer, ByVal nAFP_Comm_Curr As Integer, ByVal nUsercode As Integer, Optional ByVal sDirTyp_old As String = "", Optional ByVal nCollector As Integer = 0) As Boolean
        ...
        '+ Se invoca el SP para Postidar los campos de la transacci�n
...
insvalCA851_Err:
    ...
    '% insValFall_Vul: V�lida y calcula suma asegurada para fallecimiento
...
insValFall_Vul_Err:
    ...
    '% insPostVI7010. Esta rutina se encarga de realizar actualizaci�n de la ventana
    '% "Informaci�n general VUL" VI7010
...
insvalVI7010_Err:
    ...
    '% insPostVI7011. Esta rutina se encarga de realizar actualizaci�n de la ventana
    '% "Coberturas" VI7011
...
insValCAL901_Err:
    ...
    '% DateType_Amend: Se valida que la duraci�n real de la p�liza sea mayor o igual a la duraci�n
    '% m�nima establecida en el dise�ador de productos
    Public Function insValDuration(ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nCertif As Double, ByVal dEffecdate As Date, ByVal dDate_Origi As Date, ByVal nTypDurins As Integer, ByVal nInsur_time As Integer) As Boolean
        ...
        If nTypDurins <> 4 And nTypDurins <> 5 And nTypDurins <> 6 Then
            ...
            '+ Se determina la fecha de fin de la p�liza seg�n el tipo de duraci�n
            ...
            '% ydavila 14/01/2009
            '% Es necesario incluir la condiciones para este manejo cuando el tipo de duraci�n es variable

            '+ Se recuperan los datos del asegurado de la p�liza
            If lclsRoleses.Find_by_Policy(sCertype, nBranch, nProduct, nPolicy, nCertif, String.Empty, dEffecdate, 2) Then
                ...
                '+ Si el tipo de duraci�n es Edad Alcanzada, se calcula la edad actuarial del asegurado a la fecha original de la p�liza
                If nTypDurins = 1 Then '+ Edad alcanzada
                    ...
                    If lclsRoles.mintInsuAge < nInsur_time Then
                        ...
                        End If
                    Else
                        '+ Si la edad del asegurado es mayor que la establecida para el asegurado no se puede emitir la p�liza
                        If lclsDurinsu_prod.Find(nBranch, nProduct, nInsur_time, dEffecdate, nTypDurins) Then
                            If lclsDurinsu_prod.nMinDurIns > 0 Then
                                If nDurAge < lclsDurinsu_prod.nMinDurIns Then
                                    insValDuration = True
                    ...
                    '+ En caso contrario se calcula edad actuarial del asegura al final de la p�liza
                Else
                    ...
                    '+ Se busca la edad m�xima de permanencia en los datos del producto
...
DateType_Amend_Err:
    ...
    '% insPostCA004: Se realiza la actualizaci�n de los datos
    Public Function insPostCA830(ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nCertif As Double, ByVal nCoverageCertificate As Double, ByVal dEffecdate As Date, ByVal nUsercode As Integer) As Boolean
        Dim lrecInsPostCA830 As eRemoteDB.Execute

        On Error GoTo InsPostCA830_Err

        lrecInsPostCA830 = New eRemoteDB.Execute

        '+Definici�n de par�metros para stored procedure 'InsPostCA830'
        '+Informaci�n le�da el 23/04/2003
        With lrecInsPostCA830
            .StoredProcedure = "insCA830PKG.inspostCA830"
            .Parameters.Add("sCertype", sCertype, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbVarchar, 1, 0, 0, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
            .Parameters.Add("nBranch", nBranch, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbInteger, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
            .Parameters.Add("nProduct", nProduct, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbInteger, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
            .Parameters.Add("nPolicy", nPolicy, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbDouble, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
            .Parameters.Add("nCertif", nCertif, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbDouble, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
            .Parameters.Add("nCoverageCertificate", nCoverageCertificate, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbDouble, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
            .Parameters.Add("dEffecdate", dEffecdate, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbDBTimeStamp, 0, 0, 0, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
            .Parameters.Add("nUsercode", nUsercode, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbInteger, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
            insPostCA830 = .Run(False)
        End With
...
InsPostCA830_Err:
        If Err.Number Then
            insPostCA830 = False
        End If
        'UPGRADE_NOTE: Object lrecInsPostCA830 may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
        lrecInsPostCA830 = Nothing
        On Error GoTo 0
    End Function

    '% insValCA830: se realizan las validaciones de los campos de la forma CA830
    Public Function insValCA830(ByVal sCodispl As String, ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nCertif As Double, ByVal nCoverageCertificate As Double, Byval nIntermed As Double, ByVal dEffecdate As Date) As String
        Dim lstrErrorAll As String = String.Empty
        Dim lclsErrors As eFunctions.Errors
        Dim lrecinsvalCA830 As eRemoteDB.Execute

        On Error GoTo insvalCA830_Err
        ...
        With lrecinsvalCA830
            .StoredProcedure = "insCA830PKG.insvalCA830"
            .Parameters.Add("sCertype", sCertype, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbVarchar, 1, 0, 0, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
            .Parameters.Add("nBranch", nBranch, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbInteger, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
            .Parameters.Add("nProduct", nProduct, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbInteger, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
            .Parameters.Add("nPolicy", nPolicy, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbDouble, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
...
insvalCA830_Err:
        If Err.Number Then
            insValCA830 = "insvalCA830: " & Err.Description
        End If
        On Error GoTo 0
        'UPGRADE_NOTE: Object lclsErrors may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
        lclsErrors = Nothing
        'UPGRADE_NOTE: Object lrecinsvalCA004 may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
        lrecinsvalCA830 = Nothing
    End Function
