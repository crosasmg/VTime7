...
Module ConstLanguage
    ...
    'Public Const HttpContext.GetGlobalResourceObject("BackOfficeResource", "Policy") As String = "Póliza" '4
    'Public Const HttpContext.GetGlobalResourceObject("BackOfficeResource", "Proposal") As String = "Propuesta" '5
    'Public ConstHttpContext.GetGlobalResourceObject("BackOfficeResource", "Quotation") As String = "Cotización" '6
