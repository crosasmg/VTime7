...
Public Class Cuentecn
    ...
    Public sAd_Cuentecn As String
    Public nInd_Val As Integer
    ...
    Public Function Find(ByVal nNumber As Integer, ByVal nBranch As Integer, ByVal nType As Integer, ByVal nCompany As Integer, ByVal nPerType As Integer, ByVal nPerNum As Integer, ByVal sBussiType As String, ByVal nCurrency As Integer, ByVal nIdConsecut As Integer) As Boolean
        ...
        With lrecreaCuentecn
            ...
            .Parameters.Add("nIdConsec", nIdConsecut, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbInteger, 0, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
            ...
            If .Run(True) Then
                If .FieldToClass("Record") = "True" Then
                    ...
                    sAd_Cuentecn = .FieldToClass("sAd_Cuentecn")
                    nInd_Val = .FieldToClass("nInd_Val")
                Else
                    Find = False
                End If
            Else
    ...
    Public Function insValCR006_k(ByVal sCodispl As String, ByVal nReinsurance As Integer, ByVal nNumber As Integer, ByVal nBranchRei As Integer, ByVal nContraType As Integer, ByVal nCompany As Integer, ByVal nPerType As Integer, ByVal nPerNum As Integer, ByVal sBussiType As String, ByVal nCurrency As Integer, ByVal nIdConsecut As Integer) As String
        ...
        If Not Find(nNumber, nBranchRei, nContraType, nCompany, nPerType, nPerNum, sBussiType, nCurrency, nIdConsecut) Then
        ...
        Else
            ...
            End If
            'PRY-REASEGUROS VT - LEVANTAMIENTO DE AJUSTE DE CUENTAS TECNICAS  - LAMC - INICIO
            If Me.sAd_Cuentecn = "1" Then
                Call lclsErrors.ErrorMessage(sCodispl, 600002)
            End If

            If Me.sAd_Cuentecn = "2" Then
                Call lclsErrors.ErrorMessage(sCodispl, 600001)
            End If

            If Me.nInd_Val <> 1 Then
                Call lclsErrors.ErrorMessage(sCodispl, 600003)
            End If
            'PRY-REASEGUROS VT - LEVANTAMIENTO DE AJUSTE DE CUENTAS TECNICAS  - LAMC - FIN
        End If
...
insValCR006_k_Err:
    ...
    Public Function insPostCR006_k(ByVal sCodispl As String, ByVal nAction As Integer, ByVal nNumber As Integer, ByVal nBranchRei As Integer, ByVal nContraType As Integer, ByVal nYearSer As Integer, ByVal nCompany As Integer, ByVal nPerType As Integer, ByVal nPerNum As Integer, ByVal sBussiType As String, ByVal nCurrency As Integer, ByVal nIdConsecut As Integer) As Boolean
        ...
        With Me
            insPostCR006_k = .Find(nNumber, nBranchRei, nContraType, nCompany, nPerType, nPerNum, sBussiType, nCurrency, nIdConsecut)
        End With
...
insPostCR006_k_Err:
    ...
    Public Function Update(ByVal sCodispl As String) As Boolean
        ...
        With lrecupdCuentecn
            ...
            If sCodispl = "CR006H" Then
                .Parameters.Add("nSal_f_comp", Me.nSal_f_comp, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbNumeric, 22, 6, 18, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
                'UPGRADE_WARNING: Use of Null/IsNull() detected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"'
                .Parameters.Add("nSal_f_rein", System.DBNull.Value, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbNumeric, 22, 6, 18, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
            Else
                'UPGRADE_WARNING: Use of Null/IsNull() detected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="2EED02CB-5C0E-4DC1-AE94-4FAA3A30F51A"'
                .Parameters.Add("nSal_f_comp", System.DBNull.Value, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbNumeric, 22, 6, 18, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
                .Parameters.Add("nSal_f_rein", Me.nSal_f_rein, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbNumeric, 22, 6, 18, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
            End If
