...
Public Class Tab_gencovs
	...
	'% AddAllCovergen: Añade un nuevo elemento a la colección.
	...
	'% es "No Vida" en la ventana DP039 - Consulta de coberturas genéricas.
	Public Function Find(ByVal nCurrency As Integer, ByVal sCondition As String, Optional ByVal lblnFind As Boolean = True) As Boolean
		...
		If nCurrency <> mintCurrency Or sCondition <> mstrCondition Or lblnFind Then
			...
			'+ Definición de parámetros para stored procedure 'insudb.reaTab_gencov_4'.
			With lrecTab_cov
...
Find_Err: 
	...
	'% FindAllCovergen: Permite realizar la lectura de las coberturas genéricas cuando la opción
	'% es "Todas" en la ventana DP039 - COnsulta de coberturas genéricas.
