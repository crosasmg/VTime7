Option Strict Off
Option Explicit On
Public Class Tab_Am_Bil
	'%-------------------------------------------------------%'
	'% $Workfile:: Tab_Am_Bil.cls                           $%'
	'% $Author:: Nvaplat41                                  $%'
	'% $Date:: 10/10/03 17.34                               $%'
	'% $Revision:: 18                                       $%'
	'%-------------------------------------------------------%'
	...
	'+
	'+ Estructura de tabla insudb.tab_am_bil al 07-10-2002 16:40:52
	...
	Public nAmoun_used As Double ' NUMBER     22   2     10   S
	Public dCompdate As Date ' DATE       7    0     0    N
	Public nDed_amount As Integer ' NUMBER     22   6     18   S
	...
	Public nIndem_rate As Double ' NUMBER     22   2     5    S
    ...
    Public nCaren_Dur As Double ' NUMBER     22   2     5    S
    Public sPay_concept As String
    Public sPrestac As String
	...
	Public SOTHERLIM As String
	
	'+
	'+ Estructura de tabla timetmp.SI007_TABLETMP al 05-09-2005 08:29:22
	'+     Property                Type         DBType   Size Scale  Prec  Null
	'+-------------------------------------------------------------------------
	...
	Public nReserve As Double ' NUMBER     22   6     18   S
	...
	Public nLimit_h As Double
	Public sAuto_resist_h As String
	
	'%insCreTab_am_bil: Función que permite crear los datos de la tabla Tab_am_bil.
	Public Function insCreTab_am_bil(ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nCertif As Double, ByVal nGroup As Integer, ByVal nModulec As Integer, ByVal nCover As Integer, ByVal nPay_concep As Integer, ByVal nPrestac As Integer, ByVal nTariff As Integer, ByVal nRole As Integer, ByVal sClient As String, ByVal sIllness As String, ByVal dEffecdate As Date, ByVal dNulldate As Date, ByVal nDed_type As Integer, ByVal nDed_percen As Double, ByVal nDed_amount As Double, ByVal nDed_quanti As Double, ByVal nIndem_rate As Double, ByVal nLimit As Double, ByVal nLimit_exe As Double, ByVal nCount As Integer, ByVal nTyplim As Integer, ByVal nPunish As Integer, ByVal sCaren_Type As String, ByVal nCaren_Dur As Integer, ByVal NDED_QUANTI_2 As Integer, ByVal NINDEM_RATE_2 As Double, ByVal NLIMIT_2 As Double, ByVal NTYPLIM_2 As Integer, ByVal NCOUNT_2 As Integer, ByVal NLIMIT_EXE_2 As Double, ByVal NPUNISH_2 As Double, ByVal SOTHERLIM As String, ByVal nTransaction As Integer, ByVal nUsercode As Integer) As Boolean
		Dim lrecTab_am_bil As eRemoteDB.Execute
		
		On Error GoTo insCreTab_am_bil_Err
		
		lrecTab_am_bil = New eRemoteDB.Execute
		
		With lrecTab_am_bil
			.StoredProcedure = "CreTab_am_bil"
			...
			.Parameters.Add("nPrestac", nPrestac, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbInteger, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			...
			.Parameters.Add("sCaren_Type", sCaren_Type, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbVarChar, 8, 0, 0, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			.Parameters.Add("nCaren_Dur", nCaren_Dur, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbNumeric, 22, 2, 5, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			.Parameters.Add("NDED_QUANTI_2", NDED_QUANTI_2, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbNumeric, 22, 2, 5, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			...
			.Parameters.Add("NLIMIT_2", NLIMIT_2, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbNumeric, 22, 2, 5, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			.Parameters.Add("NTYPLIM_2", NTYPLIM_2, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbNumeric, 22, 2, 5, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			.Parameters.Add("NCOUNT_2", NCOUNT_2, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbNumeric, 22, 2, 5, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			.Parameters.Add("NLIMIT_EXE_2", NLIMIT_EXE_2, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbNumeric, 22, 2, 5, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			...
			.Parameters.Add("SOTHERLIM", SOTHERLIM, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbVarChar, 1, 0, 0, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			.Parameters.Add("nAmoun_used", nAmoun_used, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbNumeric, 22, 6, 18, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			insCreTab_am_bil = .Run(False)
		End With
		
insCreTab_am_bil_Err: 
		If Err.Number Then
			insCreTab_am_bil = False
		End If
		On Error GoTo 0
		'UPGRADE_NOTE: Object lrecTab_am_bil may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
		lrecTab_am_bil = Nothing
	End Function
	'%CargaTab_am_bil: Función que permite heredar datos del diseñador de prestaciones por producto
	Public Function CargaTab_am_bil(ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nCertif As Double, ByVal dEffecdate As Date, ByVal nGroups As Integer) As Boolean
		Dim lrecTab_am_bil As eRemoteDB.Execute
		
		On Error GoTo CargaTab_am_bil_Err
		
		lrecTab_am_bil = New eRemoteDB.Execute
		
		With lrecTab_am_bil
			.StoredProcedure = "CargaTab_am_bil"
			.Parameters.Add("sCertype", sCertype, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbVarChar, 1, 0, 0, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			.Parameters.Add("nBranch", nBranch, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbInteger, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			.Parameters.Add("nProduct", nProduct, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbInteger, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			.Parameters.Add("nPolicy", nPolicy, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbDouble, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			.Parameters.Add("nCertif", nCertif, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbDouble, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			.Parameters.Add("dEffecdate", dEffecdate, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbDBTimeStamp, 0, 0, 0, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			.Parameters.Add("nGroups", nGroups, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbInteger, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			CargaTab_am_bil = .Run(False)
		End With
		
CargaTab_am_bil_Err: 
		If Err.Number Then
			CargaTab_am_bil = False
		End If
		On Error GoTo 0
		'UPGRADE_NOTE: Object lrecTab_am_bil may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
		lrecTab_am_bil = Nothing
	...
	'%insUpdTab_am_bil: Función que permite actualizar los datos de la tabla Tab_am_bil.
	Public Function insUpdTab_am_bil(ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nCertif As Double, ByVal nCover As Integer, ByVal nPay_concep As Integer, ByVal nTariff As Integer, ByVal dEffecdate As Date, ByVal dNulldate As Date, ByVal nDed_type As Integer, ByVal nDed_percen As Double, ByVal nDed_amount As Double, ByVal nDed_quanti As Double, ByVal nIndem_rate As Double, ByVal nLimit As Double, ByVal nLimit_exe As Double, ByVal nUsercode As Integer, ByVal nTransaction As Integer, ByVal nModulec As Integer, ByVal nRole As Integer, ByVal sClient As String, ByVal sIllness As String, ByVal nGroup As Integer, ByVal nCount As Integer, ByVal nPrestac As Integer, ByVal nTyplim As Integer, ByVal nPunish As Integer, ByVal sCaren_Type As String, ByVal nCaren_Dur As Integer, ByVal NDED_QUANTI_2 As Integer, ByVal NINDEM_RATE_2 As Double, ByVal NLIMIT_2 As Double, ByVal NTYPLIM_2 As Integer, ByVal NCOUNT_2 As Integer, ByVal NLIMIT_EXE_2 As Double, ByVal NPUNISH_2 As Double, ByVal SOTHERLIM As String) As Boolean
		Dim lrecTab_am_bil As eRemoteDB.Execute
		
		On Error GoTo insUpdTab_am_bil_Err
		
		lrecTab_am_bil = New eRemoteDB.Execute
		
		With lrecTab_am_bil
			.StoredProcedure = "insUpdTab_am_bil"
			.Parameters.Add("sCertype", sCertype, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbVarChar, 1, 0, 0, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			.Parameters.Add("nBranch", nBranch, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbInteger, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			.Parameters.Add("nProduct", nProduct, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbInteger, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			.Parameters.Add("nPolicy", nPolicy, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbDouble, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			...
			.Parameters.Add("nLimit_exe", nLimit_exe, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbNumeric, 22, 6, 18, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			.Parameters.Add("nUsercode", nUsercode, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbInteger, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			If nTransaction = 1 Or nTransaction = 6 Or nTransaction = 4 Or nTransaction = 18 Or nTransaction = 2 Or nTransaction = 7 Or nTransaction = 5 Or nTransaction = 19 Or nTransaction = 3 Then
			...
			.Parameters.Add("NLIMIT_EXE_2", NLIMIT_EXE_2, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbNumeric, 22, 2, 5, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			.Parameters.Add("NPUNISH_2", NPUNISH_2, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbNumeric, 22, 2, 5, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			.Parameters.Add("SOTHERLIM", SOTHERLIM, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbVarChar, 8, 0, 0, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			
			insUpdTab_am_bil = .Run(False)
		End With
		
insUpdTab_am_bil_Err: 
		If Err.Number Then
			insUpdTab_am_bil = False
		End If
		On Error GoTo 0
		'UPGRADE_NOTE: Object lrecTab_am_bil may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
		lrecTab_am_bil = Nothing
	...
	'%insDelTab_am_bil:Función que permite borrar los datos de la tabla Tab_am_bil.
	Public Function insDelTab_am_bil(ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nCertif As Double, ByVal nGroup As Integer, ByVal nModulec As Integer, ByVal nCover As Integer, ByVal nPay_concep As Integer, ByVal nPrestac As Integer, ByVal nTariff As Integer, ByVal nRole As Integer, ByVal sClient As String, ByVal sIllness As String, ByVal dEffecdate As Date, ByVal dNulldate As Date, ByVal nTransaction As Integer, ByVal nUsercode As Integer) As Boolean
		Dim lrecTab_am_bil As eRemoteDB.Execute
		
		On Error GoTo insDelTab_am_bil_Err
		
		lrecTab_am_bil = New eRemoteDB.Execute
		
		With lrecTab_am_bil
			.StoredProcedure = "insDelTab_am_bil"
			.Parameters.Add("sCertype", sCertype, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbVarChar, 1, 0, 0, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			.Parameters.Add("nBranch", nBranch, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbInteger, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			.Parameters.Add("nProduct", nProduct, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbInteger, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			.Parameters.Add("nPolicy", nPolicy, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbDouble, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			...
			insDelTab_am_bil = .Run(False)
		End With
		
insDelTab_am_bil_Err: 
		If Err.Number Then
			insDelTab_am_bil = False
		End If
		On Error GoTo 0
		'UPGRADE_NOTE: Object lrecTab_am_bil may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
		lrecTab_am_bil = Nothing
	...
	'%valTab_am_bilSumLim: Esta rutina es la encargada de evitar registros duplicados.
	Public Function valTab_am_bilSumLim(ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nCertif As Double, ByVal dEffecdate As Date) As Boolean
		Dim lrecTab_am_bil As eRemoteDB.Execute
		Dim lintValue As Integer
        Dim lstrValue As String = ""

        On Error GoTo valTab_am_bilSumLim_Err
		
		lrecTab_am_bil = New eRemoteDB.Execute
		
		With lrecTab_am_bil
			.StoredProcedure = "getTab_am_bil_DifSumLimi"
			.Parameters.Add("sCertype", sCertype, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbVarChar, 1, 0, 0, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			.Parameters.Add("nBranch", nBranch, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbInteger, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			.Parameters.Add("nProduct", nProduct, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbInteger, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			.Parameters.Add("nPolicy", nPolicy, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbDouble, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			...
			.Parameters.Add("nLimit_o", lintValue, eRemoteDB.Parameter.eRmtDataDir.rdbParamOutput, eRemoteDB.Parameter.eRmtDataType.rdbNumeric, 22, 6, 18, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			.Parameters.Add("nLimitsum_o", lintValue, eRemoteDB.Parameter.eRmtDataDir.rdbParamOutput, eRemoteDB.Parameter.eRmtDataType.rdbNumeric, 22, 6, 18, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			.Run(False)
			If .Parameters("nTariff_o").Value > 0 Then
				valTab_am_bilSumLim = True
				...
				Me.sIllness = .Parameters("sIllness_o").Value
			End If
		End With
		
valTab_am_bilSumLim_Err: 
		If Err.Number Then
			valTab_am_bilSumLim = False
		End If
		On Error GoTo 0
		'UPGRADE_NOTE: Object lrecTab_am_bil may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
		lrecTab_am_bil = Nothing
	...
	Public Function valExistsTab_am_bil(ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nCertif As Double, ByVal nGroup As Integer, ByVal nModulec As Integer, ByVal nCover As Integer, ByVal nTariff As Integer, ByVal nRole As Integer, ByVal sClient As String, ByVal sIllness As String, ByVal nPay_concep As Integer, ByVal nPrestac As Integer, ByVal dEffecdate As Date) As Boolean
		Dim lrecTab_am_bil As eRemoteDB.Execute
		Dim lintExists As Integer
		
		On Error GoTo valExistsTab_am_bil_Err
		
		lrecTab_am_bil = New eRemoteDB.Execute
		
		With lrecTab_am_bil
			.StoredProcedure = "valExistsTab_am_bil"
			.Parameters.Add("sCertype", sCertype, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbVarChar, 1, 0, 0, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			.Parameters.Add("nBranch", nBranch, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbInteger, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			.Parameters.Add("nProduct", nProduct, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbInteger, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			.Parameters.Add("nPolicy", nPolicy, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbDouble, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			...
			.Run(False)
			valExistsTab_am_bil = (.Parameters("nExists").Value = 1)
		End With
		
valExistsTab_am_bil_Err: 
		If Err.Number Then
			valExistsTab_am_bil = False
		End If
		On Error GoTo 0
		'UPGRADE_NOTE: Object lrecTab_am_bil may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
		lrecTab_am_bil = Nothing
	...
	'%Load: Permite crear las enfermedades excluídas a partir de las del diseñador.
	Public Function Load(ByVal sCertype As String, ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal nPolicy As Double, ByVal nCertif As Double, ByVal nGroup As Integer, ByVal nModulec As Integer, ByVal nCover As Integer, ByVal nTariff As Integer, ByVal nRole As Integer, ByVal sClient As String, ByVal sIllness As String, ByVal dEffecdate As Date, ByVal nUsercode As Integer) As Boolean
		...
		With lrecReaTab_am_Exc
			.StoredProcedure = "insReaTab_am_bil"
			.Parameters.Add("sCertype", sCertype, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbVarChar, 1, 0, 0, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			.Parameters.Add("nBranch", nBranch, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbInteger, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			.Parameters.Add("nProduct", nProduct, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbInteger, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			.Parameters.Add("nPolicy", nPolicy, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbDouble, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
