Option Strict Off
Option Explicit On
Public Class Guar_saving_rents
	Implements System.Collections.IEnumerable
	'variable local para contener colección
	Private mCol As Collection
	
	Public Function Add(ByVal nBranch As Integer, ByVal nProduct As Integer, ByVal dEffecdate As Date, ByVal NGUARSAV_VALINI As Integer, ByVal NGUARSAV_VALEND As Integer, ByVal NREN_GUARSAV As Double, ByVal NGUARSAV_YEAR As Integer) As Guar_saving_rent
		'crear un nuevo objeto
		Dim objNewMember As Guar_saving_rent
		objNewMember = New Guar_saving_rent
		
		With objNewMember
			.nBranch = nBranch
			.nProduct = nProduct
			.dEffecdate = dEffecdate
			.nGuarant_rent = NREN_GUARSAV
			.nValue_Ini = NGUARSAV_VALINI
			.nValue_End = NGUARSAV_VALEND
			.nGuarant_year = NGUARSAV_YEAR
		End With
	...
	Default Public ReadOnly Property Item(ByVal vntIndexKey As Object) As Guar_saving_rent
		Get
	...
	Public Function Find(ByVal dEffecdate As Date) As Boolean
		...
		With lclsObject
			...
			If .Run Then
				Find = True
				Do While Not .EOF
					Call Add(.FieldToClass("nBranch"), .FieldToClass("nProduct"), .FieldToClass("dEffecdate"), .FieldToClass("NGUARSAV_VALINI"), .FieldToClass("NGUARSAV_VALend"), .FieldToClass("NREN_GUARSAV"), .FieldToClass("NGUARSAV_YEAR"))
					.RNext()
				Loop 
				.RCloseRec()
			End If
