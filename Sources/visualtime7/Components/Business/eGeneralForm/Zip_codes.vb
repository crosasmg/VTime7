...
Public Class Zip_codes
	...
	'% Add: Añade una nueva instancia de la clase Zip_code a la colección
	...
	'% Find: Esta función se encarga de buscar los codigos postales
	Public Function Find() As Boolean
		...
		'Definición de parámetros para stored procedure 'insudb.reaZip_codeA'
		'Información leída el 15/11/2000 11:03:58 AM
	...
	'%Update : Permite actualizar los registros de la colección en la tabla
	'% Zip_code.
