...
Public Class Cost
	...
	Public Function Find(ByRef nParentFolder As Integer, ByRef Parameters As Properties) As eRemoteDB.Execute
		Find = insReaCost((Parameters("sCertype").Valor), (Parameters("nBranch").Valor), (Parameters("nProduct").Valor), (Parameters("nPolicy").Valor), IIf(Parameters("nCertif").Valor <> "" And Parameters("nCertif").Valor <> String.Empty, Parameters("nCertif").Valor, 0), (Parameters("HdEffecdate").Valor))
	End Function
    ...
    Private Function insReaCost(ByRef lstrCertype As String, ByRef lintBranch As Integer, ByRef lintProduct As Integer, ByRef llngPolicy As Double, ByRef llngCertif As Integer, ByRef ldmtEffecdate As Object, Optional ByRef lintFunds As Integer = 0, Optional ByRef lintOrigin As Integer = 0) As eRemoteDB.Execute

        insReaCost = New eRemoteDB.Execute
        ...
        With insReaCost
            .StoredProcedure = "QUEDATPENDING_COST"
            ...
            If Not .Run Then
                .RCloseRec()
                'UPGRADE_NOTE: Object insReaCost may not be destroyed until it is garbage collected. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6E35BFF6-CD74-4B09-9689-3E1A43DF8969"'
                insReaCost = Nothing
            End If
        End With
    End Function
