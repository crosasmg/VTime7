...
Public Class Client_EvalRisk
	...
	Public Function Find(ByRef nParentFolder As Integer, ByRef Params As Properties) As eRemoteDB.Execute
		...
		With Find
			.StoredProcedure = "queDatClient_EvalRisk"
			...
			.Parameters.Add("dEffecdate", IIf(Params("HdEffecdate").Valor Is System.DBNull.Value, Today, Params("HdEffecdate").Valor), eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbDBTimeStamp, 0, 0, 0, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
			If Not .Run Then
