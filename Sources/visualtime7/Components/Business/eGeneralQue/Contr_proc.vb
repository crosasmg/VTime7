Option Strict Off
Option Explicit On
Public Class Contr_proc
	'%-------------------------------------------------------%'
	'% $Workfile:: Contr_proc.cls                           $%'
	'% $Author:: gazuaje                                   $%'
	'% $Date:: 9/08/03 1:21p                                $%'
	'% $Revision:: 1                                        $%'
	'%-------------------------------------------------------%'
	...
	Public Function Find(ByRef nParentFolder As Integer, ByRef Parameters As Properties) As eRemoteDB.Execute
		Select Case nParentFolder
			...
			Case 0
				...
				Find = insReaClientsPol((Parameters("sCertype").Valor), (Parameters("nBranch").Valor), (Parameters("nProduct").Valor), (Parameters("nPolicy").Valor), (Parameters("nCertif").Valor), System.DBNull.Value)
			Case Else
