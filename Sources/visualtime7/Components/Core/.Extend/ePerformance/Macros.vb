...
Public Class Macros
	...
	Public Function Add(ByRef Key As String, Optional ByRef sKey As String = "") As Macro
		'crear un nuevo objeto
		Dim objNewMember As Macro
		objNewMember = New Macro
		
		
		'establecer las propiedades que se transfieren al método
		objNewMember.MacroDef = Key
		objNewMember.Key = objNewMember.Field
		If Len(sKey) = 0 Then
	...
	Public Function AddObj(ByRef objMacro As Macro) As Macro
        mCol.Add(objMacro)
		'Set lobj = objMacro
		'devolver el objeto creado
		AddObj = objMacro
	...
	Default Public ReadOnly Property Item(ByVal vntIndexKey As Object) As Macro
		Get
