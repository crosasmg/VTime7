...
mobjValues.sCodisplPage = "vic014_k"
%>
<HTML>
<HEAD>
...
With Response
	...
	.Write(mobjMenu.MakeMenu("VIC014", "VIC014_k.aspx", 1, ""))
End With
...
//------------------------------------------------------------------------------------------
    if (self.document.forms[0].cbeFund.value!=0)
            ShowPopUp("ShowDefValues.aspx?sCodispl=VIC014_K&cbeFund="+self.document.forms[0].cbeFund.value+"&tcdDate="+self.document.forms[0].tcdDate.value, "ShowDefValuesAmount", 1, 1,"no","no",2000,2000);
    else
        UpdateDiv("nInitialBalance","");
}

</SCRIPT>
</HEAD>
<BODY ONUNLOAD="closeWindows();">
<FORM METHOD="POST" ID="FORM" NAME="VIC014" ACTION="valBranchQue.aspx?Mode=1">
	<BR><BR>
    <TABLE WIDTH="100%">
		<TR>
            <TD WIDTH="25%">&nbsp;</TD>
        ...
        <TR>
            ...
            <TD><%=mobjValues.DIVControl("nInitialBalance")%> </TD>
            <TD WIDTH="25%">&nbsp;</TD>
        </TR>
    </TABLE>
</FORM>
