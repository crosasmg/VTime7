...
<%
    ...
    Response.Write(mobjValues.WindowsTitle("SIL7483", Request.QueryString("sWindowDescript")))
    mobjMenu = Nothing
%>
</HEAD>
...
<FORM method="post" id="FORM" name="frmClaim" action="valClaimRep.aspx?mode=1">
	...
	<table width="80%" border="0">
		<tr>
            <td><LABEL ID="0">Cliente</LABEL></td>
  		    <TD WIDTH="80%"><%=mobjValues.ClientControl("tctClient", String.Empty, True, "Rut del cliente",,,,,,,,,,,,, True,,,, True)%></TD>				    
        </tr>
	</table>
    </div>
</FORM>
