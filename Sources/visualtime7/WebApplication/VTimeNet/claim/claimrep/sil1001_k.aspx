...
Call mobjNetFrameWork.BeginPage("sil1001_k")
...
mobjValues.sCodisplPage = "sil1001_k"
...
'~End Body Block VisualTimer Utility
Response.Write(mobjMenu.MakeMenu("sil1001", "sil1001_k.aspx", 1, Request.QueryString("sWindowDescript"), CStr(Session("sDesMultiCompany")), CStr(Session("sSche_code"))))
...
//+ Variable para el control de versiones
    document.VssVersion="$$Revision: 2 $|$$Date: 24-03-13 13:38 $"</SCRIPT>
</HEAD>
<BODY ONUNLOAD="closeWindows();">
<FORM METHOD="POST" ID="FORM" NAME="sil1001" ACTION="valClaimRep.aspx?sMode=1">
	<BR><BR>
...
%>
	    ...
	    <TR>
			<TD><LABEL ID="9122">Cliente</LABEL></TD>
			<TD><%
With mobjValues
	.Parameters.Add("nClaim", Request.QueryString("nClaimNumber"), eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eFunctions.Parameter.eRmtDataType.rdbDouble, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
	.Parameters.Add("nCase_num", Request.QueryString("nCase_num"), eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbSmallInt, 22, 0, 5, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
	.Parameters.Add("nDeman_type", Request.QueryString("nDeman_type"), eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbSmallInt, 22, 0, 5, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
	.Parameters.Add("nBene_type", 16, eRemoteDB.Parameter.eRmtDataDir.rdbParamInput, eRemoteDB.Parameter.eRmtDataType.rdbDouble, 22, 0, 10, eRemoteDB.Parameter.eRmtDataAttrib.rdbParamNullable)
	.Parameters.ReturnValue("nId", True, "Id", True)
	.Parameters.ReturnValue("sConting", True, "Contingente", True)
	Response.Write(mobjValues.PossiblesValues("valClient", "tabClaimBenef_1", eFunctions.Values.eValuesType.clngWindowType,  , True,  ,  ,  ,  ,  , Request.QueryString("nCase_num") = vbNullString, 14, "Código del beneficiario a quien se le hará el pago", eFunctions.Values.eTypeCode.eString,  ,  , False))
End With
%>
			</TD>
		</TR>	    
...
Call mobjNetFrameWork.FinishPage("sil1001_k")
