...
<FORM method="post" id="FORM" name="Claim" action="valclaimrep.aspx?mode=1">
	...
	<table width="40%">
		<tr>
			<td class="HighLighted" align="left" colspan="2">Póliza y periódo a consultar:</td>
		</tr>
		<tr>
		...
		<tr>
            <TD style="height: 20px"><LABEL>Póliza</LABEL></TD>
     		<TD><%=mobjValues.NumericControl("tcnPolicy", 8, "",  , "Póliza",  ,  ,  ,  ,  , "")%></TD>
        </tr>
        <tr>
