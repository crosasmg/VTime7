...
Call mobjNetFrameWork.BeginPage("sil001_k")
...
mobjValues.sCodisplPage = "sil001_k"
%>
...
'~End Body Block VisualTimer Utility
Response.Write(mobjMenu.MakeMenu("SIL001", "SIL001_k.aspx", 1, Request.QueryString("sWindowDescript"), CStr(Session("sDesMultiCompany")), CStr(Session("sSche_code"))))
...
<FORM METHOD="POST" ID="FORM" NAME="SIL001" ACTION="valClaimRep.aspx?sMode=1">
<BR><BR>
...
<BR><BR>
  ...
  <TABLE WIDTH="100%">
    ...
    <TR>
      ...
      <TD WIDTH="20%"><%=mobjValues.DateControl("tcdEndDate", CStr(Session("dEndDate")), False, "Fecha hasta la cual se desea listar los siniestros")%></TD>
    </TR>
    <TR>
      <TD>&nbsp;</TD>
    </TR>
    <TR>
      ...
      <TD><%=mobjValues.PossiblesValues("valModOpc", "Table525", eFunctions.Values.eValuesType.clngComboType, "",  ,  ,  ,  ,  ,  ,  , 4, "Modalidad de reporte que se desea obtener", 1)%></TD>
    </TR>
    <TR>
      <TD><LABEL ID=0>Sucursal</LABEL></TD>
      <TD><%=mobjValues.PossiblesValues("cbeOffice", "Table9", eFunctions.Values.eValuesType.clngComboType, "",  ,  ,  ,  ,  ,  ,  , 4, "Sucursal a la cual pertenecen los movimientos de siniestros que se desean listar", 1)%></TD>
    </TR>
    <TR>
      ...
      <TD><%=mobjValues.ProductControl("valProduct", "Producto al cual pertenecen los movimientos de siniestros que se desean listar", CStr(eRemoteDB.Constants.intNull), eFunctions.Values.eValuesType.clngWindowType)%></TD>
    </TR>
    <TR>
      <TD><LABEL ID=0>Moneda</LABEL></TD>
      <TD COLSPAN="3"><%=mobjValues.PossiblesValues("valCurrency", "Table11", 2, CStr(Session("nCurrency")),  ,  ,  ,  ,  ,  ,  , 4, "Moneda a la cual pertenecen los movimientos de siniestros que se desean listar", 1)%></TD>
    </TR>
  </TABLE>
</FORM>
</BODY>
...
Call mobjNetFrameWork.FinishPage("sil001_k")
