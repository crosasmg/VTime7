...
Call mobjNetFrameWork.BeginPage("SIL00971_k")
...
mobjValues.sCodisplPage = "SIL00971_k"
...
//-----------------------------------------------------------------------------------------
{	if(nPolicy.value!=0)
        self.document.forms[0].tcnClaim.disabled=true;
    else
...
//-----------------------------------------------------------------------------
{
	...
	with(self.document.forms[0])
	{
		...
		else
		{
		    ...
		    self.document.location.href = "SIL00971_K.aspx?sCodispl=SIL00971" +
...
'~End Body Block VisualTimer Utility
Response.Write(mobjMenu.MakeMenu("SIL00971", "SIL00971_k.aspx", 1, Request.QueryString("sWindowDescript"), CStr(Session("sDesMultiCompany")), CStr(Session("sSche_code"))))
...
<FORM METHOD="POST" ID="FORM" NAME="SIL00971" ACTION="valClaimRep.aspx?sMode=1">
<input type = "hidden" name="tcnCertif" value="">
<BR><BR><BR>
...
<BR><BR>
    <TABLE WIDTH="100%">
        <TR>
            ...
            <TD><LABEL ID=LABEL1>Producto</LABEL></TD>
        ...
        <TR>
            <TD><LABEL ID=LABEL2>Póliza</LABEL></TD>
            <TD><%=mobjValues.NumericControl("tcnPolicy", 10, mstrPolicy,  , "Póliza que declara el siniestro",  , 0,  ,  ,  , "ShowPolicy(cbeBranch, valProduct, this);",  , 3)%></TD>
	       	<TD style="height: 21px"><LABEL ID=LABEL3>Siniestro</LABEL></TD>
            <TD style="height: 21px"><%=mobjValues.NumericControl("tcnClaim", 10, mstrClaim,  , "Número del Siniestro",  , 0,  ,  ,  , "AddClaimParameter(this.value)",  , 4)%></TD>              
        </TR>
        <TR>
            
            
         <TR>
            <TD><LABEL>Atención</LABEL></TD>
		    <TD><%=mobjValues.TextControl("tctAtention", 40,  , True, "Atención")%></TD>
           <TD><LABEL>Nota</LABEL></TD>
			<TD><%=mobjValues.TextAreaControl("txtComent", 4, 40, "", False, "Comentario anexo a la carta", False, False,  , "")%></TD>
        </TR>
         <TR>
...
Call mobjNetFrameWork.FinishPage("SIL00971_k")
