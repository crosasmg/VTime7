...
Call mobjNetFrameWork.BeginPage("sil762_k")
...
mobjValues.sCodisplPage = "sil762_k"
...
If Request.QueryString("nchkClaim") <> vbNullString Then
	mchkClaim = Request.QueryString("nchkClaim")
End If
	...
	with(self.document.forms[0])
	{
		...
		{   
			if(mlngClaim!=tcnClaim.value)
			    ...
			    self.document.location.href = "SIL762_K.aspx?sCodispl=SIL762" +
...
//+ Esta línea guarda la versión procedente de VSS 
    document.VssVersion="$$Revision: 3 $|$$Date: 12/02/04 13:25 $|$$Author: Nvaplat11 $" 
...
<BR><BR>
    <TABLE WIDTH="100%">
        <TR>
			<TD ALIGN="Left" COLSPAN="1" CLASS="HighLighted"><LABEL ID=40622><A NAME="Tipo de información">Tipo de proceso</A></LABEL></TD>
			<TD>&nbsp</TD>
        ...
        <TR>
   			<TD COLSPAN="2"><%=mobjValues.OptionControl(0, "optOption", "Puntual", "1", "1", "insStateCheck()")%></TD>
        ...
        <TR>
   			<TD COLSPAN="2"><%=mobjValues.OptionControl(0, "optOption", "Masivo", "2", "2", "insStateCheck()")%></TD>
        ...
        <TR>
            <TD COLSPAN="2"><%=mobjValues.CheckControl("chkClaim", "Siniestro Oncologico", mchkClaim, mchkClaim,  , True, 6)%></TD>                
        ...
        <TR>
            <TD><LABEL ID=0>Fecha desde</LABEL></TD>
			<TD><%=mobjValues.DateControl("tcdDate_ini", vbNullString,  , "Fecha desde para cuando el proceso masivo",  ,  ,  ,  , True)%></TD>        
            <TD><LABEL ID=0>Fecha hasta</LABEL></TD>
			<TD><%=mobjValues.DateControl("tcdDate_end", vbNullString,  , "Fecha hasta para cuando el proceso masivo",  ,  ,  ,  , True)%></TD>        
		</TR>
  </TABLE>
  <SCRIPT>
...
Call mobjNetFrameWork.FinishPage("sil762_k")
