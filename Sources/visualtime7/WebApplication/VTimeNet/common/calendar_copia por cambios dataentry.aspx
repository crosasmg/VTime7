...
//- Variable para el control de versiones
    ...
    var mdtmDate, mstrFieldName="", mintParentForm
...
//----------------------------------------------------------------------
	...
	opener.document.forms[mintParentForm].elements[mstrFieldName].value = lstrValue
	opener.document.forms[mintParentForm].elements[mstrFieldName].onblur();
	self.close()
}
...
//----------------------------------------------------------------------
    if (Field.checked){
        window.resizeTo(255,425)
        ShowDiv('DivDirect', 'show')
    }
    else{
        window.resizeTo(255,310)
...
End If
Response.Write("<SCRIPT> mintParentForm =""" & Request.QueryString.Item("FormNum") & """</SCRIPT>")
...
<SCRIPT>insReSize(document.forms[0].chkDirect)</SCRIPT>
<SCRIPT LANGUAGE=javascript FOR=cboMonth EVENT=onchange>
    insBackNext(0,this.value - document.forms[0].tcnCurMonth.value)
</SCRIPT>
<SCRIPT LANGUAGE=javascript FOR=cboYear EVENT=onchange>
    insBackNext(0,this.value * 12)
</SCRIPT>
<SCRIPT>insEnabledControls(document.forms[0].optType[0])</SCRIPT>
