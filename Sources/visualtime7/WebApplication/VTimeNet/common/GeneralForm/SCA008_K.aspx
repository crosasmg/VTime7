...
Private Function insPrepareQueryString() As String
	...
	Dim lintPos As Integer
        lstrStr = "SCA008_K.ASPX?" & Request.Params.Get("Query_String")
...
mobjValues = New eFunctions.Values
    ...
    mobjValues.sCodisplPage = "SCA805"
...
//-----------------------------------------------------------------------------------------------------------------
    ...
    <%mobjMenu = New eFunctions.Menues
        Response.Write(mobjMenu.MakeMenu("SCA805", "SCA008_K.aspx", 1, ""))
mobjMenu = Nothing%>
...
<BR>
<BR>
<FORM METHOD="POST" ID="FORM1" NAME="<%=Request.QueryString.Item("sCodispl")%>" ACTION="valLetters.aspx?nMainAction=<%=Request.QueryString.Item("nMainAction")%>">
...
<%=mobjValues.DateControl("tcdDate", CStr(Today),  , "",  ,  ,  ,  , True)%></TD>
  ...
  <TR>
    ...
    <%		End If%>
    <TD COLSPAN=3><%=mobjValues.NumericControl("tcnPolicy", 8, Session("nPolicy"),  , "",  ,  ,  ,  ,  , "insShowPolicy(this.value)", 0)%><LABEL ID=40587> <%= GetLocalResourceObject("Anchor4Caption") %> <<%= GetLocalResourceObject("Anchor4Caption") %>LABEL> <%=mobjValues.NumericControl("tcnCertif", 7, 0,  , "",  , 0)%></TD>
<%		
	Case Else
