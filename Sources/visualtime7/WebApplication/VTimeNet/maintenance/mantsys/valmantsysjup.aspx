	...
	Select Case Request.QueryString.Item("sCodispl")
		...
		Case "MS004"
			With Request
				...
				Else
					If .QueryString.Item("WindowType") = "PopUp" And .QueryString.Item("nMainAction") <> CStr(eFunctions.Menues.TypeActions.clngActionQuery) Then
						insvalMantSys = mobjMantsys.insValMS004(.QueryString("sCodispl"), .QueryString("Action"), 1, mobjValues.StringToType(Session("nCurrency"), eFunctions.Values.eTypeData.etdDouble), mobjValues.StringToDate(.Form.Item("tcdEffecdate")), mobjValues.StringToType(.Form.Item("tcnExchange"), eFunctions.Values.eTypeData.etdDouble))
					End If
				End If
			End With
...
Else
	If insPostMantsys() Then
		...
		Else
			Select Case Request.QueryString.Item("sCodispl")
				Case "MS001"
					Response.Write("<SCRIPT>opener.document.location.href='MS001_K.aspx?Reload=" & Request.Form.Item("chkContinue") & "&ReloadAction=" & Request.QueryString.Item("Action") & "&ReloadIndex=0" & Request.QueryString.Item("ReloadIndex") & "&tcnCode=" & Server.URLEncode(Request.Form.Item("tcnCode")) & "&tctMessage=" & Server.URLEncode(Request.Form.Item("tctMessage")) & "&continue=" & Server.URLEncode("S") & "&nMainAction=" & Request.QueryString.Item("nMainAction") & "'</SCRIPT>")
				Case "MS002"
					Response.Write("<SCRIPT>opener.document.location.href='MS002.aspx?Reload=" & Request.Form.Item("chkContinue") & "&ReloadAction=" & Request.QueryString.Item("Action") & "&ReloadIndex=" & Request.QueryString.Item("ReloadIndex") & "&sCodispl=" & Request.QueryString.Item("sCodispl") & "&nMainAction=" & Request.QueryString.Item("nMainAction") & "'</SCRIPT>")
				Case "MS004"
				...
				Case "MS006"
					Response.Write("<SCRIPT>top.opener.document.location.href='MS006_K.aspx?Reload=" & Request.Form.Item("chkContinue") & "&ReloadAction=" & Request.QueryString.Item("Action") & "&ReloadIndex=" & Request.QueryString.Item("ReloadIndex") & "&sCodispl=" & Request.QueryString.Item("sCodispl") & "&nMainAction=" & Request.QueryString.Item("nMainAction") & "'</SCRIPT>")
				Case "MS008"
				...
				Case "MS011"
					Response.Write("<SCRIPT>opener.document.location.href='MS011_K.aspx?Reload=" & Request.Form.Item("chkContinue") & "&ReloadAction=" & Request.QueryString.Item("Action") & "&ReloadIndex=" & Request.QueryString.Item("ReloadIndex") & "&sCodispl=" & Request.QueryString.Item("sCodispl") & "&nMainAction=" & Request.QueryString.Item("nMainAction") & "'</SCRIPT>")
				Case "MS100"
				...
				Case "MS5552"
					Response.Write("<SCRIPT>top.opener.document.location.href='MS5552_K.aspx?Reload=" & Request.Form.Item("chkContinue") & "&ReloadAction=" & Request.QueryString.Item("Action") & "&ReloadIndex=" & Request.QueryString.Item("ReloadIndex") & "&sCodispl=" & Request.QueryString.Item("sCodispl") & "&nMainAction=302" & "'</SCRIPT>")
				Case "MS5577"
