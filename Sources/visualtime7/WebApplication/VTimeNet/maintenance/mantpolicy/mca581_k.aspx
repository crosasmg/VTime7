...
mobjValues.sCodisplPage = "mca581_k"
%>
<HTML>
<HEAD>
...
//		insDefValues("ShowDataMCA581", "sField=" + "getDate");
    }
}
...
Response.Write(mobjMenu.MakeMenu("MCA581", "MCA581_k.aspx", 1, vbNullString))
mobjMenu = Nothing
%>    
</HEAD>
<BODY ONUNLOAD="closeWindows();">
<FORM METHOD="POST" ID="FORM" NAME="MCA581" ACTION="valMantPolicy.aspx?sMode=1">
    <BR><BR>
    <TABLE>
        <TR>        
