...
mobjValues.sCodisplPage = "MRC001_K"
...
<%
    ...
    Response.Write(mobjMenu.MakeMenu("MRC001", "MRC001_k.aspx", 1, vbNullString))
    mobjMenu = Nothing
%>    
</HEAD>
<BODY ONUNLOAD="closeWindows();">
<FORM METHOD="POST" ID="FORM" NAME="MRC001" ACTION="valmantliability.aspx?sMode=1">
    <BR><BR>
    <TABLE WIDTH="100%">
        <TR>
        ...
        <TR>
            ...
            <TD><%=mobjValues.PossiblesValues("cbeCover", "tab_cover", eFunctions.Values.eValuesType.clngWindowType,  , True,  ,  ,  ,  ,  , True,  ,GetLocalResourceObject("cbeCoverTooltip"))%></TD>
            <TD>&nbsp;</TD>
