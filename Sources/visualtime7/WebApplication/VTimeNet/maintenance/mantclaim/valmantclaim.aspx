...
Function insvalMantClaim() As String
	...
	Select Case Request.QueryString.Item("sCodispl")
		...
		Case "MSI011"
			...
			With Request
				If .QueryString.Item("WindowType") = "PopUp" And .QueryString.Item("nMainAction") <> CStr(eFunctions.Menues.TypeActions.clngActionQuery) Then
					insvalMantClaim = mobjMantClaim.insValMSI011_K(.QueryString("sCodispl"), .QueryString("Action"), mobjValues.StringToType(.Form.Item("tcnCodigo"), eFunctions.Values.eTypeData.etdDouble, True), mobjValues.StringToType(.Form.Item("cbeTypProvider"), eFunctions.Values.eTypeData.etdDouble, True), .Form.Item("dtcClient"), mobjValues.StringToDate(.Form.Item("tcdDateInitial")), mobjValues.StringToDate(.Form.Item("tcdDateEnd")), .Form.Item("cbeState"), mobjValues.StringToType(.Form.Item("cbenOffice"), eFunctions.Values.eTypeData.etdDouble, True), mobjValues.StringToType(.Form.Item("tcnMax_serv_ord"), eFunctions.Values.eTypeData.etdDouble), mobjValues.StringToType(.Form.Item("cbenTypeSupport"), eFunctions.Values.eTypeData.etdDouble, True), mobjValues.StringToType(.Form.Item("tcnPer_disc"), eFunctions.Values.eTypeData.etdDouble), .Form.Item("chkConcesionary"), Session("nUsercode"), Session("nExists_reg"), mobjValues.StringToType(.Form.Item("chkZone"), eFunctions.Values.eTypeData.etdDouble), mobjValues.StringToType(.Form.Item("chkBranch"), eFunctions.Values.eTypeData.etdDouble), mobjValues.StringToType(.Form.Item("chkGroup"), eFunctions.Values.eTypeData.etdDouble), .Form.Item("dtcClient_digit"))
				Else
					insvalMantClaim = vbNullString
				End If
			End With
		...
		Case "MSI019"
			mobjMantClaim = New eClaim.Tab_Prov_Group
			With Request
				If .QueryString.Item("WindowType") = "PopUp" Then
					If CBool(.Form.Item("blnSel")) Then
						lstrAction = "Add"
					Else
						lstrAction = "Update"
					End If
					mstrQueryString = "&nProvider=" & .QueryString.Item("nProvider")
					insvalMantClaim = mobjMantClaim.insValMSI019(.QueryString("sCodispl"), lstrAction, mobjValues.StringToType(.QueryString.Item("nProvider"), eFunctions.Values.eTypeData.etdDouble), mobjValues.StringToDate(.Form.Item("tcdInpdate")), mobjValues.StringToDate(.Form.Item("tcdOutdate")))
				Else
					insvalMantClaim = vbNullString
				End If
			End With
		...
		Case "MSI035"
			With Request
				mobjMantClaim = New eClaim.Tab_Provider
				lblnFirst2 = True
				For lintIndex2 = 1 To .Form.Item("tcnCheck").Split(",").Length
					If .Form.GetValues("tcnCheck").GetValue(lintIndex2 - 1) = "1" Then
						If lblnFirst2 Then
							lintFirst2 = 1
							lblnFirst2 = False
						Else
				...
				If lblnFirst2 Then
					insvalMantClaim = mobjMantClaim.insValMSI035_K("MSI035")
				End If
			End With
		...
		Case "MSI020"
			...
			With Request
				If CDbl(.QueryString.Item("nZone")) = 1 Then
					insvalMantClaim = mobjMantClaim.insValMSI020_K(.QueryString("sCodispl"), .QueryString("nMainAction"), mobjValues.StringToType(.Form.Item("tcdEffecDate"), eFunctions.Values.eTypeData.etdDate))
				Else
					If CDbl(.QueryString.Item("nMainAction")) <> 401 Then
						If Request.QueryString.Item("Type") = "PopUp" Then
							insvalMantClaim = mobjMantClaim.insValSI020Upd(.QueryString("sCodispl"), .QueryString("Action"), mobjValues.StringToType(.Form.Item("tcnYear"), eFunctions.Values.eTypeData.etdLong), mobjValues.StringToType(Session(dEffecdate), eFunctions.Values.eTypeData.etdDate), mobjValues.StringToType(.Form.Item("tcnIndexLiab"), eFunctions.Values.eTypeData.etdDouble), mobjValues.StringToType(.Form.Item("tcnIndexAssets"), eFunctions.Values.eTypeData.etdDouble))
						End If
					End If
				End If
                End With
            Case "MSI040"
                mobjMantClaim = New eClaim.Tab_Catevent
                With Request
                    If .QueryString.Item("WindowType") = "PopUp" Then
                        lstrAction = .QueryString.Item("Action")
                        insvalMantClaim = mobjMantClaim.InsValMSI040_K(.QueryString("sCodispl"), lstrAction, _
                                                                       mobjValues.StringToType(.Form.Item("tcnIdCatas"), eFunctions.Values.eTypeData.etdLong), _
                                                                       mobjValues.StringToType(.Form.Item("tcnNumber"), eFunctions.Values.eTypeData.etdDouble), _
                                                                       mobjValues.StringToType(.Form.Item("tcnType"), eFunctions.Values.eTypeData.etdDouble), _
                                                                       mobjValues.StringToType(.Form.Item("tcnType_rel"), eFunctions.Values.eTypeData.etdDouble), _
                                                                       mobjValues.StringToType(.Form.Item("tcnBranch"), eFunctions.Values.eTypeData.etdDouble), _
                                                                       .Form.Item("tctDescript"), _
                                                                       .Form.Item("tctShort_des"), _
                                                                       .Form.Item("cbeStatregt"), mobjValues.StringToType(Session("nUsercode"), eFunctions.Values.eTypeData.etdLong))
                    Else
                        insvalMantClaim = vbNullString
                    End If
                End With
                
                '+MSI6002: Reserva Inicial Promedio
            Case "MSI6002"
                With Request
                    mobjMantClaim = New eClaim.Res_AverageSOAT
                    If CDbl(.QueryString.Item("nZone")) = 1 Then
                        insvalMantClaim = mobjMantClaim.InsValMSI6002_K(.QueryString("sCodispl"), mobjValues.StringToType(.Form.Item("cbeCli_category"), eFunctions.Values.eTypeData.etdLong), mobjValues.StringToType(.Form.Item("cbeCurrency"), eFunctions.Values.eTypeData.etdLong))
                    Else
                        If .QueryString.Item("WindowType") = "PopUp" Then
                            insvalMantClaim = mobjMantClaim.InsValMSI6002(.QueryString("sCodispl"), .QueryString("Action"), mobjValues.StringToType(Session("nCli_category"), eFunctions.Values.eTypeData.etdLong), mobjValues.StringToType(Session("nCurrency"), eFunctions.Values.eTypeData.etdLong), .Form.Item("valIllness"), mobjValues.StringToType(.Form.Item("tcnResaveclin"), eFunctions.Values.eTypeData.etdLong), mobjValues.StringToType(.Form.Item("tcnResavehosp"), eFunctions.Values.eTypeData.etdLong), mobjValues.StringToType(.Form.Item("tcnRes_average"), eFunctions.Values.eTypeData.etdLong), mobjValues.StringToType(.Form.Item("tcnResavetdis"), eFunctions.Values.eTypeData.etdLong), mobjValues.StringToType(.Form.Item("tcnDaysavedis"), eFunctions.Values.eTypeData.etdLong))
                        End If
                    End If
                End With
			
                
                '+ MSI8000: Porcentaje de indemnización de invalidez
            Case "MSI8000"
                mobjMantClaim = New eClaim.Tar_Disability
                With Request
                    If .QueryString("nZone") = 1 Then
                        insvalMantClaim = mobjMantClaim.InsValMSI8000_K("MSI8000", mobjValues.StringToType(.QueryString("nMainAction"), eFunctions.Values.eTypeData.etdDouble), mobjValues.StringToType(.Form("cbeBranch"), eFunctions.Values.eTypeData.etdDouble, True), mobjValues.StringToType(.Form("tcdEffecdate"), eFunctions.Values.eTypeData.etdDate))
                    Else
                        If .QueryString("nMainAction") <> 401 Then
                            If .QueryString("WindowType") = "PopUp" Then
                                insvalMantClaim = mobjMantClaim.InsValMSI8000("MSI8000", .QueryString("Action"), mobjValues.StringToType(CStr(Session("nBranch")), eFunctions.Values.eTypeData.etdDouble), mobjValues.StringToType(.Form("tcnCovergen"), eFunctions.Values.eTypeData.etdDouble, True), mobjValues.StringToType(CStr(Session("dEffecdate")), eFunctions.Values.eTypeData.etdDate), mobjValues.StringToType(.Form("tcnDisability"), eFunctions.Values.eTypeData.etdDouble, True), mobjValues.StringToType(.Form("tcnRate"), eFunctions.Values.eTypeData.etdDouble, True))
                            End If
                        End If
                    End If
                End With
	...
	Select Case Request.QueryString.Item("sCodispl")
			...
			With Request
				...
				If CDbl(.QueryString.Item("nZone")) = 1 Then
					...
					If CDbl(IIf(Request.QueryString.Item("nMainAction")="",0,Request.QueryString.Item("nMainAction"))) = 306 Then
						...
						If lblnPost Then
							Session("nLastBranch") = Session("nBranch")
							Session("nLastProduct") = Session("nProduct")
						End If
					Else
						lblnPost = True
					End If
			...
			With Request
				If CDbl(.QueryString.Item("nZone")) = 1 Then
					...
					If CDbl(IIf(Request.QueryString.Item("nMainAction")="",0,Request.QueryString.Item("nMainAction"))) = 401 Then
						Session("nLastBranch") = .Form.Item("cbeBranch")
						Session("nLastProduct") = .Form.Item("valproduct")
						Session("nLastModulec") = .Form.Item("cbeModulec")
						Session("nLastCover") = .Form.Item("cbeCover")
						Session("nLastcauscodcl") = .Form.Item("cbeCauscodcl")
					End If
					'+ Se toma el valor que se va al que se va a duplicar.
					Session("nBranch") = .Form.Item("cbeBranch")
					Session("nProduct") = .Form.Item("valproduct")
					Session("nModulec") = .Form.Item("cbeModulec")
					Session("nCover") = .Form.Item("cbeCover")
					Session("nCauscodcl") = .Form.Item("cbeCauscodcl")
					'+ Si la accion es duplicar
					If CDbl(.QueryString.Item("nMainAction")) = 306 Then
						lblnPost = mobjMantClaim.insDuplicarMSI015(mobjValues.StringToType(Session("nBranch"), eFunctions.Values.eTypeData.etdDouble), mobjValues.StringToType(Session("nProduct"), eFunctions.Values.eTypeData.etdDouble), mobjValues.StringToType(Session("nModulec"), eFunctions.Values.eTypeData.etdDouble), mobjValues.StringToType(Session("nCover"), eFunctions.Values.eTypeData.etdDouble), mobjValues.StringToType(Session("nCauscodcl"), eFunctions.Values.eTypeData.etdDouble), mobjValues.StringToType(Session("nLastBranch"), eFunctions.Values.eTypeData.etdDouble), mobjValues.StringToType(Session("nLastProduct"), eFunctions.Values.eTypeData.etdDouble), mobjValues.StringToType(Session("nLastModulec"), eFunctions.Values.eTypeData.etdDouble), mobjValues.StringToType(Session("nLastCover"), eFunctions.Values.eTypeData.etdDouble), mobjValues.StringToType(Session("nLastcauscodcl"), eFunctions.Values.eTypeData.etdDouble), mobjValues.StringToType(Session("nUserCode"), eFunctions.Values.eTypeData.etdDouble))
						
						If lblnPost Then
							'+ Si se cumple la accion duplicar se le asigna a la variable de ultima consulta 
							'+ el ramo que se esta duplicando
							Session("nLastBranch") = Session("nBranch")
							Session("nLastProduct") = Session("nProduct")
							Session("nLastModulec") = Session("nModulec")
							Session("nLastCover") = Session("nCover")
							Session("nLastcauscodcl") = Session("nCauscodcl")
						End If
					Else
						lblnPost = True
					End If
		...
		Case "MSI019"
			With Request
				...
				If .QueryString.Item("WindowType") = "PopUp" Then
					mstrQueryString = "&nProvider=" & .QueryString.Item("nProvider")
					lblnPost = mobjMantClaim.InsPostMSI019(.QueryString("Action"), mobjValues.StringToType(.QueryString.Item("nProvider"), eFunctions.Values.eTypeData.etdDouble), mobjValues.StringToType(.Form.Item("cbeGroup"), eFunctions.Values.eTypeData.etdDouble), mobjValues.StringToDate(.Form.Item("tcdInpdate")), mobjValues.StringToDate(.Form.Item("tcdOutdate")), Session("nUsercode"))
				Else
					lblnPost = True
				End If
			End With
		...
		Case "MSI035"
			With Request
				mobjMantClaim = New eClaim.Tab_Provider
				lblnFirst = True
				For lintIndex = 1 To .Form.Item("tcnCheck").Split(",").Length
            ...
            Case "MSI040"
                With Request
                    ...
                    If .QueryString.Item("WindowType") = "PopUp" Then
                        If .QueryString.Item("WindowType") = "PopUp" And .QueryString.Item("nMainAction") <> CStr(eFunctions.Menues.TypeActions.clngActionQuery) Then
                            lblnPost = mobjMantClaim.InspostSI040Upd(.QueryString("Action"), mobjValues.StringToType(.Form.Item("tcnIdCatas"), eFunctions.Values.eTypeData.etdLong), _
                                                                     .Form.Item("tctDescript"), .Form.Item("tctShort_des"), mobjValues.StringToType(.Form.Item("tcnNumber"), eFunctions.Values.eTypeData.etdDouble), .Form.Item("cbeStatregt"), mobjValues.StringToType(.Form.Item("tcnBranch"), eFunctions.Values.eTypeData.etdDouble), mobjValues.StringToType(.Form.Item("tcnType_rel"), eFunctions.Values.eTypeData.etdDouble), mobjValues.StringToType(.Form.Item("tcnType"), eFunctions.Values.eTypeData.etdDouble), mobjValues.StringToType(Session("nUsercode"), eFunctions.Values.eTypeData.etdLong))
                        Else
                            lblnPost = True
                        End If
                    Else
		...
		Case "MSI020"
			With Request
				...
				Else
					If .QueryString.Item("WindowType") = "PopUp" Then
						...
						lblnPost = mobjMantClaim.insPostMSI020Upd(.QueryString("Action"), mobjValues.StringToType(.Form.Item("tcnYear"), eFunctions.Values.eTypeData.etdLong), mobjValues.StringToType(Session("dEffecdate"), eFunctions.Values.eTypeData.etdDate), mobjValues.StringToType(.Form.Item("tcnIndexLiab"), eFunctions.Values.eTypeData.etdDouble), mobjValues.StringToType(.Form.Item("tcnIndexAsset"), eFunctions.Values.eTypeData.etdDouble), Session("nUserCode"))
					Else
						lblnPost = True
					End If
				End If
            ...
            Case "MSI6002"
                With Request
                    If CDbl(.QueryString.Item("nZone")) = 1 Then
                        Session("nCli_category") = .Form.Item("cbeCli_category")
                        Session("nCurrency") = .Form.Item("cbeCurrency")
                        lblnPost = True
                    Else
                        mobjMantClaim = New eClaim.Res_AverageSOAT
                        If .QueryString.Item("WindowType") = "PopUp" Then
                            ...
                            lblnPost = mobjMantClaim.InsPostMSI6002(.QueryString("Action"), mobjValues.StringToType(Session("nUsercode"), eFunctions.Values.eTypeData.etdLong), mobjValues.StringToType(Session("nCli_category"), eFunctions.Values.eTypeData.etdLong), mobjValues.StringToType(Session("nCurrency"), eFunctions.Values.eTypeData.etdLong), .Form.Item("valIllness"), mobjValues.StringToType(.Form.Item("tcnResaveclin"), eFunctions.Values.eTypeData.etdLong), mobjValues.StringToType(.Form.Item("tcnResavehosp"), eFunctions.Values.eTypeData.etdLong), mobjValues.StringToType(.Form.Item("tcnRes_average"), eFunctions.Values.eTypeData.etdLong), mobjValues.StringToType(.Form.Item("tcnResavetdis"), eFunctions.Values.eTypeData.etdLong), mobjValues.StringToType(.Form.Item("tcnDaysavedis"), eFunctions.Values.eTypeData.etdLong), .Form.Item("valStatregt"))
                ...
                '+ MSI8000: Porcentajde de indemnización de invalidez
            Case "MSI8000"
                lblnPost = True
                With Request
                    If Request.QueryString("nAction") <> eFunctions.Menues.TypeActions.clngAcceptdatafinish Then
                        ...
                        Else
                            lblnPost = mobjMantClaim.InsPostMSI8000(.QueryString("Action"), mobjValues.StringToType(CStr(Session("nBranch")), eFunctions.Values.eTypeData.etdDouble), mobjValues.StringToType(.Form("tcnCovergen"), eFunctions.Values.eTypeData.etdDouble), mobjValues.StringToType(CStr(Session("dEffecdate")), eFunctions.Values.eTypeData.etdDate), mobjValues.StringToType(.Form("tcnDisability"), eFunctions.Values.eTypeData.etdDouble), mobjValues.StringToType(.Form("tcnRate"), eFunctions.Values.eTypeData.etdDouble), mobjValues.StringToType(CStr(Session("nUsercode")), eFunctions.Values.eTypeData.etdDouble))
                        End If
                    End If
                    'UPGRADE_NOTE: Object mobjMantClaim may not be destroyed until it is garbage collected. Copy this link in your browser for more: 'http://msdn.microsoft.com/library/en-us/vbcon/html/vbup1029.aspx'
                    mobjMantClaim = Nothing
                End With
...
If mstrErrors > vbNullString Then
	...
	Else
		With Response
			.Write("<SCRIPT LANGUAGE=JAVASCRIPT>")
			.Write("ShowPopUp(""/VTimeNet/Common/Errors.aspx?sSource=" & Server.URLEncode(mstrCommand) & "&sQueryString=" & Server.URLEncode(Request.Params.Get("Query_String")) & """, ""MantClaimError"",660,330);self.history.go(-1);")
			.Write(mobjValues.StatusControl(False, CShort(Request.QueryString.Item("nZone")), Request.QueryString.Item("WindowType")))
			.Write("</SCRIPT>")
		End With
	End If
		...
		Else
			Select Case Request.QueryString.Item("sCodispl")
				...
				Case "MSI011"
	                ...
	                Case "MSI040"
	                    Response.Write("<SCRIPT>top.opener.document.location.href='MSI040_K.aspx?Reload=" & Request.Form.Item("chkContinue") & "&ReloadAction=" & Request.QueryString.Item("Action") & "&ReloadIndex=" & Request.QueryString.Item("ReloadIndex") & "&sCodispl=" & Request.QueryString.Item("sCodispl") & "&nMainAction=" & Request.QueryString.Item("nMainAction") & "'</SCRIPT>")
	                Case "MSI014"
				...
				Case "MSI015"
					Response.Write("<SCRIPT>top.opener.document.location.href='MSI015.aspx?Reload=" & Request.Form.Item("chkContinue") & "&ReloadAction=" & Request.QueryString.Item("Action") & "&ReloadIndex=" & Request.QueryString.Item("ReloadIndex") & "&sCodispl=" & Request.QueryString.Item("sCodispl") & "&nMainAction=302 '</SCRIPT>")
				Case "MSI016"
				...
				Case "MSI019"
					If Request.Form.Item("sCodisplReload") = vbNullString Then
						Response.Write("<SCRIPT>top.opener.document.location.href='MSI019_K.aspx?Reload=" & Request.Form.Item("chkContinue") & "&ReloadAction=" & Request.QueryString.Item("Action") & "&ReloadIndex=" & Request.QueryString.Item("ReloadIndex") & "&sCodispl=" & Request.QueryString.Item("sCodispl") & mstrQueryString & "'</SCRIPT>")
					Else
						Response.Write("<SCRIPT>top.close();top.opener.top.opener.document.location.href='MSI019_K.aspx?Reload=" & Request.Form.Item("chkContinue") & "&ReloadAction=" & Request.QueryString.Item("Action") & "&ReloadIndex=" & Request.QueryString.Item("ReloadIndex") & "&sCodispl=" & Request.QueryString.Item("sCodispl") & mstrQueryString & "'</SCRIPT>")
					End If
					'+ Zonas asociadas a un proveedor
				Case "MSI647"
					Response.Write("<SCRIPT>top.opener.document.location.href='MSI647_k.aspx?Reload=" & Request.Form.Item("chkContinue") & "&ReloadAction=" & Request.QueryString.Item("Action") & "&ReloadIndex=" & Request.QueryString.Item("ReloadIndex") & "&nProvider=" & Request.QueryString.Item("nProvider") & "&nMainAction=" & Request.QueryString.Item("nMainAction") & "'</SCRIPT>")
				Case "MSI559"
				...
				Case "MSI020"
	                    Response.Write("<SCRIPT>top.opener.document.location.href='MSI020.aspx?Reload=" & Request.Form.Item("chkContinue") & "&ReloadAction=" & Request.QueryString.Item("Action") & "&ReloadIndex=" & Request.QueryString.Item("ReloadIndex") & "&sCodispl=" & Request.QueryString.Item("sCodispl") & "&nMainAction=302 '</SCRIPT>")
	                Case "MSI6002"
	                    If Request.Form.Item("sCodisplReload") = vbNullString Then
	                        Response.Write("<SCRIPT>top.opener.document.location.href='MSI6002.aspx?Reload=" & Request.Form.Item("chkContinue") & "&ReloadAction=" & Request.QueryString.Item("Action") & "&ReloadIndex=" & Request.QueryString.Item("ReloadIndex") & "&sCodispl=" & Request.QueryString.Item("sCodispl") & "&nMainAction=" & Request.QueryString.Item("nMainAction") & "&dEffecdate=" & Request.QueryString.Item("dEffecdate") & "' </SCRIPT>")
	                    Else
	                        Response.Write("<SCRIPT>top.close();top.opener.top.opener.document.location.href='MSI6002.aspx?Reload=" & Request.Form.Item("chkContinue") & "&ReloadAction=" & Request.QueryString.Item("Action") & "&ReloadIndex=" & Request.QueryString.Item("ReloadIndex") & "&sCodispl=" & Request.QueryString.Item("sCodispl") & mstrQueryString & "'</SCRIPT>")
	                    End If
				Case ""
