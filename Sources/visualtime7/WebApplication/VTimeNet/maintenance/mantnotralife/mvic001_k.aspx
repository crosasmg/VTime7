...
With Response
	...
	.Write(mobjMenu.MakeMenu("MVIC001", "MVIC001_k.aspx", 1, ""))
End With
...
<FORM METHOD="POST" ID="FORM" NAME="MVIC001" ACTION="valMantNoTraLife.aspx?Mode=1">
	<BR><BR>
    <TABLE WIDTH="100%">
		<TR>
            <TD WIDTH="25%">&nbsp;</TD>
            <TD><LABEL ID=0><%= GetLocalResourceObject("cbeFundCaption") %></LABEL></TD>
			<TD><%=mobjValues.PossiblesValues("cbeFund", "tabFund_inv", eFunctions.Values.eValuesType.clngComboType,  ,  ,  ,  ,  ,  , "", False,  , GetLocalResourceObject("cbeFundToolTip"))%></TD>
            <TD WIDTH="25%">&nbsp;</TD>
        </TR>
        <TR>
            <TD WIDTH="25%">&nbsp;</TD>
