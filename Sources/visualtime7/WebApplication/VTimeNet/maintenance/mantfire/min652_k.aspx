...
//+ Se deshabilitan los campos 
		...
		insDefValues('MIN652', 'nBranch=' + cbeBranch.value + '&nProduct=' + valProduct.value, '/VTimeNet/Maintenance/MantFire');	
	}
}
...
If Request.QueryString.Item("Type") <> "PopUp" Then
	Response.Write(mobjMenu.MakeMenu("MIN652", "MIN652_K.aspx", 1, vbNullString))
	mobjMenu = Nothing
...
<FORM METHOD="POST" NAME="MIN652_K" ACTION="valMantFire.aspx?sMode=2">
<BR><BR>
    <TABLE WIDTH="100%">
		<TR>
...
%>
           ...
           <!-- <TD><%=mobjValues.PossiblesValues("cbeModulec", "Table10", eFunctions.Values.eValuesType.clngComboType, "0",  ,  ,  ,  ,  ,  , True, 5, GetLocalResourceObject("cbeModulecToolTip"))%></TD> -->
