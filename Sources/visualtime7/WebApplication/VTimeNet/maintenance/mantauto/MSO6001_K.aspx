...
<%
    ...
    Response.Write(mobjMenu.MakeMenu("MSO6001", "MSO6001_k.aspx", 1, vbNullString))
    mobjMenu = Nothing
%>    
</HEAD>
<BODY ONUNLOAD="closeWindows();">
<FORM METHOD="POST" ID="FORM" NAME="MSO6001" ACTION="valmantauto.aspx?sMode=1">
    <BR><BR>
    <TABLE WIDTH="100%">
        <TR>
            <TD><LABEL ID=9216>Ramo</LABEL></TD>
            ...
            <TD>&nbsp;</TD>
            <TD><LABEL ID=9217>Producto</LABEL></TD>
            <% With mobjValues
            ...
            <TD>&nbsp;</TD>
            <TD><LABEL ID=9218>Moneda</LABEL></TD>
            <TD><%=mobjValues.PossiblesValues("cbecurrency", "TABLE11",1, Session("ncurrency"),,,,,,, True,2,"Indica la moneda")%></TD>
            <TD>&nbsp;</TD>
            <TD><LABEL ID=9219>Fecha de efecto</LABEL></TD>
...
Call mobjNetFrameWork.FinishPage("MSO6001_K")
