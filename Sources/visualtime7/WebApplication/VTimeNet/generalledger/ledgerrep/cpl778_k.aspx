...
Call mobjNetFrameWork.BeginPage("CPL778")
...
mobjValues.sCodisplPage = "CPL778"
...
With Response
	...
	.Write(mobjMenu.MakeMenu(Request.QueryString.Item("sCodispl"), "CPL778_K.aspx", 1, ""))
	.Write(mobjValues.WindowsTitle("CPL778"))
End With
...
<FORM METHOD="POST" ID="FORM" NAME="CPL778" ACTION="valLedgerRep.aspx?Mode=1">
	<BR><BR>
	<BR><BR>

<%Response.Write(mobjValues.ShowWindowsName("CPL778"))%>

	<TABLE WIDTH="100%">
	    <BR><BR>
	    <TR>
            <TD WIDTH=25%></TD>
            <TD WIDTH=25%><LABEL ID=11288><%= GetLocalResourceObject("tcdProc_dateCaption") %></LABEL></TD>
...
Call mobjNetFrameWork.FinishPage("CPL778")
