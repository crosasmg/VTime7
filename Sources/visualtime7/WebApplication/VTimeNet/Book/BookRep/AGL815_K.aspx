...
mobjValues.sCodisplPage = "AGL815_k"
...
With Response
	...
	.Write(mobjValues.WindowsTitle("AGL815", Request.QueryString.Item("sWindowDescript")))
	.Write(mobjMenu.MakeMenu("AGL815", "AGL815_K.aspx", 1, Request.QueryString.Item("sWindowDescript"), Session("sDesMultiCompany"), Session("sSche_code")))
...
<FORM METHOD="POST" NAME="AGL815" ACTION="valbookrep.aspx?sMode=2">
	<BR><BR>
    ...
    <TABLE WIDTH="100%">
        <TR>
			<BR><BR>
            <TD><LABEL ID=101579><%= GetLocalResourceObject("cbeBranchCaption") %></LABEL></TD>            
            <TD COLSPAN="3"><%=mobjValues.BranchControl("cbeBranch", GetLocalResourceObject("cbeBranchToolTip"), "",  ,  ,  ,  , "LockControl(""Branch"");")%></TD>
            <TD><BR><BR></TD>
            <TD><BR><BR></TD>
        </TR>
        <TR>
