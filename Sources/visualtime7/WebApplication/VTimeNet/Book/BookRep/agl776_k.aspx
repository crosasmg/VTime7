...
mobjValues.sCodisplPage = "agl776_k"
...
With Response
	...
	.Write(mobjValues.WindowsTitle("AGL776", Request.QueryString.Item("sWindowDescript")))
	.Write(mobjMenu.MakeMenu("AGL776", "AGL776_K.aspx", 1, Request.QueryString.Item("sWindowDescript"), Session("sDesMultiCompany"), Session("sSche_code")))
...
//+ Variable para el control de versiones 
	document.VssVersion="$$Revision: 1 $|$$Date: 08/04/08 15:05 $|$$Author: Ljimenez $" 
...
<FORM METHOD="POST" NAME="AGL776" ACTION="valbookrep.aspx?sMode=2">
	<BR><BR>
