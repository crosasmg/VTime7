...
mobjValues.sCodisplPage = "MGSL003"
%>
<HTML>
<HEAD>
...
With Response
	...
	.Write(mobjMenu.MakeMenu("MGSL003", "MGSL003_k.aspx", 1, Request.QueryString.Item("sWindowDescript"), Session("sDesMultiCompany"), Session("sSche_code")))
End With
%>    
</HEAD>
<BODY ONUNLOAD="closeWindows();">
<FORM METHOD="post" ID="FORM" NAME="MGSL003" ACTION="valmarginrep.aspx?sMode=1">
    <BR><BR><BR>
    <%=mobjValues.ShowWindowsName(Request.QueryString.Item("sCodispl"), Request.QueryString.Item("sWindowDescript"))%>
    <TABLE  WIDTH="100%" >
        <TR> 
            <TD WIDTH="15%" ><LABEL id=0><%= GetLocalResourceObject("tcdProcessDateCaption") %></LABEL></TD>
<TD><% %>
