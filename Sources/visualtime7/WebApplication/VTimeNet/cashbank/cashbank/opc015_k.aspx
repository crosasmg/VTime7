...
mobjValues.sCodisplPage = "opc015_k"
%>
...
<HEAD>
	...
	.Write(mobjMenu.MakeMenu("OPC015", "OPC015_k.aspx", 1, ""))
End With
mobjMenu = Nothing%>
<SCRIPT>
//------------------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------------------
	...
	if (dtcClient.value != '' &&
       ...
       ShowPopUp("/VTimeNet/CashBank/CashBank/ShowDefValues.aspx?Field=BussiType" + "&nTypeAccount=" + cbeTypeAccount.value + "&sBussiType=" + cbeBussType.value+ "&sClient=" + dtcClient.value + "&sZone=fraHeader" + "&sCodispl=OPC015", "ShowDefValuesCurrency", 1, 1,"no","no",2000,2000);
	}	
}
