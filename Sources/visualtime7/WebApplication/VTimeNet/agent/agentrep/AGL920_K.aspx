...
'%insPreAGL920: Se cargan los controles de la ventana.
'--------------------------------------------------------------------------------------------
Private Sub insPreAGL920()
	'--------------------------------------------------------------------------------------------
...
Call mobjNetFrameWork.BeginPage("AGL920_K")
...
mobjValues.sCodisplPage = "AGL920_K"
...
//- Variable para el control de versiones
    document.VssVersion="$$Revision: 1 $|$$Date: 11/12/03 16:43 $|$$Author: Nvaplat18 $"
...
<%With Response
	...
	.Write(mobjMenu.MakeMenu(Request.QueryString.Item("sCodispl"), "AGL920_K.aspx", 1, Request.QueryString.Item("sWindowDescript"), Session("sDesMultiCompany"), Session("sSche_code")))
...
<FORM METHOD="post" ID="FORM" NAME="AGL920" ACTION="ValAgentRep.aspx?Mode=1">
<BR><BR><BR>
<%
Call insPreAGL920()
mobjValues = Nothing
...
<%
Call mobjNetFrameWork.FinishPage("AGL920_K")
