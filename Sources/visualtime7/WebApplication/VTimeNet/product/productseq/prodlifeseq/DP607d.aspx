...
Private Sub insDefineHeader()
	...
	With mobjGrid.Columns
		...
		Call .AddNumericColumn(0, GetLocalResourceObject("tcnIntWarrColumnCaption"), "tcnIntWarr", 8, vbNullString,  , GetLocalResourceObject("tcnIntWarrColumnToolTip"),  , 6)
		Call .AddNumericColumn(0, GetLocalResourceObject("tcnIntWarrMinColumnCaption"), "tcnIntWarrMin", 4, vbNullString,  , GetLocalResourceObject("tcnIntWarrMinColumnToolTip"),  , 2)
		Call .AddNumericColumn(0, GetLocalResourceObject("tcnIntWarrClearColumnCaption"), "tcnIntWarrClear", 8, vbNullString,  , GetLocalResourceObject("tcnIntWarrClearColumnToolTip"),  , 6)
	End With
	...
	If lcolPlan_IntWar.Find(mobjValues.StringToType(session("nBranch"), eFunctions.Values.eTypeData.etdDouble), mobjValues.StringToType(session("nProduct"), eFunctions.Values.eTypeData.etdDouble), mobjValues.StringToType(Request.QueryString.Item("nModulec"), eFunctions.Values.eTypeData.etdDouble), mobjValues.StringToType(session("dEffecdate"), eFunctions.Values.eTypeData.etdDate)) Then
		For	Each lclsPlan_IntWar In lcolPlan_IntWar
			With mobjGrid
				...
				.Columns("tcnIntWarrClear").DefValue = CStr(lclsPlan_IntWar.nIntWarrClear)
...
Private Sub insPreDP607dUpd()
	...
	With Request
		...
		Response.Write(mobjGrid.DoFormUpd(.QueryString.Item("Action"), "valProdLifeSeq.aspx", "DP607D", .QueryString.Item("nMainAction"), mobjValues.ActionQuery, CShort(.QueryString.Item("Index"))))
	End With
...
<FORM METHOD="POST" NAME="DP607D" ACTION="valProdLifeSeq.aspx?sMode=2">
