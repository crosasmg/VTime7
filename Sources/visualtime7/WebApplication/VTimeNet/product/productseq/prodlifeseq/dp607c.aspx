...
Private Sub insDefineHeader()
	...
	With mobjGrid.Columns
		...
		Call .AddNumericColumn(0, GetLocalResourceObject("tcnPerTotSurrColumnCaption"), "tcnPerTotSurr", 5, vbNullString,  , GetLocalResourceObject("tcnPerTotSurrColumnToolTip"),  , 2)
		Call .AddNumericColumn(0, GetLocalResourceObject("tcnPerParSurrColumnCaption"), "tcnPerParSurr", 5, vbNullString,  , GetLocalResourceObject("tcnPerParSurrColumnToolTip"),  , 2)
		Call .AddNumericColumn(0, GetLocalResourceObject("tcnChargTSurrColumnCaption"), "tcnChargTSurr", 18, vbNullString,  , GetLocalResourceObject("tcnChargTSurrColumnToolTip"),  , 6)
		Call .AddNumericColumn(0, GetLocalResourceObject("tcnChargPSurrColumnCaption"), "tcnChargPSurr", 18, vbNullString,  , GetLocalResourceObject("tcnChargPSurrColumnToolTip"),  , 6)
		Call .AddNumericColumn(0, GetLocalResourceObject("tcnQFree_SurrColumnCaption"), "tcnQFree_Surr", 5, vbNullString,  , GetLocalResourceObject("tcnQFree_SurrColumnToolTip"))
	End With
	...
	If lcolLoad_Surr.Find(mobjValues.StringToType(session("nBranch"), eFunctions.Values.eTypeData.etdDouble), mobjValues.StringToType(session("nProduct"), eFunctions.Values.eTypeData.etdDouble), mobjValues.StringToType(Request.QueryString.Item("nModulec"), eFunctions.Values.eTypeData.etdDouble), mobjValues.StringToType(session("dEffecdate"), eFunctions.Values.eTypeData.etdDate)) Then
		For	Each lclsLoad_Surr In lcolLoad_Surr
			With mobjGrid
				...
				.Columns("tcnPerTotSurr").DefValue = CStr(lclsLoad_Surr.nPerTotSurr)
				.Columns("tcnPerParSurr").DefValue = CStr(lclsLoad_Surr.nPerParSurr)
				.Columns("tcnChargTSurr").DefValue = CStr(lclsLoad_Surr.nChargTSurr)
				.Columns("tcnChargPSurr").DefValue = CStr(lclsLoad_Surr.nChargPSurr)
				.Columns("tcnQFree_Surr").DefValue = CStr(lclsLoad_Surr.nQFree_Surr)
...
Private Sub insPreDP607CUpd()
	...
	With Request
		...
		Response.Write(mobjGrid.DoFormUpd(.QueryString.Item("Action"), "valProdLifeSeq.aspx", "DP607C", .QueryString.Item("nMainAction"), mobjValues.ActionQuery, CShort(.QueryString.Item("Index"))))
	End With
...
//- Variable para el control de versiones
    document.VssVersion="$$Revision: 2 $|$$Date: 1-02-06 17:32 $|$$Author: Clobos $"
...
<FORM METHOD="POST" NAME="DP607C" ACTION="valProdLifeSeq.aspx?sMode=2">
