...
Private Sub insDefineHeader()
	...
	With mobjGrid
		...
		Call .Columns.AddTextColumn(CInt("100172"), GetLocalResourceObject("tctItemColumnCaption"), "tctItem", 30, "",  , GetLocalResourceObject("tctItemColumnToolTip"),  ,  ,  , True)
            Call .Columns.AddNumericColumn(CInt("100171"), GetLocalResourceObject("tcnRateColumnCaption"), "tcnRate", 9, CStr(0), , GetLocalResourceObject("tcnRateColumnToolTip"), True, 6)
	...
	With mobjGrid
		...
		.Columns("cbeModule").Disabled = Not (Request.QueryString.Item("nAplication") = "1" And Request.QueryString.Item("nModulec") <> "0")
	End With
End Sub
...
Response.Write("            <TD>")
	...
	If Request.QueryString.Item("nDisXpreRate") <> vbNullString Then
            Response.Write(mobjValues.NumericControl("tcnDisXpreRate", 9, Request.QueryString.Item("nDisXpreRate"), , GetLocalResourceObject("tcnDisXpreRateToolTip"), True, 6, , , , , False, 8))
	Else
            Response.Write(mobjValues.NumericControl("tcnDisXpreRate", 9, CStr(mclsDisco_expr.nRate), , GetLocalResourceObject("tcnDisXpreRateToolTip"), True, 6, , , , , False, 8))
	End If
...
//- Variable para el control de versiones
    document.VssVersion="$$Revision: 3 $|$$Date: 15/06/04 12:06 $|$$Author: Nvaplat15 $"
