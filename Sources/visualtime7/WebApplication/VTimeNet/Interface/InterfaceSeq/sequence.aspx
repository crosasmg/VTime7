...
Dim mclsClass As eInterface.FieldSheet


</script>
<%Response.Expires = -1
mclsSequence = New eFunctions.Sequence
mclsClass = New eInterface.FieldSheet
%>
<HTML>
<HEAD>
<SCRIPT>
...
If Not IsNothing(Request.QueryString.Item("nAction")) Then
	...
	Response.Write(mclsClass.LoadTabsFieldSheet(CInt(Request.QueryString.Item("nAction")), Session("sSche_code"), Session("nSheet")))
