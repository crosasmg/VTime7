...
mobjValues.sCodisplPage = "crl001_k"
%>
...
Response.Write(mobjMenu.MakeMenu("CRL001", "CRL001_k.aspx", 1, ""))
Response.Write(mobjMenu.setZone(1, "CRL001", "", eFunctions.Menues.TypeForm.clngSpeWithOutHeader))
mobjMenu = Nothing
%>    
</HEAD>

<BODY ONUNLOAD="closeWindows();">
<FORM METHOD="POST" ID="FORM" NAME="CRL001" ACTION="valCoReinsuranRep.aspx?sMode=1">

<%
If lclsCtrol_date.Find(clngGenCessPremium) Then
