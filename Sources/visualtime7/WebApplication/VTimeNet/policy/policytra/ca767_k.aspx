...
'	.Write(mobjMenu.MakeMenu("CA767", "CA767_K.aspx", 1, ""))
'End With
With Response
	.Write(mobjValues.StyleSheet() & vbCrLf)
	.Write(mobjMenu.MakeMenu("CA767", "CA767_K.aspx", 2, Request.QueryString.Item("sWindowDescript"), Session("sDesMultiCompany"), Session("sSche_code")))
...
If Session("nOrigin") = 8 Then
	%>
		...
		<TR>
		    ...
		    <TD>&nbsp;</TD>
		    <TD><LABEL ID=0><%= GetLocalResourceObject("tcnAmountCaption") %></LABEL></TD>
		    <TD><%=mobjValues.NumericControl("tcnAmount", 18, CStr(mclsRequest.nAmount),  , GetLocalResourceObject("tcnAmountToolTip"), True, 6,  ,  ,  ,  , True)%></TD>
		</TR>
		<TR>
