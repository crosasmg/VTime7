...
<%Response.Expires = -1441
    ...
    Call mobjNetFrameWork.BeginPage("CA080_k")
    ...
    mobjValues.sCodisplPage = "CA080_k"
%>
<SCRIPT> 
...
//--------------------------------------------------------------------------------
    if ((sValue.value != '0' && sValue.value != "") || sField == "Certificat"){
		switch(sField){
			case "Certificat":			
...
<SCRIPT LANGUAGE="JavaScript" SRC="/VTimeNet/Scripts/tmenu.js"></SCRIPT>
	...
	<%With Response
            ...
            .Write(mobjMenu.MakeMenu("CA080", "CA080_K.aspx", 1, Request.QueryString.Item("sWindowDescript"), Session("sDesMultiCompany"), Session("sSche_code")))
        End With
        mobjMenu = Nothing
%>
<SCRIPT>
...
<FORM METHOD="post" ID="FORM" NAME="frmManReceiptk" ACTION="ValPolicyTra.aspx?sMode=1">
    ...
    <TABLE WIDTH="100%">
        ...
        <TR>
		    <TD><LABEL ID=11988>Número de Trámite</LABEL></TD>
            <TD><%= mobjvalues.NumericControl("tcnProceedingNum",10,,,vbNullString)%></TD>		
            <TD colspan="2"></TD>
		</TR>
	</TABLE>
<%
...
<%'^Begin Footer Block VisualTimer Utility 1.1 7/4/03 10.31.19
    Call mobjNetFrameWork.FinishPage("CA080_k")
