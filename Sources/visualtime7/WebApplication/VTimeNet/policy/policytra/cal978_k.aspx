...
mobjValues.sCodisplPage = "CAL978_K"
Response.Expires = -1441
mobjNetFrameWork = New eNetFrameWork.Layout
mobjNetFrameWork.sSessionID = Session.SessionID
mobjNetFrameWork.nUsercode = Session("nUsercode")
Call mobjNetFrameWork.BeginPage("CAL978_k")
...
'~End Body Block VisualTimer Utility
Response.Write(mobjMenu.MakeMenu("CAL978", "CAL978_k.aspx", 1, Request.QueryString.Item("sWindowDescript"), Session("sDesMultiCompany"), Session("sSche_code")))
Response.Write(mobjMenu.setZone(1, "CAL978", Request.QueryString.Item("sWindowDescript"), CShort(Request.QueryString.Item("nWindowTy"))))
mobjMenu = Nothing
%>
<SCRIPT>
...
//-------------------------------------------------------------------------------------------    
	with (self.document.forms[0]){
		switch(Field.name){
			case "tcnPolicy":
				insDefValues("Policy_CA099","sCodispl=CAL978&nBranch=" + cbeBranch.value + "&nProduct=" + valProduct.value + "&nPolicy= " + tcnPolicy.value)
				break;
		}
	}
}
...
%></TD>
		...
		<TR>
			...
			<TD ><%With mobjValues
	.TypeOrder = 1
	Response.Write(.PossiblesValues("cbeOffice", "Table9", 1, CStr(eRemoteDB.Constants.intNull),  ,  ,  ,  ,  , "BlankOfficeDepend();insInitialAgency(1)",  ,  , GetLocalResourceObject("cbeOfficeToolTip")))
	.TypeOrder = 2
End With
%>
			</TD>
...
%>
          ...
          <TD ><%=mobjValues.DateControl("tcdEffecDate",  ,  , GetLocalResourceObject("tcdEffecDateToolTip"),  ,  ,  ,  , False)%></TD>
		</TR>
		<TR>
...
Call mobjNetFrameWork.FinishPage("CAL978_k")
