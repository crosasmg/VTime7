...
Call mobjNetFrameWork.BeginPage("VI016_K")
...
mobjValues.sCodisplPage = "VI016_K"
...
With Response
	...
	.Write(mobjMenu.MakeMenu("VI016", "VI016_K.aspx", 1, ""))
End With
mobjMenu = Nothing
%>
<SCRIPT> 
//- Variable para el control de versiones
    document.VssVersion="$$Revision: 1 $|$$Date: 2/09/03 19:04 $|$$Author: gazuaje $"
</SCRIPT>            
<SCRIPT>
...
%>
            ...
            <TD WIDTH=35%><%=mobjValues.PossiblesValues("cbeOrigin", "TAB_ORIGINPOL", eFunctions.Values.eValuesType.clngWindowType, Session("nSwitchOrigin"), True,  ,  ,  ,  ,  , mblnDisabled,  , GetLocalResourceObject("cbeOriginToolTip"),  , 1)%></TD>
...
Call mobjNetFrameWork.FinishPage("VI016_K")
