...
mobjValues.sCodisplPage = "vi7000_k"
...
//+ Para Control de Versiones de Source Safe
    document.VssVersion="$$Revision: 7 $|$$Date: 1/09/09 11:35a $"
...
//% insTypSurr: Asigna tipo de rescate parcial cuando la razón es compra de Agorro Garantizado
//-------------------------------------------------------------------------------------------
function insTypSurr(nSurr_reason){
//-------------------------------------------------------------------------------------------
    with (self.document.forms[0]){
		if (cbeSurrReas.value == 5){
			optSurrType[0].checked = false;
			optSurrType[1].checked = true;
			optSurrType[0].disabled = true;
			optSurrType[1].disabled = true;
			chkInsur.disabled = true;			
			chkInsur.checked = false;
		}
        else{
			optSurrType[0].disabled = false;
			optSurrType[1].disabled = false;
...
With Response
	...
	.Write(mobjMenu.MakeMenu("VI7000", "VI7000_k.aspx", 1, ""))
End With
...
<TD><BR></TD>
<TD><BR></TD>
<FORM METHOD="post" ID="FORM" NAME="VI7000" ACTION="valPolicyTra.aspx?x=1&sCodisplOri=<%=Request.QueryString.Item("sCodisplOri")%>&nOperat=<%=Request.QueryString.Item("nOperat")%>">
...
Response.Write(mobjValues.PossiblesValues("cbeOffice", "Table9", 1, vbNullString,  ,  ,  ,  ,  , "insInitialAgency(1)", ,  , GetLocalResourceObject("cbeOfficeToolTip")))
%>
            </TD>
...
With mobjValues
	...
	Response.Write(.PossiblesValues("cbeOfficeAgen", "TabAgencies_T5556", 2,  , True,  ,  ,  ,  , "insInitialAgency(2)", ,  , GetLocalResourceObject("cbeOfficeAgenToolTip")))
End With
%>
            </TD>
...
End With
%>
           <TD WIDTH=35%><%=mobjValues.PossiblesValues("cbeSurrReas", "TabSur_reason_schema", eFunctions.Values.eValuesType.clngWindowType, Request.QueryString.Item("nSurrReas"), True,  ,  ,  ,  , "insTypSurr(this);", True,  , GetLocalResourceObject("cbeSurrReasToolTip"),  , 1)%></TD>
        </TR>        
        <TR>    
