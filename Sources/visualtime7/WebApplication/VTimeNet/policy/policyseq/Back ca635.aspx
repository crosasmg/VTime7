...
'--------------------------------------------------------------------------------------------
    ...
    With mobjGrid.Columns            
        ...
        Call .AddNumericColumn(0, GetLocalResourceObject("tcnRateColumnCaption"), "tcnRate", 4, vbNullString,  , GetLocalResourceObject("tcnRateColumnToolTip"), True, 2)                
        
        Call .AddPossiblesColumn(0, GetLocalResourceObject("cbeRoutineColumnCaption"), "cbeRoutine", "TABTAB_ROUTINE", Values.eValuesType.clngWindowType, ,True, , , , , True, 12, GetLocalResourceObject("tctRoupremiToolTip"), eFunctions.Values.eTypeCode.eString)            
	...
	With mobjGrid
		...
		.sDelRecordParam = "cbeGroup='+ self.document.forms[0].cbeGroup.value + '" & "&cbeModulec='+ self.document.forms[0].cbeModulec.value + '" & "&cbeCover='+ marrArray[lintIndex].cbeCover + '" & "&cbeRole='+ marrArray[lintIndex].cbeRole + '"
...
Else
	...
	With mobjValues
		...
		Response.Write(mobjValues.PossiblesValues("cbeModulec", "tabtab_modul", eFunctions.Values.eValuesType.clngComboType, Request.QueryString.Item("cbeModulec"), True,  ,  ,  ,  , "ShowReceipts(cbeGroup,cbeModulec)", False,  , GetLocalResourceObject("cbeModulecToolTip")))
	End With
	%>
	   </TD>
	  </TR>
