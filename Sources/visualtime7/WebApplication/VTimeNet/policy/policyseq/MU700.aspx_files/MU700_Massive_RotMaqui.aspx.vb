...
Public Class MU700_Massive_RotMaqui_aspx
    ...
    Protected Overrides Sub OnLoad(ByVal e As System.EventArgs)
        ...
        If Request.QueryString("MassiveRotMaqui") = "1" Then

            If MassiveRotMaqui() Then
    ...
    Private Function MassiveRotMaqui() As Boolean
    ...
    Public Function  FileToArray(ByVal lstrFile As String) As Boolean
        ...
        If Len(Dir(lstrFiledeltxt, FileAttribute.Archive)) > 0 And lstrFiledeltxt <> String.Empty Then
            ...
            Do While Not EOF(lintFileNum) And lblnContinue
                ...
                Else
                    ...
                    If lstrArray_txt(0) = "4" Then 'Solo si nType = 4 RoturaMaquinaria
        ...
        lstrErrors = (New ePolicy.ValPolicySeq_MU700).ValMassiveCharge_MultiRisk_Det(sbFileinText.ToString(), 4)
