<%@ Page Language="VB" Inherits="MU700_Massive_ElectricEquipment_aspx" CodeFile="~/VTimeNet/policy/policyseq/MU700.aspx_files/MU700_Massive_ElectricEquipment.aspx.vb"
...
<body>
    <form id="form1" method="POST"  action="MU700_Massive_ElectricEquipment.aspx?MassiveElectricEquipment=1" enctype="multipart/form-data">
    <div>
    <table width="100%">
        <tr>
            <td colspan="2" class="HighLighted">
                <label> Carga masiva de equipos electrónicos </label>
            </td>
        </tr>    
        <tr>
