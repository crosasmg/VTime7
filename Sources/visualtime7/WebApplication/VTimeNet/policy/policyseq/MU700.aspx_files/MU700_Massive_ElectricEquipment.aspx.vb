...
Public Class MU700_Massive_ElectricEquipment_aspx
    ...
    Protected Overrides Sub OnLoad(ByVal e As System.EventArgs)
        ...
        If Request.QueryString("MassiveElectricEquipment") = "1" Then
            If MassiveElectricEquipment() Then
    ...
    Private Function MassiveElectricEquipment() As Boolean
    ...
    Public Function FileToArray(ByVal lstrFile As String) As Boolean
        ...
        If Len(Dir(lstrFiledeltxt, FileAttribute.Archive)) > 0 And lstrFiledeltxt <> String.Empty Then
            ...
            Do While Not EOF(lintFileNum) And lblnContinue
                ...
                Else
                    ...
                    If lstrArray_txt(0) = "3" Then 'Solo si nType = 3 EquipoElectronico
        ...
        If sbFileinText.Length > 0 Then
            lstrErrors = (New ePolicy.ValPolicySeq_MU700).ValMassiveCharge_MultiRisk_Det(sbFileinText.ToString(), 3)
