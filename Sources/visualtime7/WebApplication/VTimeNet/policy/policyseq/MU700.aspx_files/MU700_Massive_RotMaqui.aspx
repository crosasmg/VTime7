<%@ Page Language="VB" Inherits="MU700_Massive_RotMaqui_aspx" CodeFile="~/VTimeNet/policy/policyseq/MU700.aspx_files/MU700_Massive_RotMaqui.aspx.vb"
...
<body>
    <form id="form1" method="POST"  action="MU700_Massive_RotMaqui.aspx?MassiveRotMaqui=1" enctype="multipart/form-data">
    <div>
    <table width="100%">
        <tr>
            <td colspan="2" class="HighLighted">
                <label> Carga masiva rotura de maquinaria </label>
            </td>
        </tr>    
        <tr>
