<%@ Page Language="VB" Inherits="MU700_Massive_MaquiContract_aspx" CodeFile="~/VTimeNet/policy/policyseq/MU700.aspx_files/MU700_Massive_MaquiContract.aspx.vb"
...
<body>
    <form id="form1" method="POST"  action="MU700_Massive_MaquiContract.aspx?MassiveMaquiContract=1" enctype="multipart/form-data">
    <div>
    <table width="100%">
        <tr>
            <td colspan="2" class="HighLighted">
                <label> Carga masiva equipo y maquinaria contratista </label>
            </td>
        </tr>    
        <tr>
