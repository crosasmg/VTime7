...
<script language="VB" runat="Server">
    ...
    Private Sub insPreCA021()
        ...
        With Request
            '+ PRY-REASEGUROS VT - ELIMINACION DE FACULTATIVOS  - LAMC - INI
            ...
            Session("sPopupT") = ""
            '+ PRY-REASEGUROS VT - ELIMINACION DE FACULTATIVOS  - LAMC - FIN
...
<SCRIPT>
    ...
    function insShowShare(lintCapital) {
        ...
        if ((lintCapital != '') && (lintCapital != '0')) {
            // PRY-REASEGUROS VT - CALCULO DE % EN INGRESO DE MONTO DE PARTICIPACION CONTRATO  - LAMC - INICIO
            ...
            // PRY-REASEGUROS VT - CALCULO DE % EN INGRESO DE MONTO DE PARTICIPACION CONTRATO  - LAMC - FIN
        } else {
            lintValue = 0;
        }
