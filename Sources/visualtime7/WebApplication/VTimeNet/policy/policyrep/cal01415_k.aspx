...
Private Sub insDefineHeader()
	...
	Response.Write(mobjValues.HiddenControl("hddsCertype", mstrCertype))
...
Response.Write("			</TR>        " & vbCrLf)
Response.Write("			<TR>" & vbCrLf)
Response.Write("		  		<TD> <LABEL ID=40281>")


Response.Write(mobjValues.OptionControl(0, "optTypeDoc", GetLocalResourceObject("optTypeDoc_1Caption"),  , "1", "insCheck(this)", False))
...
Response.Write(mobjValues.OptionControl(0, "optTypeDoc", GetLocalResourceObject("optTypeDoc_2Caption"), CStr(1), "2", "insCheck(this)", False))


Response.Write("</LABEL> </TD>" & vbCrLf)
Response.Write("				<TD> </TD>" & vbCrLf)
Response.Write("				<TD> <LABEL ID=41370></LABEL></TD>" & vbCrLf)
...
Response.Write("</TD>" & vbCrLf)
Response.Write("				<TD><LABEL ID=LABEL1>" & GetLocalResourceObject("dtcClientASCaption") & "</LABEL></TD>" & vbCrLf)
Response.Write("				<TD>")
...
mobjValues.sCodisplPage = "CAL01415_K"
mstrQuote = """"
%>
<HTML>
<HEAD>
...
//------------------------------------------------------------------------------------------
	...
	self.document.forms[0].elements[<%=mstrQuote%>hddsCertype<%=mstrQuote%>].value = lstrsCertype;
    ...
    if (lobject == "nPolicy"){
		insDefValues('ShowDataPropCot','sCertype='  + lstrsCertype +
                                       '&nBranch='  + lintBranch  +
...
With Response
	...
	.Write(mobjMenu.MakeMenu(Request.QueryString.Item("sCodispl"), "CAL01415_K.aspx", 1, ""))
