...
<FORM method="post" id="FORM" name="Policy" action="valPolicyRep.aspx?mode=1">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td align="left"><H2 class="WindowsName">Reporte de Ahorros Garantizados
                <HR></H2></td>
		</tr>
	</table>
    <BR></BR>
	<table width="60%">
		<tr>
            <td><LABEL ID="8704"><%= GetLocalResourceObject("tcdIniDateCaption") %> </LABEL></td>
		...
		<tr>
		<TD><LABEL ID=41208><%= GetLocalResourceObject("cbeCollectorTypeCaption") %></LABEL> </TD>    
		  <%mobjValues.BlankPosition = False%>
        <TD><%=mobjValues.PossiblesValues("cbeCollectorType", "table8019", eFunctions.Values.eValuesType.clngComboType, CStr(1),  ,  ,  ,  ,  , "ShowDefValues22(this.value);",  ,  , GetLocalResourceObject("cbeCollectorTypeToolTip"))%></TD>
		</tr>
