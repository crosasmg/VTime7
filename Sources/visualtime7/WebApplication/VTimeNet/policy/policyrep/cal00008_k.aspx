...
<table width="40%">
		...
		<tr>
		    <TD><LABEL ID=LABEL4><%= GetLocalResourceObject("cbePolicyTypeCaption") %></LABEL></TD>
			<TD>			
			<%=mobjValues.PossiblesValues("cbePolicyType", "TABLE5632", eFunctions.Values.eValuesType.clngComboType, "2",  ,  ,  ,  ,  ,  ,  ,  , GetLocalResourceObject("cbePolicyTypeToolTip"))%></TD>
		</tr>
		<tr>
