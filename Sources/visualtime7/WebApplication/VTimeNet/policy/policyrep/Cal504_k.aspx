...
<script language="VB" runat="Server">
    ...
    Const clngGenBookCollection As Short = 200
...
mobjValues.sCodisplPage = "cal504_k"
...
With Response
	...
	.Write(mobjValues.WindowsTitle("CAL504", Request.QueryString.Item("sWindowDescript")))
	.Write(mobjMenu.MakeMenu("CAL504", "CAL504_K.aspx", 1, Request.QueryString.Item("sWindowDescript"), Session("sDesMultiCompany"), Session("sSche_code")))
...
<FORM METHOD="POST" NAME="CAL504" ACTION="valPolicyRep.aspx?sMode=2">
	<BR><BR>
    ...
    <TABLE WIDTH="100%">
        <TR>
            ...
            <TD><% %>
                <%=mobjValues.DateControl("tcdDateIni", FirstDay, , GetLocalResourceObject("tcdDateIniToolTip"), , , , , False)%></TD>
			<TD><LABEL ID=0><%= GetLocalResourceObject("tcdDateEndCaption") %></LABEL></TD>
            <TD><% %>
                <%=mobjValues.DateControl("tcdDateEnd", LastDay, , GetLocalResourceObject("tcdDateEndToolTip"), , , , , False)%></TD>
        </TR>
        <TD><h5>Tipo Ejecucion</h5></TD>
