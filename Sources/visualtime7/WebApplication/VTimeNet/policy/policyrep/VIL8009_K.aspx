...
Response.Write(mobjMenu.MakeMenu("VIL8009", "VIL8009_K.aspx", 1, vbNullString))
mobjMenu = Nothing
%>    
<SCRIPT>
...
<FORM METHOD="POST" ID="FORM" NAME="VIL8009" ACTION="valPolicyRep.aspx?sMode=1">
    <BR><BR>
...
<TD><% %>
<%=mobjValues.PossiblesValues("cbeMonth", "Table7013", eFunctions.Values.eValuesType.clngComboType, CStr(Month(Today)),  ,  ,  ,  ,  ,  ,  ,  , GetLocalResourceObject("cbeMonthToolTip"))%></TD>
			<TD></TD>
		</TR>
    </TABLE>
</FORM>
