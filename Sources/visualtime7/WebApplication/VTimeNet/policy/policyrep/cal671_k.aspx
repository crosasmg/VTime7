...
<FORM method="post" id="FORM" name="Policy" action="valPolicyRep.aspx?mode=1">
	...
	<%Response.Write(mobjValues.ShowWindowsName("CAL671", Request.QueryString.Item("sWindowDescript")))%>
...
%>
        ...
        <TR>
            ...
            <TD VALIGN=TOP>
                <TABLE BORDER=0 CELLSPACING=0 CELLPADDING=1 WIDTH=100%>
                    <TR>
						<TD COLSPAN="2" CLASS="HighLighted"><LABEL ID=LABEL11><%= GetLocalResourceObject("Anchor3Caption") %></LABEL></TD>
					</TR>
			        <TR>
					    <TD COLSPAN="2" CLASS="HorLine"></TD>
					</TR>
			        <TR>
						<TD><%=mobjValues.OptionControl(0, "optProcessType", GetLocalResourceObject("optProcessType_CStr1Caption"), CStr(1), CStr(1))%></TD>
						<TD><%=mobjValues.OptionControl(0, "optProcessType", GetLocalResourceObject("optProcessType_CStr2Caption"), CStr(0), CStr(2))%></TD>
					</TR>
				</TABLE>
			</TD>    
        </TR>
