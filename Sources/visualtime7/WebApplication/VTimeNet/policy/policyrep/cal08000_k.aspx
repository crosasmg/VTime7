...
<FORM method="post" id="FORM" name="Policy" action="valPolicyRep.aspx?mode=1">
	...
	<%Response.Write(mobjValues.ShowWindowsName("CAL08000", Request.QueryString.Item("sWindowDescript")))%>
    ...
    <TABLE WIDTH=100% BORDER=0 CELLSPACING=2 CELLPADDING=2 >
        <TR>
            <TD WIDTH=50% VALIGN=TOP>
				...
				<TD> <%=mobjValues.PossiblesValues("cbeBranch", "Table10", eFunctions.Values.eValuesType.clngComboType, "2",  ,  ,  ,  ,  , "insChargeProduct(this)", True,  , "",  , 3)%></TD>
			</TR>
			<TR>
...
End With
%>
				<TD> <%=mobjValues.PossiblesValues("valProduct", "tabprodmaster1", eFunctions.Values.eValuesType.clngComboType, vbNullString, True,  ,  ,  ,  ,  ,  ,  , "",  , 4)%></TD>			
			</TR>  
