...
'% inspreCAL826: se definen los campos de la forma
'--------------------------------------------------------------------------------------------
Private Sub insPreCAL826()
	'--------------------------------------------------------------------------------------------
...
Response.Write(mobjValues.OptionControl(0, "optProcessType", GetLocalResourceObject("optProcessType_1Caption"), CStr(1), "1",  ,  ,  , GetLocalResourceObject("optProcessType_1ToolTip")))
...
Response.Write(mobjValues.OptionControl(0, "optProcessType", GetLocalResourceObject("optProcessType_2Caption"),  , "2",  ,  ,  , GetLocalResourceObject("optProcessType_2ToolTip")))
...
Call mobjNetFrameWork.BeginPage("CAL826_k")
...
mobjValues.sCodisplPage = "CAL826_k"
...
//------------------------------------------------------------------------------------------
	...
	.Write(mobjMenu.MakeMenu(Request.QueryString.Item("sCodispl"), "CAL826_k.aspx", 1, Request.QueryString.Item("sWindowDescript"), Session("sDesMultiCompany"), Session("sSche_code")))
	.Write(mobjMenu.setZone(1, "CAL826", Request.QueryString.Item("sWindowDescript"), CShort(Request.QueryString.Item("nWindowTy"))))
End With
mobjMenu = Nothing
%>
...
<FORM METHOD="post" ID="FORM" NAME="CAL826" ACTION="valPolicyRep.aspx?sMode=1">
<%Call insPreCAL826()
mobjValues = Nothing
%>
</FORM>
...
Call mobjNetFrameWork.FinishPage("CAL826_k")
