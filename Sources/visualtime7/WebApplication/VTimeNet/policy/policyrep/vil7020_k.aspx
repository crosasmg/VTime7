...
<HEAD>
 ...
 <%With Response
	...
	.Write(mobjMenu.MakeMenu("VIL7020", "VIL7020_k.aspx", 1, ""))
End With
...
<TD><BR></TD>
<TD><BR></TD>
<FORM METHOD="post" ID="FORM" NAME="VIL7020" ACTION="valPolicyRep.aspx?x=1">
...
<TD><%=mobjValues.ClientControl("dtcClient", "", 1 , GetLocalResourceObject("dtcClientToolTip"),,,"lstrCliename" )%></TD>
</TR>
        <TR>
...
%>
            ...
            <TD><%=mobjValues.DateControl("tcdInitDate", Session("dEffecdate"),  , GetLocalResourceObject("tcdInitDateToolTip"))%></TD>
