...
Call mobjNetFrameWork.BeginPage("LTL971_K")
...
mobjValues.sCodisplPage = "LTL971_K"
...
'~End Body Block VisualTimer Utility
Response.Write(mobjMenu.MakeMenu("LTL971", "LTL971_k.aspx", 1, Request.QueryString.Item("sWindowDescript"), Session("sDesMultiCompany"), Session("sSche_code")))
mobjMenu = Nothing
%>    
</HEAD>
<BODY ONUNLOAD="closeWindows();">
<FORM METHOD="POST" ID="FORM" NAME="LT971" ACTION="valLetterRep.aspx?sMode=1">
	<BR><BR>
    <TABLE WIDTH="100%">
        <TR>
            <TD ><LABEL ID=17403>Fecha del proceso</LABEL>
...
Call mobjNetFrameWork.FinishPage("LTL971_K")
