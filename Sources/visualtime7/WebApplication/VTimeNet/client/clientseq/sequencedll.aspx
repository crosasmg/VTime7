...
If Not IsNothing(Request.QueryString.Item("nAction")) Then
	...
	'+ Si el parámerto "sOriginalForm" del QueryString es distinto de blanco, su valor es
	'+ asignado a una variable de sesión. ACM - 31/07/2001
	If Request.QueryString.Item("sOriginalForm") <> vbNullString Then
		Session("sOriginalForm") = Request.QueryString.Item("sOriginalForm")
	Else
