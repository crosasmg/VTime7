...
//-------------------------------------------------------------------
   ...
   //vtime como directorio virtual cambia por vtimenet
...
//-------------------------------------------------------------------
    ...
    doc.writeln ("<HTML>")
    doc.writeln ("<HEAD>")
    doc.writeln("   <LINK REL='StyleSheet' TYPE='text/css' HREF='/VTimeNet/common/GreenBlueVT.css'>")
    ...
    doc.writeln ("function insGoTo(RefUrl){\n" +
               "    var win=open(RefUrl, 'Transaccion','toolbar=no,resizable=no,location=no,directories=no,status=yes,menubar=no,copyhistory=no,width=4000,height=4000,left=20,top=20');\n    win.moveTo(0, 0);\n    win.resizeTo(window.screen.availWidth, window.screen.availHeight);\n    parent.insClose()\n}");
