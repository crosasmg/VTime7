...
Response.Write(mobjValues.OptionControl(0, "optDocType", GetLocalResourceObject("optDocType_1Caption"), CStr(0), "1",  , True))
...
//+ Se obtiene el tipo de factura a tratar
		if (optDocType[1].checked==true)
			   ...
			   (lintBillType!=mintBillType)) 
			{
				...
				mintBillType=lintBillType;
        		insDefValues("ShowDataCO700", "sField=FindBill" +  "&nBill=" + tcnBill.value + "&sBillType=" + lintBillType + "&nInsur_area=" + mintInsur_area +
