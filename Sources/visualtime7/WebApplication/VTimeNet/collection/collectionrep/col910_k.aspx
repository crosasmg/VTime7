...
mobjValues.sCodisplPage = "col910_k"
...
With Response
	...
	.Write(mobjValues.WindowsTitle("COL910", Request.QueryString.Item("sWindowDescript")))
	.Write(mobjMenu.MakeMenu("COL910", "COL910_K.aspx", 1, Request.QueryString.Item("sWindowDescript"), Session("sDesMultiCompany"), Session("sSche_code")))
...
//+ Variable para el control de versiones 
	document.VssVersion="$$Revision: 3 $|$$Date: 5/01/04 18:51 $|$$Author: Nvaplat61 $" 
...
<FORM METHOD="POST" NAME="COL910" ACTION="valCollectionRep.aspx?sMode=2">
	<BR><BR>
