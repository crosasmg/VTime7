    ...
    <form id="form1" runat="server">
        ...
        <dx:ASPxGridView  ID="GridViewNotes" runat="server" EnableCallBacks ="false" AutoGenerateColumns="false" OnCustomUnboundColumnData="GridViewNotes_CustomUnboundColumnData" ClientIDMode="Predictable" DataSourceID="DataSourceNotes" ClientInstanceName="GridViewNotes" Width="100%" KeyFieldName="SequenceId;ConsequenceId" OnRowInserting="GridViewNotes_rowinserting"  OnRowUpdating="GridViewNotes_rowupdating" OnRowDeleting="GridViewNotes_rowdeleting" meta:resourcekey="GridViewNotes"  Enabled="True" Settings-EnableFilterControlPopupMenuScrolling="false">
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn FieldName="CreatorUserName" Caption="Usuario Creador" VisibleIndex="8" Name="CreatorUserName" CellStyle-Wrap="True" Width="10%" HeaderStyle-Wrap="True" UnboundType="String" meta:resourcekey="GridViewDataTexColumnCreatorUserName">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="UpdateUserCode" Caption="Código Usuario Modificador" VisibleIndex="9" Visible="False" HeaderStyle-Wrap="True" Name="CreatorUserName" UnboundType="String" meta:resourcekey="GridViewDataTexColumnUpdateUserCode">
                </dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="UpdateUserName" Caption="Modificado Por" VisibleIndex="10" Name="CreatorUserName" CellStyle-Wrap="True" Width="10%" HeaderStyle-Wrap="True" UnboundType="String" meta:resourcekey="GridViewDataTexColumnUpdateUserName">
                </dx:GridViewDataTextColumn>
            </Columns>
                    ...
                    <table style="width: 100%;">
                        <tr>
                            ...
                            <td style="width: 275px; height: 24px;">
                                <dx:ASPxTextBox ID="TextBoxNameId" runat="server" MaxLength="30" EnableClientSideAPI="true" Text='<%#Eval("Name") %>' ValidationSettings-ValidationGroup='<%# Container.ValidationGroup %>' Width="170px" meta:resourcekey="TextBoxNameId">
