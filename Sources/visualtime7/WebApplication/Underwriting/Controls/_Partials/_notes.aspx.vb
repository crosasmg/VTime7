...
Partial Class Underwriting_Controls_Partials_notes
    ...
    Protected Sub MapClassToPage()
        ...
        If instance IsNot Nothing _
            ...
            If (_formData.SequenceId = 0) Then
                'Dim sequenceDTO As New SequenceDTO
            ...
            GridViewNotes.Enabled = Session("IsEditMode")
            AspxHyperLinkNew.Visible = Session("IsEditMode")
            ...
            DataSourceNotes.SelectParameters.Add(New Parameter("accessToken", DbType.String, ResponseHelper.GetValidToken()))
    ...
    Protected Function CreateSequence() As Integer
        Dim sequenceId = InMotionGIT.DatosNoEstruct.Proxy.DNE.OperationContracts.SequenceExistInTags(TryCast(Session("UnderwritingCaseID"), UnderwritingCase).UnderwritingCaseID, ResponseHelper.GetValidToken(), provider)
...
#Region "DNENotes GridViewNotes Methods"
    ...
    Private Sub ActivateButtonsBasedOnPageState()
        AspxHyperLinkNew.Enabled = Session("IsEditMode")
        AspxHyperLinkNew.Visible = Session("IsEditMode")
        ButtonFilter.Enabled = Session("IsEditMode")
    End Sub
    ...
    Private Sub CreateTagCheckBoxes()
        ...
        If IsNumeric(_formData.SequenceId) Then
    ...
    Protected Sub GridViewNotes_RowInserting(sender As Object, e As DevExpress.Web.Data.ASPxDataInsertingEventArgs)
        ...
        resourceDTO.Note.SequenceId = _formData.SequenceId
        resourceDTO.Note.Content = DirectCast(e.NewValues("Note.Content"), [String])

        resourceDTO.SequenceId = _formData.SequenceId
    ...
    Protected Function GenerateTags(sequenceId As Integer, consequenceId As Integer) As HashSet(Of TagDTO)
        ...
        tagsResult.Add(GenerateCaseIdTag(sequenceId, consequenceId))
        Return tagsResult
    End Function
