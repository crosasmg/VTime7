<%@ Page Language="VB" AutoEventWireup="false" CodeFile="_restrictionsDetailExtraPremium.aspx.vb" Inherits="Underwriting_Controls_Partials_restrictionsDetail" %>
...
<body>
    <form id="form-restrictions-detail-recharge" name="form-restrictions-detail-recharge" action="" class="form-horizontal">
        ...
        <div class="col-md-6" id="divMoneda">
            <div class="form-group">
        ...
        <div class="col-md-6" id="divFactor">
            <div class="form-group">
