...
<table width="100%" cellspacing="5" border="0" align="left" class="table_fixed">
    <tbody>
        <tr>
            <td style="width: <%=LeftPanelSize%>; vertical-align: top" class="mainColumn firstColumn">
            ...
            <td style="visibility: <%=MiddlePanelVisible%>" class="column_divider mainColumn secondColumn"></td>

            <td style="width: <%=MiddlePanelSize%>; vertical-align: top; visibility: <%=MiddlePanelVisible%>" class="mainColumn thirdColumn">
            ...
            <td style="visibility: <%=RightPanelVisible%>" class="column_divider mainColumn fourthColumn"></td>

            <td style="width: <%=RightPanelSize%>; vertical-align: top; visibility: <%=RightPanelVisible%>" class="mainColumn fifthColumn">
