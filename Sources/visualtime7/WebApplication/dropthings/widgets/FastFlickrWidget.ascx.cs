...
using Dropthings.Widgets;
using System.Runtime.Serialization.Json;

namespace Dropthings.Widgets 
{

public partial class FastFlickrWidgetUserControl : System.Web.UI.UserControl, IWidget
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (this._Host.IsFirstLoad)
        {
            ...
            typeof(FastFlickrWidgetUserControl),
            "FastFlickrWidget",
            ...
            ScriptManager.RegisterStartupScript(this, typeof(FastFlickrWidgetUserControl), "LoadFlickr",
