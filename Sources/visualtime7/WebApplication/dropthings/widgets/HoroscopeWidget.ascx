<%@ Control Language="C#" AutoEventWireup="true" CodeFile="HoroscopeWidget.ascx.cs" Inherits="Dropthings.Widgets.HoroscopeWidgetUserControl" %>
<asp:MultiView ID="Multiview" runat="server" ActiveViewIndex="0">

<asp:View runat="server" ID="ProgressView">
    <asp:image runat="server" ID="image1" ImageAlign="middle" 
        ImageUrl="~/images/dropthings/indicator.gif" />
...
<tr><td>Select Horoscope: 
    <asp:DropDownList ID="Horoscope" runat="server" AutoPostBack="True" OnSelectedIndexChanged="Horoscope_SelectedIndexChanged">
...
<tr><td valign="middle">
    <asp:Label ID="HoroscopeLabel" runat="server" Text="" EnableViewState="false"></asp:Label></td></tr>
</table>
