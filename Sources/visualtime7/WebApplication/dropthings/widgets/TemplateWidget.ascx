<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TemplateWidget.ascx.cs" Inherits="Dropthings.Widgets.TemplateWidgetUserControl" %>
<asp:Panel ID="SettingsPanel" runat="server" Visible="false">
<asp:Label ID="Nothing" Text="No Settings" runat="server" />
</asp:Panel>

<asp:Panel ID="BodyPanel" runat="server" Style="text-align:center">
