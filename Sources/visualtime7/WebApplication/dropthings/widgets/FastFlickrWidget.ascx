<%@ Control Language="C#" AutoEventWireup="true" CodeFile="FastFlickrWidget.ascx.cs" Inherits="Dropthings.Widgets.FastFlickrWidgetUserControl" EnableViewState="false" %>
