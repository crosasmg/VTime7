...
var DropthingsUI = {
    Actions : {
        deleteWidget: function(instanceId)
        {
           ...
           var theDiv = document.getElementById("ctl00_ContentPlaceholder1_WidgetPanelsLayout_WidgetContainer" + instanceId + "_WidgetPanel");
...
var DeleteWarning =
{
    ...
    init : function()
    {
        ...
        div.innerHTML = '<div id="DeleteConfirmPopup" style="display:none"><h1>' + DeleteWidgetMessages.Get("Title") + '</h1><p>' + DeleteWidgetMessages.Get("Text") + '</p><input id="DeleteConfirmPopup_Yes" type="button" value=' + DeleteWidgetMessages.Get("Yes") + ' /><input id="DeleteConfirmPopup_No" type="button" value="No" /></div>';
...
//        var html = hiddenHtmlTextArea.value;
        var div = document.createElement('div');
        div.innerHTML = '<div id="DeletePageConfirmPopup"><h1>Delete a Page</h1><p>Are you sure you want to delete the page?</p><input id="DeletePageConfirmPopup_Yes" type="button" value="Yes" /><input id="DeletePageConfirmPopup_No" type="button" value="No" />';
        document.body.appendChild(div);
