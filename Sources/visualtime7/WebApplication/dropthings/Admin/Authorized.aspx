<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="Authorized.aspx.vb" Inherits="Maintenance_Authorized" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                case 'ViewItem':
                case 'Authorized_ViewItem':

                    CurrentGrid = Authorized;
                    CurrentGrid.PerformCallback('');
                    break;
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <table width="1000px" border="0" cellspacing="5">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="1000px">
                                <dxp:ASPxPanel ID="Authorized_View" ClientInstanceName="Authorized_View" runat="server"
                                    ClientVisible="True" Width="100%">
                                    <PanelCollection>
                                        <dxp:PanelContent ID="Authorized_ViewPanel" runat="server" SupportsDisabledAttribute="True">
                                            <dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='Authorized' ID='Authorized'
                                                runat='server' Width='100%' KeyFieldName='NAME'  Enabled="True"
                                                ClientVisible="True" EnableRowsCache="False"
                                                ...
                                                <Columns>
                                                    ...
                                                    <dxwgv:GridViewDataTextColumn Name='Name' FieldName='NAME' Caption='User Name' ToolTip='Name of user'
                                                        VisibleIndex="0" CellStyle-HorizontalAlign="Left" Width="100%" Visible="True"
                                                        HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="Name">
                                                    ...
                                                    <dxwgv:GridViewCommandColumn VisibleIndex="1" ButtonType="Image" Caption=" " Width="24px">
            ...
            <script type="text/javascript">
                AddKeyboardNavigationTo(Authorized);

                HandlerView('Authorized_ViewItem')
            </script>
                        ...
                        <div style="width: 350px">
                            <dx:ASPxUploadControl ID="ExcelFileUpload" ClientInstanceName="ExcelFileUpload" runat="server"
                                ...
                                <ClientSideEvents FileUploadComplete="function(s, e) {
                                    ExcelFileName.SetText(e.callbackData);s.SetClientVisible(false);ExcelFileName.SetClientVisible(true);Authorized.PerformCallback('import_'+ExcelFileName.GetValue());
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <dxe:ASPxButton ID="btnaccepton" runat="server" Width="50px" AutoPostBack="False"
                                                ...
                                                Image-Url="~/images/16x16/Commands/accept.png">
                                                <ClientSideEvents Click="function(s, e) {Authorized.PerformCallback('importconf_'+ExcelFileName.GetValue());popupImport.Hide();}" />
                                            </dxe:ASPxButton>
                                        </td>
                                        <td>
                                        ...
                                        <table>
                                            <tr>
                                                <td>
                                                 ...
                                                 {Authorized.PerformCallback('template.'+WithDataCheckBox.GetChecked()+'.'+WithLookupCheckBox.GetChecked());
