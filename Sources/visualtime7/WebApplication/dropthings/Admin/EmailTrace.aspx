<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="EmailTrace.aspx.vb" Inherits="dropthings_Admin_EmailTrace" meta:resourcekey="PageResource" %>
        ...
        function HandlerView(name) {
            switch (name) {
                ...
                case 'AcceptInfoItem':
                    ...
                    if (typeof (tempDateFrom) == 'undefined' || tempDateFrom == null || typeof (tempDateFrom) == 'undefined' || tempDateFrom == null) {
                        ...
                        if ((Date.parse(tempDateTo)) >= (Date.parse(tempDateFrom))) {
                            ...
                            Jobs_View.SetClientVisible(true);
                ...
                case 'CancelInfoItem':
                    ...
                    Jobs_View.SetClientVisible(false);
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td width="1000px">
                                                        ...
                                                        <table style="border: 0; width: 100%;">
                                                            <tbody>
                                                                <tr style="vertical-align: top;">
                                                                    ...
                                                                    <td style="text-align: left; width: 50.0%;">
                                                                        <dxe:ASPxDateEdit runat='server' ID='DateFrom' ClientInstanceName='DateFrom' ToolTip="Date from:"
                                                                            Enabled='True' ClientVisible='True' meta:resourcekey="DateFrom" OnInit="DateFrom_Init"  >
                                                                ...
                                                                <tr style="vertical-align: top;">
                                                                    ...
                                                                    <td style="text-align: left; width: 50.0%;">
                                                                        <dxe:ASPxDateEdit runat='server' ID='DateTo' ClientInstanceName='DateTo' ToolTip="Date to:"
                                                                            Enabled='True' ClientVisible='True' meta:resourcekey="DateTo" OnInit="DateTo_Init" >
                                                                            <Paddings PaddingBottom="0px" PaddingLeft="0px" PaddingRight="0px" PaddingTop="0px" />
                                                                        </dxe:ASPxDateEdit>
                                                                    </td>
                                                                </tr>
                                ...
                                <dxp:ASPxPanel ID="Jobs_View" ClientInstanceName="Jobs_View" runat="server" ClientVisible="True"
                                    Width="100%">
                                    <PanelCollection>
                                        <dxp:PanelContent ID="Jobs_ViewPanel" runat="server" SupportsDisabledAttribute="True">
                                            <dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='Jobs' ID='Jobs'
                                                runat='server' Width='100%' KeyFieldName='JOBID' Enabled="True" ClientVisible="True"
                                                EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True"
                                                EnableCallBacks="True">
                                                <%--meta:resourcekey="JobsResource" Caption='E-mail Trace'--%>
                                                ...
                                                <Columns>
                                                    <dxwgv:GridViewCommandColumn VisibleIndex="0" Visible="False" ButtonType="Image"
                                                        Width="8px" ShowSelectCheckbox="True" />
                                                    <dxwgv:GridViewDataTextColumn Name='JOBID' FieldName='JOBID' Caption='ID' ToolTip='Id'
                                                        VisibleIndex="0" CellStyle-HorizontalAlign="Left" Width="1%" Visible="False"
                                                        HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="JOBID">
                                                        <EditFormSettings VisibleIndex="0" Visible="False" />
                                                        <PropertiesTextEdit Size='36' MaxLength='36'>
                                                        </PropertiesTextEdit>
                                                    </dxwgv:GridViewDataTextColumn>
                                                    <dxwgv:GridViewDataDateColumn Name='LASTUPDATEDON' FieldName='LASTUPDATEDON' Caption='Last Update On'
                                                        ToolTip='Last Update On' VisibleIndex="1" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom"
                                                        HeaderStyle-HorizontalAlign="Center" Width="10%" Visible="True" meta:resourcekey="LASTUPDATEDON">
                                                        <EditFormSettings VisibleIndex="1" Visible="True" />
                                                        <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy hh:mm:ss" >
                                                        </PropertiesDateEdit>
                                                    </dxwgv:GridViewDataDateColumn>
                                                    <dxwgv:GridViewDataTextColumn Name='EMAIL' FieldName='EMAIL' Caption='E- Mail' ToolTip='E-Mail'
                                                        VisibleIndex="2" CellStyle-HorizontalAlign="Left" Width="13%" Visible="True"
                                                    ...
                                                    <dxwgv:GridViewDataTextColumn Name='SUBJECT' FieldName='SUBJECT' Caption='Subject'
                                                        ToolTip='Message Subject' VisibleIndex="3" CellStyle-HorizontalAlign="Left" Width="10%"
                                                        Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="SUBJECT">
                                                        <EditFormSettings VisibleIndex="3" Visible="True" />
                                                        <PropertiesTextEdit Size='255' MaxLength='255'>
                                                        </PropertiesTextEdit>
                                                    </dxwgv:GridViewDataTextColumn>
                                                    <dxwgv:GridViewDataTextColumn Name='BODY' FieldName='BODY' Caption='Body' ToolTip='Message Body'
                                                        VisibleIndex="4" CellStyle-HorizontalAlign="Left" Width="39%" Visible="False"
                                                        HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="BODY">
                                                        <EditFormSettings VisibleIndex="4" Visible="False" />
                                                        <PropertiesTextEdit Size='1000' MaxLength='1000'>
                                                        </PropertiesTextEdit>
                                                    </dxwgv:GridViewDataTextColumn>
                                                    <dxwgv:GridViewDataComboBoxColumn Name='STATUS' FieldName='STATUS' Caption='Status'
                                                        ToolTip='Message Status' VisibleIndex="5" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom"
                                                        HeaderStyle-HorizontalAlign="Center" Width="9%" Visible="True" meta:resourcekey="STATUS">
                                                     ...
                                                     <dxwgv:GridViewDataDateColumn Name='VIEWEDDATE' FieldName='VIEWEDDATE' Caption='Viewed Date'
                                                        ToolTip='Last Update On' VisibleIndex="1" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom"
                                                        HeaderStyle-HorizontalAlign="Center" Width="10%" Visible="True" meta:resourcekey="VIEWEDDATE">
                                                        <EditFormSettings VisibleIndex="6" Visible="True" />
                                                        <PropertiesDateEdit DisplayFormatString="dd/MM/yyyy hh:mm:ss" >
                                                        </PropertiesDateEdit>
                                                    </dxwgv:GridViewDataDateColumn>
                                                    <dxwgv:GridViewDataTextColumn Name='FAIL' FieldName='FAIL' Caption='Fail' ToolTip='System of Fail'
                                                        VisibleIndex="6" CellStyle-HorizontalAlign="Left" Width="20%" Visible="True"
                                                        HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="FAIL">
                        ...
                        <div style="width: 350px">
                            <dx:ASPxUploadControl ID="ExcelFileUpload" ClientInstanceName="ExcelFileUpload" runat="server"
                                ...
                                <ClientSideEvents FileUploadComplete="function(s, e) {
                                    ExcelFileName.SetText(e.callbackData);s.SetClientVisible(false);ExcelFileName.SetClientVisible(true);Jobs.PerformCallback('import_'+ExcelFileName.GetValue());
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <dxe:ASPxButton ID="btnaccepton" runat="server" Width="50px" AutoPostBack="False"
                                                ...
                                                Image-Url="~/images/16x16/Commands/accept.png">
                                                <ClientSideEvents Click="function(s, e) {Jobs.PerformCallback('importconf_'+ExcelFileName.GetValue());popupImport.Hide();}" />
                                            </dxe:ASPxButton>
                                        </td>
                                        <td>
                                        ...
                                        <table>
                                            <tr>
                                                <td>
                                                 ...
                                                 {Jobs.PerformCallback('template.'+WithDataCheckBox.GetChecked()+'.'+WithLookupCheckBox.GetChecked());
                ...
                <ContentCollection>
                    <dxpc:PopupControlContentControl>
                        <div>
                            ...
                            <dxe:ASPxLabel ID="lblDateLogic" runat="server" ClientInstanceName="lblDateLogic"
                                meta:resourcekey="lblDateLogicResource" Text="Fecha fin menor que fehca final" />
                        </div>
                    </dxpc:PopupControlContentControl>
                </ContentCollection>
            </dxpc:ASPxPopupControl>
