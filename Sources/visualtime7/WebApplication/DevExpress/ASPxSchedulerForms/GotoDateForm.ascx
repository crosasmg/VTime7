...
<table style="width:100%; height:100%">
    <tr>
        ...
        <td style="width:100%">
            <dxe:ASPxDateEdit ClientInstanceName="_dx" ID="edtDate" runat="server" Width="100%" Date='<%#((DevExpress.Web.ASPxScheduler.GotoDateFormTemplateContainer)Container).Date %>' />
        </td> 
    </tr>
    <tr>
        <td>
        ...
        <td style="width:100%">
            <dxe:ASPxComboBox ClientInstanceName="_dx" ID="cbView" runat="server" Width="100%" DataSource='<%#((DevExpress.Web.ASPxScheduler.GotoDateFormTemplateContainer)Container).ViewsDataSource %>'></dxe:ASPxComboBox>
        </td>
    </tr>
    <tr>
