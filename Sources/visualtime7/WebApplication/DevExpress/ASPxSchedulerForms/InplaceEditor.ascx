...
<table cellpadding="2"; cellspacing="0" style="width:100%; height:100%">
    <tr>
        <td style="width:100%" >
            <dxe:ASPxMemo ClientInstanceName="_dx" ID="memSubject" runat="server" Width="100%" Rows="5" Text='<%# ((DevExpress.Web.ASPxScheduler.AppointmentInplaceEditorTemplateContainer)Container).Appointment.Subject %>'>
            </dxe:ASPxMemo>
        </td>
        <td valign="top" >

        <div>
            <dxsc:NoBorderButton runat="server" ClientInstanceName="_dx" ID="btnSave" Width="19px" Height="19px" ToolTip="Save" 
                Image-IsResourcePng="True">
            </dxsc:NoBorderButton> 
        </div>
        
        <div style="padding-top:1px;">
            <dxsc:NoBorderButton runat="server" ClientInstanceName="_dx" ID="btnCancel" Width="19px" Height="19px" ToolTip="Cancel" 
                 CausesValidation="False" Image-IsResourcePng="True">
            </dxsc:NoBorderButton> 
        </div>

        <div style="padding-top:6px;">
            <dxsc:NoBorderButton runat="server" ClientInstanceName="_dx" ID="btnEditForm" Width="19px" Height="19px" ToolTip="Open Edit Form..." 
                CausesValidation="False" Image-IsResourcePng="True">
            </dxsc:NoBorderButton>
        </div>
        </td>
