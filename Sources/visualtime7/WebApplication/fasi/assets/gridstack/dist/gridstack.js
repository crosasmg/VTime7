    ...
    GridStack.prototype._updateStyles = function(maxHeight) {
        ...
        if (maxHeight > this._styles._max) {
            for (var i = this._styles._max; i < maxHeight; ++i) {
                ...
                var strHeight = getHeight(i + 1, i);
                Utils.insertCSSRule(this._styles,
                    prefix + '[data-gs-height="' + (i + 1) + '"] .grid-stack-item-content .ibox .ibox-content',
                    'height: ' + (strHeight.substring(0, (strHeight.length - 2)) - this.opts.cellHeight) + 'px; overflow-y: auto;',
                    i
                );                          
                Utils.insertCSSRule(this._styles,
