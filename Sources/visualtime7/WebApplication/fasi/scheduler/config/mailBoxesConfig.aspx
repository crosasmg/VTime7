<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/fasi/FASI.master" CodeFile="mailBoxesConfig.aspx.cs" Inherits="fasi_scheduler_MailBoxesConfig" %>
            ...
            <div class="ibox-content mailbox-content">
                <div class="file-manager">
                    <ul class="treeViewTopMenu">
                        <li><a id="lnkCreate" href="javascript:mailBoxesConfigSupport.createNode();" data-toggle="tooltip-task"><i class="fa fa-plus"></i></a></li>
                        <li><a id="lnkUpdate" href="javascript:mailBoxesConfigSupport.renameNode();" data-toggle="tooltip-task"><i class="fa fa-pencil"></i></a></li>
                        <li><a id="lnkDelete" href="javascript:mailBoxesConfigSupport.deleteNode();" data-toggle="tooltip-task"><i class="fa fa-trash"></i></a></li>
                    </ul>
                    <div id="treeView"></div>
                                ...
                                <div class="ibox-content">
                                    <div class="form-group">
                                        <form id="formCondition" class="form-horizontal" style="display: none;">
                                            ...
                                            <div class="col-sm-2">
                                                <select id="cbxField" name="field" class="form-control" style="width: 100%;" onchange="mailBoxesConfigSupport.onChangeField(this);"></select>
                                            </div>
                                        ...
                                        <div class="col-sm-1">
                                            <button id="addCondition" class="btn btn-primary" onclick="mailBoxesConfigSupport.createCondition(event);" data-toggle="tooltip-task"><i class="fa fa-plus"></i></button>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12 checkbox c-checkbox">
                                                <label id="enableSemaphore">
                                                    <input id="semaphoreActive" type="checkbox" onchange="mailBoxesConfigSupport.enableSemaphoreClick(this);" value="true" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="Server">
    ...
    <script type="text/javascript" src="/fasi/scheduler/config/mailBoxesConfig.js?rel=1526481090736"></script>
</asp:Content>
