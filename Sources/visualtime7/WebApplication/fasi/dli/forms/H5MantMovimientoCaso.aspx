...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <!-- This code was generated by Form Designer v7.3.24.1 at 2019-11-08 04:12:46 p. m. model release 1, Form Generator v1.0.37.9 -->
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <div id="app" class="ibox">
     <div class="ibox-content">
        <form id="H5MantMovimientoCasoMainForm">
            <input type="hidden" id="H5MantMovimientoCasoFormId" name="H5MantMovimientoCasoFormId" value="" />
            <div id="alerts-container"></div>
			<div class="row">
            <!-- Container content -->
                        <!-- Container: TabManualOrAutomaticType_Grid grid -->
                        <div  class='col-md-12'>

                       <div id='TabManualOrAutomaticType_GridContainer'>
                            <div id="TabManualOrAutomaticType_Gridtoolbar">
                            <div class='form-inline'>
                                <button id="TabManualOrAutomaticType_GridCreateBtn" type="button" data-i18n="app.form.TabManualOrAutomaticType_Grid_AddButtonCaption;[data-modal-title]app.form.TabManualOrAutomaticType_Grid_AddButtonCaption"  class="btn btn-default" data-modal-title="Agregar">
                                    Agregar
                                </button>
                                <button id="TabManualOrAutomaticType_GridRemoveBtn"  data-i18n="app.form.TabManualOrAutomaticType_Grid_DeleteButtonCaption;[data-title]app.form.TabManualOrAutomaticType_Grid_DeleteButtonCaption"  type="button" class="btn btn-danger" disabled data-title="Eliminar">
                ...
                <!-- ShowTranslatorGrid button -->
                  <div class='form-group'>
                    <button id='ShowTranslatorGrid' class='ladda-button btn pull-left btn-default' data-style='expand-right' title='Mostrar Vista Traducción' data-i18n="app.form.ShowTranslatorGrid_Caption;[title]app.form.ShowTranslatorGrid_Tooltip" ><span class='ladda-label'>Vista Traducción</span><span class='ladda-spinner'></span></button>
                            ...
                            <div id='TabManualOrAutomaticType_GridTblPlaceHolder'></div>
                       </div>

                        </div>
                        <!-- End Container: TabManualOrAutomaticType_Grid grid -->
                        <!-- Container: TabManualOrAutomaticTypeTranslator_Grid grid -->
                        <div  class='col-md-12'>

                       <div id='TabManualOrAutomaticTypeTranslator_GridContainer' class='hidden'>
                            <div id="TabManualOrAutomaticTypeTranslator_Gridtoolbar">
                            <div class='form-inline'>
                <!-- ShowStandardGrid button -->
                  <div class='form-group'>
                    <button id='ShowStandardGrid' class='ladda-button btn pull-left btn-default' data-style='expand-right' title='Mostrar Vista Estándar' data-i18n="app.form.ShowStandardGrid_Caption;[title]app.form.ShowStandardGrid_Tooltip" ><span class='ladda-label'>Vista Estándar</span><span class='ladda-spinner'></span></button>
                            ...
                            <div id='TabManualOrAutomaticTypeTranslator_GridTblPlaceHolder' class='hidden'></div>
                       </div>

                        </div>
                        <!-- End Container: TabManualOrAutomaticTypeTranslator_Grid grid -->
        ...
        <div id='TabManualOrAutomaticType_GridPopup' class='modal fade' tabindex='-1' role='dialog' aria-labelledby='edit' aria-hidden='true'>
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="row">
                        <form id='TabManualOrAutomaticType_GridEditForm'>
                            <!-- Container content -->
                                        <!-- ManualOrAutomatic numeric -->
                                        <div class='col-md-6 form-horizontal'>
                                          <div class='form-group'>
                                            <div class='col-md-4 text-left'>
                                              <label id='ManualOrAutomaticLabel' data-i18n="[html]app.form.ManualOrAutomatic_Label" class='control-label' for='ManualOrAutomatic'>Manual o automático</label><span id='ManualOrAutomaticRequired' class='required-mark'>*</span>
                                            </div>
                                            <div class='col-md-8'>
                                                <input class='form-control' id='ManualOrAutomatic' data-i18n="[title]app.form.ManualOrAutomatic_Tooltip" name='ManualOrAutomatic' title='Movimiento manual o automático.' type='text' style='text-align: right'/>
                                            </div>
                                          </div>
                                        </div>
                    ...
                    <div class="modal-footer">
                        <button id="TabManualOrAutomaticType_GridSaveBtn"  data-i18n="app.form.GridViewPopup_SaveButtonCaption"  class="btn btn-warning">Guardar</button>
        ...
        <div id='TabManualOrAutomaticTypeTranslator_GridPopup' class='modal fade' tabindex='-1' role='dialog' aria-labelledby='edit' aria-hidden='true'>
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    ...
                    <div class="modal-body">
                      <div class="row">
                        <form id='TabManualOrAutomaticTypeTranslator_GridEditForm'>
                            <!-- Container content -->
                                        <!-- ManualOrAutomaticTranslator numeric -->
                                        <div class='col-md-6 form-horizontal'>
                                          <div class='form-group'>
                                            <div class='col-md-4 text-left'>
                                              <label id='ManualOrAutomaticTranslatorLabel' data-i18n="[html]app.form.ManualOrAutomaticTranslator_Label" class='control-label' for='ManualOrAutomaticTranslator'>Movimiento</label><span id='ManualOrAutomaticTranslatorRequired' class='required-mark'>*</span>
                                            </div>
                                            <div class='col-md-8'>
                                                <input class='form-control' id='ManualOrAutomaticTranslator' data-i18n="[title]app.form.ManualOrAutomaticTranslator_Tooltip" name='ManualOrAutomaticTranslator' title='Movimiento manual o automático' type='text' style='text-align: right'/>
                                            </div>
                                          </div>
                                        </div>
                                        ...
                                        <div class='col-md-6 form-horizontal'>
                                          <div class='form-group'>
                                            <div class='col-md-4 text-left'>
                                              <label id='LanguageIdTranslatorLabel' data-i18n="[html]app.form.LanguageIdTranslator_Label" class='control-label' for='LanguageIdTranslator'>Lenguaje Id</label><span id='LanguageIdTranslatorRequired' class='required-mark'>*</span>
                                            </div>
                                            <div class='col-md-8'>
                    ...
                    <div class="modal-footer">
                        <button id="TabManualOrAutomaticTypeTranslator_GridSaveBtn"  data-i18n="app.form.GridViewPopup_SaveButtonCaption"  class="btn btn-warning">Guardar</button>
                        <button class="btn"  data-i18n="app.form.GridViewPopup_CancelButtonCaption"  data-dismiss="modal" aria-hidden="true">Cancelar</button>
                    </div>
                </div>
            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="Server">
    ...
    <script src='/fasi/app/js/TableHelper.js?rel=20191108041246304'></script>
    ...
    <script src="H5MantMovimientoCaso.js?rel=20191108041246304"></script>
