...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <div class="ibox">
     <div class="ibox-content">
        <form id="HT5AuthorizationToObtainDiscloseInformationUWMainForm">
            <input type="hidden" id="HT5AuthorizationToObtainDiscloseInformationUWFormId" name="HT5AuthorizationToObtainDiscloseInformationUWFormId" value="" />
    ...
    <!-- Container content -->
                ...
                <div class='col-md-3 form-horizontal'>
                  ...
                  <input type='radio' name='AcceptanceIndicator' id='AcceptanceIndicator_true' value='true' title='Indicador de aceptación.' />Si
                </label>
                <label class='radio-inline'>
                  <input type='radio' name='AcceptanceIndicator' id='AcceptanceIndicator_false' value='false' />No
                </label>
    ...
    <!-- Container content -->
                ...
                <div class='col-md-4 form-vertical'>
                  <div class='form-group'>
                    <button id='submit' class='ladda-button btn pull-right btn-default' data-style='expand-right' title='' ><span class='ladda-label'>
   <img src='/images/Library/16x16_ASPNetIcons/file_manager_16x16.gif' id='submitImage' />Guardar temporalmente</span><span class='ladda-spinner'></span></button>
                ...
                <div class='col-md-4 form-vertical'>
                  <div class='form-group'>
                    <button id='save' class='ladda-button btn pull-right btn-default' data-style='expand-right' title='' disabled='disabled' ><span class='ladda-label'>
   <img src='/images/Library/16x16_ASPNetIcons/mail2_(add)_16x16.gif' id='saveImage' />Enviar</span><span class='ladda-spinner'></span></button>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="Server">
    ...
    <script src="HT5AuthorizationToObtainDiscloseInformationUW.js?rel=20181128024013608"></script>
