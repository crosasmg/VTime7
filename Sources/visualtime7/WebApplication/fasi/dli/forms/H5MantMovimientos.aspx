...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <!-- This code was generated by Form Designer v7.3.24.1 at 2019-11-08 04:25:44 p. m. model release 1, Form Generator v1.0.37.9 -->
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <div id="app" class="ibox">
     <div class="ibox-content">
        <form id="H5MantMovimientosMainForm">
            <input type="hidden" id="H5MantMovimientosFormId" name="H5MantMovimientosFormId" value="" />
            <div id="alerts-container"></div>
			<div class="row">
            <!-- Container content -->
                        <!-- Container: TabEntryType_Grid grid -->
                        <div  class='col-md-12'>

                       <div id='TabEntryType_GridContainer'>
                            <div id="TabEntryType_Gridtoolbar">
                            <div class='form-inline'>
                                <button id="TabEntryType_GridCreateBtn" type="button" data-i18n="app.form.TabEntryType_Grid_AddButtonCaption;[data-modal-title]app.form.TabEntryType_Grid_AddButtonCaption"  class="btn btn-default" data-modal-title="Agregar">
                                    Agregar
                                </button>
                                <button id="TabEntryType_GridRemoveBtn"  data-i18n="app.form.TabEntryType_Grid_DeleteButtonCaption;[data-title]app.form.TabEntryType_Grid_DeleteButtonCaption"  type="button" class="btn btn-danger" disabled data-title="Eliminar">
                ...
                <!-- ShowTranslatorGrid button -->
                  <div class='form-group'>
                    <button id='ShowTranslatorGrid' class='ladda-button btn pull-left btn-default' data-style='expand-right' title='Mostrar Vista Traducción' data-i18n="app.form.ShowTranslatorGrid_Caption;[title]app.form.ShowTranslatorGrid_Tooltip" ><span class='ladda-label'>Vista Traducción</span><span class='ladda-spinner'></span></button>
                            ...
                            <div id='TabEntryType_GridTblPlaceHolder'></div>
                       </div>

                        </div>
                        <!-- End Container: TabEntryType_Grid grid -->
                        <!-- Container: TabEntryTypeTranslator_Grid grid -->
                        <div  class='col-md-12'>

                       <div id='TabEntryTypeTranslator_GridContainer' class='hidden'>
                            <div id="TabEntryTypeTranslator_Gridtoolbar">
                            <div class='form-inline'>
                <!-- ShowStandardGrid button -->
                  <div class='form-group'>
                    <button id='ShowStandardGrid' class='ladda-button btn pull-left btn-default' data-style='expand-right' title='Mostrar Vista Estándar' data-i18n="app.form.ShowStandardGrid_Caption;[title]app.form.ShowStandardGrid_Tooltip" ><span class='ladda-label'>Vista Estándar</span><span class='ladda-spinner'></span></button>
                            ...
                            <div id='TabEntryTypeTranslator_GridTblPlaceHolder' class='hidden'></div>
                       </div>

                        </div>
                        <!-- End Container: TabEntryTypeTranslator_Grid grid -->
        ...
        <div id='TabEntryType_GridPopup' class='modal fade' tabindex='-1' role='dialog' aria-labelledby='edit' aria-hidden='true'>
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="row">
                        <form id='TabEntryType_GridEditForm'>
                            <!-- Container content -->
                                        <!-- EntryType numeric -->
                                        <div class='col-md-6 form-horizontal'>
                                          <div class='form-group'>
                                            <div class='col-md-4 text-left'>
                                              <label id='EntryTypeLabel' data-i18n="[html]app.form.EntryType_Label" class='control-label' for='EntryType'>Movimiento</label><span id='EntryTypeRequired' class='required-mark'>*</span>
                                            </div>
                                            <div class='col-md-8'>
                                                <input class='form-control' id='EntryType' data-i18n="[title]app.form.EntryType_Tooltip" name='EntryType' title='Tipo de movimiento que se hace a un caso de suscripción' type='text' style='text-align: right'/>
                                            </div>
                                          </div>
                                        </div>
                    ...
                    <div class="modal-footer">
                        <button id="TabEntryType_GridSaveBtn"  data-i18n="app.form.GridViewPopup_SaveButtonCaption"  class="btn btn-warning">Guardar</button>
        ...
        <div id='TabEntryTypeTranslator_GridPopup' class='modal fade' tabindex='-1' role='dialog' aria-labelledby='edit' aria-hidden='true'>
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    ...
                    <div class="modal-body">
                      <div class="row">
                        <form id='TabEntryTypeTranslator_GridEditForm'>
                            <!-- Container content -->
                                        <!-- EntryTypeTranslator numeric -->
                                        <div class='col-md-6 form-horizontal'>
                                          <div class='form-group'>
                                            <div class='col-md-4 text-left'>
                                              <label id='EntryTypeTranslatorLabel' data-i18n="[html]app.form.EntryTypeTranslator_Label" class='control-label' for='EntryTypeTranslator'>Movimiento</label><span id='EntryTypeTranslatorRequired' class='required-mark'>*</span>
                                            </div>
                                            <div class='col-md-8'>
                                                <input class='form-control' id='EntryTypeTranslator' data-i18n="[title]app.form.EntryTypeTranslator_Tooltip" name='EntryTypeTranslator' title='Tipo de movimiento que se hace a un caso de suscripción' type='text' style='text-align: right'/>
                                            </div>
                                          </div>
                                        </div>
                    ...
                    <div class="modal-footer">
                        <button id="TabEntryTypeTranslator_GridSaveBtn"  data-i18n="app.form.GridViewPopup_SaveButtonCaption"  class="btn btn-warning">Guardar</button>
                        <button class="btn"  data-i18n="app.form.GridViewPopup_CancelButtonCaption"  data-dismiss="modal" aria-hidden="true">Cancelar</button>
                    </div>
                </div>
            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="Server">
    ...
    <script src='/fasi/app/js/TableHelper.js?rel=20191108042544922'></script>
    ...
    <script src="H5MantMovimientos.js?rel=20191108042544922"></script>
