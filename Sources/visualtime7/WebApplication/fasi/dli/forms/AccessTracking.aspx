...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <div id="app" class="ibox">
     <div class="ibox-content">
        <form id="AccessTrackingMainForm">
            <input type="hidden" id="AccessTrackingFormId" name="AccessTrackingFormId" value="" />
                  ...
                  <div class='form-group'>
                    ...
                    <div class='col-md-8'>
                        <div class='input-group date' id='StartDP_group'>
                                    <input id='StartDP' name='StartDP' type='text' class='form-control' title='' size='10' data-i18n="[title]app.form.StartDP_Tooltip" maxlength='10'/>
                                    <span class='input-group-addon'>
                                        <span class='glyphicon glyphicon-calendar'></span>
                                    </span>
                                </div>
                                   <div id='StartDP_validate'></div>
                    </div>
                  </div>
                </div>
                <!-- FinishDP datepicker -->
                  ...
                  <div class='form-group'>
                    ...
                    <div class='col-md-8'>
                        <div class='input-group date' id='FinishDP_group'>
                                    <input id='FinishDP' name='FinishDP' type='text' class='form-control' title='' size='10' data-i18n="[title]app.form.FinishDP_Tooltip" maxlength='10'/>
                                    <span class='input-group-addon'>
                                        <span class='glyphicon glyphicon-calendar'></span>
                                    </span>
                                </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="Server">
    ...
    <script src='/fasi/app/js/TableHelper.js?rel=20200318085648063'></script>
    ...
    <script src="AccessTracking.js?rel=20200318085648063"></script>
