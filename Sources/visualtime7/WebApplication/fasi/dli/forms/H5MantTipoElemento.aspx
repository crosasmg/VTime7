...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <!-- This code was generated by Form Designer v7.3.24.1 at 2019-11-08 04:27:53 p. m. model release 1, Form Generator v1.0.37.9 -->
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <div id="app" class="ibox">
     <div class="ibox-content">
        <form id="H5MantTipoElementoMainForm">
            <input type="hidden" id="H5MantTipoElementoFormId" name="H5MantTipoElementoFormId" value="" />
            <div id="alerts-container"></div>
			<div class="row">
            <!-- Container content -->
                        <!-- Container: TabDiscountOrExtraPremium_Grid grid -->
                        <div  class='col-md-12'>

                       <div id='TabDiscountOrExtraPremium_GridContainer'>
                            <div id="TabDiscountOrExtraPremium_Gridtoolbar">
                            <div class='form-inline'>
                                <button id="TabDiscountOrExtraPremium_GridCreateBtn" type="button" data-i18n="app.form.TabDiscountOrExtraPremium_Grid_AddButtonCaption;[data-modal-title]app.form.TabDiscountOrExtraPremium_Grid_AddButtonCaption"  class="btn btn-default" data-modal-title="Agregar">
                                    Agregar
                                </button>
                                <button id="TabDiscountOrExtraPremium_GridRemoveBtn"  data-i18n="app.form.TabDiscountOrExtraPremium_Grid_DeleteButtonCaption;[data-title]app.form.TabDiscountOrExtraPremium_Grid_DeleteButtonCaption"  type="button" class="btn btn-danger" disabled data-title="Eliminar">
                ...
                <!-- ShowTranslatorGrid button -->
                  <div class='form-group'>
                    <button id='ShowTranslatorGrid' class='ladda-button btn pull-left btn-default' data-style='expand-right' title='Mostrar Vista Traducción' data-i18n="app.form.ShowTranslatorGrid_Caption;[title]app.form.ShowTranslatorGrid_Tooltip" ><span class='ladda-label'>Vista Traducción</span><span class='ladda-spinner'></span></button>
                            ...
                            <div id='TabDiscountOrExtraPremium_GridTblPlaceHolder'></div>
                       </div>

                        </div>
                        <!-- End Container: TabDiscountOrExtraPremium_Grid grid -->
                        <!-- Container: TabDiscountOrExtraPremiumTranslator_Grid grid -->
                        <div  class='col-md-12'>

                       <div id='TabDiscountOrExtraPremiumTranslator_GridContainer' class='hidden'>
                            <div id="TabDiscountOrExtraPremiumTranslator_Gridtoolbar">
                            <div class='form-inline'>
                <!-- ShowStandardGrid button -->
                  <div class='form-group'>
                    <button id='ShowStandardGrid' class='ladda-button btn pull-left btn-default' data-style='expand-right' title='Mostrar Vista Estándar' data-i18n="app.form.ShowStandardGrid_Caption;[title]app.form.ShowStandardGrid_Tooltip" ><span class='ladda-label'>Vista Estándar</span><span class='ladda-spinner'></span></button>
                            ...
                            <div id='TabDiscountOrExtraPremiumTranslator_GridTblPlaceHolder' class='hidden'></div>
                       </div>

                        </div>
                        <!-- End Container: TabDiscountOrExtraPremiumTranslator_Grid grid -->
        ...
        <div id='TabDiscountOrExtraPremium_GridPopup' class='modal fade' tabindex='-1' role='dialog' aria-labelledby='edit' aria-hidden='true'>
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="row">
                        <form id='TabDiscountOrExtraPremium_GridEditForm'>
                            <!-- Container content -->
                                        <!-- DiscountOrExtraPremiumType numeric -->
                                        <div class='col-md-6 form-horizontal'>
                                          <div class='form-group'>
                                            <div class='col-md-4 text-left'>
                                              <label id='DiscountOrExtraPremiumTypeLabel' data-i18n="[html]app.form.DiscountOrExtraPremiumType_Label" class='control-label' for='DiscountOrExtraPremiumType'>Tipo</label><span id='DiscountOrExtraPremiumTypeRequired' class='required-mark'>*</span>
                                            </div>
                                            <div class='col-md-8'>
                                                <input class='form-control' id='DiscountOrExtraPremiumType' data-i18n="[title]app.form.DiscountOrExtraPremiumType_Tooltip" name='DiscountOrExtraPremiumType' title='Tipo de elemento: extra prima, recargo' type='text' style='text-align: right'/>
                                            </div>
                                          </div>
                                        </div>
                    ...
                    <div class="modal-footer">
                        <button id="TabDiscountOrExtraPremium_GridSaveBtn"  data-i18n="app.form.GridViewPopup_SaveButtonCaption"  class="btn btn-warning">Guardar</button>
        ...
        <div id='TabDiscountOrExtraPremiumTranslator_GridPopup' class='modal fade' tabindex='-1' role='dialog' aria-labelledby='edit' aria-hidden='true'>
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    ...
                    <div class="modal-body">
                      <div class="row">
                        <form id='TabDiscountOrExtraPremiumTranslator_GridEditForm'>
                            <!-- Container content -->
                                        <!-- DiscountOrExtraPremiumTypeTranslator numeric -->
                                        <div class='col-md-6 form-horizontal'>
                                          <div class='form-group'>
                                            <div class='col-md-4 text-left'>
                                              <label id='DiscountOrExtraPremiumTypeTranslatorLabel' data-i18n="[html]app.form.DiscountOrExtraPremiumTypeTranslator_Label" class='control-label' for='DiscountOrExtraPremiumTypeTranslator'>Tipo</label><span id='DiscountOrExtraPremiumTypeTranslatorRequired' class='required-mark'>*</span>
                                            </div>
                                            <div class='col-md-8'>
                                                <input class='form-control' id='DiscountOrExtraPremiumTypeTranslator' data-i18n="[title]app.form.DiscountOrExtraPremiumTypeTranslator_Tooltip" name='DiscountOrExtraPremiumTypeTranslator' title='Tipo de elemento: extra prima, recargo' type='text' style='text-align: right'/>
                                            </div>
                                          </div>
                                        </div>
                    ...
                    <div class="modal-footer">
                        <button id="TabDiscountOrExtraPremiumTranslator_GridSaveBtn"  data-i18n="app.form.GridViewPopup_SaveButtonCaption"  class="btn btn-warning">Guardar</button>
                        <button class="btn"  data-i18n="app.form.GridViewPopup_CancelButtonCaption"  data-dismiss="modal" aria-hidden="true">Cancelar</button>
                    </div>
                </div>
            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="Server">
    ...
    <script src='/fasi/app/js/TableHelper.js?rel=20191108042753538'></script>
    ...
    <script src="H5MantTipoElemento.js?rel=20191108042753538"></script>
