...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <!-- This code was generated by Form Designer v7.3.24.1 at 2019-11-08 04:32:02 p. m. model release 1, Form Generator v1.0.37.9 -->
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <div id="app" class="ibox">
     <div class="ibox-content">
        <form id="H5MantTiposDePuntosMainForm">
            <input type="hidden" id="H5MantTiposDePuntosFormId" name="H5MantTiposDePuntosFormId" value="" />
            <div id="alerts-container"></div>
			<div class="row">
            <!-- Container content -->
                        <!-- Container: TabDebitOrCreditType_Grid grid -->
                        <div  class='col-md-12'>

                       <div id='TabDebitOrCreditType_GridContainer'>
                            <div id="TabDebitOrCreditType_Gridtoolbar">
                            <div class='form-inline'>
                                <button id="TabDebitOrCreditType_GridCreateBtn" type="button" data-i18n="app.form.TabDebitOrCreditType_Grid_AddButtonCaption;[data-modal-title]app.form.TabDebitOrCreditType_Grid_AddButtonCaption"  class="btn btn-default" data-modal-title="Agregar">
                                    Agregar
                                </button>
                                <button id="TabDebitOrCreditType_GridRemoveBtn"  data-i18n="app.form.TabDebitOrCreditType_Grid_DeleteButtonCaption;[data-title]app.form.TabDebitOrCreditType_Grid_DeleteButtonCaption"  type="button" class="btn btn-danger" disabled data-title="Eliminar">
                ...
                <!-- ShowTranslatorGrid button -->
                  <div class='form-group'>
                    <button id='ShowTranslatorGrid' class='ladda-button btn pull-left btn-default' data-style='expand-right' title='Mostrar Vista Traducción' data-i18n="app.form.ShowTranslatorGrid_Caption;[title]app.form.ShowTranslatorGrid_Tooltip" ><span class='ladda-label'>Vista Traducción</span><span class='ladda-spinner'></span></button>
                            ...
                            <div id='TabDebitOrCreditType_GridTblPlaceHolder'></div>
                       </div>

                        </div>
                        <!-- End Container: TabDebitOrCreditType_Grid grid -->
                        <!-- Container: TabDebitOrCreditTypeTranslator_Grid grid -->
                        <div  class='col-md-12'>

                       <div id='TabDebitOrCreditTypeTranslator_GridContainer' class='hidden'>
                            <div id="TabDebitOrCreditTypeTranslator_Gridtoolbar">
                            <div class='form-inline'>
                <!-- ShowStandardGrid button -->
                  <div class='form-group'>
                    <button id='ShowStandardGrid' class='ladda-button btn pull-left btn-default' data-style='expand-right' title='Mostrar Vista Estándar' data-i18n="app.form.ShowStandardGrid_Caption;[title]app.form.ShowStandardGrid_Tooltip" ><span class='ladda-label'>Vista Estándar</span><span class='ladda-spinner'></span></button>
                            ...
                            <div id='TabDebitOrCreditTypeTranslator_GridTblPlaceHolder' class='hidden'></div>
                       </div>

                        </div>
                        <!-- End Container: TabDebitOrCreditTypeTranslator_Grid grid -->
        ...
        <div id='TabDebitOrCreditType_GridPopup' class='modal fade' tabindex='-1' role='dialog' aria-labelledby='edit' aria-hidden='true'>
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="row">
                        <form id='TabDebitOrCreditType_GridEditForm'>
                            <!-- Container content -->
                                        <!-- DebitOrCredit numeric -->
                                        <div class='col-md-6 form-horizontal'>
                                          <div class='form-group'>
                                            <div class='col-md-4 text-left'>
                                              <label id='DebitOrCreditLabel' data-i18n="[html]app.form.DebitOrCredit_Label" class='control-label' for='DebitOrCredit'>Tipo de Puntos</label><span id='DebitOrCreditRequired' class='required-mark'>*</span>
                                            </div>
                                            <div class='col-md-8'>
                                                <input class='form-control' id='DebitOrCredit' data-i18n="[title]app.form.DebitOrCredit_Tooltip" name='DebitOrCredit' title='Tipos de puntos (débito o crédito), para la probabilidad de muerte' type='text' style='text-align: right'/>
                                            </div>
                                          </div>
                                        </div>
                    ...
                    <div class="modal-footer">
                        <button id="TabDebitOrCreditType_GridSaveBtn"  data-i18n="app.form.GridViewPopup_SaveButtonCaption"  class="btn btn-warning">Guardar</button>
        ...
        <div id='TabDebitOrCreditTypeTranslator_GridPopup' class='modal fade' tabindex='-1' role='dialog' aria-labelledby='edit' aria-hidden='true'>
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    ...
                    <div class="modal-body">
                      <div class="row">
                        <form id='TabDebitOrCreditTypeTranslator_GridEditForm'>
                            <!-- Container content -->
                                        <!-- DebitOrCreditTranslator numeric -->
                                        <div class='col-md-6 form-horizontal'>
                                          <div class='form-group'>
                                            <div class='col-md-4 text-left'>
                                              <label id='DebitOrCreditTranslatorLabel' data-i18n="[html]app.form.DebitOrCreditTranslator_Label" class='control-label' for='DebitOrCreditTranslator'>Tipo de Puntos</label><span id='DebitOrCreditTranslatorRequired' class='required-mark'>*</span>
                                            </div>
                                            <div class='col-md-8'>
                                                <input class='form-control' id='DebitOrCreditTranslator' data-i18n="[title]app.form.DebitOrCreditTranslator_Tooltip" name='DebitOrCreditTranslator' title='Tipos de puntos (débito o crédito), para la probabilidad de muerte' type='text' style='text-align: right'/>
                                            </div>
                                          </div>
                                        </div>
                    ...
                    <div class="modal-footer">
                        <button id="TabDebitOrCreditTypeTranslator_GridSaveBtn"  data-i18n="app.form.GridViewPopup_SaveButtonCaption"  class="btn btn-warning">Guardar</button>
                        <button class="btn"  data-i18n="app.form.GridViewPopup_CancelButtonCaption"  data-dismiss="modal" aria-hidden="true">Cancelar</button>
                    </div>
                </div>
            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="Server">
    ...
    <script src='/fasi/app/js/TableHelper.js?rel=20191108043202414'></script>
    ...
    <script src="H5MantTiposDePuntos.js?rel=20191108043202414"></script>
