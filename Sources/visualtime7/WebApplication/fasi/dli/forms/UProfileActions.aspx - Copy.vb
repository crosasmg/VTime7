'---------------------------------------------------------------------------------------------------
' <generated>
'     This code was generated by Form Designer v7.1.220.1 at 2019/02/26 07:48:20 AM model release 9, Form Generator v1.0.34.21
'     
       ...
       <WebMethod(EnableSession:=True)>
        Public Shared Function Initialization(id As String, urlid As String, fromid As String) As InMotionGIT.FrontOffice.Support.DataType.ServerActionResult
            ...
            Catch ex As Exception
                LogHandler.ErrorLog("UProfile", "Initialization", ex)
        ...
        Public Shared Function btnSaClick(instance As EntryData) As InMotionGIT.FrontOffice.Support.DataType.ServerActionResult
            ...
            UProfileParametersInstance.stateSave = _Boolean_4f95136419d847d4a2f3e61b28240652 
                ...
                End With
                    ...
                    messageAction = "Could not save changes to the user"
            ...
            Catch ex As Exception
                LogHandler.ErrorLog("UProfile", "btnSaClick", ex)
        ...
        Public Shared Function LookUpForCountry(id As String) As InMotionGIT.FrontOffice.Support.DataType.ClientActionResult
            ...
            Try
                ...
                With New DataManagerFactory(String.Format(CultureInfo.CurrentCulture,
                                                          "SELECT  TABLE66.NCOUNTRY, TABLE66.SDESCRIPT FROM TABLE66 TABLE66    WHERE NOT SDESCRIPT IS NULL ORDER BY SDESCRIPT", ""), 
            ...
            Catch ex As Exception
                LogHandler.ErrorLog("UProfile", "LookUpForCountry", ex)

                With result
                    .Success = False
                    .Reason = String.Format(CultureInfo.InvariantCulture, "{0} ({1})", ex.Message, "LookUpForCountry")
                End With
            End Try
            Return result
        End Function
