...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <div id="app" class="ibox">
     <div class="ibox-content">
        <form id="H5MantCategoriaRiesgoMainForm">
            <input type="hidden" id="H5MantCategoriaRiesgoFormId" name="H5MantCategoriaRiesgoFormId" value="" />
            <div id="alerts-container"></div>
			<div class="row">
            <!-- Container content -->
                        <!-- Container: TabRiskClassType_Grid grid -->
                        <div  class='col-md-12'>

                       <div id='TabRiskClassType_GridContainer'>
                            <div id="TabRiskClassType_Gridtoolbar">
                            <div class='form-inline'>
                                <button id="TabRiskClassType_GridCreateBtn" type="button" data-i18n="app.form.TabRiskClassType_Grid_AddButtonCaption;[data-modal-title]app.form.TabRiskClassType_Grid_AddButtonCaption"  class="btn btn-default" data-modal-title="Agregar">
                                    Agregar
                                </button>
                                <button id="TabRiskClassType_GridRemoveBtn"  data-i18n="app.form.TabRiskClassType_Grid_DeleteButtonCaption;[data-title]app.form.TabRiskClassType_Grid_DeleteButtonCaption"  type="button" class="btn btn-danger" disabled data-title="Eliminar">
                ...
                <!-- ShowTranslatorGrid button -->
                  <div class='form-group'>
                    <button id='ShowTranslatorGrid' class='ladda-button btn pull-left btn-default' data-style='expand-right' title='Mostrar Vista Traducción' data-i18n="app.form.ShowTranslatorGrid_Caption;[title]app.form.ShowTranslatorGrid_Tooltip" ><span class='ladda-label'>Vista Traducción</span><span class='ladda-spinner'></span></button>
                            ...
                            <div id='TabRiskClassType_GridTblPlaceHolder'></div>
                       </div>

                        </div>
                        <!-- End Container: TabRiskClassType_Grid grid -->
                        <!-- Container: TabRiskClassTypeTranslator_Grid grid -->
                        <div  class='col-md-12'>

                       <div id='TabRiskClassTypeTranslator_GridContainer' class='hidden'>
                            <div id="TabRiskClassTypeTranslator_Gridtoolbar">
                            <div class='form-inline'>
                <!-- ShowStandardGrid button -->
                  <div class='form-group'>
                    <button id='ShowStandardGrid' class='ladda-button btn pull-left btn-default' data-style='expand-right' title='Mostrar Vista Estándar' data-i18n="app.form.ShowStandardGrid_Caption;[title]app.form.ShowStandardGrid_Tooltip" ><span class='ladda-label'>Vista Estándar</span><span class='ladda-spinner'></span></button>
                            ...
                            <div id='TabRiskClassTypeTranslator_GridTblPlaceHolder' class='hidden'></div>
                       </div>

                        </div>
                        <!-- End Container: TabRiskClassTypeTranslator_Grid grid -->
        ...
        <div id='TabRiskClassType_GridPopup' class='modal fade' tabindex='-1' role='dialog' aria-labelledby='edit' aria-hidden='true'>
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="row">
                        <form id='TabRiskClassType_GridEditForm'>
                            <!-- Container content -->
                                        <!-- RiskClass numeric -->
                                        <div class='col-md-6 form-horizontal'>
                                          <div class='form-group'>
                                            <div class='col-md-4 text-left'>
                                              <label id='RiskClassLabel' data-i18n="[html]app.form.RiskClass_Label" class='control-label' for='RiskClass'>Clasificación de riesgo</label><span id='RiskClassRequired' class='required-mark'>*</span>
                                            </div>
                                            <div class='col-md-8'>
                                                <input class='form-control' id='RiskClass' data-i18n="[title]app.form.RiskClass_Tooltip" name='RiskClass' title='Clasificación de riesgo.' type='text' style='text-align: right'/>
                                            </div>
                                          </div>
                                        </div>
                                        <!-- Description text -->
                    ...
                    <div class="modal-footer">
                        <button id="TabRiskClassType_GridSaveBtn"  data-i18n="app.form.GridViewPopup_SaveButtonCaption"  class="btn btn-warning">Guardar</button>
        ...
        <div id='TabRiskClassTypeTranslator_GridPopup' class='modal fade' tabindex='-1' role='dialog' aria-labelledby='edit' aria-hidden='true'>
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    ...
                    <div class="modal-body">
                      <div class="row">
                        <form id='TabRiskClassTypeTranslator_GridEditForm'>
                            <!-- Container content -->
                                        <!-- RiskClassTranslator numeric -->
                                        <div class='col-md-6 form-horizontal'>
                                          <div class='form-group'>
                                            <div class='col-md-4 text-left'>
                                              <label id='RiskClassTranslatorLabel' data-i18n="[html]app.form.RiskClassTranslator_Label" class='control-label' for='RiskClassTranslator'>Clasificación de riesgo</label><span id='RiskClassTranslatorRequired' class='required-mark'>*</span>
                                            </div>
                                            <div class='col-md-8'>
                                                <input class='form-control' id='RiskClassTranslator' data-i18n="[title]app.form.RiskClassTranslator_Tooltip" name='RiskClassTranslator' title='Clasificación de riesgo.' type='text' style='text-align: right'/>
                                            </div>
                                          </div>
                                        </div>
                    ...
                    <div class="modal-footer">
                        <button id="TabRiskClassTypeTranslator_GridSaveBtn"  data-i18n="app.form.GridViewPopup_SaveButtonCaption"  class="btn btn-warning">Guardar</button>
                        <button class="btn"  data-i18n="app.form.GridViewPopup_CancelButtonCaption"  data-dismiss="modal" aria-hidden="true">Cancelar</button>
                    </div>
                </div>
            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="Server">
    ...
    <script src='/fasi/app/js/TableHelper.js?rel=20191108033511870'></script>
    ...
    <script src="H5MantCategoriaRiesgo.js?rel=20191108033511870"></script>
