'---------------------------------------------------------------------------------------------------
' <generated>
'     This code was generated by Form Designer v7.1.214.1 at 2018/11/28 02:40:13 p.m. model release 1, Form Generator v1.0.33.9
'     
...
Namespace dli.forms
    ...
    Public Class HT5AuthorizationToObtainDiscloseInformationUWActions
...
#Region "Actions Methods"
       ...
       <WebMethod(EnableSession:=True)>
        Public Shared Function Initialization(id As String, urlid As String, fromid As String) As InMotionGIT.FrontOffice.Support.DataType.ServerActionResult
            ...
            Dim HT5AuthorizationToObtainDiscloseInformationUWParametersInstance As HT5AuthorizationToObtainDiscloseInformationUWParameters = Nothing
            ...
            Try
                If id.IsEmpty AndAlso urlid.IsEmpty Then
                    ...
                    HT5AuthorizationToObtainDiscloseInformationUWParametersInstance = EntryDataToClass(HT5AuthorizationToObtainDiscloseInformationUWParametersInstance, instance)
                    SetDefaultValuesFromQueryString(HT5AuthorizationToObtainDiscloseInformationUWParametersInstance)
                    
                    If fromid.IsNotEmpty Then
                        GetTransferParameters(HT5AuthorizationToObtainDiscloseInformationUWParametersInstance, fromid)
                    End If
                Else       
                    instance.InstanceFormId = id.IfEmpty(urlid)
                    HT5AuthorizationToObtainDiscloseInformationUWParametersInstance = RetrieveFormInformationFromDatabase(instance.InstanceFormId)
    
                    If IsNothing(HT5AuthorizationToObtainDiscloseInformationUWParametersInstance) then
                        HT5AuthorizationToObtainDiscloseInformationUWParametersInstance = EntryDataToClass(HT5AuthorizationToObtainDiscloseInformationUWParametersInstance, instance)
                        SetDefaultValuesFromQueryString(HT5AuthorizationToObtainDiscloseInformationUWParametersInstance)
                    End If
                End If
                ...
                If id.IsEmpty AndAlso urlid.IsEmpty Then
                    Form_Initialization(currentAction, HT5AuthorizationToObtainDiscloseInformationUWParametersInstance, resultData)
                End If


                instance = ClassToEntryData(instance, HT5AuthorizationToObtainDiscloseInformationUWParametersInstance) 
		        
                StoreFormInformation(HT5AuthorizationToObtainDiscloseInformationUWParametersInstance)
                With resultData
                    .Success = True
                    .Data = instance
                End With
            ...
            Catch ex As Exception
                LogHandler.ErrorLog("HT5AuthorizationToObtainDiscloseInformationUW", "Initialization", ex)
        ...
        Public Shared Function saveClick(instance As EntryData) As InMotionGIT.FrontOffice.Support.DataType.ServerActionResult
            ...
            Try
                ...
                .Add("uwcaseid", HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.uwcaseidint)
                .Add("uwreqid", HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.uwreqid)
                .Add("ClientName", HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.ClientName)
                .Add("StatusCase", HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.StatusCase)
                .Add("StatusRequirement", HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.StatusRequirement)
                .Add("RiskInformation", HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.RiskInformation)
                .Add("Identifier", "Authorization")
                .Add("context", formContext)
                .Add("caseLocked", HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.caselocked)
                End With

                WorkflowOutArguments = InMotionGIT.Workflow.Support.Runtime.DoWorkFromForm("RetrieveCaseInformation", "1632D520-852F-46AD-8F03-D0A778676380", 11, WorkflowInArguments, True, True, HttpContext.Current.Request.UrlReferrer.AbsolutePath, HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.InternalId)

                currentAction += "'Mapping Outputs'"
                HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.uwcaseidint = WorkflowOutArguments("uwcaseid")
                HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.uwreqid = WorkflowOutArguments("uwreqid")
                HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.ClientName = WorkflowOutArguments("ClientName")
                HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.StatusCase = WorkflowOutArguments("StatusCase")
                HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.StatusRequirement = WorkflowOutArguments("StatusRequirement")
                HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.RiskInformation = WorkflowOutArguments("RiskInformation")

                currentAction = SessionTrace("2. If HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.StatusRequirement <> 1 Then")
                If HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.StatusRequirement <> 1 Then

                    currentAction = SessionTrace("3. The message 'El estado del requer...' will displayed as 'Splash'")
                    ParametersToDictionary(HT5AuthorizationToObtainDiscloseInformationUWParametersInstance, parametersDictionary)
                    ...
                    Else
                    currentAction = SessionTrace("4. HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.UsercodeFASI = UserInfo.UserId...")
                    currentAction = SessionTrace("4.1. HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.UsercodeFASI = UserInfo.UserId...")

                    HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.UsercodeFASI = UserInfo.UserId
                    currentAction = SessionTrace("4.2. HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.IsAnonymous = UserInfo.IsAnonymous()...")

                    HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.IsAnonymous = UserInfo.IsAnonymous()

                    currentAction = SessionTrace("5. If HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.IsAnonymous = true Then")
                    If HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.IsAnonymous = true Then

                        currentAction = SessionTrace("6. HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.UsercodeFASI = 9998...")
                        currentAction = SessionTrace("6.1. HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.UsercodeFASI = 9998...")

                        HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.UsercodeFASI = 9998

                                End If
                    currentAction = SessionTrace("7. If HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.caselocked = true Then")
                    If HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.caselocked = true Then
                        ...
                        .Add("uwcaseid", HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.uwcaseidint)
                        .Add("uwreqid", HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.uwreqid)
                        .Add("AuthorizationObtainDiscloseInformation", HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.AuthorizationObtainDiscloseInformation)
                        .Add("locked", HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.caselocked)
                        .Add("ConnectedUserCode", HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.UsercodeFASI)
                        End With

                        WorkflowOutArguments = InMotionGIT.Workflow.Support.Runtime.DoWorkFromForm("QuestionnaireRuleAuthorizationToObtainDiscloseInfo", "92ad1197-a1af-4b31-b4f5-f90ed356ae37", 1, WorkflowInArguments, True, True, HttpContext.Current.Request.UrlReferrer.AbsolutePath, HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.InternalId)

                        currentAction += "'Mapping Outputs'"
                        HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.uwcaseidint = WorkflowOutArguments("uwcaseid")
                        HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.uwreqid = WorkflowOutArguments("uwreqid")
                        HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.AuthorizationObtainDiscloseInformation = WorkflowOutArguments("AuthorizationObtainDiscloseInformation")
                ...
                End With
                        ...
                        WorkflowOutArguments = InMotionGIT.Workflow.Support.Runtime.DoWorkFromForm("QuestionnaireRuleAuthorizationToObtainDiscloseInfo", "92ad1197-a1af-4b31-b4f5-f90ed356ae37", 1, WorkflowInArguments, True, False, HttpContext.Current.Request.UrlReferrer.AbsolutePath, HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.InternalId)
            ...
            Catch ex As Exception
                LogHandler.ErrorLog("HT5AuthorizationToObtainDiscloseInformationUW", "saveClick", ex)
...
#Region "Form Actions"
        ...
        Private Shared Sub Form_Initialization(ByRef currentAction As String, ByRef HT5AuthorizationToObtainDiscloseInformationUWParametersInstance As HT5AuthorizationToObtainDiscloseInformationUWParameters, ByRef resultData As InMotionGIT.FrontOffice.Support.DataType.ServerActionResult)
            Dim UserInfo As New InMotionGIT.Membership.Providers.MemberContext
            Dim formContext As New InMotionGIT.Common.Contracts.Context(UserInfo.LanguageId, HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.InternalId) With {.UserId = HttpContext.Current.Session("UserId"), .UserCode = HttpContext.Current.Session("nUsercode"), .SecuritySchemeCode = HttpContext.Current.Session("sSche_code"), .AccessToken = HttpContext.Current.Session("AccessToken")}
            Dim selectDataTableItem As DataTable = Nothing
            Dim parametersDictionary As Dictionary(Of String, Object) = Nothing
            Dim WorkflowInArguments As Dictionary(Of String, Object) = Nothing
            Dim WorkflowOutArguments As IDictionary(Of String, Object) = Nothing
            ...
            currentAction = SessionTrace("1. If HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.uwcaseid Not Is Null Or Not Empty '' Then")
            If Not String.IsNullOrEmpty(HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.uwcaseid) Then

                currentAction = SessionTrace("2. HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.uwcaseidint = HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.uwcaseid...")
                currentAction = SessionTrace("2.1. HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.uwcaseidint = HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.uwcaseid...")

                HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.uwcaseidint = HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.uwcaseid

                currentAction = SessionTrace("3. HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.AuthorizationObtainDiscloseInformation.DateSignatureProposed = Date.Today...")
                currentAction = SessionTrace("3.1. HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.AuthorizationObtainDiscloseInformation.DateSignatureProposed = Date.Today...")
                                If IsNothing(HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.AuthorizationObtainDiscloseInformation) Then
                    HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.AuthorizationObtainDiscloseInformation = New InMotionGIT.Questionnaires.AuthorizationObtainDiscloseInformation
                End If

                HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.AuthorizationObtainDiscloseInformation.DateSignatureProposed = Date.Today

                currentAction = SessionTrace("4. If HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.caselocked Is Null Or Empty  Then")
                If IsNothing(HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.caselocked) Then

                    currentAction = SessionTrace("5. HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.caselocked = False...")
                    currentAction = SessionTrace("5.1. HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.caselocked = False...")

                    HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.caselocked = False
                ...
                currentAction = SessionTrace("7. If HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.StatusRequirement <> 1 Then")
                If HT5AuthorizationToObtainDiscloseInformationUWParametersInstance.StatusRequirement <> 1 Then

                    currentAction = SessionTrace("8. The message 'El estado del requer...' will displayed as 'Splash'")
                    ParametersToDictionary(HT5AuthorizationToObtainDiscloseInformationUWParametersInstance, parametersDictionary)
                    messageAction = "El estado del requerimiento no permite ser llenado. Verifique la información que ha recibido por parte de la empresa de seguros."
                    messageAction = InMotionGIT.FrontOffice.Proxy.Helpers.Email.Process(messageAction, parametersDictionary)
                    resultData.AddNotifySplash(messageAction)
...
#Region "Utilities"
        ...
        Private Shared Sub ParametersToDictionary(formData As HT5AuthorizationToObtainDiscloseInformationUWParameters, ByRef target As Dictionary(Of String, Object))
        ...
        Private Shared Sub GetTransferParameters(parametersData As HT5AuthorizationToObtainDiscloseInformationUWParameters, fromid As String)
...
#Region "Storage Database Methods"
      ...
      Private Shared Sub StoreFormInformation(formData As HT5AuthorizationToObtainDiscloseInformationUWParameters)
            If Not IsNothing(formData) Then
                ...
                If Not IsNothing(HttpContext.Current.Session("Form.Track")) AndAlso
                    ...
                    HttpContext.Current.Session(String.Format(CultureInfo.InvariantCulture, "Form.HT5AuthorizationToObtainDiscloseInformationUW", formData.InternalId)) = formData
                End If
                ...
                If Not IsNothing(HttpContext.Current.Session("Form.Track.Parameters")) AndAlso
                    ...
                    If Not IsNothing(HttpContext.Current.Session("Form.Track")) AndAlso HttpContext.Current.Session("Form.Track").ToString.ToLower = "true" Then
                        InMotionGIT.Common.Helpers.FileHandler.SaveContent(String.Format(CultureInfo.InvariantCulture, 
                                                                                         "{0}\{1}.HT5AuthorizationToObtainDiscloseInformationUW.txt", ConfigurationManager.AppSettings("Path.Logs"), formData.InternalId), 
                    ...
                    InMotionGIT.Common.Helpers.Serialize.SerializeToFile(Of HT5AuthorizationToObtainDiscloseInformationUWParameters)(formData, String.Format(CultureInfo.InvariantCulture, "{0}\{1}.HT5AuthorizationToObtainDiscloseInformationUW.xml", 
                                                                                                                        ConfigurationManager.AppSettings("Path.Logs"), formData.InternalId), True)
                End If
            End If
        End Sub

        Private Shared Function RetrieveFormInformationFromDatabase(instanceFormId As String) As HT5AuthorizationToObtainDiscloseInformationUWParameters
            Dim result As HT5AuthorizationToObtainDiscloseInformationUWParameters = Nothing
            ...
            If records.Rows.Count > 0 Then
                result = Serialize.Deserialize(Of HT5AuthorizationToObtainDiscloseInformationUWParameters)(records.FirstRow.Item("Content"))
            End If

            Return result
        End Function

        Private Shared Sub InsertStorageData(formData As HT5AuthorizationToObtainDiscloseInformationUWParameters)
            Dim UserInfo As New InMotionGIT.Membership.Providers.MemberContext
            ...
            With New DataManagerFactory("INSERT INTO FrontOffice.DocumentCache (FormId, ModelId, UserId, Page, Content, CreationDate, UpdateDate) VALUES(@:FormId, @:ModelId, @:UserId, @:Page, @:Content, @:CreationDate, @:UpdateDate)",
                ...
                .AddParameter("FormId", DbType.AnsiStringFixedLength, 36, False, formData.InternalId)
                .AddParameter("ModelId", DbType.AnsiStringFixedLength, 36, False, "d3037eae-62dc-43bb-af42-705bb53f7d55")
            ...
            .AddParameter("Content", DbType.Xml, 1, False, Serialize.Serialize(Of HT5AuthorizationToObtainDiscloseInformationUWParameters)(formData))
        ...
        Private Shared Sub UpdateStorageData(formData As HT5AuthorizationToObtainDiscloseInformationUWParameters)
            Dim UserInfo As New InMotionGIT.Membership.Providers.MemberContext
...
#Region "Contracts Mappers"
        ...
        Private Shared Function EntryDataToClass(parametersData As HT5AuthorizationToObtainDiscloseInformationUWParameters, formData As EntryData) As HT5AuthorizationToObtainDiscloseInformationUWParameters
            If IsNothing(parametersData) Then
                parametersData = New HT5AuthorizationToObtainDiscloseInformationUWParameters
            End If
        ...
        Private Shared Function ClassToEntryData(formData As EntryData, parametersData As HT5AuthorizationToObtainDiscloseInformationUWParameters) As EntryData
...
#Region "Common Utilities"
        ...
        Private Shared Sub SetDefaultValuesFromQueryString(formData As HT5AuthorizationToObtainDiscloseInformationUWParameters)
        ...
        Private Sub ValidateParametersInstance(ByRef formData As HT5AuthorizationToObtainDiscloseInformationUWParameters)
...
#Region "Form Contracts"
        ...
        <Serializable()>
        Public Class HT5AuthorizationToObtainDiscloseInformationUWParameters
            Inherits InMotionGIT.FrontOffice.Support.DataType.FormBase(Of HT5AuthorizationToObtainDiscloseInformationUWParameters)
