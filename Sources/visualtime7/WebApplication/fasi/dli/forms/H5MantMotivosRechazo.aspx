...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <!-- This code was generated by Form Designer v7.3.24.1 at 2019-11-08 03:57:26 p. m. model release 1, Form Generator v1.0.37.9 -->
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <div id="app" class="ibox">
     <div class="ibox-content">
        <form id="H5MantMotivosRechazoMainForm">
            <input type="hidden" id="H5MantMotivosRechazoFormId" name="H5MantMotivosRechazoFormId" value="" />
            <div id="alerts-container"></div>
			<div class="row">
            <!-- Container content -->
                        <!-- Container: TabRejectionReason_Grid grid -->
                        <div  class='col-md-12'>

                       <div id='TabRejectionReason_GridContainer'>
                            <div id="TabRejectionReason_Gridtoolbar">
                            <div class='form-inline'>
                                <button id="TabRejectionReason_GridCreateBtn" type="button" data-i18n="app.form.TabRejectionReason_Grid_AddButtonCaption;[data-modal-title]app.form.TabRejectionReason_Grid_AddButtonCaption"  class="btn btn-default" data-modal-title="Agregar">
                                    Agregar
                                </button>
                                <button id="TabRejectionReason_GridRemoveBtn"  data-i18n="app.form.TabRejectionReason_Grid_DeleteButtonCaption;[data-title]app.form.TabRejectionReason_Grid_DeleteButtonCaption"  type="button" class="btn btn-danger" disabled data-title="Eliminar">
                ...
                <!-- ShowTranslatorGrid button -->
                  <div class='form-group'>
                    <button id='ShowTranslatorGrid' class='ladda-button btn pull-left btn-default' data-style='expand-right' title='Mostrar Vista Traducción' data-i18n="app.form.ShowTranslatorGrid_Caption;[title]app.form.ShowTranslatorGrid_Tooltip" ><span class='ladda-label'>Vista Traducción</span><span class='ladda-spinner'></span></button>
                            ...
                            <div id='TabRejectionReason_GridTblPlaceHolder'></div>
                       </div>

                        </div>
                        <!-- End Container: TabRejectionReason_Grid grid -->
                        <!-- Container: TabRejectionReasonTranslator_Grid grid -->
                        <div  class='col-md-12'>

                       <div id='TabRejectionReasonTranslator_GridContainer' class='hidden'>
                            <div id="TabRejectionReasonTranslator_Gridtoolbar">
                            <div class='form-inline'>
                <!-- ShowStandardGrid button -->
                  <div class='form-group'>
                    <button id='ShowStandardGrid' class='ladda-button btn pull-left btn-default' data-style='expand-right' title='Mostrar Vista Estándar' data-i18n="app.form.ShowStandardGrid_Caption;[title]app.form.ShowStandardGrid_Tooltip" ><span class='ladda-label'>Vista Estándar</span><span class='ladda-spinner'></span></button>
                            ...
                            <div id='TabRejectionReasonTranslator_GridTblPlaceHolder' class='hidden'></div>
                       </div>

                        </div>
                        <!-- End Container: TabRejectionReasonTranslator_Grid grid -->
        ...
        <div id='TabRejectionReason_GridPopup' class='modal fade' tabindex='-1' role='dialog' aria-labelledby='edit' aria-hidden='true'>
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="row">
                        <form id='TabRejectionReason_GridEditForm'>
                            <!-- Container content -->
                                        <!-- ReasonOfRejection numeric -->
                                        <div class='col-md-6 form-horizontal'>
                                          <div class='form-group'>
                                            <div class='col-md-4 text-left'>
                                              <label id='ReasonOfRejectionLabel' data-i18n="[html]app.form.ReasonOfRejection_Label" class='control-label' for='ReasonOfRejection'>Motivo</label><span id='ReasonOfRejectionRequired' class='required-mark'>*</span>
                                            </div>
                                            <div class='col-md-8'>
                                                <input class='form-control' id='ReasonOfRejection' data-i18n="[title]app.form.ReasonOfRejection_Tooltip" name='ReasonOfRejection' title='Motivo del rechazo de un caso de suscripción.' type='text' style='text-align: right'/>
                                            </div>
                                          </div>
                                        </div>
                    ...
                    <div class="modal-footer">
                        <button id="TabRejectionReason_GridSaveBtn"  data-i18n="app.form.GridViewPopup_SaveButtonCaption"  class="btn btn-warning">Guardar</button>
        ...
        <div id='TabRejectionReasonTranslator_GridPopup' class='modal fade' tabindex='-1' role='dialog' aria-labelledby='edit' aria-hidden='true'>
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    ...
                    <div class="modal-body">
                      <div class="row">
                        <form id='TabRejectionReasonTranslator_GridEditForm'>
                            <!-- Container content -->
                                        <!-- ReasonOfRejectionTranslator numeric -->
                                        <div class='col-md-6 form-horizontal'>
                                          <div class='form-group'>
                                            <div class='col-md-4 text-left'>
                                              <label id='ReasonOfRejectionTranslatorLabel' data-i18n="[html]app.form.ReasonOfRejectionTranslator_Label" class='control-label' for='ReasonOfRejectionTranslator'>Motivo</label><span id='ReasonOfRejectionTranslatorRequired' class='required-mark'>*</span>
                                            </div>
                                            <div class='col-md-8'>
                                                <input class='form-control' id='ReasonOfRejectionTranslator' data-i18n="[title]app.form.ReasonOfRejectionTranslator_Tooltip" name='ReasonOfRejectionTranslator' title='Motivo del rechazo de un caso de suscripción.' type='text' style='text-align: right'/>
                                            </div>
                                          </div>
                                        </div>
                                        ...
                                        <div class='col-md-6 form-horizontal'>
                                          <div class='form-group'>
                                            <div class='col-md-4 text-left'>
                                              <label id='LanguageIdTranslatorLabel' data-i18n="[html]app.form.LanguageIdTranslator_Label" class='control-label' for='LanguageIdTranslator'>Código de idioma</label><span id='LanguageIdTranslatorRequired' class='required-mark'>*</span>
                                            </div>
                                            <div class='col-md-8'>
                    ...
                    <div class="modal-footer">
                        <button id="TabRejectionReasonTranslator_GridSaveBtn"  data-i18n="app.form.GridViewPopup_SaveButtonCaption"  class="btn btn-warning">Guardar</button>
                        <button class="btn"  data-i18n="app.form.GridViewPopup_CancelButtonCaption"  data-dismiss="modal" aria-hidden="true">Cancelar</button>
                    </div>
                </div>
            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="Server">
    ...
    <script src='/fasi/app/js/TableHelper.js?rel=20191108035726584'></script>
    ...
    <script src="H5MantMotivosRechazo.js?rel=20191108035726584"></script>
