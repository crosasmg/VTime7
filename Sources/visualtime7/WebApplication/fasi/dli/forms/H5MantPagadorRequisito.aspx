...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <!-- This code was generated by Form Designer v7.3.24.1 at 2019-11-08 04:06:13 p. m. model release 1, Form Generator v1.0.37.9 -->
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <div id="app" class="ibox">
     <div class="ibox-content">
        <form id="H5MantPagadorRequisitoMainForm">
            <input type="hidden" id="H5MantPagadorRequisitoFormId" name="H5MantPagadorRequisitoFormId" value="" />
            <div id="alerts-container"></div>
			<div class="row">
            <!-- Container content -->
                        <!-- Container: TabPayableByType_Grid grid -->
                        <div  class='col-md-12'>

                       <div id='TabPayableByType_GridContainer'>
                            <div id="TabPayableByType_Gridtoolbar">
                            <div class='form-inline'>
                                <button id="TabPayableByType_GridCreateBtn" type="button" data-i18n="app.form.TabPayableByType_Grid_AddButtonCaption;[data-modal-title]app.form.TabPayableByType_Grid_AddButtonCaption"  class="btn btn-default" data-modal-title="Agregar">
                                    Agregar
                                </button>
                                <button id="TabPayableByType_GridRemoveBtn"  data-i18n="app.form.TabPayableByType_Grid_DeleteButtonCaption;[data-title]app.form.TabPayableByType_Grid_DeleteButtonCaption"  type="button" class="btn btn-danger" disabled data-title="Eliminar">
                ...
                <!-- ShowTranslatorGrid button -->
                  <div class='form-group'>
                    <button id='ShowTranslatorGrid' class='ladda-button btn pull-left btn-default' data-style='expand-right' title='Mostrar Vista Traducción' data-i18n="app.form.ShowTranslatorGrid_Caption;[title]app.form.ShowTranslatorGrid_Tooltip" ><span class='ladda-label'>Vista Traducción</span><span class='ladda-spinner'></span></button>
                            ...
                            <div id='TabPayableByType_GridTblPlaceHolder'></div>
                       </div>

                        </div>
                        <!-- End Container: TabPayableByType_Grid grid -->
                        <!-- Container: TabPayableByTypeTranslator_Grid grid -->
                        <div  class='col-md-12'>

                       <div id='TabPayableByTypeTranslator_GridContainer' class='hidden'>
                            <div id="TabPayableByTypeTranslator_Gridtoolbar">
                            <div class='form-inline'>
                <!-- ShowStandardGrid button -->
                  <div class='form-group'>
                    <button id='ShowStandardGrid' class='ladda-button btn pull-left btn-default' data-style='expand-right' title='Mostrar Vista Estándar' data-i18n="app.form.ShowStandardGrid_Caption;[title]app.form.ShowStandardGrid_Tooltip" ><span class='ladda-label'>Vista Estándar</span><span class='ladda-spinner'></span></button>
                            ...
                            <div id='TabPayableByTypeTranslator_GridTblPlaceHolder' class='hidden'></div>
                       </div>

                        </div>
                        <!-- End Container: TabPayableByTypeTranslator_Grid grid -->
        ...
        <div id='TabPayableByType_GridPopup' class='modal fade' tabindex='-1' role='dialog' aria-labelledby='edit' aria-hidden='true'>
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="row">
                        <form id='TabPayableByType_GridEditForm'>
                            <!-- Container content -->
                                        <!-- Payer numeric -->
                    ...
                    <div class="modal-footer">
                        <button id="TabPayableByType_GridSaveBtn"  data-i18n="app.form.GridViewPopup_SaveButtonCaption"  class="btn btn-warning">Guardar</button>
        ...
        <div id='TabPayableByTypeTranslator_GridPopup' class='modal fade' tabindex='-1' role='dialog' aria-labelledby='edit' aria-hidden='true'>
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    ...
                    <div class="modal-body">
                      <div class="row">
                        <form id='TabPayableByTypeTranslator_GridEditForm'>
                            <!-- Container content -->
                                        <!-- PayerTranslator numeric -->
                                        <div class='col-md-6 form-horizontal'>
                                          <div class='form-group'>
                                            <div class='col-md-4 text-left'>
                                              <label id='PayerTranslatorLabel' data-i18n="[html]app.form.PayerTranslator_Label" class='control-label' for='PayerTranslator'>Pagador</label><span id='PayerTranslatorRequired' class='required-mark'>*</span>
                                            </div>
                                            <div class='col-md-8'>
                                                <input class='form-control' id='PayerTranslator' data-i18n="[title]app.form.PayerTranslator_Tooltip" name='PayerTranslator' title='Pagador del requisito' type='text' style='text-align: right'/>
                                            </div>
                                          </div>
                                        </div>
                    ...
                    <div class="modal-footer">
                        <button id="TabPayableByTypeTranslator_GridSaveBtn"  data-i18n="app.form.GridViewPopup_SaveButtonCaption"  class="btn btn-warning">Guardar</button>
                        <button class="btn"  data-i18n="app.form.GridViewPopup_CancelButtonCaption"  data-dismiss="modal" aria-hidden="true">Cancelar</button>
                    </div>
                </div>
            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="Server">
    ...
    <script src='/fasi/app/js/TableHelper.js?rel=20191108040613104'></script>
    ...
    <script src="H5MantPagadorRequisito.js?rel=20191108040613104"></script>
