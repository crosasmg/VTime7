...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <div id="app" class="ibox">
     <div class="ibox-content">
        <form id="H5MantEstadoReglasSuscripcionMainForm">
            <input type="hidden" id="H5MantEstadoReglasSuscripcionFormId" name="H5MantEstadoReglasSuscripcionFormId" value="" />
            <div id="alerts-container"></div>
			<div class="row">
            <!-- Container content -->
                        <!-- Container: TabUnderwritingRuleSType_Grid grid -->
                        <div  class='col-md-12'>

                       <div id='TabUnderwritingRuleSType_GridContainer'>
                            <div id="TabUnderwritingRuleSType_Gridtoolbar">
                            <div class='form-inline'>
                                <button id="TabUnderwritingRuleSType_GridCreateBtn" type="button" data-i18n="app.form.TabUnderwritingRuleSType_Grid_AddButtonCaption;[data-modal-title]app.form.TabUnderwritingRuleSType_Grid_AddButtonCaption"  class="btn btn-default" data-modal-title="Agregar">
                                    Agregar
                                </button>
                                <button id="TabUnderwritingRuleSType_GridRemoveBtn"  data-i18n="app.form.TabUnderwritingRuleSType_Grid_DeleteButtonCaption;[data-title]app.form.TabUnderwritingRuleSType_Grid_DeleteButtonCaption"  type="button" class="btn btn-danger" disabled data-title="Eliminar">
                ...
                <!-- ShowTranslatorGrid button -->
                  <div class='form-group'>
                    <button id='ShowTranslatorGrid' class='ladda-button btn pull-left btn-default' data-style='expand-right' title='Mostrar Vista Traducción' data-i18n="app.form.ShowTranslatorGrid_Caption;[title]app.form.ShowTranslatorGrid_Tooltip" ><span class='ladda-label'>Vista Traducción</span><span class='ladda-spinner'></span></button>
                            ...
                            <div id='TabUnderwritingRuleSType_GridTblPlaceHolder'></div>
                       </div>

                        </div>
                        <!-- End Container: TabUnderwritingRuleSType_Grid grid -->
                        <!-- Container: TabUnderwritingRuleSTypeTranslator_Grid grid -->
                        <div  class='col-md-12'>

                       <div id='TabUnderwritingRuleSTypeTranslator_GridContainer' class='hidden'>
                            <div id="TabUnderwritingRuleSTypeTranslator_Gridtoolbar">
                            <div class='form-inline'>
                <!-- ShowStandardGrid button -->
                  <div class='form-group'>
                    <button id='ShowStandardGrid' class='ladda-button btn pull-left btn-default' data-style='expand-right' title='Mostrar Vista Estándar' data-i18n="app.form.ShowStandardGrid_Caption;[title]app.form.ShowStandardGrid_Tooltip" ><span class='ladda-label'>Vista Estándar</span><span class='ladda-spinner'></span></button>
                            ...
                            <div id='TabUnderwritingRuleSTypeTranslator_GridTblPlaceHolder' class='hidden'></div>
                       </div>

                        </div>
                        <!-- End Container: TabUnderwritingRuleSTypeTranslator_Grid grid -->
        ...
        <div id='TabUnderwritingRuleSType_GridPopup' class='modal fade' tabindex='-1' role='dialog' aria-labelledby='edit' aria-hidden='true'>
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="row">
                        <form id='TabUnderwritingRuleSType_GridEditForm'>
                            <!-- Container content -->
                                        <!-- UnderwritingRuleStatus numeric -->
                                        <div class='col-md-6 form-horizontal'>
                                          <div class='form-group'>
                                            <div class='col-md-4 text-left'>
                                              <label id='UnderwritingRuleStatusLabel' data-i18n="[html]app.form.UnderwritingRuleStatus_Label" class='control-label' for='UnderwritingRuleStatus'>Estado de la regla de suscripción</label><span id='UnderwritingRuleStatusRequired' class='required-mark'>*</span>
                                            </div>
                                            <div class='col-md-8'>
                                                <input class='form-control' id='UnderwritingRuleStatus' data-i18n="[title]app.form.UnderwritingRuleStatus_Tooltip" name='UnderwritingRuleStatus' title='Estado de las reglas de suscripción' type='text' style='text-align: right'/>
                                            </div>
                                          </div>
                                        </div>
                    ...
                    <div class="modal-footer">
                        <button id="TabUnderwritingRuleSType_GridSaveBtn"  data-i18n="app.form.GridViewPopup_SaveButtonCaption"  class="btn btn-warning">Guardar</button>
        ...
        <div id='TabUnderwritingRuleSTypeTranslator_GridPopup' class='modal fade' tabindex='-1' role='dialog' aria-labelledby='edit' aria-hidden='true'>
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    ...
                    <div class="modal-body">
                      <div class="row">
                        <form id='TabUnderwritingRuleSTypeTranslator_GridEditForm'>
                            <!-- Container content -->
                                        <!-- UnderwritingRuleStatusTranslator numeric -->
                                        <div class='col-md-6 form-horizontal'>
                                          <div class='form-group'>
                                            <div class='col-md-4 text-left'>
                                              <label id='UnderwritingRuleStatusTranslatorLabel' data-i18n="[html]app.form.UnderwritingRuleStatusTranslator_Label" class='control-label' for='UnderwritingRuleStatusTranslator'>Estado de la regla de suscripción</label><span id='UnderwritingRuleStatusTranslatorRequired' class='required-mark'>*</span>
                                            </div>
                                            <div class='col-md-8'>
                                                <input class='form-control' id='UnderwritingRuleStatusTranslator' data-i18n="[title]app.form.UnderwritingRuleStatusTranslator_Tooltip" name='UnderwritingRuleStatusTranslator' title='Estado de las reglas de suscripción.' type='text' style='text-align: right'/>
                                            </div>
                                          </div>
                                        </div>
                    ...
                    <div class="modal-footer">
                        <button id="TabUnderwritingRuleSTypeTranslator_GridSaveBtn"  data-i18n="app.form.GridViewPopup_SaveButtonCaption"  class="btn btn-warning">Guardar</button>
                        <button class="btn"  data-i18n="app.form.GridViewPopup_CancelButtonCaption"  data-dismiss="modal" aria-hidden="true">Cancelar</button>
                    </div>
                </div>
            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="Server">
    ...
    <script src='/fasi/app/js/TableHelper.js?rel=20191108033217092'></script>
    ...
    <script src="H5MantEstadoReglasSuscripcion.js?rel=20191108033217092"></script>
