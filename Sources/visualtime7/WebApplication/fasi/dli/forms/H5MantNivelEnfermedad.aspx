...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <!-- This code was generated by Form Designer v7.3.24.1 at 2019-11-08 04:33:58 p. m. model release 1, Form Generator v1.0.37.9 -->
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <div id="app" class="ibox">
     <div class="ibox-content">
        <form id="H5MantNivelEnfermedadMainForm">
            <input type="hidden" id="H5MantNivelEnfermedadFormId" name="H5MantNivelEnfermedadFormId" value="" />
            <div id="alerts-container"></div>
			<div class="row">
            <!-- Container content -->
                        <!-- Container: TabDegree_Grid grid -->
                        <div  class='col-md-12'>

                       <div id='TabDegree_GridContainer'>
                            <div id="TabDegree_Gridtoolbar">
                            <div class='form-inline'>
                                <button id="TabDegree_GridCreateBtn" type="button" data-i18n="app.form.TabDegree_Grid_AddButtonCaption;[data-modal-title]app.form.TabDegree_Grid_AddButtonCaption"  class="btn btn-default" data-modal-title="Agregar">
                                    Agregar
                                </button>
                                <button id="TabDegree_GridRemoveBtn"  data-i18n="app.form.TabDegree_Grid_DeleteButtonCaption;[data-title]app.form.TabDegree_Grid_DeleteButtonCaption"  type="button" class="btn btn-danger" disabled data-title="Eliminar">
                ...
                <!-- ShowTranslatorGrid button -->
                  <div class='form-group'>
                    <button id='ShowTranslatorGrid' class='ladda-button btn pull-left btn-default' data-style='expand-right' title='Mostrar Vista Traducción' data-i18n="app.form.ShowTranslatorGrid_Caption;[title]app.form.ShowTranslatorGrid_Tooltip" ><span class='ladda-label'>Vista Traducción</span><span class='ladda-spinner'></span></button>
                            ...
                            <div id='TabDegree_GridTblPlaceHolder'></div>
                       </div>

                        </div>
                        <!-- End Container: TabDegree_Grid grid -->
                        <!-- Container: TabDegreeTranslator_Grid grid -->
                        <div  class='col-md-12'>

                       <div id='TabDegreeTranslator_GridContainer' class='hidden'>
                            <div id="TabDegreeTranslator_Gridtoolbar">
                            <div class='form-inline'>
                <!-- ShowStandardGrid button -->
                  <div class='form-group'>
                    <button id='ShowStandardGrid' class='ladda-button btn pull-left btn-default' data-style='expand-right' title='Mostrar Vista Estándar' data-i18n="app.form.ShowStandardGrid_Caption;[title]app.form.ShowStandardGrid_Tooltip" ><span class='ladda-label'>Vista Estándar</span><span class='ladda-spinner'></span></button>
                            ...
                            <div id='TabDegreeTranslator_GridTblPlaceHolder' class='hidden'></div>
                       </div>

                        </div>
                        <!-- End Container: TabDegreeTranslator_Grid grid -->
        ...
        <div id='TabDegree_GridPopup' class='modal fade' tabindex='-1' role='dialog' aria-labelledby='edit' aria-hidden='true'>
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="row">
                        <form id='TabDegree_GridEditForm'>
                            <!-- Container content -->
                                        <!-- DegreeId numeric -->
                                        <div class='col-md-6 form-horizontal'>
                                          <div class='form-group'>
                                            <div class='col-md-4 text-left'>
                                              <label id='DegreeIdLabel' data-i18n="[html]app.form.DegreeId_Label" class='control-label' for='DegreeId'>Nivel/ Grado de la enfermedad</label><span id='DegreeIdRequired' class='required-mark'>*</span>
                                            </div>
                                            <div class='col-md-8'>
                                                <input class='form-control' id='DegreeId' data-i18n="[title]app.form.DegreeId_Tooltip" name='DegreeId' title='Indica si la enfermedad se presenta en grado suave, medio o severo' type='text' style='text-align: right'/>
                                            </div>
                                          </div>
                                        </div>
                    ...
                    <div class="modal-footer">
                        <button id="TabDegree_GridSaveBtn"  data-i18n="app.form.GridViewPopup_SaveButtonCaption"  class="btn btn-warning">Guardar</button>
        ...
        <div id='TabDegreeTranslator_GridPopup' class='modal fade' tabindex='-1' role='dialog' aria-labelledby='edit' aria-hidden='true'>
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    ...
                    <div class="modal-body">
                      <div class="row">
                        <form id='TabDegreeTranslator_GridEditForm'>
                            <!-- Container content -->
                                        <!-- DegreeIdTranslator numeric -->
                                        <div class='col-md-6 form-horizontal'>
                                          <div class='form-group'>
                                            <div class='col-md-4 text-left'>
                                              <label id='DegreeIdTranslatorLabel' data-i18n="[html]app.form.DegreeIdTranslator_Label" class='control-label' for='DegreeIdTranslator'>Nivel o grado de la enfermedad</label><span id='DegreeIdTranslatorRequired' class='required-mark'>*</span>
                                            </div>
                                            <div class='col-md-8'>
                                                <input class='form-control' id='DegreeIdTranslator' data-i18n="[title]app.form.DegreeIdTranslator_Tooltip" name='DegreeIdTranslator' title='Describe si la enfermedad se presenta en grado suave, medio o severo' type='text' style='text-align: right'/>
                                            </div>
                                          </div>
                                        </div>
                    ...
                    <div class="modal-footer">
                        <button id="TabDegreeTranslator_GridSaveBtn"  data-i18n="app.form.GridViewPopup_SaveButtonCaption"  class="btn btn-warning">Guardar</button>
                        <button class="btn"  data-i18n="app.form.GridViewPopup_CancelButtonCaption"  data-dismiss="modal" aria-hidden="true">Cancelar</button>
                    </div>
                </div>
            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="Server">
    ...
    <script src='/fasi/app/js/TableHelper.js?rel=20191108043358825'></script>
    ...
    <script src="H5MantNivelEnfermedad.js?rel=20191108043358825"></script>
