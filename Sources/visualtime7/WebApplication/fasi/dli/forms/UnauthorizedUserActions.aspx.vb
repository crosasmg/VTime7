...
Namespace dli.forms
    ...
    Public Class UnauthorizedUserActions
       ...
       <WebMethod(EnableSession:=True)>
        Public Shared Function Initialization(id As String, urlid As String, fromid As String) As InMotionGIT.FrontOffice.Support.DataType.ServerActionResult
            ...
            Catch ex As Exception
                resultData = InMotionGIT.FrontOffice.Support.ExceptionHandler.ProcessServerAction(ex, "UnauthorizedUser", "Initialization", currentAction)
            End Try
