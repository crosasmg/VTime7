...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <!-- This code was generated by Form Designer v7.3.24.1 at 2019-11-08 04:00:37 p. m. model release 1, Form Generator v1.0.37.9 -->
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <div id="app" class="ibox">
     <div class="ibox-content">
        <form id="H5MantPreguntasRequisitosMainForm">
            <input type="hidden" id="H5MantPreguntasRequisitosFormId" name="H5MantPreguntasRequisitosFormId" value="" />
            <div id="alerts-container"></div>
			<div class="row">
            <!-- Container content -->
                        <!-- Container: TabQuestionsFromRequirement_Grid grid -->
                        <div  class='col-md-12'>

                       <div id='TabQuestionsFromRequirement_GridContainer'>
                            <div id="TabQuestionsFromRequirement_Gridtoolbar">
                            <div class='form-inline'>
                                <button id="TabQuestionsFromRequirement_GridCreateBtn" type="button" data-i18n="app.form.TabQuestionsFromRequirement_Grid_AddButtonCaption;[data-modal-title]app.form.TabQuestionsFromRequirement_Grid_AddButtonCaption"  class="btn btn-default" data-modal-title="Agregar">
                                    Agregar
                                </button>
                                <button id="TabQuestionsFromRequirement_GridRemoveBtn"  data-i18n="app.form.TabQuestionsFromRequirement_Grid_DeleteButtonCaption;[data-title]app.form.TabQuestionsFromRequirement_Grid_DeleteButtonCaption"  type="button" class="btn btn-danger" disabled data-title="Eliminar">
                ...
                <!-- ShowTranslatorGrid button -->
                  <div class='form-group'>
                    <button id='ShowTranslatorGrid' class='ladda-button btn pull-left btn-default' data-style='expand-right' title='Mostrar Vista Traducción' data-i18n="app.form.ShowTranslatorGrid_Caption;[title]app.form.ShowTranslatorGrid_Tooltip" ><span class='ladda-label'>Vista Traducción</span><span class='ladda-spinner'></span></button>
                            ...
                            <div id='TabQuestionsFromRequirement_GridTblPlaceHolder'></div>
                       </div>

                        </div>
                        <!-- End Container: TabQuestionsFromRequirement_Grid grid -->
                        <!-- Container: TabQuestionsFromRequirementTranslator_Grid grid -->
                        <div  class='col-md-12'>

                       <div id='TabQuestionsFromRequirementTranslator_GridContainer' class='hidden'>
                            <div id="TabQuestionsFromRequirementTranslator_Gridtoolbar">
                            <div class='form-inline'>
                <!-- ShowStandardGrid button -->
                  <div class='form-group'>
                    <button id='ShowStandardGrid' class='ladda-button btn pull-left btn-default' data-style='expand-right' title='Mostrar Vista Estándar' data-i18n="app.form.ShowStandardGrid_Caption;[title]app.form.ShowStandardGrid_Tooltip" ><span class='ladda-label'>Vista Estándar</span><span class='ladda-spinner'></span></button>
                            ...
                            <div id='TabQuestionsFromRequirementTranslator_GridTblPlaceHolder' class='hidden'></div>
                       </div>

                        </div>
                        <!-- End Container: TabQuestionsFromRequirementTranslator_Grid grid -->
        ...
        <div id='TabQuestionsFromRequirement_GridPopup' class='modal fade' tabindex='-1' role='dialog' aria-labelledby='edit' aria-hidden='true'>
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="row">
                        <form id='TabQuestionsFromRequirement_GridEditForm'>
                            <!-- Container content -->
                                        <!-- QuestionId numeric -->
                                        <div class='col-md-6 form-horizontal'>
                                          <div class='form-group'>
                                            <div class='col-md-4 text-left'>
                                              <label id='QuestionIdLabel' data-i18n="[html]app.form.QuestionId_Label" class='control-label' for='QuestionId'>Código de Pregunta</label><span id='QuestionIdRequired' class='required-mark'>*</span>
                                            </div>
                                            <div class='col-md-8'>
                                                <input class='form-control' id='QuestionId' data-i18n="[title]app.form.QuestionId_Tooltip" name='QuestionId' title='Código de Pregunta' type='text' style='text-align: right'/>
                                            </div>
                                          </div>
                                        </div>
                                        ...
                                        <div class='col-md-6 form-horizontal'>
                                          <div class='form-group'>
                                            <div class='col-md-4 text-left'>
                                              <label id='RequirementTypeLabel' data-i18n="[html]app.form.RequirementType_Label" class='control-label' for='RequirementType'>Tipo de requisito</label><span id='RequirementTypeRequired' class='required-mark'>*</span>
                                            </div>
                                            <div class='col-md-8'>
                                                <input class='form-control' id='RequirementType' data-i18n="[title]app.form.RequirementType_Tooltip" name='RequirementType' title='Tipo de requisito.' type='text' style='text-align: right'/>
                                            </div>
                                          </div>
                                        </div>
                                        ...
                                        <div class='col-md-6 form-horizontal'>
                                          <div class='form-group'>
                                            ...
                                            <div class='col-md-8'>
                                                <input class='form-control' id='Description' data-i18n="[title]app.form.Description_Tooltip;[placeholder]app.form.Description_Watermark" name='Description' title='Descripción asociado con el código.' type='text' size='256' maxlength='256'/>
                                            </div>
                                          </div>
                                        </div>
                    ...
                    <div class="modal-footer">
                        <button id="TabQuestionsFromRequirement_GridSaveBtn"  data-i18n="app.form.GridViewPopup_SaveButtonCaption"  class="btn btn-warning">Guardar</button>
        ...
        <div id='TabQuestionsFromRequirementTranslator_GridPopup' class='modal fade' tabindex='-1' role='dialog' aria-labelledby='edit' aria-hidden='true'>
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    ...
                    <div class="modal-body">
                      <div class="row">
                        <form id='TabQuestionsFromRequirementTranslator_GridEditForm'>
                            <!-- Container content -->
                                        <!-- QuestionIdTranslator numeric -->
                                        <div class='col-md-6 form-horizontal'>
                                          <div class='form-group'>
                                            <div class='col-md-4 text-left'>
                                              <label id='QuestionIdTranslatorLabel' data-i18n="[html]app.form.QuestionIdTranslator_Label" class='control-label' for='QuestionIdTranslator'>Pregunta</label><span id='QuestionIdTranslatorRequired' class='required-mark'>*</span>
                                            </div>
                                            <div class='col-md-8'>
                                                <input class='form-control' id='QuestionIdTranslator' data-i18n="[title]app.form.QuestionIdTranslator_Tooltip" name='QuestionIdTranslator' title='Código de pregunta de un cuestionario' type='text' style='text-align: right'/>
                                            </div>
                                          </div>
                                        </div>
                                        ...
                                        <div class='col-md-6 form-horizontal'>
                                          <div class='form-group'>
                                            ...
                                            <div class='col-md-8'>
                                                <input class='form-control' id='DescriptionTranslator' data-i18n="[title]app.form.DescriptionTranslator_Tooltip;[placeholder]app.form.DescriptionTranslator_Watermark" name='DescriptionTranslator' title='Descripción asociado con el código.' type='text' size='256' maxlength='256'/>
                                            </div>
                                          </div>
                                        </div>
                    ...
                    <div class="modal-footer">
                        <button id="TabQuestionsFromRequirementTranslator_GridSaveBtn"  data-i18n="app.form.GridViewPopup_SaveButtonCaption"  class="btn btn-warning">Guardar</button>
                        <button class="btn"  data-i18n="app.form.GridViewPopup_CancelButtonCaption"  data-dismiss="modal" aria-hidden="true">Cancelar</button>
                    </div>
                </div>
            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="Server">
    ...
    <script src='/fasi/app/js/TableHelper.js?rel=20191108040037301'></script>
    ...
    <script src="H5MantPreguntasRequisitos.js?rel=20191108040037301"></script>
