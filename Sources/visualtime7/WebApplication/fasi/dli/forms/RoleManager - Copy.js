var RoleManagerSupport = new function () {
    ...
    this.ActionProcess = function (data, source) {
        if (data.d.Success === true) {
            if (data.d.Data !== null)
                RoleManagerSupport.ObjectToInput(data.d.Data, source);
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (roleInUser == false) {
                    ...
                    notification.swal.error('Eliminación del rol', 'No se pudo eliminar el rol porque esta asociado a uno o más usuarios');
                }
            },
            error: function (qXHR, textStatus, errorThrown) {
                generalSupport.ErrorHandler(qXHR, textStatus, errorThrown, true);
