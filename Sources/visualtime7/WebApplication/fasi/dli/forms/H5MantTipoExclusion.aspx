...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <!-- This code was generated by Form Designer v7.3.24.1 at 2019-11-08 04:08:13 p. m. model release 1, Form Generator v1.0.37.9 -->
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <div id="app" class="ibox">
     <div class="ibox-content">
        <form id="H5MantTipoExclusionMainForm">
            <input type="hidden" id="H5MantTipoExclusionFormId" name="H5MantTipoExclusionFormId" value="" />
            <div id="alerts-container"></div>
			<div class="row">
            <!-- Container content -->
                        <!-- Container: TabExclusionType_Grid grid -->
                        <div  class='col-md-12'>

                       <div id='TabExclusionType_GridContainer'>
                            <div id="TabExclusionType_Gridtoolbar">
                            <div class='form-inline'>
                                <button id="TabExclusionType_GridCreateBtn" type="button" data-i18n="app.form.TabExclusionType_Grid_AddButtonCaption;[data-modal-title]app.form.TabExclusionType_Grid_AddButtonCaption"  class="btn btn-default" data-modal-title="Agregar">
                                    Agregar
                                </button>
                                <button id="TabExclusionType_GridRemoveBtn"  data-i18n="app.form.TabExclusionType_Grid_DeleteButtonCaption;[data-title]app.form.TabExclusionType_Grid_DeleteButtonCaption"  type="button" class="btn btn-danger" disabled data-title="Eliminar">
                ...
                <!-- ShowTranslatorGrid button -->
                  <div class='form-group'>
                    <button id='ShowTranslatorGrid' class='ladda-button btn pull-left btn-default' data-style='expand-right' title='Mostrar Vista Traducción' data-i18n="app.form.ShowTranslatorGrid_Caption;[title]app.form.ShowTranslatorGrid_Tooltip" ><span class='ladda-label'>Vista Traducción</span><span class='ladda-spinner'></span></button>
                            ...
                            <div id='TabExclusionType_GridTblPlaceHolder'></div>
                       </div>

                        </div>
                        <!-- End Container: TabExclusionType_Grid grid -->
                        <!-- Container: TabExclusionTypeTranslator_Grid grid -->
                        <div  class='col-md-12'>

                       <div id='TabExclusionTypeTranslator_GridContainer' class='hidden'>
                            <div id="TabExclusionTypeTranslator_Gridtoolbar">
                            <div class='form-inline'>
                <!-- ShowStandardGrid button -->
                  <div class='form-group'>
                    <button id='ShowStandardGrid' class='ladda-button btn pull-left btn-default' data-style='expand-right' title='Mostrar Vista Estándar' data-i18n="app.form.ShowStandardGrid_Caption;[title]app.form.ShowStandardGrid_Tooltip" ><span class='ladda-label'>Vista Estándar</span><span class='ladda-spinner'></span></button>
                            ...
                            <div id='TabExclusionTypeTranslator_GridTblPlaceHolder' class='hidden'></div>
                       </div>

                        </div>
                        <!-- End Container: TabExclusionTypeTranslator_Grid grid -->
        ...
        <div id='TabExclusionType_GridPopup' class='modal fade' tabindex='-1' role='dialog' aria-labelledby='edit' aria-hidden='true'>
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="row">
                        <form id='TabExclusionType_GridEditForm'>
                            <!-- Container content -->
                                        <!-- ExclusionType numeric -->
                                        <div class='col-md-6 form-horizontal'>
                                          <div class='form-group'>
                                            <div class='col-md-4 text-left'>
                                              <label id='ExclusionTypeLabel' data-i18n="[html]app.form.ExclusionType_Label" class='control-label' for='ExclusionType'>Tipo de exclusión</label><span id='ExclusionTypeRequired' class='required-mark'>*</span>
                                            </div>
                                            <div class='col-md-8'>
                                                <input class='form-control' id='ExclusionType' data-i18n="[title]app.form.ExclusionType_Tooltip" name='ExclusionType' title='Tipo de exclusión: enfermedad, cobertura' type='text' style='text-align: right'/>
                                            </div>
                                          </div>
                                        </div>
                    ...
                    <div class="modal-footer">
                        <button id="TabExclusionType_GridSaveBtn"  data-i18n="app.form.GridViewPopup_SaveButtonCaption"  class="btn btn-warning">Guardar</button>
        ...
        <div id='TabExclusionTypeTranslator_GridPopup' class='modal fade' tabindex='-1' role='dialog' aria-labelledby='edit' aria-hidden='true'>
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    ...
                    <div class="modal-body">
                      <div class="row">
                        <form id='TabExclusionTypeTranslator_GridEditForm'>
                            <!-- Container content -->
                                        <!-- ExclusionTypeTranslator numeric -->
                                        <div class='col-md-6 form-horizontal'>
                                          <div class='form-group'>
                                            <div class='col-md-4 text-left'>
                                              <label id='ExclusionTypeTranslatorLabel' data-i18n="[html]app.form.ExclusionTypeTranslator_Label" class='control-label' for='ExclusionTypeTranslator'>Tipo de exclusión</label><span id='ExclusionTypeTranslatorRequired' class='required-mark'>*</span>
                                            </div>
                                            <div class='col-md-8'>
                                                <input class='form-control' id='ExclusionTypeTranslator' data-i18n="[title]app.form.ExclusionTypeTranslator_Tooltip" name='ExclusionTypeTranslator' title='Tipo de exclusión: enfermedad, cobertura, etc' type='text' style='text-align: right'/>
                                            </div>
                                          </div>
                                        </div>
                    ...
                    <div class="modal-footer">
                        <button id="TabExclusionTypeTranslator_GridSaveBtn"  data-i18n="app.form.GridViewPopup_SaveButtonCaption"  class="btn btn-warning">Guardar</button>
                        <button class="btn"  data-i18n="app.form.GridViewPopup_CancelButtonCaption"  data-dismiss="modal" aria-hidden="true">Cancelar</button>
                    </div>
                </div>
            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="Server">
    ...
    <script src='/fasi/app/js/TableHelper.js?rel=20191108040813923'></script>
    ...
    <script src="H5MantTipoExclusion.js?rel=20191108040813923"></script>
