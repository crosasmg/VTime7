...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <div id="app" class="ibox">
     <div class="ibox-content">
        <form id="H5MantTiposDeCasoMainForm">
            <input type="hidden" id="H5MantTiposDeCasoFormId" name="H5MantTiposDeCasoFormId" value="" />
            <div id="alerts-container"></div>
			<div class="row">
            <!-- Container content -->
                        <!-- Container: TabUnderwritingCaseType_Grid grid -->
                        <div  class='col-md-12'>

                       <div id='TabUnderwritingCaseType_GridContainer'>
                            <div id="TabUnderwritingCaseType_Gridtoolbar">
                            <div class='form-inline'>
                                <button id="TabUnderwritingCaseType_GridCreateBtn" type="button" data-i18n="app.form.TabUnderwritingCaseType_Grid_AddButtonCaption;[data-modal-title]app.form.TabUnderwritingCaseType_Grid_AddButtonCaption"  class="btn btn-default" data-modal-title="Agregar">
                                    Agregar
                                </button>
                                <button id="TabUnderwritingCaseType_GridRemoveBtn"  data-i18n="app.form.TabUnderwritingCaseType_Grid_DeleteButtonCaption;[data-title]app.form.TabUnderwritingCaseType_Grid_DeleteButtonCaption"  type="button" class="btn btn-danger" disabled data-title="Eliminar">
                ...
                <!-- ShowTranslatorGrid button -->
                  <div class='form-group'>
                    <button id='ShowTranslatorGrid' class='ladda-button btn pull-left btn-default' data-style='expand-right' title='Mostrar Vista Traducción' data-i18n="app.form.ShowTranslatorGrid_Caption;[title]app.form.ShowTranslatorGrid_Tooltip" ><span class='ladda-label'>Vista Traducción</span><span class='ladda-spinner'></span></button>
                            ...
                            <div id='TabUnderwritingCaseType_GridTblPlaceHolder'></div>
                       </div>

                        </div>
                        <!-- End Container: TabUnderwritingCaseType_Grid grid -->
                        <!-- Container: TabUnderwritingCaseTypeTranslator_Grid grid -->
                        <div  class='col-md-12'>

                       <div id='TabUnderwritingCaseTypeTranslator_GridContainer' class='hidden'>
                            <div id="TabUnderwritingCaseTypeTranslator_Gridtoolbar">
                            <div class='form-inline'>
                <!-- ShowStandardGrid button -->
                  <div class='form-group'>
                    <button id='ShowStandardGrid' class='ladda-button btn pull-left btn-default' data-style='expand-right' title='Mostrar Vista Estándar' data-i18n="app.form.ShowStandardGrid_Caption;[title]app.form.ShowStandardGrid_Tooltip" ><span class='ladda-label'>Vista Estándar</span><span class='ladda-spinner'></span></button>
                            ...
                            <div id='TabUnderwritingCaseTypeTranslator_GridTblPlaceHolder' class='hidden'></div>
                       </div>

                        </div>
                        <!-- End Container: TabUnderwritingCaseTypeTranslator_Grid grid -->
        ...
        <div id='TabUnderwritingCaseType_GridPopup' class='modal fade' tabindex='-1' role='dialog' aria-labelledby='edit' aria-hidden='true'>
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="row">
                        <form id='TabUnderwritingCaseType_GridEditForm'>
                            <!-- Container content -->
                                        <!-- UnderwritingCaseType numeric -->
                                        <div class='col-md-6 form-horizontal'>
                                          <div class='form-group'>
                                            <div class='col-md-4 text-left'>
                                              <label id='UnderwritingCaseTypeLabel' data-i18n="[html]app.form.UnderwritingCaseType_Label" class='control-label' for='UnderwritingCaseType'>Tipo de suscripción</label><span id='UnderwritingCaseTypeRequired' class='required-mark'>*</span>
                                            </div>
                                            <div class='col-md-8'>
                                                <input class='form-control' id='UnderwritingCaseType' data-i18n="[title]app.form.UnderwritingCaseType_Tooltip" name='UnderwritingCaseType' title='Tipo de suscripción: nuevo negocio, cotización de modificación' type='text' style='text-align: right'/>
                                            </div>
                                          </div>
                                        </div>
                                        ...
                                        <div class='col-md-6 form-horizontal'>
                                          <div class='form-group'>
                                            <div class='col-md-4 text-left'>
                                              <label id='CreationDateLabel' data-i18n="[html]app.form.CreationDate_Label" class='control-label hidden' for='CreationDate'>Fecha de Actualización del Registro</label><span id='CreationDateRequired' class='required-mark hidden'>*</span>
                                            </div>
                                            <div class='col-md-8'>
                    ...
                    <div class="modal-footer">
                        <button id="TabUnderwritingCaseType_GridSaveBtn"  data-i18n="app.form.GridViewPopup_SaveButtonCaption"  class="btn btn-warning">Guardar</button>
        ...
        <div id='TabUnderwritingCaseTypeTranslator_GridPopup' class='modal fade' tabindex='-1' role='dialog' aria-labelledby='edit' aria-hidden='true'>
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    ...
                    <div class="modal-body">
                      <div class="row">
                        <form id='TabUnderwritingCaseTypeTranslator_GridEditForm'>
                            <!-- Container content -->
                                        <!-- UnderwritingCaseTypeTranslator numeric -->
                                        <div class='col-md-6 form-horizontal'>
                                          <div class='form-group'>
                                            <div class='col-md-4 text-left'>
                                              <label id='UnderwritingCaseTypeTranslatorLabel' data-i18n="[html]app.form.UnderwritingCaseTypeTranslator_Label" class='control-label' for='UnderwritingCaseTypeTranslator'>Tipo de suscripción</label><span id='UnderwritingCaseTypeTranslatorRequired' class='required-mark'>*</span>
                                            </div>
                                            <div class='col-md-8'>
                                                <input class='form-control' id='UnderwritingCaseTypeTranslator' data-i18n="[title]app.form.UnderwritingCaseTypeTranslator_Tooltip" name='UnderwritingCaseTypeTranslator' title='Tipo de suscripción: nuevo negocio, cotización de modificación' type='text' style='text-align: right'/>
                                            </div>
                                          </div>
                                        </div>
                    ...
                    <div class="modal-footer">
                        <button id="TabUnderwritingCaseTypeTranslator_GridSaveBtn"  data-i18n="app.form.GridViewPopup_SaveButtonCaption"  class="btn btn-warning">Guardar</button>
                        <button class="btn"  data-i18n="app.form.GridViewPopup_CancelButtonCaption"  data-dismiss="modal" aria-hidden="true">Cancelar</button>
                    </div>
                </div>
            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="Server">
    ...
    <script src='/fasi/app/js/TableHelper.js?rel=20191108032142419'></script>
    ...
    <script src="H5MantTiposDeCaso.js?rel=20191108032142419"></script>
