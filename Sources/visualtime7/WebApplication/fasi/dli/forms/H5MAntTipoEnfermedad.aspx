...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <!-- This code was generated by Form Designer v7.3.24.1 at 2019-11-08 04:16:00 p. m. model release 1, Form Generator v1.0.37.9 -->
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <div id="app" class="ibox">
     <div class="ibox-content">
        <form id="H5MAntTipoEnfermedadMainForm">
            <input type="hidden" id="H5MAntTipoEnfermedadFormId" name="H5MAntTipoEnfermedadFormId" value="" />
            <div id="alerts-container"></div>
			<div class="row">
            <!-- Container content -->
                        <!-- Container: TabIllnessType_Grid grid -->
                        <div  class='col-md-12'>

                       <div id='TabIllnessType_GridContainer'>
                            <div id="TabIllnessType_Gridtoolbar">
                            <div class='form-inline'>
                                <button id="TabIllnessType_GridCreateBtn" type="button" data-i18n="app.form.TabIllnessType_Grid_AddButtonCaption;[data-modal-title]app.form.TabIllnessType_Grid_AddButtonCaption"  class="btn btn-default" data-modal-title="Agregar">
                                    Agregar
                                </button>
                                <button id="TabIllnessType_GridRemoveBtn"  data-i18n="app.form.TabIllnessType_Grid_DeleteButtonCaption;[data-title]app.form.TabIllnessType_Grid_DeleteButtonCaption"  type="button" class="btn btn-danger" disabled data-title="Eliminar">
                ...
                <!-- ShowTranslatorGrid button -->
                  <div class='form-group'>
                    <button id='ShowTranslatorGrid' class='ladda-button btn pull-left btn-default' data-style='expand-right' title='Mostrar Vista Traducción' data-i18n="app.form.ShowTranslatorGrid_Caption;[title]app.form.ShowTranslatorGrid_Tooltip" ><span class='ladda-label'>Vista Traducción</span><span class='ladda-spinner'></span></button>
                            ...
                            <div id='TabIllnessType_GridTblPlaceHolder'></div>
                       </div>

                        </div>
                        <!-- End Container: TabIllnessType_Grid grid -->
                        <!-- Container: TabIllnessTypeTranslator_Grid grid -->
                        <div  class='col-md-12'>

                       <div id='TabIllnessTypeTranslator_GridContainer' class='hidden'>
                            <div id="TabIllnessTypeTranslator_Gridtoolbar">
                            <div class='form-inline'>
                <!-- ShowStandardGrid button -->
                  <div class='form-group'>
                    <button id='ShowStandardGrid' class='ladda-button btn pull-left btn-default' data-style='expand-right' title='Mostrar Vista Estándar' data-i18n="app.form.ShowStandardGrid_Caption;[title]app.form.ShowStandardGrid_Tooltip" ><span class='ladda-label'>Vista Estándar</span><span class='ladda-spinner'></span></button>
                            ...
                            <div id='TabIllnessTypeTranslator_GridTblPlaceHolder' class='hidden'></div>
                       </div>

                        </div>
                        <!-- End Container: TabIllnessTypeTranslator_Grid grid -->
        ...
        <div id='TabIllnessType_GridPopup' class='modal fade' tabindex='-1' role='dialog' aria-labelledby='edit' aria-hidden='true'>
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="row">
                        <form id='TabIllnessType_GridEditForm'>
                            <!-- Container content -->
                                        <!-- ImpairmentCode text -->
                                        <div class='col-md-6 form-horizontal'>
                                          <div class='form-group'>
                                            <div class='col-md-4 text-left'>
                                              <label id='ImpairmentCodeLabel' data-i18n="[html]app.form.ImpairmentCode_Label" class='control-label' for='ImpairmentCode'>Enfermedad</label><span id='ImpairmentCodeRequired' class='required-mark'>*</span>
                                            </div>
                                            <div class='col-md-8'>
                                                <input class='form-control' id='ImpairmentCode' data-i18n="[title]app.form.ImpairmentCode_Tooltip;[placeholder]app.form.ImpairmentCode_Watermark" name='ImpairmentCode' title='Enfermedad de un cliente' type='text' size='5' maxlength='5'/>
                                            </div>
                                          </div>
                                        </div>
                                        ...
                                        <div class='col-md-6 form-horizontal'>
                                          <div class='form-group'>
                                            ...
                                            <div class='col-md-8'>
                                                <input class='form-control' id='Description' data-i18n="[title]app.form.Description_Tooltip;[placeholder]app.form.Description_Watermark" name='Description' title='Descripción del código.' type='text' size='256' maxlength='256'/>
                                            </div>
                                          </div>
                                        </div>
                    ...
                    <div class="modal-footer">
                        <button id="TabIllnessType_GridSaveBtn"  data-i18n="app.form.GridViewPopup_SaveButtonCaption"  class="btn btn-warning">Guardar</button>
        ...
        <div id='TabIllnessTypeTranslator_GridPopup' class='modal fade' tabindex='-1' role='dialog' aria-labelledby='edit' aria-hidden='true'>
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    ...
                    <div class="modal-body">
                      <div class="row">
                        <form id='TabIllnessTypeTranslator_GridEditForm'>
                            <!-- Container content -->
                                        <!-- ImpairmentCodeTranslator text -->
                                        <div class='col-md-6 form-horizontal'>
                                          <div class='form-group'>
                                            <div class='col-md-4 text-left'>
                                              <label id='ImpairmentCodeTranslatorLabel' data-i18n="[html]app.form.ImpairmentCodeTranslator_Label" class='control-label' for='ImpairmentCodeTranslator'>Enfermedad</label><span id='ImpairmentCodeTranslatorRequired' class='required-mark'>*</span>
                                            </div>
                                            <div class='col-md-8'>
                                                <input class='form-control' id='ImpairmentCodeTranslator' data-i18n="[title]app.form.ImpairmentCodeTranslator_Tooltip;[placeholder]app.form.ImpairmentCodeTranslator_Watermark" name='ImpairmentCodeTranslator' title='Enfermedades de un cliente' type='text' size='5' maxlength='5'/>
                                            </div>
                                          </div>
                                        </div>
                                        ...
                                        <div class='col-md-6 form-horizontal'>
                                          <div class='form-group'>
                                            ...
                                            <div class='col-md-8'>
                                                <input class='form-control' id='DescriptionTranslator' data-i18n="[title]app.form.DescriptionTranslator_Tooltip;[placeholder]app.form.DescriptionTranslator_Watermark" name='DescriptionTranslator' title='Descripción del código.' type='text' size='256' maxlength='256'/>
                                            </div>
                                          </div>
                                        </div>
                    ...
                    <div class="modal-footer">
                        <button id="TabIllnessTypeTranslator_GridSaveBtn"  data-i18n="app.form.GridViewPopup_SaveButtonCaption"  class="btn btn-warning">Guardar</button>
                        <button class="btn"  data-i18n="app.form.GridViewPopup_CancelButtonCaption"  data-dismiss="modal" aria-hidden="true">Cancelar</button>
                    </div>
                </div>
            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="Server">
    ...
    <script src='/fasi/app/js/TableHelper.js?rel=20191108041600821'></script>
    ...
    <script src="H5MAntTipoEnfermedad.js?rel=20191108041600821"></script>
