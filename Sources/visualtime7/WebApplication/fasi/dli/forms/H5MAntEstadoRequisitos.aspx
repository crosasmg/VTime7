...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <!-- This code was generated by Form Designer v7.3.24.1 at 2019-11-08 03:54:22 p. m. model release 1, Form Generator v1.0.37.9 -->
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <div id="app" class="ibox">
     <div class="ibox-content">
        <form id="H5MAntEstadoRequisitosMainForm">
            <input type="hidden" id="H5MAntEstadoRequisitosFormId" name="H5MAntEstadoRequisitosFormId" value="" />
            <div id="alerts-container"></div>
			<div class="row">
            <!-- Container content -->
                        <!-- Container: TabRequirementStatusType_Grid grid -->
                        <div  class='col-md-12'>

                       <div id='TabRequirementStatusType_GridContainer'>
                            <div id="TabRequirementStatusType_Gridtoolbar">
                            <div class='form-inline'>
                                <button id="TabRequirementStatusType_GridCreateBtn" type="button" data-i18n="app.form.TabRequirementStatusType_Grid_AddButtonCaption;[data-modal-title]app.form.TabRequirementStatusType_Grid_AddButtonCaption"  class="btn btn-default" data-modal-title="Agregar">
                                    Agregar
                                </button>
                                <button id="TabRequirementStatusType_GridRemoveBtn"  data-i18n="app.form.TabRequirementStatusType_Grid_DeleteButtonCaption;[data-title]app.form.TabRequirementStatusType_Grid_DeleteButtonCaption"  type="button" class="btn btn-danger" disabled data-title="Eliminar">
                ...
                <!-- ShowTranslatorGrid button -->
                  <div class='form-group'>
                    <button id='ShowTranslatorGrid' class='ladda-button btn pull-left btn-default' data-style='expand-right' title='Mostrar Vista Traducción' data-i18n="app.form.ShowTranslatorGrid_Caption;[title]app.form.ShowTranslatorGrid_Tooltip" ><span class='ladda-label'>Vista Traducción</span><span class='ladda-spinner'></span></button>
                            ...
                            <div id='TabRequirementStatusType_GridTblPlaceHolder'></div>
                       </div>

                        </div>
                        <!-- End Container: TabRequirementStatusType_Grid grid -->
                        <!-- Container: TabRequirementStatusTypeTranslator_Grid grid -->
                        <div  class='col-md-12'>

                       <div id='TabRequirementStatusTypeTranslator_GridContainer' class='hidden'>
                            <div id="TabRequirementStatusTypeTranslator_Gridtoolbar">
                            <div class='form-inline'>
                <!-- ShowStandardGrid button -->
                  <div class='form-group'>
                    <button id='ShowStandardGrid' class='ladda-button btn pull-left btn-default' data-style='expand-right' title='Mostrar Vista Estándar' data-i18n="app.form.ShowStandardGrid_Caption;[title]app.form.ShowStandardGrid_Tooltip" ><span class='ladda-label'>Vista Estándar</span><span class='ladda-spinner'></span></button>
                            ...
                            <div id='TabRequirementStatusTypeTranslator_GridTblPlaceHolder' class='hidden'></div>
                       </div>

                        </div>
                        <!-- End Container: TabRequirementStatusTypeTranslator_Grid grid -->
        ...
        <div id='TabRequirementStatusType_GridPopup' class='modal fade' tabindex='-1' role='dialog' aria-labelledby='edit' aria-hidden='true'>
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="row">
                        <form id='TabRequirementStatusType_GridEditForm'>
                            <!-- Container content -->
                                        <!-- RequirementStatus numeric -->
                                        <div class='col-md-6 form-horizontal'>
                                          <div class='form-group'>
                                            <div class='col-md-4 text-left'>
                                              <label id='RequirementStatusLabel' data-i18n="[html]app.form.RequirementStatus_Label" class='control-label' for='RequirementStatus'>Estado del requisito</label><span id='RequirementStatusRequired' class='required-mark'>*</span>
                                            </div>
                                            <div class='col-md-8'>
                                                <input class='form-control' id='RequirementStatus' data-i18n="[title]app.form.RequirementStatus_Tooltip" name='RequirementStatus' title='Estado del requisito.' type='text' style='text-align: right'/>
                                            </div>
                                          </div>
                                        </div>
                    ...
                    <div class="modal-footer">
                        <button id="TabRequirementStatusType_GridSaveBtn"  data-i18n="app.form.GridViewPopup_SaveButtonCaption"  class="btn btn-warning">Guardar</button>
        ...
        <div id='TabRequirementStatusTypeTranslator_GridPopup' class='modal fade' tabindex='-1' role='dialog' aria-labelledby='edit' aria-hidden='true'>
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    ...
                    <div class="modal-body">
                      <div class="row">
                        <form id='TabRequirementStatusTypeTranslator_GridEditForm'>
                            <!-- Container content -->
                                        <!-- RequirementStatusTranslator numeric -->
                                        <div class='col-md-6 form-horizontal'>
                                          <div class='form-group'>
                                            <div class='col-md-4 text-left'>
                                              <label id='RequirementStatusTranslatorLabel' data-i18n="[html]app.form.RequirementStatusTranslator_Label" class='control-label' for='RequirementStatusTranslator'>Estado del requisito</label><span id='RequirementStatusTranslatorRequired' class='required-mark'>*</span>
                                            </div>
                                            <div class='col-md-8'>
                                                <input class='form-control' id='RequirementStatusTranslator' data-i18n="[title]app.form.RequirementStatusTranslator_Tooltip" name='RequirementStatusTranslator' title='Estado del requisito.' type='text' style='text-align: right'/>
                                            </div>
                                          </div>
                                        </div>
                    ...
                    <div class="modal-footer">
                        <button id="TabRequirementStatusTypeTranslator_GridSaveBtn"  data-i18n="app.form.GridViewPopup_SaveButtonCaption"  class="btn btn-warning">Guardar</button>
                        <button class="btn"  data-i18n="app.form.GridViewPopup_CancelButtonCaption"  data-dismiss="modal" aria-hidden="true">Cancelar</button>
                    </div>
                </div>
            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="footer" runat="Server">
    ...
    <script src='/fasi/app/js/TableHelper.js?rel=20191108035422366'></script>
    ...
    <script src="H5MAntEstadoRequisitos.js?rel=20191108035422366"></script>
