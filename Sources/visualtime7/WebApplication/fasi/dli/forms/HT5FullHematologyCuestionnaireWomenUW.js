var HT5FullHematologyCuestionnaireWomenUWSupport = new function () {

    this.currentRow = {};
    
    this.InputToObject = function () {
        var data = {
            InstanceFormId: $('#HT5FullHematologyCuestionnaireWomenUWFormId').val(),
    ...
    this.ObjectToInput = function (data) {
        $('#HT5FullHematologyCuestionnaireWomenUWFormId').val(data.InstanceFormId);
    ...
    this.ActionProcess = function (data) {
        if (data.d.Success === true) {
            if (data.d.Data !== null)
                HT5FullHematologyCuestionnaireWomenUWSupport.ObjectToInput(data.d.Data);
    ...
    this.Initialization = function () {
        ...
        $.ajax({
            type: "POST",
            url: "/fasi/dli/forms/HT5FullHematologyCuestionnaireWomenUWActions.aspx/Initialization"+ (window.location.href.split("?")[1] ? "?" + window.location.href.split("?")[1] : ""),
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            data: JSON.stringify({
                id: $('#HT5FullHematologyCuestionnaireWomenUWFormId').val(),
            ...
            success: function (data) {
                ...
                HT5FullHematologyCuestionnaireWomenUWSupport.ActionProcess(data);
                
                if (generalSupport.URLStringValue('fromid') !== '' && window.history.replaceState)
                    window.history.replaceState({}, null, '/fasi/dli/forms/HT5FullHematologyCuestionnaireWomenUW.aspx?id=' + $('#HT5FullHematologyCuestionnaireWomenUWFormId').val());
    ...
    this.ControlActions = function () {
        ...
        $('#save').click(function (event) {
            var formInstance = $("#HT5FullHematologyCuestionnaireWomenUWMainForm");
            ...
            if (formInstance.valid()) {
                ...
                $.ajax({
                    type: "POST",
                    url: "/fasi/dli/forms/HT5FullHematologyCuestionnaireWomenUWActions.aspx/saveClick",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: JSON.stringify({
                        instance: HT5FullHematologyCuestionnaireWomenUWSupport.InputToObject()
                    }),
                    success: function (data) {
                        btnLoading.stop();
        ...
        $('#submit').click(function (event) {
            ...
            if (formInstance.valid()) {
                ...
                $.ajax({
                    type: "POST",
                    url: "/fasi/dli/forms/HT5FullHematologyCuestionnaireWomenUWActions.aspx/submitClick",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    data: JSON.stringify({
                        instance: HT5FullHematologyCuestionnaireWomenUWSupport.InputToObject()
    ...
    this.ValidateSetup = function () {
        ...
        $("#HT5FullHematologyCuestionnaireWomenUWMainForm").validate({
...
$(document).ready(function () {
    ...
    if (typeof masterSupport !== 'undefined' && typeof constants !== 'undefined' && window.location.pathname !== constants.defaultPage)
        masterSupport.setPageTitle('HT5Hematología completa - Mujeres');
        

    HT5FullHematologyCuestionnaireWomenUWSupport.ControlBehaviour();
    HT5FullHematologyCuestionnaireWomenUWSupport.ControlActions();
    HT5FullHematologyCuestionnaireWomenUWSupport.ValidateSetup();
    HT5FullHematologyCuestionnaireWomenUWSupport.Initialization();
