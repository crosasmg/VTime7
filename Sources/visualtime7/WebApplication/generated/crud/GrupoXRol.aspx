<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="GrupoXRol.aspx.vb" Inherits="Maintenance_GrupoXRol" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'GrupoXRol_ViewItem':     
     
     
     CurrentGrid = GrupoXRol;
     CurrentGrid.PerformCallback('');
     break;
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="GrupoXRol_View" ClientInstanceName="GrupoXRol_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="GrupoXRol_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='GrupoXRol' ID='GrupoXRol' runat='server' Width='100%' KeyFieldName='ID_ROL;ID_GRUPO_ACCESO;ID_COMPANIA;EXTERNALUSER' Caption='Group XR ole' Enabled="True" ClientVisible ="True" meta:resourcekey="GrupoXRolResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataComboBoxColumn Name='Id_Rol' FieldName='ID_ROL' Caption='Id Rol' ToolTip='Code of the security role. See schema FrontOffice for details.' VisibleIndex="0" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="45%" Visible="True" meta:resourcekey="Id_Rol" >
<EditFormSettings VisibleIndex="0" Visible="True"/>
<PropertiesComboBox ValueType="System.Int32" IncrementalFilteringMode="StartsWith" EnableCallbackMode="false"  TextField='ROLENAME' ValueField='ROLEID'> 
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Id Rol" is required.'/>
     </ValidationSettings>
...
<dxwgv:GridViewDataComboBoxColumn Name='Id_Grupo_Acceso' FieldName='ID_GRUPO_ACCESO' Caption='Id Grupo Acceso' ToolTip='Group of access code.' VisibleIndex="1" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="45%" Visible="True" meta:resourcekey="Id_Grupo_Acceso" >
<EditFormSettings VisibleIndex="1" Visible="True"/>
<PropertiesComboBox ValueType="System.Int32" IncrementalFilteringMode="StartsWith" EnableCallbackMode="false"  TextField='DESCRIPCION' ValueField='ID_GRUPO_ACCESO'> 
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Id Grupo Acceso" is required.'/>
     </ValidationSettings>
     <Style Paddings-PaddingLeft="8px" BackgroundImage-HorizontalPosition="left" BackgroundImage-ImageUrl ="/images/generaluse/required.PNG" BackgroundImage-Repeat="NoRepeat" BackgroundImage-VerticalPosition="center">
</Style>
</PropertiesComboBox>
</dxwgv:GridViewDataComboBoxColumn>
<dxwgv:GridViewDataTextColumn Name='Id_Compania' FieldName='ID_COMPANIA' Caption='Id Compania' ToolTip='Code that identifies the user company owner of the information. See schema Common for details.' VisibleIndex="2" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="8%" Visible="True" meta:resourcekey="Id_Compania">
...
<PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="###,##0" Size='5'>
 <MaskSettings IncludeLiterals="DecimalSymbol" Mask=" <0..99999g>" />
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Id Compania" is required.'/>
     </ValidationSettings>
     <Style Paddings-PaddingLeft="8px" BackgroundImage-HorizontalPosition="left" BackgroundImage-ImageUrl ="/images/generaluse/required.PNG" BackgroundImage-Repeat="NoRepeat" BackgroundImage-VerticalPosition="center">
</Style>
</PropertiesTextEdit>
</dxwgv:GridViewDataTextColumn>
<dxwgv:GridViewDataTextColumn Name='ExternalUser' FieldName='EXTERNALUSER' Caption='External User' ToolTip='Indicates if the user is external or internal. Could be true or false, 1 or 0.' VisibleIndex="3" CellStyle-HorizontalAlign="Left" Width="2%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="ExternalUser">
<EditFormSettings VisibleIndex="3" Visible="True"/>
<PropertiesTextEdit Size='1' MaxLength='1'>
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "External User" is required.'/>
     </ValidationSettings>
     <Style Paddings-PaddingLeft="8px" BackgroundImage-HorizontalPosition="left" BackgroundImage-ImageUrl ="/images/generaluse/required.PNG" BackgroundImage-Repeat="NoRepeat" BackgroundImage-VerticalPosition="center">
</Style>
</PropertiesTextEdit>
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(GrupoXRol);

                 HandlerView('GrupoXRol_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/GrupoXRol.html" AllowResize="True"
