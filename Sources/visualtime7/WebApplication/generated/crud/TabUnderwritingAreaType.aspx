<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="TabUnderwritingAreaType.aspx.vb" Inherits="Maintenance_TabUnderwritingAreaType" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'TabUnderwritingAreaType_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TabUnderwritingAreaType_ViewItem.Text")%>');
           TabUnderwritingAreaType_View.SetClientVisible(true);
           MainMenu.GetItemByName('TabUnderwritingAreaType_ViewItem').SetVisible(false);
       TransUnderwritingAreaType_View.SetClientVisible(false);
  MainMenu.GetItemByName('TransUnderwritingAreaType_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(true);
     CurrentGrid = TabUnderwritingAreaType_Grid;
     CurrentGrid.PerformCallback('');
     break;
case 'TransUnderwritingAreaType_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TransUnderwritingAreaType_ViewItem.Text")%>');
           TransUnderwritingAreaType_View.SetClientVisible(true);
           MainMenu.GetItemByName('TransUnderwritingAreaType_ViewItem').SetVisible(false);
       TabUnderwritingAreaType_View.SetClientVisible(false);
  MainMenu.GetItemByName('TabUnderwritingAreaType_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(false);
     CurrentGrid = TransUnderwritingAreaType_Grid;
     CurrentGrid.PerformCallback('');
     break;
...
break;
                            ...
                            <Items>
                                ...
                                <dxm:MenuItem BeginGroup="True" Name="ViewItem" Text="View" DropDownMode="True" Image-Url="/images/16x16/Toolbar/view.png">
                                        <Items>
                                            <dxm:MenuItem Name="TabUnderwritingAreaType_ViewItem" Text="Standard" meta:resourcekey="TabUnderwritingAreaType_ViewItem"/>
<dxm:MenuItem Name="TransUnderwritingAreaType_ViewItem" Text="Translator" meta:resourcekey="TransUnderwritingAreaType_ViewItem"/>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="TabUnderwritingAreaType_View" ClientInstanceName="TabUnderwritingAreaType_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TabUnderwritingAreaType_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TabUnderwritingAreaType_Grid' ID='TabUnderwritingAreaType_Grid' runat='server' Width='100%' KeyFieldName='UNDERWRITINGAREA' Caption='Underwriting areas' Enabled="True" ClientVisible ="True" meta:resourcekey="TabUnderwritingAreaType_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataTextColumn Name='UnderwritingArea' FieldName='UNDERWRITINGAREA' Caption='Underwriting Area' ToolTip='Underwriting Area.' VisibleIndex="0" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="3%" Visible="True" meta:resourcekey="UnderwritingArea">
...
<dxp:ASPxPanel ID="TransUnderwritingAreaType_View" ClientInstanceName="TransUnderwritingAreaType_View" runat="server" ClientVisible="False" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TransUnderwritingAreaType_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TransUnderwritingAreaType_Grid' ID='TransUnderwritingAreaType_Grid' runat='server' Width='100%' KeyFieldName='UNDERWRITINGAREA;LANGUAGEID' Caption='Underwriting areas' Enabled="True" ClientVisible ="True" meta:resourcekey="TransUnderwritingAreaType_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
<SettingsPager PageSize="20"/>
<SettingsBehavior AllowFocusedRow="True"/>
<SettingsEditing Mode="Inline" />
<ClientSideEvents RowDblClick="function(s, e) {s.StartEditRow(e.visibleIndex);}" FocusedRowChanged="function(s, e) {MainMenu.GetItemByName('EditRegisterItem').SetEnabled(s.GetFocusedRowIndex()>-1);}" SelectionChanged="function(s, e) {MainMenu.GetItemByName('RemoveRegisterItem').SetEnabled(s.GetSelectedRowCount()>0);}" />
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(TabUnderwritingAreaType_Grid);
AddKeyboardNavigationTo(TransUnderwritingAreaType_Grid);

                 HandlerView('TabUnderwritingAreaType_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/TabUnderwritingAreaType.html" AllowResize="True"
