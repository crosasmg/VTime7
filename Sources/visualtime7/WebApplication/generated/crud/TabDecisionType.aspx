<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="TabDecisionType.aspx.vb" Inherits="Maintenance_TabDecisionType" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'TabDecisionType_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TabDecisionType_ViewItem.Text")%>');
           TabDecisionType_View.SetClientVisible(true);
           MainMenu.GetItemByName('TabDecisionType_ViewItem').SetVisible(false);
       TransDecisionType_View.SetClientVisible(false);
  MainMenu.GetItemByName('TransDecisionType_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(true);
     CurrentGrid = TabDecisionType_Grid;
     CurrentGrid.PerformCallback('');
     break;
case 'TransDecisionType_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TransDecisionType_ViewItem.Text")%>');
           TransDecisionType_View.SetClientVisible(true);
           MainMenu.GetItemByName('TransDecisionType_ViewItem').SetVisible(false);
       TabDecisionType_View.SetClientVisible(false);
  MainMenu.GetItemByName('TabDecisionType_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(false);
     CurrentGrid = TransDecisionType_Grid;
     CurrentGrid.PerformCallback('');
     break;
...
break;
                            ...
                            <Items>
                                ...
                                <dxm:MenuItem BeginGroup="True" Name="ViewItem" Text="View" DropDownMode="True" Image-Url="/images/16x16/Toolbar/view.png">
                                        <Items>
                                            <dxm:MenuItem Name="TabDecisionType_ViewItem" Text="Standard" meta:resourcekey="TabDecisionType_ViewItem"/>
<dxm:MenuItem Name="TransDecisionType_ViewItem" Text="Translator" meta:resourcekey="TransDecisionType_ViewItem"/>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="TabDecisionType_View" ClientInstanceName="TabDecisionType_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TabDecisionType_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TabDecisionType_Grid' ID='TabDecisionType_Grid' runat='server' Width='100%' KeyFieldName='DECISION' Caption='Types of decision' Enabled="True" ClientVisible ="True" meta:resourcekey="TabDecisionType_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataTextColumn Name='Decision' FieldName='DECISION' Caption='Decision' ToolTip='Code of the decision.' VisibleIndex="0" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="3%" Visible="True" meta:resourcekey="Decision">
...
<PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="###,##0" Size='5'>
 <MaskSettings IncludeLiterals="DecimalSymbol" Mask=" <0..99999g>" />
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Decision" is required.'/>
     </ValidationSettings>
...
<dxp:ASPxPanel ID="TransDecisionType_View" ClientInstanceName="TransDecisionType_View" runat="server" ClientVisible="False" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TransDecisionType_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TransDecisionType_Grid' ID='TransDecisionType_Grid' runat='server' Width='100%' KeyFieldName='DECISION;LANGUAGEID' Caption='Types of decision' Enabled="True" ClientVisible ="True" meta:resourcekey="TransDecisionType_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
<SettingsPager PageSize="20"/>
<SettingsBehavior AllowFocusedRow="True"/>
<SettingsEditing Mode="Inline" />
<ClientSideEvents RowDblClick="function(s, e) {s.StartEditRow(e.visibleIndex);}" FocusedRowChanged="function(s, e) {MainMenu.GetItemByName('EditRegisterItem').SetEnabled(s.GetFocusedRowIndex()>-1);}" SelectionChanged="function(s, e) {MainMenu.GetItemByName('RemoveRegisterItem').SetEnabled(s.GetSelectedRowCount()>0);}" />
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(TabDecisionType_Grid);
AddKeyboardNavigationTo(TransDecisionType_Grid);

                 HandlerView('TabDecisionType_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/TabDecisionType.html" AllowResize="True"
