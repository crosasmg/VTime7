<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="TabAddressAllowed.aspx.vb" Inherits="Maintenance_TabAddressAllowed" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'TabAddressAllowed_ViewItem':     
     
     
     CurrentGrid = TabAddressAllowed;
     CurrentGrid.PerformCallback('');
     break;
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="TabAddressAllowed_View" ClientInstanceName="TabAddressAllowed_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TabAddressAllowed_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TabAddressAllowed' ID='TabAddressAllowed' runat='server' Width='100%' KeyFieldName='COMPANYID;TYPEOFADDRESS;RECORDOWNERTYPE' Caption='Alloewd addressses type' Enabled="True" ClientVisible ="True" meta:resourcekey="TabAddressAllowedResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataComboBoxColumn Name='TypeOfAddress' FieldName='TYPEOFADDRESS' Caption='Typeof Address' ToolTip='Type of address.' VisibleIndex="1" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="0%" Visible="True" meta:resourcekey="TypeOfAddress" >
<EditFormSettings VisibleIndex="1" Visible="True"/>
<PropertiesComboBox ValueType="System.Int32" IncrementalFilteringMode="StartsWith" EnableCallbackMode="false"  TextField='DESCRIPTION' ValueField='TYPEOFADDRESS'> 
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
...
<dxwgv:GridViewDataTextColumn Name='RecordOwnerType' FieldName='RECORDOWNERTYPE' Caption='Record Owner Type' ToolTip='Owner of the record. ' VisibleIndex="2" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="100%" Visible="True" meta:resourcekey="RecordOwnerType">
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(TabAddressAllowed);

                 HandlerView('TabAddressAllowed_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/TabAddressAllowed.html" AllowResize="True"
