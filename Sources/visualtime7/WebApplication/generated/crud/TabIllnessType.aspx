<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="TabIllnessType.aspx.vb" Inherits="Maintenance_TabIllnessType" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'TabIllnessType_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TabIllnessType_ViewItem.Text")%>');
           TabIllnessType_View.SetClientVisible(true);
           MainMenu.GetItemByName('TabIllnessType_ViewItem').SetVisible(false);
       TransIllnessType_View.SetClientVisible(false);
  MainMenu.GetItemByName('TransIllnessType_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(true);
     CurrentGrid = TabIllnessType_Grid;
     CurrentGrid.PerformCallback('');
     break;
case 'TransIllnessType_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TransIllnessType_ViewItem.Text")%>');
           TransIllnessType_View.SetClientVisible(true);
           MainMenu.GetItemByName('TransIllnessType_ViewItem').SetVisible(false);
       TabIllnessType_View.SetClientVisible(false);
  MainMenu.GetItemByName('TabIllnessType_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(false);
     CurrentGrid = TransIllnessType_Grid;
     CurrentGrid.PerformCallback('');
     break;
...
break;
                            ...
                            <Items>
                                ...
                                <dxm:MenuItem BeginGroup="True" Name="ViewItem" Text="View" DropDownMode="True" Image-Url="/images/16x16/Toolbar/view.png">
                                        <Items>
                                            <dxm:MenuItem Name="TabIllnessType_ViewItem" Text="Standard" meta:resourcekey="TabIllnessType_ViewItem"/>
<dxm:MenuItem Name="TransIllnessType_ViewItem" Text="Translator" meta:resourcekey="TransIllnessType_ViewItem"/>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="TabIllnessType_View" ClientInstanceName="TabIllnessType_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TabIllnessType_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TabIllnessType_Grid' ID='TabIllnessType_Grid' runat='server' Width='100%' KeyFieldName='IMPAIRMENTCODE' Caption='Types of illness' Enabled="True" ClientVisible ="True" meta:resourcekey="TabIllnessType_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataTextColumn Name='ImpairmentCode' FieldName='IMPAIRMENTCODE' Caption='Impairment Code' ToolTip='Code of the illness. ' VisibleIndex="0" CellStyle-HorizontalAlign="Left" Width="1%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="ImpairmentCode">
...
<PropertiesTextEdit Size='5' MaxLength='5'>
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Impairment Code" is required.'/>
     </ValidationSettings>
...
<dxwgv:GridViewDataComboBoxColumn Name='RecordStatus' FieldName='RECORDSTATUS' Caption='Record Status' ToolTip='Status of the record.' VisibleIndex="1" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="9%" Visible="True" meta:resourcekey="RecordStatus" >
...
<dxwgv:GridViewDataTextColumn Name='Description' FieldName='DESCRIPTION' Caption='Description' ToolTip='Description associated with the code.' VisibleIndex="2" CellStyle-HorizontalAlign="Left" Width="73%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="Description">
<EditFormSettings VisibleIndex="2" Visible="True"/>
<PropertiesTextEdit Size='256' MaxLength='256'>
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
...
<dxp:ASPxPanel ID="TransIllnessType_View" ClientInstanceName="TransIllnessType_View" runat="server" ClientVisible="False" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TransIllnessType_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TransIllnessType_Grid' ID='TransIllnessType_Grid' runat='server' Width='100%' KeyFieldName='IMPAIRMENTCODE;LANGUAGEID' Caption='Types of illness' Enabled="True" ClientVisible ="True" meta:resourcekey="TransIllnessType_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
<SettingsPager PageSize="20"/>
<SettingsBehavior AllowFocusedRow="True"/>
<SettingsEditing Mode="Inline" />
<ClientSideEvents RowDblClick="function(s, e) {s.StartEditRow(e.visibleIndex);}" FocusedRowChanged="function(s, e) {MainMenu.GetItemByName('EditRegisterItem').SetEnabled(s.GetFocusedRowIndex()>-1);}" SelectionChanged="function(s, e) {MainMenu.GetItemByName('RemoveRegisterItem').SetEnabled(s.GetSelectedRowCount()>0);}" />
...
<dxwgv:GridViewDataComboBoxColumn Name='RecordStatus' FieldName='RECORDSTATUS' Caption='Record Status' ToolTip='Status of the record.' VisibleIndex="1" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="8%" Visible="True" meta:resourcekey="RecordStatus" >
<EditFormSettings VisibleIndex="1" Visible="True"/>
<PropertiesComboBox ValueType="System.Int32" IncrementalFilteringMode="StartsWith" EnableCallbackMode="false"  TextField='DESCRIPTION' ValueField='RECORDSTATUS'> 
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Record Status" is required.'/>
...
<dxwgv:GridViewDataTextColumn Name='Description' FieldName='DESCRIPTION' Caption='Description' ToolTip='Description associated with the code.' VisibleIndex="3" CellStyle-HorizontalAlign="Left" Width="67%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="Description">
<EditFormSettings VisibleIndex="3" Visible="True"/>
<PropertiesTextEdit Size='256' MaxLength='256'>
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Description" is required.'/>
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(TabIllnessType_Grid);
AddKeyboardNavigationTo(TransIllnessType_Grid);

                 HandlerView('TabIllnessType_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/TabIllnessType.html" AllowResize="True"
