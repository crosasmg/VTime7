<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="TabProcessType.aspx.vb" Inherits="Maintenance_TabProcessType" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'TabProcessType_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TabProcessType_ViewItem.Text")%>');
           TabProcessType_View.SetClientVisible(true);
           MainMenu.GetItemByName('TabProcessType_ViewItem').SetVisible(false);
       TransProcessType_View.SetClientVisible(false);
  MainMenu.GetItemByName('TransProcessType_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(true);
     CurrentGrid = TabProcessType_Grid;
     CurrentGrid.PerformCallback('');
     break;
case 'TransProcessType_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TransProcessType_ViewItem.Text")%>');
           TransProcessType_View.SetClientVisible(true);
           MainMenu.GetItemByName('TransProcessType_ViewItem').SetVisible(false);
       TabProcessType_View.SetClientVisible(false);
  MainMenu.GetItemByName('TabProcessType_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(false);
     CurrentGrid = TransProcessType_Grid;
     CurrentGrid.PerformCallback('');
     break;
...
break;
                            ...
                            <Items>
                                ...
                                <dxm:MenuItem BeginGroup="True" Name="ViewItem" Text="View" DropDownMode="True" Image-Url="/images/16x16/Toolbar/view.png">
                                        <Items>
                                            <dxm:MenuItem Name="TabProcessType_ViewItem" Text="Standard" meta:resourcekey="TabProcessType_ViewItem"/>
<dxm:MenuItem Name="TransProcessType_ViewItem" Text="Translator" meta:resourcekey="TransProcessType_ViewItem"/>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="TabProcessType_View" ClientInstanceName="TabProcessType_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TabProcessType_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TabProcessType_Grid' ID='TabProcessType_Grid' runat='server' Width='100%' KeyFieldName='PROCESSTYPE' Caption='Process type' Enabled="True" ClientVisible ="True" meta:resourcekey="TabProcessType_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataTextColumn Name='ProcessType' FieldName='PROCESSTYPE' Caption='Process Type' ToolTip='Process Type.' VisibleIndex="0" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="3%" Visible="True" meta:resourcekey="ProcessType">
...
<dxp:ASPxPanel ID="TransProcessType_View" ClientInstanceName="TransProcessType_View" runat="server" ClientVisible="False" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TransProcessType_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TransProcessType_Grid' ID='TransProcessType_Grid' runat='server' Width='100%' KeyFieldName='PROCESSTYPE;LANGUAGEID' Caption='Process type' Enabled="True" ClientVisible ="True" meta:resourcekey="TransProcessType_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
<SettingsPager PageSize="20"/>
<SettingsBehavior AllowFocusedRow="True"/>
<SettingsEditing Mode="Inline" />
<ClientSideEvents RowDblClick="function(s, e) {s.StartEditRow(e.visibleIndex);}" FocusedRowChanged="function(s, e) {MainMenu.GetItemByName('EditRegisterItem').SetEnabled(s.GetFocusedRowIndex()>-1);}" SelectionChanged="function(s, e) {MainMenu.GetItemByName('RemoveRegisterItem').SetEnabled(s.GetSelectedRowCount()>0);}" />
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(TabProcessType_Grid);
AddKeyboardNavigationTo(TransProcessType_Grid);

                 HandlerView('TabProcessType_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/TabProcessType.html" AllowResize="True"
