<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="TabNetworkType.aspx.vb" Inherits="Maintenance_TabNetworkType" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'TabNetworkType_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TabNetworkType_ViewItem.Text")%>');
           TabNetworkType_View.SetClientVisible(true);
           MainMenu.GetItemByName('TabNetworkType_ViewItem').SetVisible(false);
       TransNetworkType_View.SetClientVisible(false);
  MainMenu.GetItemByName('TransNetworkType_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(true);
     CurrentGrid = TabNetworkType_Grid;
     CurrentGrid.PerformCallback('');
     break;
case 'TransNetworkType_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TransNetworkType_ViewItem.Text")%>');
           TransNetworkType_View.SetClientVisible(true);
           MainMenu.GetItemByName('TransNetworkType_ViewItem').SetVisible(false);
       TabNetworkType_View.SetClientVisible(false);
  MainMenu.GetItemByName('TabNetworkType_ViewItem').SetVisible(true);
...
break;
                            ...
                            <Items>
                                ...
                                <dxm:MenuItem BeginGroup="True" Name="ViewItem" Text="View" DropDownMode="True" Image-Url="/images/16x16/Toolbar/view.png">
                                        <Items>
                                            <dxm:MenuItem Name="TabNetworkType_ViewItem" Text="Standard" meta:resourcekey="TabNetworkType_ViewItem"/>
<dxm:MenuItem Name="TransNetworkType_ViewItem" Text="Translator" meta:resourcekey="TransNetworkType_ViewItem"/>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="TabNetworkType_View" ClientInstanceName="TabNetworkType_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TabNetworkType_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TabNetworkType_Grid' ID='TabNetworkType_Grid' runat='server' Width='100%' KeyFieldName='NETWORKTYPE' Caption='Social network type' Enabled="True" ClientVisible ="True" meta:resourcekey="TabNetworkType_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataTextColumn Name='NetworkType' FieldName='NETWORKTYPE' Caption='Network Type' ToolTip='Social network type.' VisibleIndex="0" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="10%" Visible="True" meta:resourcekey="NetworkType">
...
<PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="###,##0" Size='5'>
 <MaskSettings IncludeLiterals="DecimalSymbol" Mask=" <0..99999g>" />
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Network Type" is required.'/>
     </ValidationSettings>
...
<dxp:ASPxPanel ID="TransNetworkType_View" ClientInstanceName="TransNetworkType_View" runat="server" ClientVisible="False" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TransNetworkType_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TransNetworkType' ID='TransNetworkType' runat='server' Width='100%' KeyFieldName='NETWORKTYPE;LANGUAGEID' Caption='Trans Network Type' Enabled="True" ClientVisible ="True" meta:resourcekey="TransNetworkTypeResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
<SettingsPager PageSize="20"/>
<SettingsBehavior AllowFocusedRow="True"/>
<SettingsEditing Mode="Inline" />
<ClientSideEvents RowDblClick="function(s, e) {s.StartEditRow(e.visibleIndex);}" FocusedRowChanged="function(s, e) {MainMenu.GetItemByName('EditRegisterItem').SetEnabled(s.GetFocusedRowIndex()>-1);}" SelectionChanged="function(s, e) {MainMenu.GetItemByName('RemoveRegisterItem').SetEnabled(s.GetSelectedRowCount()>0);}" />
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(TabNetworkType_Grid);
AddKeyboardNavigationTo(TransNetworkType);

                 HandlerView('TabNetworkType_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/TabNetworkType.html" AllowResize="True"
