<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="TabDebitOrCreditType.aspx.vb" Inherits="Maintenance_TabDebitOrCreditType" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'TabDebitOrCreditType_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TabDebitOrCreditType_ViewItem.Text")%>');
           TabDebitOrCreditType_View.SetClientVisible(true);
           MainMenu.GetItemByName('TabDebitOrCreditType_ViewItem').SetVisible(false);
       TransDebitOrCreditType_View.SetClientVisible(false);
  MainMenu.GetItemByName('TransDebitOrCreditType_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(true);
     CurrentGrid = TabDebitOrCreditType_Grid;
     CurrentGrid.PerformCallback('');
     break;
case 'TransDebitOrCreditType_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TransDebitOrCreditType_ViewItem.Text")%>');
           TransDebitOrCreditType_View.SetClientVisible(true);
           MainMenu.GetItemByName('TransDebitOrCreditType_ViewItem').SetVisible(false);
       TabDebitOrCreditType_View.SetClientVisible(false);
  MainMenu.GetItemByName('TabDebitOrCreditType_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(false);
     CurrentGrid = TransDebitOrCreditType_Grid;
     CurrentGrid.PerformCallback('');
     break;
...
break;
                            ...
                            <Items>
                                ...
                                <dxm:MenuItem BeginGroup="True" Name="ViewItem" Text="View" DropDownMode="True" Image-Url="/images/16x16/Toolbar/view.png">
                                        <Items>
                                            <dxm:MenuItem Name="TabDebitOrCreditType_ViewItem" Text="Standard" meta:resourcekey="TabDebitOrCreditType_ViewItem"/>
<dxm:MenuItem Name="TransDebitOrCreditType_ViewItem" Text="Translator" meta:resourcekey="TransDebitOrCreditType_ViewItem"/>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="TabDebitOrCreditType_View" ClientInstanceName="TabDebitOrCreditType_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TabDebitOrCreditType_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TabDebitOrCreditType_Grid' ID='TabDebitOrCreditType_Grid' runat='server' Width='100%' KeyFieldName='DEBITORCREDIT' Caption='Point types' Enabled="True" ClientVisible ="True" meta:resourcekey="TabDebitOrCreditType_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataTextColumn Name='DebitOrCredit' FieldName='DEBITORCREDIT' Caption='Debit or Credit' ToolTip='Code of the debit or credit.' VisibleIndex="0" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="3%" Visible="True" meta:resourcekey="DebitOrCredit">
...
<PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="###,##0" Size='5'>
 <MaskSettings IncludeLiterals="DecimalSymbol" Mask=" <0..99999g>" />
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Debit or Credit" is required.'/>
     </ValidationSettings>
...
<dxp:ASPxPanel ID="TransDebitOrCreditType_View" ClientInstanceName="TransDebitOrCreditType_View" runat="server" ClientVisible="False" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TransDebitOrCreditType_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TransDebitOrCreditType_Grid' ID='TransDebitOrCreditType_Grid' runat='server' Width='100%' KeyFieldName='DEBITORCREDIT;LANGUAGEID' Caption='Point types' Enabled="True" ClientVisible ="True" meta:resourcekey="TransDebitOrCreditType_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
<SettingsPager PageSize="20"/>
<SettingsBehavior AllowFocusedRow="True"/>
<SettingsEditing Mode="Inline" />
<ClientSideEvents RowDblClick="function(s, e) {s.StartEditRow(e.visibleIndex);}" FocusedRowChanged="function(s, e) {MainMenu.GetItemByName('EditRegisterItem').SetEnabled(s.GetFocusedRowIndex()>-1);}" SelectionChanged="function(s, e) {MainMenu.GetItemByName('RemoveRegisterItem').SetEnabled(s.GetSelectedRowCount()>0);}" />
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(TabDebitOrCreditType_Grid);
AddKeyboardNavigationTo(TransDebitOrCreditType_Grid);

                 HandlerView('TabDebitOrCreditType_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/TabDebitOrCreditType.html" AllowResize="True"
