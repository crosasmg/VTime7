<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="TabMarketingZoneTables.aspx.vb" Inherits="Maintenance_TabMarketingZoneTables" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'TabMarketingZoneTables_ViewItem':     
     
     
     CurrentGrid = TabMarketingZoneTables;
     CurrentGrid.PerformCallback('');
     break;
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="TabMarketingZoneTables_View" ClientInstanceName="TabMarketingZoneTables_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TabMarketingZoneTables_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TabMarketingZoneTables' ID='TabMarketingZoneTables' runat='server' Width='100%' KeyFieldName='COMPANYID;MARKETINGZONETABLEID' Caption='Marketing Zone Tables' Enabled="True" ClientVisible ="True" meta:resourcekey="TabMarketingZoneTablesResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataDateColumn Name='CancellationDate' FieldName='CANCELLATIONDATE' Caption='Record Cancellation Date' ToolTip='Date when the record is cancelled.' VisibleIndex="3" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="40%" Visible="True" meta:resourcekey="CancellationDate">
<EditFormSettings VisibleIndex="3" Visible="True"/>
<PropertiesDateEdit>
</PropertiesDateEdit>
</dxwgv:GridViewDataDateColumn>
<dxwgv:GridViewDataDateColumn Name='EffectiveDate' FieldName='EFFECTIVEDATE' Caption='Record Effective Date' ToolTip='Date which from the record is valid.' VisibleIndex="4" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="40%" Visible="True" meta:resourcekey="EffectiveDate">
<EditFormSettings VisibleIndex="4" Visible="True"/>
<PropertiesDateEdit>
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Record Effective Date" is required.'/>
     </ValidationSettings>
     <Style Paddings-PaddingLeft="8px" BackgroundImage-HorizontalPosition="left" BackgroundImage-ImageUrl ="/images/generaluse/required.PNG" BackgroundImage-Repeat="NoRepeat" BackgroundImage-VerticalPosition="center">
</Style>
</PropertiesDateEdit>
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(TabMarketingZoneTables);

                 HandlerView('TabMarketingZoneTables_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/TabMarketingZoneTables.html" AllowResize="True"
