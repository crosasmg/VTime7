<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="TabUnderwritingCaseType.aspx.vb" Inherits="Maintenance_TabUnderwritingCaseType" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'TabUnderwritingCaseType_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TabUnderwritingCaseType_ViewItem.Text")%>');
           TabUnderwritingCaseType_View.SetClientVisible(true);
           MainMenu.GetItemByName('TabUnderwritingCaseType_ViewItem').SetVisible(false);
       TransUnderwritingCaseType_View.SetClientVisible(false);
  MainMenu.GetItemByName('TransUnderwritingCaseType_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(true);
     CurrentGrid = TabUnderwritingCaseType_Grid;
     CurrentGrid.PerformCallback('');
     break;
case 'TransUnderwritingCaseType_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TransUnderwritingCaseType_ViewItem.Text")%>');
           TransUnderwritingCaseType_View.SetClientVisible(true);
           MainMenu.GetItemByName('TransUnderwritingCaseType_ViewItem').SetVisible(false);
       TabUnderwritingCaseType_View.SetClientVisible(false);
  MainMenu.GetItemByName('TabUnderwritingCaseType_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(false);
     CurrentGrid = TransUnderwritingCaseType_Grid;
     CurrentGrid.PerformCallback('');
     break;
...
break;
                            ...
                            <Items>
                                ...
                                <dxm:MenuItem BeginGroup="True" Name="ViewItem" Text="View" DropDownMode="True" Image-Url="/images/16x16/Toolbar/view.png">
                                        <Items>
                                            <dxm:MenuItem Name="TabUnderwritingCaseType_ViewItem" Text="Standard" meta:resourcekey="TabUnderwritingCaseType_ViewItem"/>
<dxm:MenuItem Name="TransUnderwritingCaseType_ViewItem" Text="Translator" meta:resourcekey="TransUnderwritingCaseType_ViewItem"/>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="TabUnderwritingCaseType_View" ClientInstanceName="TabUnderwritingCaseType_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TabUnderwritingCaseType_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TabUnderwritingCaseType_Grid' ID='TabUnderwritingCaseType_Grid' runat='server' Width='100%' KeyFieldName='UNDERWRITINGCASETYPE' Caption='Types of underwriting case' Enabled="True" ClientVisible ="True" meta:resourcekey="TabUnderwritingCaseType_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataTextColumn Name='UnderwritingCaseType' FieldName='UNDERWRITINGCASETYPE' Caption='Underwriting Case Type' ToolTip='Underwriting Case Type' VisibleIndex="0" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="3%" Visible="True" meta:resourcekey="UnderwritingCaseType">
...
<dxp:ASPxPanel ID="TransUnderwritingCaseType_View" ClientInstanceName="TransUnderwritingCaseType_View" runat="server" ClientVisible="False" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TransUnderwritingCaseType_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TransUnderwritingCaseType_Grid' ID='TransUnderwritingCaseType_Grid' runat='server' Width='100%' KeyFieldName='UNDERWRITINGCASETYPE;LANGUAGEID' Caption='Types of underwriting case' Enabled="True" ClientVisible ="True" meta:resourcekey="TransUnderwritingCaseType_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
<SettingsPager PageSize="20"/>
<SettingsBehavior AllowFocusedRow="True"/>
<SettingsEditing Mode="Inline" />
<ClientSideEvents RowDblClick="function(s, e) {s.StartEditRow(e.visibleIndex);}" FocusedRowChanged="function(s, e) {MainMenu.GetItemByName('EditRegisterItem').SetEnabled(s.GetFocusedRowIndex()>-1);}" SelectionChanged="function(s, e) {MainMenu.GetItemByName('RemoveRegisterItem').SetEnabled(s.GetSelectedRowCount()>0);}" />
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(TabUnderwritingCaseType_Grid);
AddKeyboardNavigationTo(TransUnderwritingCaseType_Grid);

                 HandlerView('TabUnderwritingCaseType_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/TabUnderwritingCaseType.html" AllowResize="True"
