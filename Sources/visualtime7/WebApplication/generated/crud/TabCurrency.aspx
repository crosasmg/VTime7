<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="TabCurrency.aspx.vb" Inherits="Maintenance_TabCurrency" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'TabCurrency_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TabCurrency_ViewItem.Text")%>');
           TabCurrency_View.SetClientVisible(true);
           MainMenu.GetItemByName('TabCurrency_ViewItem').SetVisible(false);
       TransCurrency_View.SetClientVisible(false);
  MainMenu.GetItemByName('TransCurrency_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(true);
     CurrentGrid = TabCurrency_Grid;
     CurrentGrid.PerformCallback('');
     break;
case 'TransCurrency_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TransCurrency_ViewItem.Text")%>');
           TransCurrency_View.SetClientVisible(true);
           MainMenu.GetItemByName('TransCurrency_ViewItem').SetVisible(false);
       TabCurrency_View.SetClientVisible(false);
  MainMenu.GetItemByName('TabCurrency_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(false);
     CurrentGrid = TransCurrency_Grid;
     CurrentGrid.PerformCallback('');
     break;
...
break;
                            ...
                            <Items>
                                ...
                                <dxm:MenuItem BeginGroup="True" Name="ViewItem" Text="View" DropDownMode="True" Image-Url="/images/16x16/Toolbar/view.png">
                                        <Items>
                                            <dxm:MenuItem Name="TabCurrency_ViewItem" Text="Standard" meta:resourcekey="TabCurrency_ViewItem"/>
<dxm:MenuItem Name="TransCurrency_ViewItem" Text="Translator" meta:resourcekey="TransCurrency_ViewItem"/>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="TabCurrency_View" ClientInstanceName="TabCurrency_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TabCurrency_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TabCurrency_Grid' ID='TabCurrency_Grid' runat='server' Width='100%' KeyFieldName='CURRENCYCODE' Caption='Currencies' Enabled="True" ClientVisible ="True" meta:resourcekey="TabCurrency_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataTextColumn Name='CurrencyCode' FieldName='CURRENCYCODE' Caption='Currency Code' ToolTip='Code of the cuerrency.' VisibleIndex="0" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="3%" Visible="True" meta:resourcekey="CurrencyCode">
...
<PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="###,##0" Size='5'>
 <MaskSettings IncludeLiterals="DecimalSymbol" Mask=" <0..99999g>" />
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Currency Code" is required.'/>
     </ValidationSettings>
...
<dxp:ASPxPanel ID="TransCurrency_View" ClientInstanceName="TransCurrency_View" runat="server" ClientVisible="False" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TransCurrency_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TransCurrency_Grid' ID='TransCurrency_Grid' runat='server' Width='100%' KeyFieldName='CURRENCYCODE;LANGUAGEID' Caption='Currencies' Enabled="True" ClientVisible ="True" meta:resourcekey="TransCurrency_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
<SettingsPager PageSize="20"/>
<SettingsBehavior AllowFocusedRow="True"/>
<SettingsEditing Mode="Inline" />
<ClientSideEvents RowDblClick="function(s, e) {s.StartEditRow(e.visibleIndex);}" FocusedRowChanged="function(s, e) {MainMenu.GetItemByName('EditRegisterItem').SetEnabled(s.GetFocusedRowIndex()>-1);}" SelectionChanged="function(s, e) {MainMenu.GetItemByName('RemoveRegisterItem').SetEnabled(s.GetSelectedRowCount()>0);}" />
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(TabCurrency_Grid);
AddKeyboardNavigationTo(TransCurrency_Grid);

                 HandlerView('TabCurrency_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/TabCurrency.html" AllowResize="True"
