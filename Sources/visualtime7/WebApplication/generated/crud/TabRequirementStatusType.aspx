<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="TabRequirementStatusType.aspx.vb" Inherits="Maintenance_TabRequirementStatusType" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'TabRequirementStatusType_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TabRequirementStatusType_ViewItem.Text")%>');
           TabRequirementStatusType_View.SetClientVisible(true);
           MainMenu.GetItemByName('TabRequirementStatusType_ViewItem').SetVisible(false);
       TransRequirementStatusType_View.SetClientVisible(false);
  MainMenu.GetItemByName('TransRequirementStatusType_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(true);
     CurrentGrid = TabRequirementStatusType_Grid;
     CurrentGrid.PerformCallback('');
     break;
case 'TransRequirementStatusType_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TransRequirementStatusType_ViewItem.Text")%>');
           TransRequirementStatusType_View.SetClientVisible(true);
           MainMenu.GetItemByName('TransRequirementStatusType_ViewItem').SetVisible(false);
       TabRequirementStatusType_View.SetClientVisible(false);
  MainMenu.GetItemByName('TabRequirementStatusType_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(false);
     CurrentGrid = TransRequirementStatusType_Grid;
     CurrentGrid.PerformCallback('');
     break;
...
break;
                            ...
                            <Items>
                                ...
                                <dxm:MenuItem BeginGroup="True" Name="ViewItem" Text="View" DropDownMode="True" Image-Url="/images/16x16/Toolbar/view.png">
                                        <Items>
                                            <dxm:MenuItem Name="TabRequirementStatusType_ViewItem" Text="Standard" meta:resourcekey="TabRequirementStatusType_ViewItem"/>
<dxm:MenuItem Name="TransRequirementStatusType_ViewItem" Text="Translator" meta:resourcekey="TransRequirementStatusType_ViewItem"/>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="TabRequirementStatusType_View" ClientInstanceName="TabRequirementStatusType_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TabRequirementStatusType_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TabRequirementStatusType_Grid' ID='TabRequirementStatusType_Grid' runat='server' Width='100%' KeyFieldName='REQUIREMENTSTATUS' Caption='Requirement status' Enabled="True" ClientVisible ="True" meta:resourcekey="TabRequirementStatusType_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataTextColumn Name='RequirementStatus' FieldName='REQUIREMENTSTATUS' Caption='Requirement Status' ToolTip='Requirement Status.' VisibleIndex="0" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="3%" Visible="True" meta:resourcekey="RequirementStatus">
...
<PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="###,##0" Size='5'>
 <MaskSettings IncludeLiterals="DecimalSymbol" Mask=" <0..99999g>" />
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Requirement Status" is required.'/>
     </ValidationSettings>
...
<dxp:ASPxPanel ID="TransRequirementStatusType_View" ClientInstanceName="TransRequirementStatusType_View" runat="server" ClientVisible="False" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TransRequirementStatusType_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TransRequirementStatusType_Grid' ID='TransRequirementStatusType_Grid' runat='server' Width='100%' KeyFieldName='REQUIREMENTSTATUS;LANGUAGEID' Caption='Requirement status' Enabled="True" ClientVisible ="True" meta:resourcekey="TransRequirementStatusType_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
<SettingsPager PageSize="20"/>
<SettingsBehavior AllowFocusedRow="True"/>
<SettingsEditing Mode="Inline" />
<ClientSideEvents RowDblClick="function(s, e) {s.StartEditRow(e.visibleIndex);}" FocusedRowChanged="function(s, e) {MainMenu.GetItemByName('EditRegisterItem').SetEnabled(s.GetFocusedRowIndex()>-1);}" SelectionChanged="function(s, e) {MainMenu.GetItemByName('RemoveRegisterItem').SetEnabled(s.GetSelectedRowCount()>0);}" />
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(TabRequirementStatusType_Grid);
AddKeyboardNavigationTo(TransRequirementStatusType_Grid);

                 HandlerView('TabRequirementStatusType_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/TabRequirementStatusType.html" AllowResize="True"
