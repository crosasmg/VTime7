<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="TabGeographicZoneRelation.aspx.vb" Inherits="Maintenance_TabGeographicZoneRelation" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'TabGeographicZoneRelation_ViewItem':     
     
     
     CurrentGrid = TabGeographicZoneRelation;
     CurrentGrid.PerformCallback('');
     break;
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="TabGeographicZoneRelation_View" ClientInstanceName="TabGeographicZoneRelation_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TabGeographicZoneRelation_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TabGeographicZoneRelation' ID='TabGeographicZoneRelation' runat='server' Width='100%' KeyFieldName='COUNTRYID;GEOGRAPHICZONETABLEID;GEOGRAPHICZONELEVELID;GEOGRAPHICZONEID;GEOGRAPHICZONELEVELCHILDID;GEOGRAPHICZONECHILDID' Caption='Geographic Zone Relation' Enabled="True" ClientVisible ="True" meta:resourcekey="TabGeographicZoneRelationResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataTextColumn Name='GeographicZoneTableID' FieldName='GEOGRAPHICZONETABLEID' Caption='Geographic Zone Table ID' ToolTip='Number identifying the geographic zone table.' VisibleIndex="1" CellStyle-HorizontalAlign="Left" Width="100%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="GeographicZoneTableID">
...
<dxwgv:GridViewDataComboBoxColumn Name='GeographicZoneLevelChildID' FieldName='GEOGRAPHICZONELEVELCHILDID' Caption='Geographic Zone Level Child ID' ToolTip='Number identifying the zone (child).' VisibleIndex="4" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="0%" Visible="True" meta:resourcekey="GeographicZoneLevelChildID" >
<EditFormSettings VisibleIndex="4" Visible="True"/>
<PropertiesComboBox ValueType="System.Int32" IncrementalFilteringMode="StartsWith" EnableCallbackMode="false"  TextField='DESCRIPTION' ValueField='GEOGRAPHICZONELEVELID'> 
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Geographic Zone Level Child ID" is required.'/>
     </ValidationSettings>
     <Style Paddings-PaddingLeft="8px" BackgroundImage-HorizontalPosition="left" BackgroundImage-ImageUrl ="/images/generaluse/required.PNG" BackgroundImage-Repeat="NoRepeat" BackgroundImage-VerticalPosition="center">
</Style>
</PropertiesComboBox>
</dxwgv:GridViewDataComboBoxColumn>
<dxwgv:GridViewDataComboBoxColumn Name='GeographicZoneChildID' FieldName='GEOGRAPHICZONECHILDID' Caption='Geographic Level Child ID' ToolTip='Number identifying the geographic zone level (Child).' VisibleIndex="5" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="0%" Visible="True" meta:resourcekey="GeographicZoneChildID" >
<EditFormSettings VisibleIndex="5" Visible="True"/>
<PropertiesComboBox ValueType="System.String" IncrementalFilteringMode="StartsWith" EnableCallbackMode="false"  TextField='DESCRIPTION' ValueField='GEOGRAPHICZONEID'> 
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Geographic Level Child ID" is required.'/>
     </ValidationSettings>
     <Style Paddings-PaddingLeft="8px" BackgroundImage-HorizontalPosition="left" BackgroundImage-ImageUrl ="/images/generaluse/required.PNG" BackgroundImage-Repeat="NoRepeat" BackgroundImage-VerticalPosition="center">
</Style>
</PropertiesComboBox>
</dxwgv:GridViewDataComboBoxColumn>
<dxwgv:GridViewDataComboBoxColumn Name='RecordStatus' FieldName='RECORDSTATUS' Caption='Record Status' ToolTip='General status of the record.' VisibleIndex="6" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="0%" Visible="True" meta:resourcekey="RecordStatus" >
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(TabGeographicZoneRelation);

                 HandlerView('TabGeographicZoneRelation_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/TabGeographicZoneRelation.html" AllowResize="True"
