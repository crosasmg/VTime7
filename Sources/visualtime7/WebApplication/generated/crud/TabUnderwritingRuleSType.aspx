<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="TabUnderwritingRuleSType.aspx.vb" Inherits="Maintenance_TabUnderwritingRuleSType" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'TabUnderwritingRuleSType_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TabUnderwritingRuleSType_ViewItem.Text")%>');
           TabUnderwritingRuleSType_View.SetClientVisible(true);
           MainMenu.GetItemByName('TabUnderwritingRuleSType_ViewItem').SetVisible(false);
       TransUnderwritingRuleSType_View.SetClientVisible(false);
  MainMenu.GetItemByName('TransUnderwritingRuleSType_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(true);
     CurrentGrid = TabUnderwritingRuleSType_Grid;
     CurrentGrid.PerformCallback('');
     break;
case 'TransUnderwritingRuleSType_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TransUnderwritingRuleSType_ViewItem.Text")%>');
           TransUnderwritingRuleSType_View.SetClientVisible(true);
           MainMenu.GetItemByName('TransUnderwritingRuleSType_ViewItem').SetVisible(false);
       TabUnderwritingRuleSType_View.SetClientVisible(false);
  MainMenu.GetItemByName('TabUnderwritingRuleSType_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(false);
     CurrentGrid = TransUnderwritingRuleSType_Grid;
     CurrentGrid.PerformCallback('');
     break;
...
break;
                            ...
                            <Items>
                                ...
                                <dxm:MenuItem BeginGroup="True" Name="ViewItem" Text="View" DropDownMode="True" Image-Url="/images/16x16/Toolbar/view.png">
                                        <Items>
                                            <dxm:MenuItem Name="TabUnderwritingRuleSType_ViewItem" Text="Standard" meta:resourcekey="TabUnderwritingRuleSType_ViewItem"/>
<dxm:MenuItem Name="TransUnderwritingRuleSType_ViewItem" Text="Translator" meta:resourcekey="TransUnderwritingRuleSType_ViewItem"/>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="TabUnderwritingRuleSType_View" ClientInstanceName="TabUnderwritingRuleSType_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TabUnderwritingRuleSType_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TabUnderwritingRuleSType_Grid' ID='TabUnderwritingRuleSType_Grid' runat='server' Width='100%' KeyFieldName='UNDERWRITINGRULESTATUS' Caption='States of a Underwriting rule' Enabled="True" ClientVisible ="True" meta:resourcekey="TabUnderwritingRuleSType_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataTextColumn Name='UnderwritingRuleStatus' FieldName='UNDERWRITINGRULESTATUS' Caption='Underwriting Rule Status' ToolTip='Underwriting Rule Status.' VisibleIndex="0" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="3%" Visible="True" meta:resourcekey="UnderwritingRuleStatus">
...
<PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="###,##0" Size='5'>
 <MaskSettings IncludeLiterals="DecimalSymbol" Mask=" <0..99999g>" />
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Underwriting Rule Status" is required.'/>
     </ValidationSettings>
...
<dxp:ASPxPanel ID="TransUnderwritingRuleSType_View" ClientInstanceName="TransUnderwritingRuleSType_View" runat="server" ClientVisible="False" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TransUnderwritingRuleSType_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TransUnderwritingRuleSType_Grid' ID='TransUnderwritingRuleSType_Grid' runat='server' Width='100%' KeyFieldName='UNDERWRITINGRULESTATUS;LANGUAGEID' Caption='States of a Underwriting rule' Enabled="True" ClientVisible ="True" meta:resourcekey="TransUnderwritingRuleSType_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
<SettingsPager PageSize="20"/>
<SettingsBehavior AllowFocusedRow="True"/>
<SettingsEditing Mode="Inline" />
<ClientSideEvents RowDblClick="function(s, e) {s.StartEditRow(e.visibleIndex);}" FocusedRowChanged="function(s, e) {MainMenu.GetItemByName('EditRegisterItem').SetEnabled(s.GetFocusedRowIndex()>-1);}" SelectionChanged="function(s, e) {MainMenu.GetItemByName('RemoveRegisterItem').SetEnabled(s.GetSelectedRowCount()>0);}" />
...
<dxwgv:GridViewDataComboBoxColumn Name='LanguageId' FieldName='LANGUAGEID' Caption='Language Id' ToolTip='Language information.' VisibleIndex="2" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="16%" Visible="True" meta:resourcekey="LanguageId" >
<EditFormSettings VisibleIndex="2" Visible="True"/>
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(TabUnderwritingRuleSType_Grid);
AddKeyboardNavigationTo(TransUnderwritingRuleSType_Grid);

                 HandlerView('TabUnderwritingRuleSType_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/TabUnderwritingRuleSType.html" AllowResize="True"
