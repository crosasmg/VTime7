<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="EnumTypeOfRoute.aspx.vb" Inherits="Maintenance_EnumTypeOfRoute" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'EnumTypeOfRoute_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("EnumTypeOfRoute_ViewItem.Text")%>');
           EnumTypeOfRoute_View.SetClientVisible(true);
           MainMenu.GetItemByName('EnumTypeOfRoute_ViewItem').SetVisible(false);
       ETranTypeOfRoute_View.SetClientVisible(false);
  MainMenu.GetItemByName('ETranTypeOfRoute_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(true);
     CurrentGrid = EnumTypeOfRoute_Grid;
     CurrentGrid.PerformCallback('');
     break;
case 'ETranTypeOfRoute_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("ETranTypeOfRoute_ViewItem.Text")%>');
           ETranTypeOfRoute_View.SetClientVisible(true);
           MainMenu.GetItemByName('ETranTypeOfRoute_ViewItem').SetVisible(false);
       EnumTypeOfRoute_View.SetClientVisible(false);
  MainMenu.GetItemByName('EnumTypeOfRoute_ViewItem').SetVisible(true);
...
break;
                            ...
                            <Items>
                                ...
                                <dxm:MenuItem BeginGroup="True" Name="ViewItem" Text="View" DropDownMode="True" Image-Url="/images/16x16/Toolbar/view.png">
                                        <Items>
                                            <dxm:MenuItem Name="EnumTypeOfRoute_ViewItem" Text="Standard" meta:resourcekey="EnumTypeOfRoute_ViewItem"/>
<dxm:MenuItem Name="ETranTypeOfRoute_ViewItem" Text="Translator" meta:resourcekey="ETranTypeOfRoute_ViewItem"/>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="EnumTypeOfRoute_View" ClientInstanceName="EnumTypeOfRoute_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="EnumTypeOfRoute_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='EnumTypeOfRoute_Grid' ID='EnumTypeOfRoute_Grid' runat='server' Width='100%' KeyFieldName='TYPEOFROUTE' Caption='Type of routes of physical addresses' Enabled="True" ClientVisible ="True" meta:resourcekey="EnumTypeOfRoute_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataTextColumn Name='TypeOfRoute' FieldName='TYPEOFROUTE' Caption='Type of Route' ToolTip='Type of route.' VisibleIndex="0" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="11%" Visible="True" meta:resourcekey="TypeOfRoute">
...
<dxwgv:GridViewDataTextColumn Name='Description' FieldName='DESCRIPTION' Caption='Description' ToolTip='Description of the type of route.' VisibleIndex="2" CellStyle-HorizontalAlign="Left" Width="64%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="Description">
...
<dxwgv:GridViewDataTextColumn Name='ShortDescription' FieldName='SHORTDESCRIPTION' Caption='Short Description' ToolTip='Abbreviated description of the type of route.' VisibleIndex="3" CellStyle-HorizontalAlign="Left" Width="26%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="ShortDescription">
...
<dxp:ASPxPanel ID="ETranTypeOfRoute_View" ClientInstanceName="ETranTypeOfRoute_View" runat="server" ClientVisible="False" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="ETranTypeOfRoute_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='ETranTypeOfRoute' ID='ETranTypeOfRoute' runat='server' Width='100%' KeyFieldName='TYPEOFROUTE;LANGUAGEID' Caption='ET ran Type of Route' Enabled="True" ClientVisible ="True" meta:resourcekey="ETranTypeOfRouteResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
<SettingsPager PageSize="20"/>
<SettingsBehavior AllowFocusedRow="True"/>
<SettingsEditing Mode="Inline" />
<ClientSideEvents RowDblClick="function(s, e) {s.StartEditRow(e.visibleIndex);}" FocusedRowChanged="function(s, e) {MainMenu.GetItemByName('EditRegisterItem').SetEnabled(s.GetFocusedRowIndex()>-1);}" SelectionChanged="function(s, e) {MainMenu.GetItemByName('RemoveRegisterItem').SetEnabled(s.GetSelectedRowCount()>0);}" />
...
<dxwgv:GridViewDataTextColumn Name='Description' FieldName='DESCRIPTION' Caption='Description' ToolTip='Description of the type of route.' VisibleIndex="3" CellStyle-HorizontalAlign="Left" Width="64%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="Description">
<EditFormSettings VisibleIndex="3" Visible="True"/>
<PropertiesTextEdit Size='30' MaxLength='30'>
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Description" is required.'/>
...
<dxwgv:GridViewDataTextColumn Name='ShortDescription' FieldName='SHORTDESCRIPTION' Caption='Short Description' ToolTip='Abbreviated description of the type of route.' VisibleIndex="4" CellStyle-HorizontalAlign="Left" Width="26%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="ShortDescription">
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(EnumTypeOfRoute_Grid);
AddKeyboardNavigationTo(ETranTypeOfRoute);

                 HandlerView('EnumTypeOfRoute_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/EnumTypeOfRoute.html" AllowResize="True"
