<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="EnumPhoneType.aspx.vb" Inherits="Maintenance_EnumPhoneType" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'EnumPhoneType_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("EnumPhoneType_ViewItem.Text")%>');
           EnumPhoneType_View.SetClientVisible(true);
           MainMenu.GetItemByName('EnumPhoneType_ViewItem').SetVisible(false);
       ETranPhoneType_View.SetClientVisible(false);
  MainMenu.GetItemByName('ETranPhoneType_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(true);
     CurrentGrid = EnumPhoneType_Grid;
     CurrentGrid.PerformCallback('');
     break;
case 'ETranPhoneType_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("ETranPhoneType_ViewItem.Text")%>');
           ETranPhoneType_View.SetClientVisible(true);
           MainMenu.GetItemByName('ETranPhoneType_ViewItem').SetVisible(false);
       EnumPhoneType_View.SetClientVisible(false);
  MainMenu.GetItemByName('EnumPhoneType_ViewItem').SetVisible(true);
...
break;
                            ...
                            <Items>
                                ...
                                <dxm:MenuItem BeginGroup="True" Name="ViewItem" Text="View" DropDownMode="True" Image-Url="/images/16x16/Toolbar/view.png">
                                        <Items>
                                            <dxm:MenuItem Name="EnumPhoneType_ViewItem" Text="Standard" meta:resourcekey="EnumPhoneType_ViewItem"/>
<dxm:MenuItem Name="ETranPhoneType_ViewItem" Text="Translator" meta:resourcekey="ETranPhoneType_ViewItem"/>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="EnumPhoneType_View" ClientInstanceName="EnumPhoneType_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="EnumPhoneType_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='EnumPhoneType_Grid' ID='EnumPhoneType_Grid' runat='server' Width='100%' KeyFieldName='PHONETYPE' Caption='Type of phone' Enabled="True" ClientVisible ="True" meta:resourcekey="EnumPhoneType_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataTextColumn Name='PhoneType' FieldName='PHONETYPE' Caption='Phone Type' ToolTip='Phone type.' VisibleIndex="0" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="11%" Visible="True" meta:resourcekey="PhoneType">
...
<PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="###,##0" Size='5'>
 <MaskSettings IncludeLiterals="DecimalSymbol" Mask=" <0..99999g>" />
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Phone Type" is required.'/>
     </ValidationSettings>
...
<dxp:ASPxPanel ID="ETranPhoneType_View" ClientInstanceName="ETranPhoneType_View" runat="server" ClientVisible="False" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="ETranPhoneType_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='ETranPhoneType' ID='ETranPhoneType' runat='server' Width='100%' KeyFieldName='PHONETYPE;LANGUAGEID' Caption='ET ran Phone Type' Enabled="True" ClientVisible ="True" meta:resourcekey="ETranPhoneTypeResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
<SettingsPager PageSize="20"/>
<SettingsBehavior AllowFocusedRow="True"/>
<SettingsEditing Mode="Inline" />
<ClientSideEvents RowDblClick="function(s, e) {s.StartEditRow(e.visibleIndex);}" FocusedRowChanged="function(s, e) {MainMenu.GetItemByName('EditRegisterItem').SetEnabled(s.GetFocusedRowIndex()>-1);}" SelectionChanged="function(s, e) {MainMenu.GetItemByName('RemoveRegisterItem').SetEnabled(s.GetSelectedRowCount()>0);}" />
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(EnumPhoneType_Grid);
AddKeyboardNavigationTo(ETranPhoneType);

                 HandlerView('EnumPhoneType_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/EnumPhoneType.html" AllowResize="True"
