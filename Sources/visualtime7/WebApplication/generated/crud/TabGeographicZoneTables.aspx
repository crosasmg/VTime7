<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="TabGeographicZoneTables.aspx.vb" Inherits="Maintenance_TabGeographicZoneTables" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'TabGeographicZoneTables_ViewItem':     
     
     
     CurrentGrid = TabGeographicZoneTables;
     CurrentGrid.PerformCallback('');
     break;
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="TabGeographicZoneTables_View" ClientInstanceName="TabGeographicZoneTables_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TabGeographicZoneTables_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TabGeographicZoneTables' ID='TabGeographicZoneTables' runat='server' Width='100%' KeyFieldName='COUNTRYID;GEOGRAPHICZONETABLEID' Caption='Geographic Zone Tables' Enabled="True" ClientVisible ="True" meta:resourcekey="TabGeographicZoneTablesResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataTextColumn Name='GeographicZoneTableID' FieldName='GEOGRAPHICZONETABLEID' Caption='Geographic Zone Table ID' ToolTip='Number identifying the geographic zone table.' VisibleIndex="1" CellStyle-HorizontalAlign="Left" Width="50%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="GeographicZoneTableID">
...
<dxwgv:GridViewDataDateColumn Name='EffectiveDate' FieldName='EFFECTIVEDATE' Caption='Effective Date' ToolTip='Date which from the record is valid.' VisibleIndex="3" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="25%" Visible="True" meta:resourcekey="EffectiveDate">
<EditFormSettings VisibleIndex="3" Visible="True"/>
<PropertiesDateEdit>
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Effective Date" is required.'/>
     </ValidationSettings>
     <Style Paddings-PaddingLeft="8px" BackgroundImage-HorizontalPosition="left" BackgroundImage-ImageUrl ="/images/generaluse/required.PNG" BackgroundImage-Repeat="NoRepeat" BackgroundImage-VerticalPosition="center">
</Style>
</PropertiesDateEdit>
</dxwgv:GridViewDataDateColumn>
<dxwgv:GridViewDataDateColumn Name='CancellationDate' FieldName='CANCELLATIONDATE' Caption='Cancellation Date' ToolTip='Date when the record is cancelled.' VisibleIndex="4" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="25%" Visible="True" meta:resourcekey="CancellationDate">
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(TabGeographicZoneTables);

                 HandlerView('TabGeographicZoneTables_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/TabGeographicZoneTables.html" AllowResize="True"
