<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="TabGeographicZoneNames.aspx.vb" Inherits="Maintenance_TabGeographicZoneNames" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'TabGeographicZoneNames_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TabGeographicZoneNames_ViewItem.Text")%>');
           TabGeographicZoneNames_View.SetClientVisible(true);
           MainMenu.GetItemByName('TabGeographicZoneNames_ViewItem').SetVisible(false);
       TransGeographicZoneNames_View.SetClientVisible(false);
  MainMenu.GetItemByName('TransGeographicZoneNames_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(true);
     CurrentGrid = TabGeographicZoneNames_Grid;
     CurrentGrid.PerformCallback('');
     break;
case 'TransGeographicZoneNames_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TransGeographicZoneNames_ViewItem.Text")%>');
           TransGeographicZoneNames_View.SetClientVisible(true);
           MainMenu.GetItemByName('TransGeographicZoneNames_ViewItem').SetVisible(false);
       TabGeographicZoneNames_View.SetClientVisible(false);
  MainMenu.GetItemByName('TabGeographicZoneNames_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(false);
     CurrentGrid = TransGeographicZoneNames;
     CurrentGrid.PerformCallback('');
     break;
...
break;
                            ...
                            <Items>
                                ...
                                <dxm:MenuItem BeginGroup="True" Name="ViewItem" Text="View" DropDownMode="True" Image-Url="/images/16x16/Toolbar/view.png">
                                        <Items>
                                            <dxm:MenuItem Name="TabGeographicZoneNames_ViewItem" Text="Standard" meta:resourcekey="TabGeographicZoneNames_ViewItem"/>
<dxm:MenuItem Name="TransGeographicZoneNames_ViewItem" Text="Translator" meta:resourcekey="TransGeographicZoneNames_ViewItem"/>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="TabGeographicZoneNames_View" ClientInstanceName="TabGeographicZoneNames_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TabGeographicZoneNames_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TabGeographicZoneNames_Grid' ID='TabGeographicZoneNames_Grid' runat='server' Width='100%' KeyFieldName='COUNTRYID;GEOGRAPHICZONELEVELID' Caption='Geographic areas for the country.' Enabled="True" ClientVisible ="True" meta:resourcekey="TabGeographicZoneNames_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataTextColumn Name='GeographicZoneLevelID' FieldName='GEOGRAPHICZONELEVELID' Caption='Geographic Zone Level ID' ToolTip='Number identifying the zone.' VisibleIndex="1" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="11%" Visible="True" meta:resourcekey="GeographicZoneLevelID">
...
<dxwgv:GridViewDataTextColumn Name='Description' FieldName='DESCRIPTION' Caption='Description' ToolTip='Description of the geographic zone.' VisibleIndex="3" CellStyle-HorizontalAlign="Left" Width="64%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="Description">
...
<dxwgv:GridViewDataTextColumn Name='ShortDescription' FieldName='SHORTDESCRIPTION' Caption='Short Description' ToolTip='Abbreviated description of the geographic zone.' VisibleIndex="4" CellStyle-HorizontalAlign="Left" Width="26%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="ShortDescription">
...
<dxp:ASPxPanel ID="TransGeographicZoneNames_View" ClientInstanceName="TransGeographicZoneNames_View" runat="server" ClientVisible="False" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TransGeographicZoneNames_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TransGeographicZoneNames' ID='TransGeographicZoneNames' runat='server' Width='100%' KeyFieldName='COUNTRYID;GEOGRAPHICZONELEVELID;LANGUAGEID' Caption='Trans Geographic Zone Names' Enabled="True" ClientVisible ="True" meta:resourcekey="TransGeographicZoneNamesResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
<SettingsPager PageSize="20"/>
<SettingsBehavior AllowFocusedRow="True"/>
<SettingsEditing Mode="Inline" />
<ClientSideEvents RowDblClick="function(s, e) {s.StartEditRow(e.visibleIndex);}" FocusedRowChanged="function(s, e) {MainMenu.GetItemByName('EditRegisterItem').SetEnabled(s.GetFocusedRowIndex()>-1);}" SelectionChanged="function(s, e) {MainMenu.GetItemByName('RemoveRegisterItem').SetEnabled(s.GetSelectedRowCount()>0);}" />
...
<dxwgv:GridViewDataTextColumn Name='Description' FieldName='DESCRIPTION' Caption='Description' ToolTip='Description of the geographic zone.' VisibleIndex="4" CellStyle-HorizontalAlign="Left" Width="64%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="Description">
<EditFormSettings VisibleIndex="4" Visible="True"/>
<PropertiesTextEdit Size='30' MaxLength='30'>
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Description" is required.'/>
...
<dxwgv:GridViewDataTextColumn Name='ShortDescription' FieldName='SHORTDESCRIPTION' Caption='Short Description' ToolTip='Abbreviated description of the geographic zone.' VisibleIndex="5" CellStyle-HorizontalAlign="Left" Width="26%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="ShortDescription">
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(TabGeographicZoneNames_Grid);
AddKeyboardNavigationTo(TransGeographicZoneNames);

                 HandlerView('TabGeographicZoneNames_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/TabGeographicZoneNames.html" AllowResize="True"
