<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="TabQuestionsFromRequirement.aspx.vb" Inherits="Maintenance_TabQuestionsFromRequirement" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'TabQuestionsFromRequirement_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TabQuestionsFromRequirement_ViewItem.Text")%>');
           TabQuestionsFromRequirement_View.SetClientVisible(true);
           MainMenu.GetItemByName('TabQuestionsFromRequirement_ViewItem').SetVisible(false);
       TransQuestionsFromRequirement_View.SetClientVisible(false);
  MainMenu.GetItemByName('TransQuestionsFromRequirement_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(true);
     CurrentGrid = TabQuestionsFromRequirement_Grid;
     CurrentGrid.PerformCallback('');
     break;
case 'TransQuestionsFromRequirement_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TransQuestionsFromRequirement_ViewItem.Text")%>');
           TransQuestionsFromRequirement_View.SetClientVisible(true);
           MainMenu.GetItemByName('TransQuestionsFromRequirement_ViewItem').SetVisible(false);
       TabQuestionsFromRequirement_View.SetClientVisible(false);
  MainMenu.GetItemByName('TabQuestionsFromRequirement_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(false);
     CurrentGrid = TransQuestionsFromRequirement_Grid;
     CurrentGrid.PerformCallback('');
     break;
...
break;
                            ...
                            <Items>
                                ...
                                <dxm:MenuItem BeginGroup="True" Name="ViewItem" Text="View" DropDownMode="True" Image-Url="/images/16x16/Toolbar/view.png">
                                        <Items>
                                            <dxm:MenuItem Name="TabQuestionsFromRequirement_ViewItem" Text="Standard" meta:resourcekey="TabQuestionsFromRequirement_ViewItem"/>
<dxm:MenuItem Name="TransQuestionsFromRequirement_ViewItem" Text="Translator" meta:resourcekey="TransQuestionsFromRequirement_ViewItem"/>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="TabQuestionsFromRequirement_View" ClientInstanceName="TabQuestionsFromRequirement_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TabQuestionsFromRequirement_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TabQuestionsFromRequirement_Grid' ID='TabQuestionsFromRequirement_Grid' runat='server' Width='100%' KeyFieldName='QUESTIONID' Caption='Questions in the questionnaires' Enabled="True" ClientVisible ="True" meta:resourcekey="TabQuestionsFromRequirement_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataTextColumn Name='QuestionId' FieldName='QUESTIONID' Caption='Question Id' ToolTip='Question Id.' VisibleIndex="0" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="2%" Visible="True" meta:resourcekey="QuestionId">
...
<PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="###,##0" Size='5'>
 <MaskSettings IncludeLiterals="DecimalSymbol" Mask=" <0..99999g>" />
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Question Id" is required.'/>
     </ValidationSettings>
...
<dxwgv:GridViewDataTextColumn Name='RequirementType' FieldName='REQUIREMENTTYPE' Caption='Requirement Type' ToolTip='Requirement Type.' VisibleIndex="1" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="2%" Visible="True" meta:resourcekey="RequirementType">
...
<dxwgv:GridViewDataTextColumn Name='RecordStatus' FieldName='RECORDSTATUS' Caption='Record Status' ToolTip='Status of the record.' VisibleIndex="2" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="0%" Visible="True" meta:resourcekey="RecordStatus">
...
<dxwgv:GridViewDataTextColumn Name='Description' FieldName='DESCRIPTION' Caption='Description' ToolTip='Description associated with the code.' VisibleIndex="3" CellStyle-HorizontalAlign="Left" Width="78%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="Description">
...
<dxp:ASPxPanel ID="TransQuestionsFromRequirement_View" ClientInstanceName="TransQuestionsFromRequirement_View" runat="server" ClientVisible="False" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TransQuestionsFromRequirement_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TransQuestionsFromRequirement_Grid' ID='TransQuestionsFromRequirement_Grid' runat='server' Width='100%' KeyFieldName='QUESTIONID;LANGUAGEID' Caption='Questions in the questionnaires' Enabled="True" ClientVisible ="True" meta:resourcekey="TransQuestionsFromRequirement_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
<SettingsPager PageSize="20"/>
<SettingsBehavior AllowFocusedRow="True"/>
<SettingsEditing Mode="Inline" />
<ClientSideEvents RowDblClick="function(s, e) {s.StartEditRow(e.visibleIndex);}" FocusedRowChanged="function(s, e) {MainMenu.GetItemByName('EditRegisterItem').SetEnabled(s.GetFocusedRowIndex()>-1);}" SelectionChanged="function(s, e) {MainMenu.GetItemByName('RemoveRegisterItem').SetEnabled(s.GetSelectedRowCount()>0);}" />
<Columns>
<dxwgv:GridViewDataTextColumn Name='QuestionId' FieldName='QUESTIONID' Caption='Question Id' ToolTip='Question Id.' VisibleIndex="0" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="1%" Visible="True" meta:resourcekey="QuestionId">
<EditFormSettings VisibleIndex="0" Visible="True"/>
<PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="###,##0" Size='5'>
 <MaskSettings IncludeLiterals="DecimalSymbol" Mask=" <0..99999g>" />
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
...
<dxwgv:GridViewDataTextColumn Name='RequirementType' FieldName='REQUIREMENTTYPE' Caption='Requirement Type' ToolTip='Requirement Type.' VisibleIndex="1" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="1%" Visible="True" meta:resourcekey="RequirementType">
<EditFormSettings VisibleIndex="1" Visible="True"/>
<PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="###,##0" Size='5'>
 <MaskSettings IncludeLiterals="DecimalSymbol" Mask=" <0..99999g>" />
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
...
<dxwgv:GridViewDataComboBoxColumn Name='LanguageId' FieldName='LANGUAGEID' Caption='Language Id' ToolTip='Language information.' VisibleIndex="3" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="8%" Visible="True" meta:resourcekey="LanguageId" >
<EditFormSettings VisibleIndex="3" Visible="True"/>
...
<dxwgv:GridViewDataTextColumn Name='Description' FieldName='DESCRIPTION' Caption='Description' ToolTip='Description associated with the code.' VisibleIndex="4" CellStyle-HorizontalAlign="Left" Width="72%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="Description">
<EditFormSettings VisibleIndex="4" Visible="True"/>
<PropertiesTextEdit Size='255' MaxLength='255'>
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Description" is required.'/>
...
<dxwgv:GridViewDataTextColumn Name='ShortDescription' FieldName='SHORTDESCRIPTION' Caption='Short Description' ToolTip='Brief description associated with the code.' VisibleIndex="5" CellStyle-HorizontalAlign="Left" Width="17%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="ShortDescription">
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(TabQuestionsFromRequirement_Grid);
AddKeyboardNavigationTo(TransQuestionsFromRequirement_Grid);

                 HandlerView('TabQuestionsFromRequirement_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/TabQuestionsFromRequirement.html" AllowResize="True"
