<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="TabRiskClassType.aspx.vb" Inherits="Maintenance_TabRiskClassType" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'TabRiskClassType_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TabRiskClassType_ViewItem.Text")%>');
           TabRiskClassType_View.SetClientVisible(true);
           MainMenu.GetItemByName('TabRiskClassType_ViewItem').SetVisible(false);
       TransRiskClassType_View.SetClientVisible(false);
  MainMenu.GetItemByName('TransRiskClassType_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(true);
     CurrentGrid = TabRiskClassType_Grid;
     CurrentGrid.PerformCallback('');
     break;
case 'TransRiskClassType_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TransRiskClassType_ViewItem.Text")%>');
           TransRiskClassType_View.SetClientVisible(true);
           MainMenu.GetItemByName('TransRiskClassType_ViewItem').SetVisible(false);
       TabRiskClassType_View.SetClientVisible(false);
  MainMenu.GetItemByName('TabRiskClassType_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(false);
     CurrentGrid = TransRiskClassType_Grid;
     CurrentGrid.PerformCallback('');
     break;
...
break;
                            ...
                            <Items>
                                ...
                                <dxm:MenuItem BeginGroup="True" Name="ViewItem" Text="View" DropDownMode="True" Image-Url="/images/16x16/Toolbar/view.png">
                                        <Items>
                                            <dxm:MenuItem Name="TabRiskClassType_ViewItem" Text="Standard" meta:resourcekey="TabRiskClassType_ViewItem"/>
<dxm:MenuItem Name="TransRiskClassType_ViewItem" Text="Translator" meta:resourcekey="TransRiskClassType_ViewItem"/>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="TabRiskClassType_View" ClientInstanceName="TabRiskClassType_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TabRiskClassType_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TabRiskClassType_Grid' ID='TabRiskClassType_Grid' runat='server' Width='100%' KeyFieldName='RISKCLASS' Caption='Risk category' Enabled="True" ClientVisible ="True" meta:resourcekey="TabRiskClassType_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataTextColumn Name='RiskClass' FieldName='RISKCLASS' Caption='Risk Classification' ToolTip='Risk Classification.' VisibleIndex="0" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="3%" Visible="True" meta:resourcekey="RiskClass">
...
<PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="###,##0" Size='5'>
 <MaskSettings IncludeLiterals="DecimalSymbol" Mask=" <0..99999g>" />
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Risk Classification" is required.'/>
     </ValidationSettings>
...
<dxp:ASPxPanel ID="TransRiskClassType_View" ClientInstanceName="TransRiskClassType_View" runat="server" ClientVisible="False" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TransRiskClassType_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TransRiskClassType_Grid' ID='TransRiskClassType_Grid' runat='server' Width='100%' KeyFieldName='RISKCLASS;LANGUAGEID' Caption='Risk category' Enabled="True" ClientVisible ="True" meta:resourcekey="TransRiskClassType_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
<SettingsPager PageSize="20"/>
<SettingsBehavior AllowFocusedRow="True"/>
<SettingsEditing Mode="Inline" />
<ClientSideEvents RowDblClick="function(s, e) {s.StartEditRow(e.visibleIndex);}" FocusedRowChanged="function(s, e) {MainMenu.GetItemByName('EditRegisterItem').SetEnabled(s.GetFocusedRowIndex()>-1);}" SelectionChanged="function(s, e) {MainMenu.GetItemByName('RemoveRegisterItem').SetEnabled(s.GetSelectedRowCount()>0);}" />
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(TabRiskClassType_Grid);
AddKeyboardNavigationTo(TransRiskClassType_Grid);

                 HandlerView('TabRiskClassType_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/TabRiskClassType.html" AllowResize="True"
