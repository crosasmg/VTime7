<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="TabMarketingZoneRelation.aspx.vb" Inherits="Maintenance_TabMarketingZoneRelation" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'TabMarketingZoneRelation_ViewItem':     
     
     
     CurrentGrid = TabMarketingZoneRelation;
     CurrentGrid.PerformCallback('');
     break;
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="TabMarketingZoneRelation_View" ClientInstanceName="TabMarketingZoneRelation_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TabMarketingZoneRelation_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TabMarketingZoneRelation' ID='TabMarketingZoneRelation' runat='server' Width='100%' KeyFieldName='COMPANYID;MARKETINGZONETABLEID;COUNTRYID;MARKETINGZONELEVELID;MARKETINGZONEID;CONSECUTIVE' Caption='Detail of marketing Zone' Enabled="True" ClientVisible ="True" meta:resourcekey="TabMarketingZoneRelationResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<ClientSideEvents SelectedIndexChanged="function(s, e) {TabMarketingZoneRelation.GetEditor('MarketingZoneID').PerformCallback(s.GetValue().toString()); TabMarketingZoneRelation.GetEditor('ZipCode').PerformCallback(s.GetValue().toString()); }"/> 
</PropertiesComboBox>
</dxwgv:GridViewDataComboBoxColumn>
<dxwgv:GridViewDataTextColumn Name='MarketingZoneLevelID' FieldName='MARKETINGZONELEVELID' Caption='Marketing Zone Level ID' ToolTip='Number identifying the marketing zone.' VisibleIndex="3" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="10%" Visible="True" meta:resourcekey="MarketingZoneLevelID">
...
<dxwgv:GridViewDataComboBoxColumn Name='MarketingZoneID' FieldName='MARKETINGZONEID' Caption='Marketing Zone ID' ToolTip='Number identifying the zone.' VisibleIndex="4" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="0%" Visible="True" meta:resourcekey="MarketingZoneID" >
<EditFormSettings VisibleIndex="4" Visible="True"/>
<PropertiesComboBox ValueType="System.String" IncrementalFilteringMode="StartsWith" EnableCallbackMode="false"  TextField='DESCRIPTION' ValueField='MARKETINGZONEID'> 
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
...
<dxwgv:GridViewDataTextColumn Name='Consecutive' FieldName='CONSECUTIVE' Caption='Consecutive' ToolTip='Unique number to identify the record.' VisibleIndex="5" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="10%" Visible="True" meta:resourcekey="Consecutive">
<EditFormSettings VisibleIndex="5" Visible="True"/>
<PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="###,##0" Size='5'>
 <MaskSettings IncludeLiterals="DecimalSymbol" Mask=" <0..99999g>" />
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Consecutive" is required.'/>
     </ValidationSettings>
     <Style Paddings-PaddingLeft="8px" BackgroundImage-HorizontalPosition="left" BackgroundImage-ImageUrl ="/images/generaluse/required.PNG" BackgroundImage-Repeat="NoRepeat" BackgroundImage-VerticalPosition="center">
</Style>
</PropertiesTextEdit>
</dxwgv:GridViewDataTextColumn>
<dxwgv:GridViewDataComboBoxColumn Name='ZipCode' FieldName='ZIPCODE' Caption='Zip Code' ToolTip='Zip code.' VisibleIndex="6" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="20%" Visible="True" meta:resourcekey="ZipCode" >
...
<dxwgv:GridViewDataComboBoxColumn Name='RecordStatus' FieldName='RECORDSTATUS' Caption='Record Status' ToolTip='General status of the record.' VisibleIndex="7" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="0%" Visible="True" meta:resourcekey="RecordStatus" >
...
<dxwgv:GridViewDataTextColumn Name='GeographicZoneTableID' FieldName='GEOGRAPHICZONETABLEID' Caption='Geographic Zone Table ID' ToolTip='Number identifying the geographic zone table.' VisibleIndex="8" CellStyle-HorizontalAlign="Left" Width="40%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="GeographicZoneTableID">
<EditFormSettings VisibleIndex="8" Visible="True"/>
<PropertiesTextEdit Size='20' MaxLength='20'>
</PropertiesTextEdit>
</dxwgv:GridViewDataTextColumn>
<dxwgv:GridViewDataTextColumn Name='GeographicZoneLevelID' FieldName='GEOGRAPHICZONELEVELID' Caption='Geographic Zone Level ID' ToolTip='Number identifying the zone.' VisibleIndex="9" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="10%" Visible="True" meta:resourcekey="GeographicZoneLevelID">
<EditFormSettings VisibleIndex="9" Visible="True"/>
<PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="###,##0" Size='5'>
 <MaskSettings IncludeLiterals="DecimalSymbol" Mask=" <0..99999g>" />
</PropertiesTextEdit>
</dxwgv:GridViewDataTextColumn>
<dxwgv:GridViewDataComboBoxColumn Name='GeographicZoneID' FieldName='GEOGRAPHICZONEID' Caption='Geographic Level ID' ToolTip='Number identifying the geographic zone level.' VisibleIndex="10" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="0%" Visible="True" meta:resourcekey="GeographicZoneID" >
<EditFormSettings VisibleIndex="10" Visible="True"/>
<PropertiesComboBox ValueType="System.String" IncrementalFilteringMode="StartsWith" EnableCallbackMode="false"  TextField='DESCRIPTION' ValueField='GEOGRAPHICZONEID'> 
</PropertiesComboBox>
</dxwgv:GridViewDataComboBoxColumn>
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(TabMarketingZoneRelation);

                 HandlerView('TabMarketingZoneRelation_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/TabMarketingZoneRelation.html" AllowResize="True"
