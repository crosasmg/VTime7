<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="EnumTypeOfPhysicalAddress.aspx.vb" Inherits="Maintenance_EnumTypeOfPhysicalAddress" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'EnumTypeOfPhysicalAddress_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("EnumTypeOfPhysicalAddress_ViewItem.Text")%>');
           EnumTypeOfPhysicalAddress_View.SetClientVisible(true);
           MainMenu.GetItemByName('EnumTypeOfPhysicalAddress_ViewItem').SetVisible(false);
       ETranTypeOfPhysicalAddress_View.SetClientVisible(false);
  MainMenu.GetItemByName('ETranTypeOfPhysicalAddress_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(true);
     CurrentGrid = EnumTypeOfPhysicalAddress_Grid;
     CurrentGrid.PerformCallback('');
     break;
case 'ETranTypeOfPhysicalAddress_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("ETranTypeOfPhysicalAddress_ViewItem.Text")%>');
           ETranTypeOfPhysicalAddress_View.SetClientVisible(true);
           MainMenu.GetItemByName('ETranTypeOfPhysicalAddress_ViewItem').SetVisible(false);
       EnumTypeOfPhysicalAddress_View.SetClientVisible(false);
  MainMenu.GetItemByName('EnumTypeOfPhysicalAddress_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(false);
     CurrentGrid = ETranTypeOfPhysicalAddress;
     CurrentGrid.PerformCallback('');
     break;
...
break;
                            ...
                            <Items>
                                ...
                                <dxm:MenuItem BeginGroup="True" Name="ViewItem" Text="View" DropDownMode="True" Image-Url="/images/16x16/Toolbar/view.png">
                                        <Items>
                                            <dxm:MenuItem Name="EnumTypeOfPhysicalAddress_ViewItem" Text="Standard" meta:resourcekey="EnumTypeOfPhysicalAddress_ViewItem"/>
<dxm:MenuItem Name="ETranTypeOfPhysicalAddress_ViewItem" Text="Translator" meta:resourcekey="ETranTypeOfPhysicalAddress_ViewItem"/>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="EnumTypeOfPhysicalAddress_View" ClientInstanceName="EnumTypeOfPhysicalAddress_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="EnumTypeOfPhysicalAddress_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='EnumTypeOfPhysicalAddress_Grid' ID='EnumTypeOfPhysicalAddress_Grid' runat='server' Width='100%' KeyFieldName='TYPEOFPHYSICALADDRESS' Caption='Type of physical addresses.' Enabled="True" ClientVisible ="True" meta:resourcekey="EnumTypeOfPhysicalAddress_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataTextColumn Name='TypeOfPhysicalAddress' FieldName='TYPEOFPHYSICALADDRESS' Caption='Type of Physical Address' ToolTip='Type of physical address.' VisibleIndex="0" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="11%" Visible="True" meta:resourcekey="TypeOfPhysicalAddress">
...
<PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="###,##0" Size='5'>
 <MaskSettings IncludeLiterals="DecimalSymbol" Mask=" <0..99999g>" />
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Type of Physical Address" is required.'/>
     </ValidationSettings>
...
<dxwgv:GridViewDataTextColumn Name='Description' FieldName='DESCRIPTION' Caption='Description' ToolTip='Description of the type of address.' VisibleIndex="2" CellStyle-HorizontalAlign="Left" Width="64%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="Description">
...
<dxwgv:GridViewDataTextColumn Name='ShortDescription' FieldName='SHORTDESCRIPTION' Caption='Short Description' ToolTip='Abbreviated description of the type of address.' VisibleIndex="3" CellStyle-HorizontalAlign="Left" Width="26%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="ShortDescription">
...
<dxp:ASPxPanel ID="ETranTypeOfPhysicalAddress_View" ClientInstanceName="ETranTypeOfPhysicalAddress_View" runat="server" ClientVisible="False" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="ETranTypeOfPhysicalAddress_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='ETranTypeOfPhysicalAddress' ID='ETranTypeOfPhysicalAddress' runat='server' Width='100%' KeyFieldName='TYPEOFPHYSICALADDRESS;LANGUAGEID' Caption='ET ran Type of Physical Address' Enabled="True" ClientVisible ="True" meta:resourcekey="ETranTypeOfPhysicalAddressResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
<SettingsPager PageSize="20"/>
<SettingsBehavior AllowFocusedRow="True"/>
<SettingsEditing Mode="Inline" />
<ClientSideEvents RowDblClick="function(s, e) {s.StartEditRow(e.visibleIndex);}" FocusedRowChanged="function(s, e) {MainMenu.GetItemByName('EditRegisterItem').SetEnabled(s.GetFocusedRowIndex()>-1);}" SelectionChanged="function(s, e) {MainMenu.GetItemByName('RemoveRegisterItem').SetEnabled(s.GetSelectedRowCount()>0);}" />
...
<dxwgv:GridViewDataTextColumn Name='Description' FieldName='DESCRIPTION' Caption='Description' ToolTip='Description of the type of address.' VisibleIndex="3" CellStyle-HorizontalAlign="Left" Width="64%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="Description">
<EditFormSettings VisibleIndex="3" Visible="True"/>
<PropertiesTextEdit Size='30' MaxLength='30'>
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Description" is required.'/>
...
<dxwgv:GridViewDataTextColumn Name='ShortDescription' FieldName='SHORTDESCRIPTION' Caption='Short Description' ToolTip='Abbreviated description of the type of address.' VisibleIndex="4" CellStyle-HorizontalAlign="Left" Width="26%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="ShortDescription">
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(EnumTypeOfPhysicalAddress_Grid);
AddKeyboardNavigationTo(ETranTypeOfPhysicalAddress);

                 HandlerView('EnumTypeOfPhysicalAddress_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/EnumTypeOfPhysicalAddress.html" AllowResize="True"
