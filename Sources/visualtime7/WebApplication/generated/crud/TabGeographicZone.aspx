<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="TabGeographicZone.aspx.vb" Inherits="Maintenance_TabGeographicZone" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'TabGeographicZone_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TabGeographicZone_ViewItem.Text")%>');
           TabGeographicZone_View.SetClientVisible(true);
           MainMenu.GetItemByName('TabGeographicZone_ViewItem').SetVisible(false);
       TransGeographicZone_View.SetClientVisible(false);
  MainMenu.GetItemByName('TransGeographicZone_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(true);
     CurrentGrid = TabGeographicZone_Grid;
     CurrentGrid.PerformCallback('');
     break;
case 'TransGeographicZone_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TransGeographicZone_ViewItem.Text")%>');
           TransGeographicZone_View.SetClientVisible(true);
           MainMenu.GetItemByName('TransGeographicZone_ViewItem').SetVisible(false);
       TabGeographicZone_View.SetClientVisible(false);
  MainMenu.GetItemByName('TabGeographicZone_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(false);
     CurrentGrid = TransGeographicZone;
     CurrentGrid.PerformCallback('');
     break;
...
break;
                            ...
                            <Items>
                                ...
                                <dxm:MenuItem BeginGroup="True" Name="ViewItem" Text="View" DropDownMode="True" Image-Url="/images/16x16/Toolbar/view.png">
                                        <Items>
                                            <dxm:MenuItem Name="TabGeographicZone_ViewItem" Text="Standard" meta:resourcekey="TabGeographicZone_ViewItem"/>
<dxm:MenuItem Name="TransGeographicZone_ViewItem" Text="Translator" meta:resourcekey="TransGeographicZone_ViewItem"/>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="TabGeographicZone_View" ClientInstanceName="TabGeographicZone_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TabGeographicZone_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TabGeographicZone_Grid' ID='TabGeographicZone_Grid' runat='server' Width='100%' KeyFieldName='COUNTRYID;GEOGRAPHICZONETABLEID;GEOGRAPHICZONELEVELID;GEOGRAPHICZONEID' Caption='Detail of geographic zones of the country' Enabled="True" ClientVisible ="True" meta:resourcekey="TabGeographicZone_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<ClientSideEvents SelectedIndexChanged="function(s, e) {TabGeographicZone_Grid.GetEditor('ZipCode').PerformCallback(s.GetValue().toString()); }"/> 
</PropertiesComboBox>
</dxwgv:GridViewDataComboBoxColumn>
<dxwgv:GridViewDataTextColumn Name='GeographicZoneTableID' FieldName='GEOGRAPHICZONETABLEID' Caption='Geographic Zone Table ID' ToolTip='Number identifying the geographic zone table.' VisibleIndex="1" CellStyle-HorizontalAlign="Left" Width="22%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="GeographicZoneTableID">
<EditFormSettings VisibleIndex="1" Visible="True"/>
<PropertiesTextEdit Size='20' MaxLength='20'>
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Geographic Zone Table ID" is required.'/>
     </ValidationSettings>
     <Style Paddings-PaddingLeft="8px" BackgroundImage-HorizontalPosition="left" BackgroundImage-ImageUrl ="/images/generaluse/required.PNG" BackgroundImage-Repeat="NoRepeat" BackgroundImage-VerticalPosition="center">
</Style>
</PropertiesTextEdit>
</dxwgv:GridViewDataTextColumn>
<dxwgv:GridViewDataComboBoxColumn Name='GeographicZoneLevelID' FieldName='GEOGRAPHICZONELEVELID' Caption='Geographic Zone Level ID' ToolTip='Number identifying the zone.' VisibleIndex="2" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="0%" Visible="True" meta:resourcekey="GeographicZoneLevelID" >
<EditFormSettings VisibleIndex="2" Visible="True"/>
<PropertiesComboBox ValueType="System.Int32" IncrementalFilteringMode="StartsWith" EnableCallbackMode="false"  TextField='DESCRIPTION' ValueField='GEOGRAPHICZONELEVELID'> 
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Geographic Zone Level ID" is required.'/>
     </ValidationSettings>
     <Style Paddings-PaddingLeft="8px" BackgroundImage-HorizontalPosition="left" BackgroundImage-ImageUrl ="/images/generaluse/required.PNG" BackgroundImage-Repeat="NoRepeat" BackgroundImage-VerticalPosition="center">
</Style>
</PropertiesComboBox>
</dxwgv:GridViewDataComboBoxColumn>
<dxwgv:GridViewDataTextColumn Name='GeographicZoneID' FieldName='GEOGRAPHICZONEID' Caption='Geographic Level ID' ToolTip='Number identifying the geographic zone level.' VisibleIndex="3" CellStyle-HorizontalAlign="Left" Width="22%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="GeographicZoneID">
<EditFormSettings VisibleIndex="3" Visible="True"/>
<PropertiesTextEdit Size='20' MaxLength='20'>
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Geographic Level ID" is required.'/>
     </ValidationSettings>
     <Style Paddings-PaddingLeft="8px" BackgroundImage-HorizontalPosition="left" BackgroundImage-ImageUrl ="/images/generaluse/required.PNG" BackgroundImage-Repeat="NoRepeat" BackgroundImage-VerticalPosition="center">
</Style>
</PropertiesTextEdit>
</dxwgv:GridViewDataTextColumn>
<dxwgv:GridViewDataComboBoxColumn Name='ZipCode' FieldName='ZIPCODE' Caption='Zip Code' ToolTip='Zip code.' VisibleIndex="4" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="11%" Visible="True" meta:resourcekey="ZipCode" >
<EditFormSettings VisibleIndex="4" Visible="True"/>
<PropertiesComboBox ValueType="System.String" IncrementalFilteringMode="StartsWith" EnableCallbackMode="false"  TextField='ZIPCODE' ValueField='ZIPCODE'> 
</PropertiesComboBox>
</dxwgv:GridViewDataComboBoxColumn>
<dxwgv:GridViewDataComboBoxColumn Name='RecordStatus' FieldName='RECORDSTATUS' Caption='Record Status' ToolTip='General status of the record.' VisibleIndex="5" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="0%" Visible="True" meta:resourcekey="RecordStatus" >
...
<dxwgv:GridViewDataTextColumn Name='Description' FieldName='DESCRIPTION' Caption='Description' ToolTip='Description of the geographic zone level.' VisibleIndex="6" CellStyle-HorizontalAlign="Left" Width="33%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="Description">
...
<dxwgv:GridViewDataTextColumn Name='ShortDescription' FieldName='SHORTDESCRIPTION' Caption='Short Description' ToolTip='Abbreviated description of the geographic zone level.' VisibleIndex="7" CellStyle-HorizontalAlign="Left" Width="13%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="ShortDescription">
...
<dxp:ASPxPanel ID="TransGeographicZone_View" ClientInstanceName="TransGeographicZone_View" runat="server" ClientVisible="False" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TransGeographicZone_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TransGeographicZone' ID='TransGeographicZone' runat='server' Width='100%' KeyFieldName='COUNTRYID;GEOGRAPHICZONETABLEID;GEOGRAPHICZONELEVELID;GEOGRAPHICZONEID;LANGUAGEID' Caption='Trans Geographic Zone' Enabled="True" ClientVisible ="True" meta:resourcekey="TransGeographicZoneResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
<SettingsPager PageSize="20"/>
<SettingsBehavior AllowFocusedRow="True"/>
<SettingsEditing Mode="Inline" />
<ClientSideEvents RowDblClick="function(s, e) {s.StartEditRow(e.visibleIndex);}" FocusedRowChanged="function(s, e) {MainMenu.GetItemByName('EditRegisterItem').SetEnabled(s.GetFocusedRowIndex()>-1);}" SelectionChanged="function(s, e) {MainMenu.GetItemByName('RemoveRegisterItem').SetEnabled(s.GetSelectedRowCount()>0);}" />
...
<dxwgv:GridViewDataTextColumn Name='Description' FieldName='DESCRIPTION' Caption='Description' ToolTip='Description of the geographic zone level.' VisibleIndex="7" CellStyle-HorizontalAlign="Left" Width="33%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="Description">
<EditFormSettings VisibleIndex="7" Visible="True"/>
<PropertiesTextEdit Size='30' MaxLength='30'>
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Description" is required.'/>
...
<dxwgv:GridViewDataTextColumn Name='ShortDescription' FieldName='SHORTDESCRIPTION' Caption='Short Description' ToolTip='Abbreviated description of the geographic zone level.' VisibleIndex="8" CellStyle-HorizontalAlign="Left" Width="13%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="ShortDescription">
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(TabGeographicZone_Grid);
AddKeyboardNavigationTo(TransGeographicZone);

                 HandlerView('TabGeographicZone_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/TabGeographicZone.html" AllowResize="True"
