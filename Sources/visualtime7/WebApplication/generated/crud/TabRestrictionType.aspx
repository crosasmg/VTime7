<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="TabRestrictionType.aspx.vb" Inherits="Maintenance_TabRestrictionType" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'TabRestrictionType_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TabRestrictionType_ViewItem.Text")%>');
           TabRestrictionType_View.SetClientVisible(true);
           MainMenu.GetItemByName('TabRestrictionType_ViewItem').SetVisible(false);
       TransRestrictionType_View.SetClientVisible(false);
  MainMenu.GetItemByName('TransRestrictionType_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(true);
     CurrentGrid = TabRestrictionType_Grid;
     CurrentGrid.PerformCallback('');
     break;
case 'TransRestrictionType_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TransRestrictionType_ViewItem.Text")%>');
           TransRestrictionType_View.SetClientVisible(true);
           MainMenu.GetItemByName('TransRestrictionType_ViewItem').SetVisible(false);
       TabRestrictionType_View.SetClientVisible(false);
  MainMenu.GetItemByName('TabRestrictionType_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(false);
     CurrentGrid = TransRestrictionType_Grid;
     CurrentGrid.PerformCallback('');
     break;
...
break;
                            ...
                            <Items>
                                ...
                                <dxm:MenuItem BeginGroup="True" Name="ViewItem" Text="View" DropDownMode="True" Image-Url="/images/16x16/Toolbar/view.png">
                                        <Items>
                                            <dxm:MenuItem Name="TabRestrictionType_ViewItem" Text="Standard" meta:resourcekey="TabRestrictionType_ViewItem"/>
<dxm:MenuItem Name="TransRestrictionType_ViewItem" Text="Translator" meta:resourcekey="TransRestrictionType_ViewItem"/>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="TabRestrictionType_View" ClientInstanceName="TabRestrictionType_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TabRestrictionType_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TabRestrictionType_Grid' ID='TabRestrictionType_Grid' runat='server' Width='100%' KeyFieldName='RESTRICTIONTYPE' Caption='Types of the restriction' Enabled="True" ClientVisible ="True" meta:resourcekey="TabRestrictionType_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataTextColumn Name='RestrictionType' FieldName='RESTRICTIONTYPE' Caption='Restriction Type' ToolTip='Restriction Type.' VisibleIndex="0" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="3%" Visible="True" meta:resourcekey="RestrictionType">
...
<PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="###,##0" Size='5'>
 <MaskSettings IncludeLiterals="DecimalSymbol" Mask=" <0..99999g>" />
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Restriction Type" is required.'/>
     </ValidationSettings>
...
<dxp:ASPxPanel ID="TransRestrictionType_View" ClientInstanceName="TransRestrictionType_View" runat="server" ClientVisible="False" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TransRestrictionType_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TransRestrictionType_Grid' ID='TransRestrictionType_Grid' runat='server' Width='100%' KeyFieldName='RESTRICTIONTYPE;LANGUAGEID' Caption='Types of the restriction' Enabled="True" ClientVisible ="True" meta:resourcekey="TransRestrictionType_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
<SettingsPager PageSize="20"/>
<SettingsBehavior AllowFocusedRow="True"/>
<SettingsEditing Mode="Inline" />
<ClientSideEvents RowDblClick="function(s, e) {s.StartEditRow(e.visibleIndex);}" FocusedRowChanged="function(s, e) {MainMenu.GetItemByName('EditRegisterItem').SetEnabled(s.GetFocusedRowIndex()>-1);}" SelectionChanged="function(s, e) {MainMenu.GetItemByName('RemoveRegisterItem').SetEnabled(s.GetSelectedRowCount()>0);}" />
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(TabRestrictionType_Grid);
AddKeyboardNavigationTo(TransRestrictionType_Grid);

                 HandlerView('TabRestrictionType_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/TabRestrictionType.html" AllowResize="True"
