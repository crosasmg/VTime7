<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="TabPartsOfAddressNames.aspx.vb" Inherits="Maintenance_TabPartsOfAddressNames" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'TabPartsOfAddressNames_ViewItem':     
     
     
     CurrentGrid = TabPartsOfAddressNames;
     CurrentGrid.PerformCallback('');
     break;
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="TabPartsOfAddressNames_View" ClientInstanceName="TabPartsOfAddressNames_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TabPartsOfAddressNames_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TabPartsOfAddressNames' ID='TabPartsOfAddressNames' runat='server' Width='100%' KeyFieldName='COUNTRYID;TYPEOFROUTE;PARTNAMEID' Caption='Levels of physical address' Enabled="True" ClientVisible ="True" meta:resourcekey="TabPartsOfAddressNamesResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataTextColumn Name='PartNameID' FieldName='PARTNAMEID' Caption='Part Name ID' ToolTip='Identification of levels of physical address.' VisibleIndex="2" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="83%" Visible="True" meta:resourcekey="PartNameID">
...
<dxwgv:GridViewDataTextColumn Name='LineAtWhichMustBeShown' FieldName='LINEATWHICHMUSTBESHOWN' Caption='Line At Which Must Be Shown' ToolTip='Line at which must be shown.' VisibleIndex="4" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="17%" Visible="True" meta:resourcekey="LineAtWhichMustBeShown">
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(TabPartsOfAddressNames);

                 HandlerView('TabPartsOfAddressNames_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/TabPartsOfAddressNames.html" AllowResize="True"
