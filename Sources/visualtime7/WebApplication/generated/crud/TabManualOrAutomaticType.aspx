<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="TabManualOrAutomaticType.aspx.vb" Inherits="Maintenance_TabManualOrAutomaticType" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'TabManualOrAutomaticType_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TabManualOrAutomaticType_ViewItem.Text")%>');
           TabManualOrAutomaticType_View.SetClientVisible(true);
           MainMenu.GetItemByName('TabManualOrAutomaticType_ViewItem').SetVisible(false);
       TransManualOrAutomaticType_View.SetClientVisible(false);
  MainMenu.GetItemByName('TransManualOrAutomaticType_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(true);
     CurrentGrid = TabManualOrAutomaticType_Grid;
     CurrentGrid.PerformCallback('');
     break;
case 'TransManualOrAutomaticType_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TransManualOrAutomaticType_ViewItem.Text")%>');
           TransManualOrAutomaticType_View.SetClientVisible(true);
           MainMenu.GetItemByName('TransManualOrAutomaticType_ViewItem').SetVisible(false);
       TabManualOrAutomaticType_View.SetClientVisible(false);
  MainMenu.GetItemByName('TabManualOrAutomaticType_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(false);
     CurrentGrid = TransManualOrAutomaticType_Grid;
     CurrentGrid.PerformCallback('');
     break;
...
break;
                            ...
                            <Items>
                                ...
                                <dxm:MenuItem BeginGroup="True" Name="ViewItem" Text="View" DropDownMode="True" Image-Url="/images/16x16/Toolbar/view.png">
                                        <Items>
                                            <dxm:MenuItem Name="TabManualOrAutomaticType_ViewItem" Text="Standard" meta:resourcekey="TabManualOrAutomaticType_ViewItem"/>
<dxm:MenuItem Name="TransManualOrAutomaticType_ViewItem" Text="Translator" meta:resourcekey="TransManualOrAutomaticType_ViewItem"/>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="TabManualOrAutomaticType_View" ClientInstanceName="TabManualOrAutomaticType_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TabManualOrAutomaticType_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TabManualOrAutomaticType_Grid' ID='TabManualOrAutomaticType_Grid' runat='server' Width='100%' KeyFieldName='MANUALORAUTOMATIC' Caption='Source of the information' Enabled="True" ClientVisible ="True" meta:resourcekey="TabManualOrAutomaticType_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataTextColumn Name='ManualOrAutomatic' FieldName='MANUALORAUTOMATIC' Caption='Manual or Automatic' ToolTip='Manual Or Automatic.' VisibleIndex="0" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="3%" Visible="True" meta:resourcekey="ManualOrAutomatic">
...
<PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="###,##0" Size='5'>
 <MaskSettings IncludeLiterals="DecimalSymbol" Mask=" <0..99999g>" />
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Manual or Automatic" is required.'/>
     </ValidationSettings>
...
<dxp:ASPxPanel ID="TransManualOrAutomaticType_View" ClientInstanceName="TransManualOrAutomaticType_View" runat="server" ClientVisible="False" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TransManualOrAutomaticType_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TransManualOrAutomaticType_Grid' ID='TransManualOrAutomaticType_Grid' runat='server' Width='100%' KeyFieldName='MANUALORAUTOMATIC;LANGUAGEID' Caption='Source of the information' Enabled="True" ClientVisible ="True" meta:resourcekey="TransManualOrAutomaticType_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
<SettingsPager PageSize="20"/>
<SettingsBehavior AllowFocusedRow="True"/>
<SettingsEditing Mode="Inline" />
<ClientSideEvents RowDblClick="function(s, e) {s.StartEditRow(e.visibleIndex);}" FocusedRowChanged="function(s, e) {MainMenu.GetItemByName('EditRegisterItem').SetEnabled(s.GetFocusedRowIndex()>-1);}" SelectionChanged="function(s, e) {MainMenu.GetItemByName('RemoveRegisterItem').SetEnabled(s.GetSelectedRowCount()>0);}" />
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(TabManualOrAutomaticType_Grid);
AddKeyboardNavigationTo(TransManualOrAutomaticType_Grid);

                 HandlerView('TabManualOrAutomaticType_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/TabManualOrAutomaticType.html" AllowResize="True"
