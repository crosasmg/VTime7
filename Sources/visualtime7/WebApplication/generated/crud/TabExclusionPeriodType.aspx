<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="TabExclusionPeriodType.aspx.vb" Inherits="Maintenance_TabExclusionPeriodType" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'TabExclusionPeriodType_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TabExclusionPeriodType_ViewItem.Text")%>');
           TabExclusionPeriodType_View.SetClientVisible(true);
           MainMenu.GetItemByName('TabExclusionPeriodType_ViewItem').SetVisible(false);
       TransExclusionPeriodType_View.SetClientVisible(false);
  MainMenu.GetItemByName('TransExclusionPeriodType_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(true);
     CurrentGrid = TabExclusionPeriodType_Grid;
     CurrentGrid.PerformCallback('');
     break;
case 'TransExclusionPeriodType_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TransExclusionPeriodType_ViewItem.Text")%>');
           TransExclusionPeriodType_View.SetClientVisible(true);
           MainMenu.GetItemByName('TransExclusionPeriodType_ViewItem').SetVisible(false);
       TabExclusionPeriodType_View.SetClientVisible(false);
  MainMenu.GetItemByName('TabExclusionPeriodType_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(false);
     CurrentGrid = TransExclusionPeriodType_Grid;
     CurrentGrid.PerformCallback('');
     break;
...
break;
                            ...
                            <Items>
                                ...
                                <dxm:MenuItem BeginGroup="True" Name="ViewItem" Text="View" DropDownMode="True" Image-Url="/images/16x16/Toolbar/view.png">
                                        <Items>
                                            <dxm:MenuItem Name="TabExclusionPeriodType_ViewItem" Text="Standard" meta:resourcekey="TabExclusionPeriodType_ViewItem"/>
<dxm:MenuItem Name="TransExclusionPeriodType_ViewItem" Text="Translator" meta:resourcekey="TransExclusionPeriodType_ViewItem"/>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="TabExclusionPeriodType_View" ClientInstanceName="TabExclusionPeriodType_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TabExclusionPeriodType_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TabExclusionPeriodType_Grid' ID='TabExclusionPeriodType_Grid' runat='server' Width='100%' KeyFieldName='EXCLUSIONPERIODTYPE' Caption='Exclusion periods.' Enabled="True" ClientVisible ="True" meta:resourcekey="TabExclusionPeriodType_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataTextColumn Name='ExclusionPeriodType' FieldName='EXCLUSIONPERIODTYPE' Caption='Exclusion Period Type' ToolTip='Exclusion Period Type.' VisibleIndex="0" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="3%" Visible="True" meta:resourcekey="ExclusionPeriodType">
...
<PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="###,##0" Size='5'>
 <MaskSettings IncludeLiterals="DecimalSymbol" Mask=" <0..99999g>" />
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Exclusion Period Type" is required.'/>
     </ValidationSettings>
...
<dxp:ASPxPanel ID="TransExclusionPeriodType_View" ClientInstanceName="TransExclusionPeriodType_View" runat="server" ClientVisible="False" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TransExclusionPeriodType_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TransExclusionPeriodType_Grid' ID='TransExclusionPeriodType_Grid' runat='server' Width='100%' KeyFieldName='EXCLUSIONPERIODTYPE;LANGUAGEID' Caption='Exclusion periods.' Enabled="True" ClientVisible ="True" meta:resourcekey="TransExclusionPeriodType_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
<SettingsPager PageSize="20"/>
<SettingsBehavior AllowFocusedRow="True"/>
<SettingsEditing Mode="Inline" />
<ClientSideEvents RowDblClick="function(s, e) {s.StartEditRow(e.visibleIndex);}" FocusedRowChanged="function(s, e) {MainMenu.GetItemByName('EditRegisterItem').SetEnabled(s.GetFocusedRowIndex()>-1);}" SelectionChanged="function(s, e) {MainMenu.GetItemByName('RemoveRegisterItem').SetEnabled(s.GetSelectedRowCount()>0);}" />
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(TabExclusionPeriodType_Grid);
AddKeyboardNavigationTo(TransExclusionPeriodType_Grid);

                 HandlerView('TabExclusionPeriodType_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/TabExclusionPeriodType.html" AllowResize="True"
