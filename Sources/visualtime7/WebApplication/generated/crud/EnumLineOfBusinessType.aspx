<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="EnumLineOfBusinessType.aspx.vb" Inherits="Maintenance_EnumLineOfBusinessType" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'EnumLineOfBusinessType_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("EnumLineOfBusinessType_ViewItem.Text")%>');
           EnumLineOfBusinessType_View.SetClientVisible(true);
           MainMenu.GetItemByName('EnumLineOfBusinessType_ViewItem').SetVisible(false);
       ETranLineOfBusinessType_View.SetClientVisible(false);
  MainMenu.GetItemByName('ETranLineOfBusinessType_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(true);
     CurrentGrid = EnumLineOfBusinessType_Grid;
     CurrentGrid.PerformCallback('');
     break;
case 'ETranLineOfBusinessType_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("ETranLineOfBusinessType_ViewItem.Text")%>');
           ETranLineOfBusinessType_View.SetClientVisible(true);
           MainMenu.GetItemByName('ETranLineOfBusinessType_ViewItem').SetVisible(false);
       EnumLineOfBusinessType_View.SetClientVisible(false);
  MainMenu.GetItemByName('EnumLineOfBusinessType_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(false);
     CurrentGrid = ETranLineOfBusinessType;
     CurrentGrid.PerformCallback('');
     break;
...
break;
                            ...
                            <Items>
                                ...
                                <dxm:MenuItem BeginGroup="True" Name="ViewItem" Text="View" DropDownMode="True" Image-Url="/images/16x16/Toolbar/view.png">
                                        <Items>
                                            <dxm:MenuItem Name="EnumLineOfBusinessType_ViewItem" Text="Standard" meta:resourcekey="EnumLineOfBusinessType_ViewItem"/>
<dxm:MenuItem Name="ETranLineOfBusinessType_ViewItem" Text="Translator" meta:resourcekey="ETranLineOfBusinessType_ViewItem"/>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="EnumLineOfBusinessType_View" ClientInstanceName="EnumLineOfBusinessType_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="EnumLineOfBusinessType_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='EnumLineOfBusinessType_Grid' ID='EnumLineOfBusinessType_Grid' runat='server' Width='100%' KeyFieldName='LINEOFBUSINESSTYPE' Caption='Type of line of business ' Enabled="True" ClientVisible ="True" meta:resourcekey="EnumLineOfBusinessType_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataTextColumn Name='LineOfBusinessType' FieldName='LINEOFBUSINESSTYPE' Caption='Line of Business Type' ToolTip='Type of line of business (Life, Fitre, Health, etc)' VisibleIndex="0" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="11%" Visible="True" meta:resourcekey="LineOfBusinessType">
...
<PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="###,##0" Size='5'>
 <MaskSettings IncludeLiterals="DecimalSymbol" Mask=" <0..99999g>" />
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Line of Business Type" is required.'/>
     </ValidationSettings>
...
<dxwgv:GridViewDataComboBoxColumn Name='RecordStatus' FieldName='RECORDSTATUS' Caption='Record Status Key' ToolTip='Status of the record.' VisibleIndex="1" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="0%" Visible="True" meta:resourcekey="RecordStatus" >
...
<dxp:ASPxPanel ID="ETranLineOfBusinessType_View" ClientInstanceName="ETranLineOfBusinessType_View" runat="server" ClientVisible="False" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="ETranLineOfBusinessType_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='ETranLineOfBusinessType' ID='ETranLineOfBusinessType' runat='server' Width='100%' KeyFieldName='LINEOFBUSINESSTYPE;LANGUAGEID' Caption='Type of line of business ' Enabled="True" ClientVisible ="True" meta:resourcekey="ETranLineOfBusinessTypeResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
<SettingsPager PageSize="20"/>
<SettingsBehavior AllowFocusedRow="True"/>
<SettingsEditing Mode="Inline" />
<ClientSideEvents RowDblClick="function(s, e) {s.StartEditRow(e.visibleIndex);}" FocusedRowChanged="function(s, e) {MainMenu.GetItemByName('EditRegisterItem').SetEnabled(s.GetFocusedRowIndex()>-1);}" SelectionChanged="function(s, e) {MainMenu.GetItemByName('RemoveRegisterItem').SetEnabled(s.GetSelectedRowCount()>0);}" />
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(EnumLineOfBusinessType_Grid);
AddKeyboardNavigationTo(ETranLineOfBusinessType);

                 HandlerView('EnumLineOfBusinessType_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/EnumLineOfBusinessType.html" AllowResize="True"
