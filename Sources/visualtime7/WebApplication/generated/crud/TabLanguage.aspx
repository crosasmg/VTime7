<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="TabLanguage.aspx.vb" Inherits="Maintenance_TabLanguage" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'TabLanguage_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TabLanguage_ViewItem.Text")%>');
           TabLanguage_View.SetClientVisible(true);
           MainMenu.GetItemByName('TabLanguage_ViewItem').SetVisible(false);
       TransLanguage_View.SetClientVisible(false);
  MainMenu.GetItemByName('TransLanguage_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(true);
     CurrentGrid = TabLanguage_Grid;
     CurrentGrid.PerformCallback('');
     break;
case 'TransLanguage_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TransLanguage_ViewItem.Text")%>');
           TransLanguage_View.SetClientVisible(true);
           MainMenu.GetItemByName('TransLanguage_ViewItem').SetVisible(false);
       TabLanguage_View.SetClientVisible(false);
  MainMenu.GetItemByName('TabLanguage_ViewItem').SetVisible(true);
...
break;
                            ...
                            <Items>
                                ...
                                <dxm:MenuItem BeginGroup="True" Name="ViewItem" Text="View" DropDownMode="True" Image-Url="/images/16x16/Toolbar/view.png">
                                        <Items>
                                            <dxm:MenuItem Name="TabLanguage_ViewItem" Text="Standard" meta:resourcekey="TabLanguage_ViewItem"/>
<dxm:MenuItem Name="TransLanguage_ViewItem" Text="Translator" meta:resourcekey="TransLanguage_ViewItem"/>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="TabLanguage_View" ClientInstanceName="TabLanguage_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TabLanguage_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TabLanguage_Grid' ID='TabLanguage_Grid' runat='server' Width='100%' KeyFieldName='LANGUAGEID' Caption='Languages' Enabled="True" ClientVisible ="True" meta:resourcekey="TabLanguage_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataTextColumn Name='LanguageID' FieldName='LANGUAGEID' Caption='Language ID' ToolTip='Language in which the description is indicated' VisibleIndex="0" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="11%" Visible="True" meta:resourcekey="LanguageID">
...
<dxwgv:GridViewDataTextColumn Name='Description' FieldName='DESCRIPTION' Caption='Description' ToolTip='Description of the language.' VisibleIndex="2" CellStyle-HorizontalAlign="Left" Width="64%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="Description">
...
<dxwgv:GridViewDataTextColumn Name='ShortDescription' FieldName='SHORTDESCRIPTION' Caption='Short Description' ToolTip='Abbreviated description of the language.' VisibleIndex="3" CellStyle-HorizontalAlign="Left" Width="26%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="ShortDescription">
...
<dxp:ASPxPanel ID="TransLanguage_View" ClientInstanceName="TransLanguage_View" runat="server" ClientVisible="False" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TransLanguage_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TransLanguage' ID='TransLanguage' runat='server' Width='100%' KeyFieldName='LANGUAGECODEID;LANGUAGEID' Caption='Languages' Enabled="True" ClientVisible ="True" meta:resourcekey="TransLanguageResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
<SettingsPager PageSize="20"/>
<SettingsBehavior AllowFocusedRow="True"/>
<SettingsEditing Mode="Inline" />
<ClientSideEvents RowDblClick="function(s, e) {s.StartEditRow(e.visibleIndex);}" FocusedRowChanged="function(s, e) {MainMenu.GetItemByName('EditRegisterItem').SetEnabled(s.GetFocusedRowIndex()>-1);}" SelectionChanged="function(s, e) {MainMenu.GetItemByName('RemoveRegisterItem').SetEnabled(s.GetSelectedRowCount()>0);}" />
<Columns>
<dxwgv:GridViewDataTextColumn Name='LanguageID' FieldName='LANGUAGEID' Caption='Language ID' ToolTip='Language in which the description is indicated' VisibleIndex="0" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="10%" Visible="True" meta:resourcekey="LanguageID">
<EditFormSettings VisibleIndex="0" Visible="True"/>
<PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="###,##0" Size='5'>
 <MaskSettings IncludeLiterals="DecimalSymbol" Mask=" <0..99999g>" />
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
...
<dxwgv:GridViewDataTextColumn Name='LanguageCodeID' FieldName='LANGUAGECODEID' Caption='Language IDK ey' ToolTip='Language in which the description is indicated' VisibleIndex="2" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="10%" Visible="True" meta:resourcekey="LanguageCodeID">
<EditFormSettings VisibleIndex="2" Visible="True"/>
<PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="###,##0" Size='5'>
 <MaskSettings IncludeLiterals="DecimalSymbol" Mask=" <0..99999g>" />
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Language IDK ey" is required.'/>
     </ValidationSettings>
     <Style Paddings-PaddingLeft="8px" BackgroundImage-HorizontalPosition="left" BackgroundImage-ImageUrl ="/images/generaluse/required.PNG" BackgroundImage-Repeat="NoRepeat" BackgroundImage-VerticalPosition="center">
</Style>
</PropertiesTextEdit>
</dxwgv:GridViewDataTextColumn>
<dxwgv:GridViewDataTextColumn Name='Description' FieldName='DESCRIPTION' Caption='Description' ToolTip='Description of the language.' VisibleIndex="3" CellStyle-HorizontalAlign="Left" Width="58%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="Description">
<EditFormSettings VisibleIndex="3" Visible="True"/>
<PropertiesTextEdit Size='30' MaxLength='30'>
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Description" is required.'/>
...
<dxwgv:GridViewDataTextColumn Name='ShortDescription' FieldName='SHORTDESCRIPTION' Caption='Short Description' ToolTip='Abbreviated description of the language.' VisibleIndex="4" CellStyle-HorizontalAlign="Left" Width="23%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="ShortDescription">
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(TabLanguage_Grid);
AddKeyboardNavigationTo(TransLanguage);

                 HandlerView('TabLanguage_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/TabLanguage.html" AllowResize="True"
