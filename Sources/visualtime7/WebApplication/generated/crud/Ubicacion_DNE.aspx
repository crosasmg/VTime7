<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="Ubicacion_DNE.aspx.vb" Inherits="Maintenance_Ubicacion_DNE" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'TAB_UBICACION_DNE_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TAB_UBICACION_DNE_ViewItem.Text")%>');
           TAB_UBICACION_DNE_View.SetClientVisible(true);
           MainMenu.GetItemByName('TAB_UBICACION_DNE_ViewItem').SetVisible(false);
       TRANS_UBICACION_DNE_View.SetClientVisible(false);
  MainMenu.GetItemByName('TRANS_UBICACION_DNE_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(true);
     CurrentGrid = TAB_UBICACION_DNE_Grid;
     CurrentGrid.PerformCallback('');
     break;
case 'TRANS_UBICACION_DNE_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TRANS_UBICACION_DNE_ViewItem.Text")%>');
           TRANS_UBICACION_DNE_View.SetClientVisible(true);
           MainMenu.GetItemByName('TRANS_UBICACION_DNE_ViewItem').SetVisible(false);
       TAB_UBICACION_DNE_View.SetClientVisible(false);
  MainMenu.GetItemByName('TAB_UBICACION_DNE_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(false);
     CurrentGrid = TRANS_UBICACION_DNE_Grid;
     CurrentGrid.PerformCallback('');
     break;
                           ...
                           <ItemStyle Width="5%" />
                            ...
                            <ItemStyle Width="5%" />
                                ...
                                <dxm:MenuItem BeginGroup="True" Name="ViewItem" Text="View" DropDownMode="True" Image-Url="/images/16x16/Toolbar/view.png">
                                        <Items>
                                            <dxm:MenuItem Name="TAB_UBICACION_DNE_ViewItem" Text="Standard" meta:resourcekey="TAB_UBICACION_DNE_ViewItem"/>
<dxm:MenuItem Name="TRANS_UBICACION_DNE_ViewItem" Text="Translator" meta:resourcekey="TRANS_UBICACION_DNE_ViewItem"/>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="TAB_UBICACION_DNE_View" ClientInstanceName="TAB_UBICACION_DNE_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TAB_UBICACION_DNE_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TAB_UBICACION_DNE_Grid' ID='TAB_UBICACION_DNE_Grid' runat='server' Width='100%' KeyFieldName='ID_UBICACION' Caption='Tab Location' Enabled="True" ClientVisible ="True" meta:resourcekey="TAB_UBICACION_DNE_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataTextColumn Name='ID_UBICACION' FieldName='ID_UBICACION' Caption='Location id' ToolTip='Location id.' VisibleIndex="0" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="5%" Visible="True" meta:resourcekey="ID_UBICACION">
...
<PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="###,##0" Size='5'>
 <MaskSettings IncludeLiterals="DecimalSymbol" Mask=" <0..99999g>" />
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Location id" is required.'/>
     </ValidationSettings>
...
<dxp:ASPxPanel ID="TRANS_UBICACION_DNE_View" ClientInstanceName="TRANS_UBICACION_DNE_View" runat="server" ClientVisible="False" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TRANS_UBICACION_DNE_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TRANS_UBICACION_DNE_Grid' ID='TRANS_UBICACION_DNE_Grid' runat='server' Width='100%' KeyFieldName='ID_UBICACION;ID_LENGUAJE' Caption='Tab Location' Enabled="True" ClientVisible ="True" meta:resourcekey="TRANS_UBICACION_DNE_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
<SettingsPager PageSize="20"/>
<SettingsBehavior AllowFocusedRow="True"/>
<SettingsEditing Mode="Inline" />
...
<Columns>
<dxwgv:GridViewDataTextColumn Name='ID_UBICACION_T' FieldName='ID_UBICACION' Caption='Location id' ToolTip='Location id.' VisibleIndex="0" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="4%" Visible="True" meta:resourcekey="ID_UBICACION_T">
<EditFormSettings VisibleIndex="0" Visible="True"/>
<PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="###,##0" Size='5'>
 <MaskSettings IncludeLiterals="DecimalSymbol" Mask=" <0..99999g>" />
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(TAB_UBICACION_DNE_Grid);
AddKeyboardNavigationTo(TRANS_UBICACION_DNE_Grid);

                 HandlerView('TAB_UBICACION_DNE_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/Ubicacion_DNE.html" AllowResize="True"
