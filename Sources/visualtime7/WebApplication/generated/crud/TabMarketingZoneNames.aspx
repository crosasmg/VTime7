<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="TabMarketingZoneNames.aspx.vb" Inherits="Maintenance_TabMarketingZoneNames" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'TabMarketingZoneNames_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TabMarketingZoneNames_ViewItem.Text")%>');
           TabMarketingZoneNames_View.SetClientVisible(true);
           MainMenu.GetItemByName('TabMarketingZoneNames_ViewItem').SetVisible(false);
       TransMarketingZoneNames_View.SetClientVisible(false);
  MainMenu.GetItemByName('TransMarketingZoneNames_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(true);
     CurrentGrid = TabMarketingZoneNames_Grid;
     CurrentGrid.PerformCallback('');
     break;
case 'TransMarketingZoneNames_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TransMarketingZoneNames_ViewItem.Text")%>');
           TransMarketingZoneNames_View.SetClientVisible(true);
           MainMenu.GetItemByName('TransMarketingZoneNames_ViewItem').SetVisible(false);
       TabMarketingZoneNames_View.SetClientVisible(false);
  MainMenu.GetItemByName('TabMarketingZoneNames_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(false);
     CurrentGrid = TransMarketingZoneNames;
     CurrentGrid.PerformCallback('');
     break;
...
break;
                            ...
                            <Items>
                                ...
                                <dxm:MenuItem BeginGroup="True" Name="ViewItem" Text="View" DropDownMode="True" Image-Url="/images/16x16/Toolbar/view.png">
                                        <Items>
                                            <dxm:MenuItem Name="TabMarketingZoneNames_ViewItem" Text="Standard" meta:resourcekey="TabMarketingZoneNames_ViewItem"/>
<dxm:MenuItem Name="TransMarketingZoneNames_ViewItem" Text="Translator" meta:resourcekey="TransMarketingZoneNames_ViewItem"/>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="TabMarketingZoneNames_View" ClientInstanceName="TabMarketingZoneNames_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TabMarketingZoneNames_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TabMarketingZoneNames_Grid' ID='TabMarketingZoneNames_Grid' runat='server' Width='100%' KeyFieldName='COUNTRYID;MARKETINGZONELEVELID' Caption='Zones of marketing for the company' Enabled="True" ClientVisible ="True" meta:resourcekey="TabMarketingZoneNames_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataTextColumn Name='MarketingZoneLevelID' FieldName='MARKETINGZONELEVELID' Caption='Marketing Zone Level ID' ToolTip='Number identifying the marketing zone.' VisibleIndex="1" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="11%" Visible="True" meta:resourcekey="MarketingZoneLevelID">
...
<dxp:ASPxPanel ID="TransMarketingZoneNames_View" ClientInstanceName="TransMarketingZoneNames_View" runat="server" ClientVisible="False" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TransMarketingZoneNames_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TransMarketingZoneNames' ID='TransMarketingZoneNames' runat='server' Width='100%' KeyFieldName='COUNTRYID;MARKETINGZONELEVELID;LANGUAGEID' Caption='Trans Marketing Zone Names' Enabled="True" ClientVisible ="True" meta:resourcekey="TransMarketingZoneNamesResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
<SettingsPager PageSize="20"/>
<SettingsBehavior AllowFocusedRow="True"/>
<SettingsEditing Mode="Inline" />
<ClientSideEvents RowDblClick="function(s, e) {s.StartEditRow(e.visibleIndex);}" FocusedRowChanged="function(s, e) {MainMenu.GetItemByName('EditRegisterItem').SetEnabled(s.GetFocusedRowIndex()>-1);}" SelectionChanged="function(s, e) {MainMenu.GetItemByName('RemoveRegisterItem').SetEnabled(s.GetSelectedRowCount()>0);}" />
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(TabMarketingZoneNames_Grid);
AddKeyboardNavigationTo(TransMarketingZoneNames);

                 HandlerView('TabMarketingZoneNames_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/TabMarketingZoneNames.html" AllowResize="True"
