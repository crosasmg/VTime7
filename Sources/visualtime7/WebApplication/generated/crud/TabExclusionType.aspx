<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="TabExclusionType.aspx.vb" Inherits="Maintenance_TabExclusionType" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'TabExclusionType_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TabExclusionType_ViewItem.Text")%>');
           TabExclusionType_View.SetClientVisible(true);
           MainMenu.GetItemByName('TabExclusionType_ViewItem').SetVisible(false);
       TransExclusionType_View.SetClientVisible(false);
  MainMenu.GetItemByName('TransExclusionType_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(true);
     CurrentGrid = TabExclusionType_Grid;
     CurrentGrid.PerformCallback('');
     break;
case 'TransExclusionType_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TransExclusionType_ViewItem.Text")%>');
           TransExclusionType_View.SetClientVisible(true);
           MainMenu.GetItemByName('TransExclusionType_ViewItem').SetVisible(false);
       TabExclusionType_View.SetClientVisible(false);
  MainMenu.GetItemByName('TabExclusionType_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(false);
     CurrentGrid = TransExclusionType_Grid;
     CurrentGrid.PerformCallback('');
     break;
...
break;
                            ...
                            <Items>
                                ...
                                <dxm:MenuItem BeginGroup="True" Name="ViewItem" Text="View" DropDownMode="True" Image-Url="/images/16x16/Toolbar/view.png">
                                        <Items>
                                            <dxm:MenuItem Name="TabExclusionType_ViewItem" Text="Standard" meta:resourcekey="TabExclusionType_ViewItem"/>
<dxm:MenuItem Name="TransExclusionType_ViewItem" Text="Translator" meta:resourcekey="TransExclusionType_ViewItem"/>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="TabExclusionType_View" ClientInstanceName="TabExclusionType_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TabExclusionType_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TabExclusionType_Grid' ID='TabExclusionType_Grid' runat='server' Width='100%' KeyFieldName='EXCLUSIONTYPE' Caption='Types of exclusion' Enabled="True" ClientVisible ="True" meta:resourcekey="TabExclusionType_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataTextColumn Name='ExclusionType' FieldName='EXCLUSIONTYPE' Caption='Exclusion Type' ToolTip='Exclusion Type.' VisibleIndex="0" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="3%" Visible="True" meta:resourcekey="ExclusionType">
...
<PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="###,##0" Size='5'>
 <MaskSettings IncludeLiterals="DecimalSymbol" Mask=" <0..99999g>" />
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Exclusion Type" is required.'/>
     </ValidationSettings>
...
<dxp:ASPxPanel ID="TransExclusionType_View" ClientInstanceName="TransExclusionType_View" runat="server" ClientVisible="False" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TransExclusionType_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TransExclusionType_Grid' ID='TransExclusionType_Grid' runat='server' Width='100%' KeyFieldName='EXCLUSIONTYPE;LANGUAGEID' Caption='Types of exclusion' Enabled="True" ClientVisible ="True" meta:resourcekey="TransExclusionType_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
<SettingsPager PageSize="20"/>
<SettingsBehavior AllowFocusedRow="True"/>
<SettingsEditing Mode="Inline" />
<ClientSideEvents RowDblClick="function(s, e) {s.StartEditRow(e.visibleIndex);}" FocusedRowChanged="function(s, e) {MainMenu.GetItemByName('EditRegisterItem').SetEnabled(s.GetFocusedRowIndex()>-1);}" SelectionChanged="function(s, e) {MainMenu.GetItemByName('RemoveRegisterItem').SetEnabled(s.GetSelectedRowCount()>0);}" />
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(TabExclusionType_Grid);
AddKeyboardNavigationTo(TransExclusionType_Grid);

                 HandlerView('TabExclusionType_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/TabExclusionType.html" AllowResize="True"
