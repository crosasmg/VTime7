<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="TabGender.aspx.vb" Inherits="Maintenance_TabGender" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'TabGender_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TabGender_ViewItem.Text")%>');
           TabGender_View.SetClientVisible(true);
           MainMenu.GetItemByName('TabGender_ViewItem').SetVisible(false);
       TransGender_View.SetClientVisible(false);
  MainMenu.GetItemByName('TransGender_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(true);
     CurrentGrid = TabGender_Grid;
     CurrentGrid.PerformCallback('');
     break;
case 'TransGender_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TransGender_ViewItem.Text")%>');
           TransGender_View.SetClientVisible(true);
           MainMenu.GetItemByName('TransGender_ViewItem').SetVisible(false);
       TabGender_View.SetClientVisible(false);
  MainMenu.GetItemByName('TabGender_ViewItem').SetVisible(true);
...
break;
                            ...
                            <Items>
                                ...
                                <dxm:MenuItem BeginGroup="True" Name="ViewItem" Text="View" DropDownMode="True" Image-Url="/images/16x16/Toolbar/view.png">
                                        <Items>
                                            <dxm:MenuItem Name="TabGender_ViewItem" Text="Standard" meta:resourcekey="TabGender_ViewItem"/>
<dxm:MenuItem Name="TransGender_ViewItem" Text="Translator" meta:resourcekey="TransGender_ViewItem"/>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="TabGender_View" ClientInstanceName="TabGender_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TabGender_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TabGender_Grid' ID='TabGender_Grid' runat='server' Width='100%' KeyFieldName='GENDER' Caption='Gender of the Client' Enabled="True" ClientVisible ="True" meta:resourcekey="TabGender_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataTextColumn Name='Gender' FieldName='GENDER' Caption='Gender' ToolTip='Code of gender.' VisibleIndex="0" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="3%" Visible="True" meta:resourcekey="Gender">
...
<PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="###,##0" Size='5'>
 <MaskSettings IncludeLiterals="DecimalSymbol" Mask=" <0..99999g>" />
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Gender" is required.'/>
     </ValidationSettings>
...
<dxp:ASPxPanel ID="TransGender_View" ClientInstanceName="TransGender_View" runat="server" ClientVisible="False" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TransGender_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TransGender_Grid' ID='TransGender_Grid' runat='server' Width='100%' KeyFieldName='GENDER;LANGUAGEID' Caption='Gender of the Client' Enabled="True" ClientVisible ="True" meta:resourcekey="TransGender_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
<SettingsPager PageSize="20"/>
<SettingsBehavior AllowFocusedRow="True"/>
<SettingsEditing Mode="Inline" />
<ClientSideEvents RowDblClick="function(s, e) {s.StartEditRow(e.visibleIndex);}" FocusedRowChanged="function(s, e) {MainMenu.GetItemByName('EditRegisterItem').SetEnabled(s.GetFocusedRowIndex()>-1);}" SelectionChanged="function(s, e) {MainMenu.GetItemByName('RemoveRegisterItem').SetEnabled(s.GetSelectedRowCount()>0);}" />
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(TabGender_Grid);
AddKeyboardNavigationTo(TransGender_Grid);

                 HandlerView('TabGender_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/TabGender.html" AllowResize="True"
