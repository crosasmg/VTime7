<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="Acceso.aspx.vb" Inherits="Maintenance_Acceso" meta:resourcekey="PageResource" %>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="Acceso_View" ClientInstanceName="Acceso_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="Acceso_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='Acceso' ID='Acceso' runat='server' Width='100%' KeyFieldName='ID_ACCESO' Caption='Access' Enabled="True" ClientVisible ="True" meta:resourcekey="AccesoResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataComboBoxColumn Name='Id_Tipo_Acceso' FieldName='ID_TIPO_ACCESO' Caption='Id Tipo Acceso' ToolTip='Type of access code.' VisibleIndex="0" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="19%" Visible="True" meta:resourcekey="Id_Tipo_Acceso" >
<EditFormSettings VisibleIndex="0" Visible="True"/>
<PropertiesComboBox ValueType="System.Int32" IncrementalFilteringMode="StartsWith" EnableCallbackMode="false"  TextField='DESCRIPCION' ValueField='ID_TIPO_ACCESO'> 
...
<dxwgv:GridViewDataTextColumn Name='Descripcion' FieldName='DESCRIPCION' Caption='Description' ToolTip='Description of the code.' VisibleIndex="1" CellStyle-HorizontalAlign="Left" Width="48%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="Descripcion">
...
<dxwgv:GridViewDataTextColumn Name='Descripcion_Corta' FieldName='DESCRIPCION_CORTA' Caption='Short Description' ToolTip='Abbreviated description of the code.' VisibleIndex="2" CellStyle-HorizontalAlign="Left" Width="32%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="Descripcion_Corta">
...
<dxwgv:GridViewDataTextColumn Name='Estado_Registro' FieldName='ESTADO_REGISTRO' Caption='Record Status' ToolTip='Status of the record.' VisibleIndex="3" CellStyle-HorizontalAlign="Left" Width="1%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="Estado_Registro">
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(Acceso);

                 HandlerView('Acceso_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/Acceso.html" AllowResize="True"
