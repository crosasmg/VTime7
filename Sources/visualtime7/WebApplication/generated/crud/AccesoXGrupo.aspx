<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="AccesoXGrupo.aspx.vb" Inherits="Maintenance_AccesoXGrupo" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'AccesoXGrupo_ViewItem':     
     
     
     CurrentGrid = AccesoXGrupo;
     CurrentGrid.PerformCallback('');
     break;
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="AccesoXGrupo_View" ClientInstanceName="AccesoXGrupo_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="AccesoXGrupo_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='AccesoXGrupo' ID='AccesoXGrupo' runat='server' Width='100%' KeyFieldName='ID_ACCESO;ID_GRUPO_ACCESO' Caption='Access XR ole' Enabled="True" ClientVisible ="True" meta:resourcekey="AccesoXGrupoResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataComboBoxColumn Name='Id_Acceso' FieldName='ID_ACCESO' Caption='Id Acceso' ToolTip='Access code to the resources.' VisibleIndex="0" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="50%" Visible="True" meta:resourcekey="Id_Acceso" >
<EditFormSettings VisibleIndex="0" Visible="True"/>
<PropertiesComboBox ValueType="System.Int32" IncrementalFilteringMode="StartsWith" EnableCallbackMode="false"  TextField='DESCRIPCION' ValueField='ID_ACCESO'> 
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Id Acceso" is required.'/>
     </ValidationSettings>
...
<dxwgv:GridViewDataComboBoxColumn Name='Id_Grupo_Acceso' FieldName='ID_GRUPO_ACCESO' Caption='Id Grupo Acceso' ToolTip='Group of access code.' VisibleIndex="1" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="50%" Visible="True" meta:resourcekey="Id_Grupo_Acceso" >
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(AccesoXGrupo);

                 HandlerView('AccesoXGrupo_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/AccesoXGrupo.html" AllowResize="True"
