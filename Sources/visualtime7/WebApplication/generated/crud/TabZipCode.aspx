<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="TabZipCode.aspx.vb" Inherits="Maintenance_TabZipCode" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'TabZipCode_ViewItem':     
     
     
     CurrentGrid = TabZipCode;
     CurrentGrid.PerformCallback('');
     break;
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="TabZipCode_View" ClientInstanceName="TabZipCode_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TabZipCode_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TabZipCode' ID='TabZipCode' runat='server' Width='100%' KeyFieldName='COUNTRYID;ZIPCODE' Caption='Number that identifies the zip code' Enabled="True" ClientVisible ="True" meta:resourcekey="TabZipCodeResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataTextColumn Name='ZipCode' FieldName='ZIPCODE' Caption='Zip Code' ToolTip='Zip code.' VisibleIndex="1" CellStyle-HorizontalAlign="Left" Width="100%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="ZipCode">
<EditFormSettings VisibleIndex="1" Visible="True"/>
<PropertiesTextEdit Size='10' MaxLength='10'>
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(TabZipCode);

                 HandlerView('TabZipCode_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/TabZipCode.html" AllowResize="True"
