<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="Grupo_Acceso.aspx.vb" Inherits="Maintenance_Grupo_Acceso" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'Grupo_Acceso_ViewItem':     
     
     
     CurrentGrid = Grupo_Acceso;
     CurrentGrid.PerformCallback('');
     break;
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="Grupo_Acceso_View" ClientInstanceName="Grupo_Acceso_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="Grupo_Acceso_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='Grupo_Acceso' ID='Grupo_Acceso' runat='server' Width='100%' KeyFieldName='ID_GRUPO_ACCESO' Caption='Access Group' Enabled="True" ClientVisible ="True" meta:resourcekey="Grupo_AccesoResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataTextColumn Name='Descripcion' FieldName='DESCRIPCION' Caption='Description' ToolTip='Description of the code.' VisibleIndex="0" CellStyle-HorizontalAlign="Left" Width="65%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="Descripcion">
...
<dxwgv:GridViewDataTextColumn Name='Descripcion_Corta' FieldName='DESCRIPCION_CORTA' Caption='Short Description' ToolTip='Abbreviated description of the code.' VisibleIndex="1" CellStyle-HorizontalAlign="Left" Width="34%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="Descripcion_Corta">
...
<dxwgv:GridViewDataTextColumn Name='Estado_Registro' FieldName='ESTADO_REGISTRO' Caption='Record Status' ToolTip='Status of the record.' VisibleIndex="2" CellStyle-HorizontalAlign="Left" Width="1%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="Estado_Registro">
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(Grupo_Acceso);

                 HandlerView('Grupo_Acceso_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/Grupo_Acceso.html" AllowResize="True"
