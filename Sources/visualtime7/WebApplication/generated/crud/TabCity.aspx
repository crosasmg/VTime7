<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="TabCity.aspx.vb" Inherits="Maintenance_TabCity" meta:resourcekey="PageResource" %>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="TabCity_View" ClientInstanceName="TabCity_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TabCity_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TabCity' ID='TabCity' runat='server' Width='100%' KeyFieldName='COUNTRYID;ZIPCODE;CITYID' Caption='Tax code of the cities' Enabled="True" ClientVisible ="True" meta:resourcekey="TabCityResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<ClientSideEvents SelectedIndexChanged="function(s, e) {TabCity.GetEditor('ZipCode').PerformCallback(s.GetValue().toString()); }"/> 
</PropertiesComboBox>
</dxwgv:GridViewDataComboBoxColumn>
<dxwgv:GridViewDataComboBoxColumn Name='ZipCode' FieldName='ZIPCODE' Caption='Zip Code' ToolTip='Zip code.' VisibleIndex="1" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="29%" Visible="True" meta:resourcekey="ZipCode" >
...
<PropertiesComboBox ValueType="System.String" IncrementalFilteringMode="StartsWith" EnableCallbackMode="false"  TextField='ZIPCODE' ValueField='ZIPCODE'> 
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Zip Code" is required.'/>
     </ValidationSettings>
     <Style Paddings-PaddingLeft="8px" BackgroundImage-HorizontalPosition="left" BackgroundImage-ImageUrl ="/images/generaluse/required.PNG" BackgroundImage-Repeat="NoRepeat" BackgroundImage-VerticalPosition="center">
</Style>
</PropertiesComboBox>
</dxwgv:GridViewDataComboBoxColumn>
<dxwgv:GridViewDataTextColumn Name='CityID' FieldName='CITYID' Caption='City Tax ID' ToolTip='Key that identifies the lowest level defined geographical areas.' VisibleIndex="2" CellStyle-HorizontalAlign="Left" Width="57%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="CityID">
<EditFormSettings VisibleIndex="2" Visible="True"/>
<PropertiesTextEdit Size='20' MaxLength='20'>
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "City Tax ID" is required.'/>
     </ValidationSettings>
     <Style Paddings-PaddingLeft="8px" BackgroundImage-HorizontalPosition="left" BackgroundImage-ImageUrl ="/images/generaluse/required.PNG" BackgroundImage-Repeat="NoRepeat" BackgroundImage-VerticalPosition="center">
</Style>
</PropertiesTextEdit>
...
<dxwgv:GridViewDataComboBoxColumn Name='CityTaxCode' FieldName='CITYTAXCODE' Caption='City Tax Code' ToolTip='Tax code of the city.' VisibleIndex="4" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="14%" Visible="True" meta:resourcekey="CityTaxCode" >
<EditFormSettings VisibleIndex="4" Visible="True"/>
<PropertiesComboBox ValueType="System.Int32" IncrementalFilteringMode="StartsWith" EnableCallbackMode="false"  TextField='CITYTAXCODE' ValueField='CITYTAXCODE'> 
</PropertiesComboBox>
</dxwgv:GridViewDataComboBoxColumn>
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(TabCity);

                 HandlerView('TabCity_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/TabCity.html" AllowResize="True"
