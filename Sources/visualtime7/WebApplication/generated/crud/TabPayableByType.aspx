<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="TabPayableByType.aspx.vb" Inherits="Maintenance_TabPayableByType" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'TabPayableByType_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TabPayableByType_ViewItem.Text")%>');
           TabPayableByType_View.SetClientVisible(true);
           MainMenu.GetItemByName('TabPayableByType_ViewItem').SetVisible(false);
       TransPayableByType_View.SetClientVisible(false);
  MainMenu.GetItemByName('TransPayableByType_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(true);
     CurrentGrid = TabPayableByType_Grid;
     CurrentGrid.PerformCallback('');
     break;
case 'TransPayableByType_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TransPayableByType_ViewItem.Text")%>');
           TransPayableByType_View.SetClientVisible(true);
           MainMenu.GetItemByName('TransPayableByType_ViewItem').SetVisible(false);
       TabPayableByType_View.SetClientVisible(false);
  MainMenu.GetItemByName('TabPayableByType_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(false);
     CurrentGrid = TransPayableByType_Grid;
     CurrentGrid.PerformCallback('');
     break;
...
break;
                            ...
                            <Items>
                                ...
                                <dxm:MenuItem BeginGroup="True" Name="ViewItem" Text="View" DropDownMode="True" Image-Url="/images/16x16/Toolbar/view.png">
                                        <Items>
                                            <dxm:MenuItem Name="TabPayableByType_ViewItem" Text="Standard" meta:resourcekey="TabPayableByType_ViewItem"/>
<dxm:MenuItem Name="TransPayableByType_ViewItem" Text="Translator" meta:resourcekey="TransPayableByType_ViewItem"/>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="TabPayableByType_View" ClientInstanceName="TabPayableByType_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TabPayableByType_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TabPayableByType_Grid' ID='TabPayableByType_Grid' runat='server' Width='100%' KeyFieldName='PAYER' Caption='Payer requirement' Enabled="True" ClientVisible ="True" meta:resourcekey="TabPayableByType_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataTextColumn Name='Payer' FieldName='PAYER' Caption='Payer' ToolTip='Payer.' VisibleIndex="0" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="3%" Visible="True" meta:resourcekey="Payer">
...
<dxp:ASPxPanel ID="TransPayableByType_View" ClientInstanceName="TransPayableByType_View" runat="server" ClientVisible="False" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TransPayableByType_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TransPayableByType_Grid' ID='TransPayableByType_Grid' runat='server' Width='100%' KeyFieldName='PAYER;LANGUAGEID' Caption='Payer requirement' Enabled="True" ClientVisible ="True" meta:resourcekey="TransPayableByType_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
<SettingsPager PageSize="20"/>
<SettingsBehavior AllowFocusedRow="True"/>
<SettingsEditing Mode="Inline" />
<ClientSideEvents RowDblClick="function(s, e) {s.StartEditRow(e.visibleIndex);}" FocusedRowChanged="function(s, e) {MainMenu.GetItemByName('EditRegisterItem').SetEnabled(s.GetFocusedRowIndex()>-1);}" SelectionChanged="function(s, e) {MainMenu.GetItemByName('RemoveRegisterItem').SetEnabled(s.GetSelectedRowCount()>0);}" />
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(TabPayableByType_Grid);
AddKeyboardNavigationTo(TransPayableByType_Grid);

                 HandlerView('TabPayableByType_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/TabPayableByType.html" AllowResize="True"
