<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="TabEntryType.aspx.vb" Inherits="Maintenance_TabEntryType" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'TabEntryType_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TabEntryType_ViewItem.Text")%>');
           TabEntryType_View.SetClientVisible(true);
           MainMenu.GetItemByName('TabEntryType_ViewItem').SetVisible(false);
       TransEntryType_View.SetClientVisible(false);
  MainMenu.GetItemByName('TransEntryType_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(true);
     CurrentGrid = TabEntryType_Grid;
     CurrentGrid.PerformCallback('');
     break;
case 'TransEntryType_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TransEntryType_ViewItem.Text")%>');
           TransEntryType_View.SetClientVisible(true);
           MainMenu.GetItemByName('TransEntryType_ViewItem').SetVisible(false);
       TabEntryType_View.SetClientVisible(false);
  MainMenu.GetItemByName('TabEntryType_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(false);
     CurrentGrid = TransEntryType_Grid;
     CurrentGrid.PerformCallback('');
     break;
...
break;
                            ...
                            <Items>
                                ...
                                <dxm:MenuItem BeginGroup="True" Name="ViewItem" Text="View" DropDownMode="True" Image-Url="/images/16x16/Toolbar/view.png">
                                        <Items>
                                            <dxm:MenuItem Name="TabEntryType_ViewItem" Text="Standard" meta:resourcekey="TabEntryType_ViewItem"/>
<dxm:MenuItem Name="TransEntryType_ViewItem" Text="Translator" meta:resourcekey="TransEntryType_ViewItem"/>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="TabEntryType_View" ClientInstanceName="TabEntryType_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TabEntryType_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TabEntryType_Grid' ID='TabEntryType_Grid' runat='server' Width='100%' KeyFieldName='ENTRYTYPE' Caption='Entry type' Enabled="True" ClientVisible ="True" meta:resourcekey="TabEntryType_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataTextColumn Name='EntryType' FieldName='ENTRYTYPE' Caption='Entry Type' ToolTip='Entry Type.' VisibleIndex="0" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="3%" Visible="True" meta:resourcekey="EntryType">
...
<PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="###,##0" Size='5'>
 <MaskSettings IncludeLiterals="DecimalSymbol" Mask=" <0..99999g>" />
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Entry Type" is required.'/>
     </ValidationSettings>
...
<dxp:ASPxPanel ID="TransEntryType_View" ClientInstanceName="TransEntryType_View" runat="server" ClientVisible="False" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TransEntryType_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TransEntryType_Grid' ID='TransEntryType_Grid' runat='server' Width='100%' KeyFieldName='ENTRYTYPE;LANGUAGEID' Caption='Entry type' Enabled="True" ClientVisible ="True" meta:resourcekey="TransEntryType_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
<SettingsPager PageSize="20"/>
<SettingsBehavior AllowFocusedRow="True"/>
<SettingsEditing Mode="Inline" />
<ClientSideEvents RowDblClick="function(s, e) {s.StartEditRow(e.visibleIndex);}" FocusedRowChanged="function(s, e) {MainMenu.GetItemByName('EditRegisterItem').SetEnabled(s.GetFocusedRowIndex()>-1);}" SelectionChanged="function(s, e) {MainMenu.GetItemByName('RemoveRegisterItem').SetEnabled(s.GetSelectedRowCount()>0);}" />
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(TabEntryType_Grid);
AddKeyboardNavigationTo(TransEntryType_Grid);

                 HandlerView('TabEntryType_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/TabEntryType.html" AllowResize="True"
