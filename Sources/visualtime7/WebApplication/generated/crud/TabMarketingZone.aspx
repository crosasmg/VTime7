<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="TabMarketingZone.aspx.vb" Inherits="Maintenance_TabMarketingZone" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'TabMarketingZone_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TabMarketingZone_ViewItem.Text")%>');
           TabMarketingZone_View.SetClientVisible(true);
           MainMenu.GetItemByName('TabMarketingZone_ViewItem').SetVisible(false);
       TransMarketingZone_View.SetClientVisible(false);
  MainMenu.GetItemByName('TransMarketingZone_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(true);
     CurrentGrid = TabMarketingZone_Grid;
     CurrentGrid.PerformCallback('');
     break;
case 'TransMarketingZone_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TransMarketingZone_ViewItem.Text")%>');
           TransMarketingZone_View.SetClientVisible(true);
           MainMenu.GetItemByName('TransMarketingZone_ViewItem').SetVisible(false);
       TabMarketingZone_View.SetClientVisible(false);
  MainMenu.GetItemByName('TabMarketingZone_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(false);
     CurrentGrid = TransMarketingZone;
     CurrentGrid.PerformCallback('');
     break;
...
break;
                            ...
                            <Items>
                                ...
                                <dxm:MenuItem BeginGroup="True" Name="ViewItem" Text="View" DropDownMode="True" Image-Url="/images/16x16/Toolbar/view.png">
                                        <Items>
                                            <dxm:MenuItem Name="TabMarketingZone_ViewItem" Text="Standard" meta:resourcekey="TabMarketingZone_ViewItem"/>
<dxm:MenuItem Name="TransMarketingZone_ViewItem" Text="Translator" meta:resourcekey="TransMarketingZone_ViewItem"/>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="TabMarketingZone_View" ClientInstanceName="TabMarketingZone_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TabMarketingZone_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TabMarketingZone_Grid' ID='TabMarketingZone_Grid' runat='server' Width='100%' KeyFieldName='COMPANYID;MARKETINGZONETABLEID;COUNTRYID;MARKETINGZONELEVELID;MARKETINGZONEID' Caption='Detail of marketing zones' Enabled="True" ClientVisible ="True" meta:resourcekey="TabMarketingZone_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataTextColumn Name='MarketingZoneTableID' FieldName='MARKETINGZONETABLEID' Caption='Marketing Zone Table ID' ToolTip='Number identifying the marketing zone table' VisibleIndex="1" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="6%" Visible="True" meta:resourcekey="MarketingZoneTableID">
...
<PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="###,##0" Size='5'>
 <MaskSettings IncludeLiterals="DecimalSymbol" Mask=" <0..99999g>" />
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Marketing Zone Table ID" is required.'/>
     </ValidationSettings>
     <Style Paddings-PaddingLeft="8px" BackgroundImage-HorizontalPosition="left" BackgroundImage-ImageUrl ="/images/generaluse/required.PNG" BackgroundImage-Repeat="NoRepeat" BackgroundImage-VerticalPosition="center">
</Style>
</PropertiesTextEdit>
</dxwgv:GridViewDataTextColumn>
<dxwgv:GridViewDataComboBoxColumn Name='CountryID' FieldName='COUNTRYID' Caption='Country' ToolTip='Code of the country.' VisibleIndex="2" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="0%" Visible="True" meta:resourcekey="CountryID" >
...
<ClientSideEvents SelectedIndexChanged="function(s, e) {TabMarketingZone_Grid.GetEditor('MarketingZoneLevelID').PerformCallback(s.GetValue().toString()); }"/> 
</PropertiesComboBox>
</dxwgv:GridViewDataComboBoxColumn>
<dxwgv:GridViewDataComboBoxColumn Name='MarketingZoneLevelID' FieldName='MARKETINGZONELEVELID' Caption='Marketing Zone Level ID' ToolTip='Number identifying the marketing zone.' VisibleIndex="3" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="0%" Visible="True" meta:resourcekey="MarketingZoneLevelID" >
<EditFormSettings VisibleIndex="3" Visible="True"/>
<PropertiesComboBox ValueType="System.Int32" IncrementalFilteringMode="StartsWith" EnableCallbackMode="false"  TextField='DESCRIPTION' ValueField='MARKETINGZONELEVELID'> 
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Marketing Zone Level ID" is required.'/>
     </ValidationSettings>
     <Style Paddings-PaddingLeft="8px" BackgroundImage-HorizontalPosition="left" BackgroundImage-ImageUrl ="/images/generaluse/required.PNG" BackgroundImage-Repeat="NoRepeat" BackgroundImage-VerticalPosition="center">
</Style>
</PropertiesComboBox>
</dxwgv:GridViewDataComboBoxColumn>
<dxwgv:GridViewDataTextColumn Name='MarketingZoneID' FieldName='MARKETINGZONEID' Caption='Marketing Zone ID' ToolTip='Number identifying the marketing zone.' VisibleIndex="4" CellStyle-HorizontalAlign="Left" Width="26%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="MarketingZoneID">
<EditFormSettings VisibleIndex="4" Visible="True"/>
<PropertiesTextEdit Size='20' MaxLength='20'>
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Marketing Zone ID" is required.'/>
     </ValidationSettings>
     <Style Paddings-PaddingLeft="8px" BackgroundImage-HorizontalPosition="left" BackgroundImage-ImageUrl ="/images/generaluse/required.PNG" BackgroundImage-Repeat="NoRepeat" BackgroundImage-VerticalPosition="center">
</Style>
</PropertiesTextEdit>
</dxwgv:GridViewDataTextColumn>
<dxwgv:GridViewDataComboBoxColumn Name='RecordStatus' FieldName='RECORDSTATUS' Caption='Record Status Key' ToolTip='Status of the record.' VisibleIndex="5" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="0%" Visible="True" meta:resourcekey="RecordStatus" >
...
<PropertiesComboBox ValueType="System.String" IncrementalFilteringMode="StartsWith" EnableCallbackMode="false"  TextField='DESCRIPTION' ValueField='RECORDSTATUS'> 
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Record Status Key" is required.'/>
     </ValidationSettings>
     <Style Paddings-PaddingLeft="8px" BackgroundImage-HorizontalPosition="left" BackgroundImage-ImageUrl ="/images/generaluse/required.PNG" BackgroundImage-Repeat="NoRepeat" BackgroundImage-VerticalPosition="center">
</Style>
</PropertiesComboBox>
</dxwgv:GridViewDataComboBoxColumn>
<dxwgv:GridViewDataTextColumn Name='Description' FieldName='DESCRIPTION' Caption='Description' ToolTip='Description of the geographic zone.' VisibleIndex="6" CellStyle-HorizontalAlign="Left" Width="39%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="Description">
...
<dxwgv:GridViewDataTextColumn Name='ShortDescription' FieldName='SHORTDESCRIPTION' Caption='Short Description' ToolTip='Abbreviated description of the geographic zone.' VisibleIndex="7" CellStyle-HorizontalAlign="Left" Width="16%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="ShortDescription">
...
<dxwgv:GridViewDataDateColumn Name='CancellationDate' FieldName='CANCELLATIONDATE' Caption='Cancellation Date' ToolTip='Date which from the record is valid.' VisibleIndex="8" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="13%" Visible="True" meta:resourcekey="CancellationDate">
<EditFormSettings VisibleIndex="8" Visible="True"/>
<PropertiesDateEdit>
</PropertiesDateEdit>
</dxwgv:GridViewDataDateColumn>
<dxwgv:GridViewCommandColumn VisibleIndex="9" ButtonType="Image" Caption=" " Width="24px">
...
<dxp:ASPxPanel ID="TransMarketingZone_View" ClientInstanceName="TransMarketingZone_View" runat="server" ClientVisible="False" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TransMarketingZone_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TransMarketingZone' ID='TransMarketingZone' runat='server' Width='100%' KeyFieldName='COMPANYID;MARKETINGZONETABLEID;COUNTRYID;MARKETINGZONELEVELID;MARKETINGZONEID;LANGUAGEID' Caption='Trans Marketing Zone' Enabled="True" ClientVisible ="True" meta:resourcekey="TransMarketingZoneResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
<SettingsPager PageSize="20"/>
<SettingsBehavior AllowFocusedRow="True"/>
<SettingsEditing Mode="Inline" />
<ClientSideEvents RowDblClick="function(s, e) {s.StartEditRow(e.visibleIndex);}" FocusedRowChanged="function(s, e) {MainMenu.GetItemByName('EditRegisterItem').SetEnabled(s.GetFocusedRowIndex()>-1);}" SelectionChanged="function(s, e) {MainMenu.GetItemByName('RemoveRegisterItem').SetEnabled(s.GetSelectedRowCount()>0);}" />
...
<dxwgv:GridViewDataComboBoxColumn Name='LanguageID' FieldName='LANGUAGEID' Caption='Language ID' ToolTip='Language in which the description is indicated' VisibleIndex="6" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="0%" Visible="True" meta:resourcekey="LanguageID" >
<EditFormSettings VisibleIndex="6" Visible="True"/>
...
<dxwgv:GridViewDataTextColumn Name='Description' FieldName='DESCRIPTION' Caption='Description' ToolTip='Description of the geographic zone.' VisibleIndex="7" CellStyle-HorizontalAlign="Left" Width="39%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="Description">
<EditFormSettings VisibleIndex="7" Visible="True"/>
<PropertiesTextEdit Size='30' MaxLength='30'>
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Description" is required.'/>
...
<dxwgv:GridViewDataTextColumn Name='ShortDescription' FieldName='SHORTDESCRIPTION' Caption='Short Description' ToolTip='Abbreviated description of the geographic zone.' VisibleIndex="8" CellStyle-HorizontalAlign="Left" Width="16%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="ShortDescription">
<EditFormSettings VisibleIndex="8" Visible="True"/>
<PropertiesTextEdit Size='12' MaxLength='12'>
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Short Description" is required.'/>
...
<dxwgv:GridViewDataDateColumn Name='CancellationDate' FieldName='CANCELLATIONDATE' Caption='Cancellation Date' ToolTip='Date which from the record is valid.' VisibleIndex="9" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="13%" Visible="True" meta:resourcekey="CancellationDate">
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(TabMarketingZone_Grid);
AddKeyboardNavigationTo(TransMarketingZone);

                 HandlerView('TabMarketingZone_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/TabMarketingZone.html" AllowResize="True"
