<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="TabDegree.aspx.vb" Inherits="Maintenance_TabDegree" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'TabDegree_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TabDegree_ViewItem.Text")%>');
           TabDegree_View.SetClientVisible(true);
           MainMenu.GetItemByName('TabDegree_ViewItem').SetVisible(false);
       TransDegree_View.SetClientVisible(false);
  MainMenu.GetItemByName('TransDegree_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(true);
     CurrentGrid = TabDegree_Grid;
     CurrentGrid.PerformCallback('');
     break;
case 'TransDegree_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TransDegree_ViewItem.Text")%>');
           TransDegree_View.SetClientVisible(true);
           MainMenu.GetItemByName('TransDegree_ViewItem').SetVisible(false);
       TabDegree_View.SetClientVisible(false);
  MainMenu.GetItemByName('TabDegree_ViewItem').SetVisible(true);
...
break;
                            ...
                            <Items>
                                ...
                                <dxm:MenuItem BeginGroup="True" Name="ViewItem" Text="View" DropDownMode="True" Image-Url="/images/16x16/Toolbar/view.png">
                                        <Items>
                                            <dxm:MenuItem Name="TabDegree_ViewItem" Text="Standard" meta:resourcekey="TabDegree_ViewItem"/>
<dxm:MenuItem Name="TransDegree_ViewItem" Text="Translator" meta:resourcekey="TransDegree_ViewItem"/>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="TabDegree_View" ClientInstanceName="TabDegree_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TabDegree_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TabDegree_Grid' ID='TabDegree_Grid' runat='server' Width='100%' KeyFieldName='DEGREEID' Caption='Illness level' Enabled="True" ClientVisible ="True" meta:resourcekey="TabDegree_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataTextColumn Name='DegreeId' FieldName='DEGREEID' Caption='Degree Id' ToolTip='Degree.' VisibleIndex="0" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="3%" Visible="True" meta:resourcekey="DegreeId">
...
<PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="###,##0" Size='5'>
 <MaskSettings IncludeLiterals="DecimalSymbol" Mask=" <0..99999g>" />
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Degree Id" is required.'/>
     </ValidationSettings>
...
<dxp:ASPxPanel ID="TransDegree_View" ClientInstanceName="TransDegree_View" runat="server" ClientVisible="False" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TransDegree_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TransDegree_Grid' ID='TransDegree_Grid' runat='server' Width='100%' KeyFieldName='DEGREEID;LANGUAGEID' Caption='Illness level' Enabled="True" ClientVisible ="True" meta:resourcekey="TransDegree_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
<SettingsPager PageSize="20"/>
<SettingsBehavior AllowFocusedRow="True"/>
<SettingsEditing Mode="Inline" />
<ClientSideEvents RowDblClick="function(s, e) {s.StartEditRow(e.visibleIndex);}" FocusedRowChanged="function(s, e) {MainMenu.GetItemByName('EditRegisterItem').SetEnabled(s.GetFocusedRowIndex()>-1);}" SelectionChanged="function(s, e) {MainMenu.GetItemByName('RemoveRegisterItem').SetEnabled(s.GetSelectedRowCount()>0);}" />
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(TabDegree_Grid);
AddKeyboardNavigationTo(TransDegree_Grid);

                 HandlerView('TabDegree_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/TabDegree.html" AllowResize="True"
