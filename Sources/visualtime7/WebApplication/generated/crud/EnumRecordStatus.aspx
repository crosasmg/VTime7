<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="EnumRecordStatus.aspx.vb" Inherits="Maintenance_EnumRecordStatus" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'EnumRecordStatus_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("EnumRecordStatus_ViewItem.Text")%>');
           EnumRecordStatus_View.SetClientVisible(true);
           MainMenu.GetItemByName('EnumRecordStatus_ViewItem').SetVisible(false);
       ETranRecordStatus_View.SetClientVisible(false);
  MainMenu.GetItemByName('ETranRecordStatus_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(true);
     CurrentGrid = EnumRecordStatus_Grid;
     CurrentGrid.PerformCallback('');
     break;
case 'ETranRecordStatus_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("ETranRecordStatus_ViewItem.Text")%>');
           ETranRecordStatus_View.SetClientVisible(true);
           MainMenu.GetItemByName('ETranRecordStatus_ViewItem').SetVisible(false);
       EnumRecordStatus_View.SetClientVisible(false);
  MainMenu.GetItemByName('EnumRecordStatus_ViewItem').SetVisible(true);
...
break;
                            ...
                            <Items>
                                ...
                                <dxm:MenuItem BeginGroup="True" Name="ViewItem" Text="View" DropDownMode="True" Image-Url="/images/16x16/Toolbar/view.png">
                                        <Items>
                                            <dxm:MenuItem Name="EnumRecordStatus_ViewItem" Text="Standard" meta:resourcekey="EnumRecordStatus_ViewItem"/>
<dxm:MenuItem Name="ETranRecordStatus_ViewItem" Text="Translator" meta:resourcekey="ETranRecordStatus_ViewItem"/>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="EnumRecordStatus_View" ClientInstanceName="EnumRecordStatus_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="EnumRecordStatus_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='EnumRecordStatus_Grid' ID='EnumRecordStatus_Grid' runat='server' Width='100%' KeyFieldName='RECORDSTATUS' Caption='Status of a record in a table' Enabled="True" ClientVisible ="True" meta:resourcekey="EnumRecordStatus_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataTextColumn Name='RecordStatus' FieldName='RECORDSTATUS' Caption='Record Status Key' ToolTip='Status of the record.' VisibleIndex="0" CellStyle-HorizontalAlign="Left" Width="2%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="RecordStatus">
...
<dxwgv:GridViewDataTextColumn Name='RecordStatusCode' FieldName='RECORDSTATUSCODE' Caption='Record Status' ToolTip='Status of the record.' VisibleIndex="1" CellStyle-HorizontalAlign="Left" Width="2%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="RecordStatusCode">
...
<dxwgv:GridViewDataTextColumn Name='Description' FieldName='DESCRIPTION' Caption='Description' ToolTip='Description of the record status.' VisibleIndex="2" CellStyle-HorizontalAlign="Left" Width="68%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="Description">
...
<dxwgv:GridViewDataTextColumn Name='ShortDescription' FieldName='SHORTDESCRIPTION' Caption='Short Description' ToolTip='Abbreviated description of the record status.' VisibleIndex="3" CellStyle-HorizontalAlign="Left" Width="27%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="ShortDescription">
...
<dxp:ASPxPanel ID="ETranRecordStatus_View" ClientInstanceName="ETranRecordStatus_View" runat="server" ClientVisible="False" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="ETranRecordStatus_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='ETranRecordStatus' ID='ETranRecordStatus' runat='server' Width='100%' KeyFieldName='RECORDSTATUS;LANGUAGEID' Caption='Status of a record in a table' Enabled="True" ClientVisible ="True" meta:resourcekey="ETranRecordStatusResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
<SettingsPager PageSize="20"/>
<SettingsBehavior AllowFocusedRow="True"/>
<SettingsEditing Mode="Inline" />
<ClientSideEvents RowDblClick="function(s, e) {s.StartEditRow(e.visibleIndex);}" FocusedRowChanged="function(s, e) {MainMenu.GetItemByName('EditRegisterItem').SetEnabled(s.GetFocusedRowIndex()>-1);}" SelectionChanged="function(s, e) {MainMenu.GetItemByName('RemoveRegisterItem').SetEnabled(s.GetSelectedRowCount()>0);}" />
...
<dxwgv:GridViewDataTextColumn Name='Description' FieldName='DESCRIPTION' Caption='Description' ToolTip='Description of the record status.' VisibleIndex="3" CellStyle-HorizontalAlign="Left" Width="68%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="Description">
<EditFormSettings VisibleIndex="3" Visible="True"/>
<PropertiesTextEdit Size='30' MaxLength='30'>
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Description" is required.'/>
...
<dxwgv:GridViewDataTextColumn Name='ShortDescription' FieldName='SHORTDESCRIPTION' Caption='Short Description' ToolTip='Abbreviated description of the record status.' VisibleIndex="4" CellStyle-HorizontalAlign="Left" Width="27%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="ShortDescription">
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(EnumRecordStatus_Grid);
AddKeyboardNavigationTo(ETranRecordStatus);

                 HandlerView('EnumRecordStatus_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/EnumRecordStatus.html" AllowResize="True"
