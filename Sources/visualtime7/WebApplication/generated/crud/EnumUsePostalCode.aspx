<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="EnumUsePostalCode.aspx.vb" Inherits="Maintenance_EnumUsePostalCode" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'EnumUsePostalCode_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("EnumUsePostalCode_ViewItem.Text")%>');
           EnumUsePostalCode_View.SetClientVisible(true);
           MainMenu.GetItemByName('EnumUsePostalCode_ViewItem').SetVisible(false);
       ETranUsePostalCode_View.SetClientVisible(false);
  MainMenu.GetItemByName('ETranUsePostalCode_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(true);
     CurrentGrid = EnumUsePostalCode_Grid;
     CurrentGrid.PerformCallback('');
     break;
case 'ETranUsePostalCode_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("ETranUsePostalCode_ViewItem.Text")%>');
           ETranUsePostalCode_View.SetClientVisible(true);
           MainMenu.GetItemByName('ETranUsePostalCode_ViewItem').SetVisible(false);
       EnumUsePostalCode_View.SetClientVisible(false);
  MainMenu.GetItemByName('EnumUsePostalCode_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(false);
     CurrentGrid = ETranUsePostalCode;
     CurrentGrid.PerformCallback('');
     break;
...
break;
                            ...
                            <Items>
                                ...
                                <dxm:MenuItem BeginGroup="True" Name="ViewItem" Text="View" DropDownMode="True" Image-Url="/images/16x16/Toolbar/view.png">
                                        <Items>
                                            <dxm:MenuItem Name="EnumUsePostalCode_ViewItem" Text="Standard" meta:resourcekey="EnumUsePostalCode_ViewItem"/>
<dxm:MenuItem Name="ETranUsePostalCode_ViewItem" Text="Translator" meta:resourcekey="ETranUsePostalCode_ViewItem"/>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="EnumUsePostalCode_View" ClientInstanceName="EnumUsePostalCode_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="EnumUsePostalCode_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='EnumUsePostalCode_Grid' ID='EnumUsePostalCode_Grid' runat='server' Width='100%' KeyFieldName='USEPOSTALCODE' Caption='Zip Code Use' Enabled="True" ClientVisible ="True" meta:resourcekey="EnumUsePostalCode_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataTextColumn Name='UsePostalCode' FieldName='USEPOSTALCODE' Caption='Use Postal Code' ToolTip='Use postal code.' VisibleIndex="0" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="11%" Visible="True" meta:resourcekey="UsePostalCode">
...
<PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="###,##0" Size='5'>
 <MaskSettings IncludeLiterals="DecimalSymbol" Mask=" <0..99999g>" />
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Use Postal Code" is required.'/>
     </ValidationSettings>
...
<dxp:ASPxPanel ID="ETranUsePostalCode_View" ClientInstanceName="ETranUsePostalCode_View" runat="server" ClientVisible="False" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="ETranUsePostalCode_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='ETranUsePostalCode' ID='ETranUsePostalCode' runat='server' Width='100%' KeyFieldName='USEPOSTALCODE;LANGUAGEID' Caption='Zip Code Use' Enabled="True" ClientVisible ="True" meta:resourcekey="ETranUsePostalCodeResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
<SettingsPager PageSize="20"/>
<SettingsBehavior AllowFocusedRow="True"/>
<SettingsEditing Mode="Inline" />
<ClientSideEvents RowDblClick="function(s, e) {s.StartEditRow(e.visibleIndex);}" FocusedRowChanged="function(s, e) {MainMenu.GetItemByName('EditRegisterItem').SetEnabled(s.GetFocusedRowIndex()>-1);}" SelectionChanged="function(s, e) {MainMenu.GetItemByName('RemoveRegisterItem').SetEnabled(s.GetSelectedRowCount()>0);}" />
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(EnumUsePostalCode_Grid);
AddKeyboardNavigationTo(ETranUsePostalCode);

                 HandlerView('EnumUsePostalCode_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/EnumUsePostalCode.html" AllowResize="True"
