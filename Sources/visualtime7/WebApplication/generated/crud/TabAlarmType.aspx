<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="TabAlarmType.aspx.vb" Inherits="Maintenance_TabAlarmType" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'TabAlarmType_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TabAlarmType_ViewItem.Text")%>');
           TabAlarmType_View.SetClientVisible(true);
           MainMenu.GetItemByName('TabAlarmType_ViewItem').SetVisible(false);
       TransAlarmType_View.SetClientVisible(false);
  MainMenu.GetItemByName('TransAlarmType_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(true);
     CurrentGrid = TabAlarmType_Grid;
     CurrentGrid.PerformCallback('');
     break;
case 'TransAlarmType_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TransAlarmType_ViewItem.Text")%>');
           TransAlarmType_View.SetClientVisible(true);
           MainMenu.GetItemByName('TransAlarmType_ViewItem').SetVisible(false);
       TabAlarmType_View.SetClientVisible(false);
  MainMenu.GetItemByName('TabAlarmType_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(false);
     CurrentGrid = TransAlarmType_Grid;
     CurrentGrid.PerformCallback('');
     break;
...
break;
                            ...
                            <Items>
                                ...
                                <dxm:MenuItem BeginGroup="True" Name="ViewItem" Text="View" DropDownMode="True" Image-Url="/images/16x16/Toolbar/view.png">
                                        <Items>
                                            <dxm:MenuItem Name="TabAlarmType_ViewItem" Text="Standard" meta:resourcekey="TabAlarmType_ViewItem"/>
<dxm:MenuItem Name="TransAlarmType_ViewItem" Text="Translator" meta:resourcekey="TransAlarmType_ViewItem"/>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="TabAlarmType_View" ClientInstanceName="TabAlarmType_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TabAlarmType_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TabAlarmType_Grid' ID='TabAlarmType_Grid' runat='server' Width='100%' KeyFieldName='ALARMTYPE' Caption='Alarm types' Enabled="True" ClientVisible ="True" meta:resourcekey="TabAlarmType_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataTextColumn Name='AlarmType' FieldName='ALARMTYPE' Caption='Alarm Type' ToolTip='Alarm type.' VisibleIndex="0" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="3%" Visible="True" meta:resourcekey="AlarmType">
...
<PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="###,##0" Size='5'>
 <MaskSettings IncludeLiterals="DecimalSymbol" Mask=" <0..99999g>" />
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Alarm Type" is required.'/>
     </ValidationSettings>
...
<dxp:ASPxPanel ID="TransAlarmType_View" ClientInstanceName="TransAlarmType_View" runat="server" ClientVisible="False" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TransAlarmType_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TransAlarmType_Grid' ID='TransAlarmType_Grid' runat='server' Width='100%' KeyFieldName='ALARMTYPE;LANGUAGEID' Caption='Alarm types' Enabled="True" ClientVisible ="True" meta:resourcekey="TransAlarmType_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
<SettingsPager PageSize="20"/>
<SettingsBehavior AllowFocusedRow="True"/>
<SettingsEditing Mode="Inline" />
<ClientSideEvents RowDblClick="function(s, e) {s.StartEditRow(e.visibleIndex);}" FocusedRowChanged="function(s, e) {MainMenu.GetItemByName('EditRegisterItem').SetEnabled(s.GetFocusedRowIndex()>-1);}" SelectionChanged="function(s, e) {MainMenu.GetItemByName('RemoveRegisterItem').SetEnabled(s.GetSelectedRowCount()>0);}" />
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(TabAlarmType_Grid);
AddKeyboardNavigationTo(TransAlarmType_Grid);

                 HandlerView('TabAlarmType_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/TabAlarmType.html" AllowResize="True"
