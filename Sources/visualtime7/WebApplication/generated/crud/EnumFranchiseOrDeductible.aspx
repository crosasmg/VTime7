<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="EnumFranchiseOrDeductible.aspx.vb" Inherits="Maintenance_EnumFranchiseOrDeductible" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'EnumFranchiseOrDeductible_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("EnumFranchiseOrDeductible_ViewItem.Text")%>');
           EnumFranchiseOrDeductible_View.SetClientVisible(true);
           MainMenu.GetItemByName('EnumFranchiseOrDeductible_ViewItem').SetVisible(false);
       ETranFranchiseOrDeductible_View.SetClientVisible(false);
  MainMenu.GetItemByName('ETranFranchiseOrDeductible_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(true);
     CurrentGrid = EnumFranchiseOrDeductible_Grid;
     CurrentGrid.PerformCallback('');
     break;
case 'ETranFranchiseOrDeductible_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("ETranFranchiseOrDeductible_ViewItem.Text")%>');
           ETranFranchiseOrDeductible_View.SetClientVisible(true);
           MainMenu.GetItemByName('ETranFranchiseOrDeductible_ViewItem').SetVisible(false);
       EnumFranchiseOrDeductible_View.SetClientVisible(false);
  MainMenu.GetItemByName('EnumFranchiseOrDeductible_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(false);
     CurrentGrid = ETranFranchiseOrDeductible;
     CurrentGrid.PerformCallback('');
     break;
...
break;
                            ...
                            <Items>
                                ...
                                <dxm:MenuItem BeginGroup="True" Name="ViewItem" Text="View" DropDownMode="True" Image-Url="/images/16x16/Toolbar/view.png">
                                        <Items>
                                            <dxm:MenuItem Name="EnumFranchiseOrDeductible_ViewItem" Text="Standard" meta:resourcekey="EnumFranchiseOrDeductible_ViewItem"/>
<dxm:MenuItem Name="ETranFranchiseOrDeductible_ViewItem" Text="Translator" meta:resourcekey="ETranFranchiseOrDeductible_ViewItem"/>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="EnumFranchiseOrDeductible_View" ClientInstanceName="EnumFranchiseOrDeductible_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="EnumFranchiseOrDeductible_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='EnumFranchiseOrDeductible_Grid' ID='EnumFranchiseOrDeductible_Grid' runat='server' Width='100%' KeyFieldName='FRANCHISEORDEDUCTIBLE' Caption='Franchise/deductible use' Enabled="True" ClientVisible ="True" meta:resourcekey="EnumFranchiseOrDeductible_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataTextColumn Name='FranchiseOrDeductible' FieldName='FRANCHISEORDEDUCTIBLE' Caption='Franchise or Deductible' ToolTip='Indicates whether a franchise or a deductible apply (it selects one of the two).' VisibleIndex="0" CellStyle-HorizontalAlign="Left" Width="2%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="FranchiseOrDeductible">
...
<PropertiesTextEdit Size='1' MaxLength='1'>
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Franchise or Deductible" is required.'/>
     </ValidationSettings>
...
<dxwgv:GridViewDataComboBoxColumn Name='RecordStatus' FieldName='RECORDSTATUS' Caption='Record Status' ToolTip='Status of the record.' VisibleIndex="1" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="0%" Visible="True" meta:resourcekey="RecordStatus" >
...
<dxwgv:GridViewDataTextColumn Name='Description' FieldName='DESCRIPTION' Caption='Description' ToolTip='Description of the code.' VisibleIndex="2" CellStyle-HorizontalAlign="Left" Width="70%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="Description">
...
<dxwgv:GridViewDataTextColumn Name='ShortDescription' FieldName='SHORTDESCRIPTION' Caption='Short Description' ToolTip='Abbreviated description of the code.' VisibleIndex="3" CellStyle-HorizontalAlign="Left" Width="28%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="ShortDescription">
...
<dxp:ASPxPanel ID="ETranFranchiseOrDeductible_View" ClientInstanceName="ETranFranchiseOrDeductible_View" runat="server" ClientVisible="False" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="ETranFranchiseOrDeductible_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='ETranFranchiseOrDeductible' ID='ETranFranchiseOrDeductible' runat='server' Width='100%' KeyFieldName='FRANCHISEORDEDUCTIBLE;LANGUAGEID' Caption='Franchise/deductible use' Enabled="True" ClientVisible ="True" meta:resourcekey="ETranFranchiseOrDeductibleResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
<SettingsPager PageSize="20"/>
<SettingsBehavior AllowFocusedRow="True"/>
<SettingsEditing Mode="Inline" />
<ClientSideEvents RowDblClick="function(s, e) {s.StartEditRow(e.visibleIndex);}" FocusedRowChanged="function(s, e) {MainMenu.GetItemByName('EditRegisterItem').SetEnabled(s.GetFocusedRowIndex()>-1);}" SelectionChanged="function(s, e) {MainMenu.GetItemByName('RemoveRegisterItem').SetEnabled(s.GetSelectedRowCount()>0);}" />
...
<dxwgv:GridViewDataTextColumn Name='Description' FieldName='DESCRIPTION' Caption='Description' ToolTip='Description of the code.' VisibleIndex="3" CellStyle-HorizontalAlign="Left" Width="70%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="Description">
<EditFormSettings VisibleIndex="3" Visible="True"/>
<PropertiesTextEdit Size='30' MaxLength='30'>
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Description" is required.'/>
...
<dxwgv:GridViewDataTextColumn Name='ShortDescription' FieldName='SHORTDESCRIPTION' Caption='Short Description' ToolTip='Abbreviated description of the code.' VisibleIndex="4" CellStyle-HorizontalAlign="Left" Width="28%" Visible="True" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" meta:resourcekey="ShortDescription">
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(EnumFranchiseOrDeductible_Grid);
AddKeyboardNavigationTo(ETranFranchiseOrDeductible);

                 HandlerView('EnumFranchiseOrDeductible_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/EnumFranchiseOrDeductible.html" AllowResize="True"
