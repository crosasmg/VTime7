<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="EnumTypeOfAddress.aspx.vb" Inherits="Maintenance_EnumTypeOfAddress" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'EnumTypeOfAddress_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("EnumTypeOfAddress_ViewItem.Text")%>');
           EnumTypeOfAddress_View.SetClientVisible(true);
           MainMenu.GetItemByName('EnumTypeOfAddress_ViewItem').SetVisible(false);
       ETranTypeOfAddress_View.SetClientVisible(false);
  MainMenu.GetItemByName('ETranTypeOfAddress_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(true);
     CurrentGrid = EnumTypeOfAddress_Grid;
     CurrentGrid.PerformCallback('');
     break;
case 'ETranTypeOfAddress_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("ETranTypeOfAddress_ViewItem.Text")%>');
           ETranTypeOfAddress_View.SetClientVisible(true);
           MainMenu.GetItemByName('ETranTypeOfAddress_ViewItem').SetVisible(false);
       EnumTypeOfAddress_View.SetClientVisible(false);
  MainMenu.GetItemByName('EnumTypeOfAddress_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(false);
     CurrentGrid = ETranTypeOfAddress;
     CurrentGrid.PerformCallback('');
     break;
...
break;
                            ...
                            <Items>
                                ...
                                <dxm:MenuItem BeginGroup="True" Name="ViewItem" Text="View" DropDownMode="True" Image-Url="/images/16x16/Toolbar/view.png">
                                        <Items>
                                            <dxm:MenuItem Name="EnumTypeOfAddress_ViewItem" Text="Standard" meta:resourcekey="EnumTypeOfAddress_ViewItem"/>
<dxm:MenuItem Name="ETranTypeOfAddress_ViewItem" Text="Translator" meta:resourcekey="ETranTypeOfAddress_ViewItem"/>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="EnumTypeOfAddress_View" ClientInstanceName="EnumTypeOfAddress_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="EnumTypeOfAddress_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='EnumTypeOfAddress_Grid' ID='EnumTypeOfAddress_Grid' runat='server' Width='100%' KeyFieldName='TYPEOFADDRESS' Caption='Type of addresses' Enabled="True" ClientVisible ="True" meta:resourcekey="EnumTypeOfAddress_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataTextColumn Name='TypeOfAddress' FieldName='TYPEOFADDRESS' Caption='Typeof Address' ToolTip='Type of address.' VisibleIndex="0" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="11%" Visible="True" meta:resourcekey="TypeOfAddress">
...
<PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="###,##0" Size='5'>
 <MaskSettings IncludeLiterals="DecimalSymbol" Mask=" <0..99999g>" />
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Typeof Address" is required.'/>
     </ValidationSettings>
...
<dxp:ASPxPanel ID="ETranTypeOfAddress_View" ClientInstanceName="ETranTypeOfAddress_View" runat="server" ClientVisible="False" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="ETranTypeOfAddress_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='ETranTypeOfAddress' ID='ETranTypeOfAddress' runat='server' Width='100%' KeyFieldName='TYPEOFADDRESS;LANGUAGEID' Caption='ET ran Type of Address' Enabled="True" ClientVisible ="True" meta:resourcekey="ETranTypeOfAddressResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
<SettingsPager PageSize="20"/>
<SettingsBehavior AllowFocusedRow="True"/>
<SettingsEditing Mode="Inline" />
<ClientSideEvents RowDblClick="function(s, e) {s.StartEditRow(e.visibleIndex);}" FocusedRowChanged="function(s, e) {MainMenu.GetItemByName('EditRegisterItem').SetEnabled(s.GetFocusedRowIndex()>-1);}" SelectionChanged="function(s, e) {MainMenu.GetItemByName('RemoveRegisterItem').SetEnabled(s.GetSelectedRowCount()>0);}" />
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(EnumTypeOfAddress_Grid);
AddKeyboardNavigationTo(ETranTypeOfAddress);

                 HandlerView('EnumTypeOfAddress_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/EnumTypeOfAddress.html" AllowResize="True"
