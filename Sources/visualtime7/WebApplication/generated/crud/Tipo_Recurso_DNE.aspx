<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="Tipo_Recurso_DNE.aspx.vb" Inherits="Maintenance_Tipo_Recurso_DNE" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'ENUM_TIPO_RECURSO_DNE_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("ENUM_TIPO_RECURSO_DNE_ViewItem.Text")%>');
           ENUM_TIPO_RECURSO_DNE_View.SetClientVisible(true);
           MainMenu.GetItemByName('ENUM_TIPO_RECURSO_DNE_ViewItem').SetVisible(false);
       ETRAN_TIPO_RECURSO_DNE_View.SetClientVisible(false);
  MainMenu.GetItemByName('ETRAN_TIPO_RECURSO_DNE_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(true);
     CurrentGrid = ENUM_TIPO_RECURSO_DNE_Grid;
     CurrentGrid.PerformCallback('');
     break;
case 'ETRAN_TIPO_RECURSO_DNE_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("ETRAN_TIPO_RECURSO_DNE_ViewItem.Text")%>');
           ETRAN_TIPO_RECURSO_DNE_View.SetClientVisible(true);
           MainMenu.GetItemByName('ETRAN_TIPO_RECURSO_DNE_ViewItem').SetVisible(false);
       ENUM_TIPO_RECURSO_DNE_View.SetClientVisible(false);
  MainMenu.GetItemByName('ENUM_TIPO_RECURSO_DNE_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(false);
     CurrentGrid = ETRAN_TIPO_RECURSO_DNE_Grid;
     CurrentGrid.PerformCallback('');
     break;
                           ...
                           <ItemStyle Width="5%" />
                            ...
                            <ItemStyle Width="5%" />
                                ...
                                <dxm:MenuItem BeginGroup="True" Name="ViewItem" Text="View" DropDownMode="True" Image-Url="/images/16x16/Toolbar/view.png">
                                        <Items>
                                            <dxm:MenuItem Name="ENUM_TIPO_RECURSO_DNE_ViewItem" Text="Standard" meta:resourcekey="ENUM_TIPO_RECURSO_DNE_ViewItem"/>
<dxm:MenuItem Name="ETRAN_TIPO_RECURSO_DNE_ViewItem" Text="Translator" meta:resourcekey="ETRAN_TIPO_RECURSO_DNE_ViewItem"/>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="ENUM_TIPO_RECURSO_DNE_View" ClientInstanceName="ENUM_TIPO_RECURSO_DNE_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="ENUM_TIPO_RECURSO_DNE_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='ENUM_TIPO_RECURSO_DNE_Grid' ID='ENUM_TIPO_RECURSO_DNE_Grid' runat='server' Width='100%' KeyFieldName='ID_TIPO_RECURSO_DNE' Caption='Enum Type Resource' Enabled="True" ClientVisible ="True" meta:resourcekey="ENUM_TIPO_RECURSO_DNE_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataTextColumn Name='ID_TIPO_RECURSO_DNE' FieldName='ID_TIPO_RECURSO_DNE' Caption='Resouce type' ToolTip='Resouce type' VisibleIndex="0" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="5%" Visible="True" meta:resourcekey="ID_TIPO_RECURSO_DNE">
...
<PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="###,##0" Size='5'>
 <MaskSettings IncludeLiterals="DecimalSymbol" Mask=" <0..99999g>" />
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Resouce type" is required.'/>
     </ValidationSettings>
...
<dxp:ASPxPanel ID="ETRAN_TIPO_RECURSO_DNE_View" ClientInstanceName="ETRAN_TIPO_RECURSO_DNE_View" runat="server" ClientVisible="False" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="ETRAN_TIPO_RECURSO_DNE_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='ETRAN_TIPO_RECURSO_DNE_Grid' ID='ETRAN_TIPO_RECURSO_DNE_Grid' runat='server' Width='100%' KeyFieldName='ID_TIPO_RECURSO_DNE;ID_LENGUAJE' Caption='Enum Type Resource' Enabled="True" ClientVisible ="True" meta:resourcekey="ETRAN_TIPO_RECURSO_DNE_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
<SettingsPager PageSize="20"/>
<SettingsBehavior AllowFocusedRow="True"/>
<SettingsEditing Mode="Inline" />
...
<Columns>
<dxwgv:GridViewDataTextColumn Name='ID_TIPO_RECURSO_DNE_T' FieldName='ID_TIPO_RECURSO_DNE' Caption='Resouce type' ToolTip='Resouce type' VisibleIndex="0" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="4%" Visible="True" meta:resourcekey="ID_TIPO_RECURSO_DNE_T">
<EditFormSettings VisibleIndex="0" Visible="True"/>
<PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="###,##0" Size='5'>
 <MaskSettings IncludeLiterals="DecimalSymbol" Mask=" <0..99999g>" />
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(ENUM_TIPO_RECURSO_DNE_Grid);
AddKeyboardNavigationTo(ETRAN_TIPO_RECURSO_DNE_Grid);

                 HandlerView('ENUM_TIPO_RECURSO_DNE_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/Tipo_Recurso_DNE.html" AllowResize="True"
