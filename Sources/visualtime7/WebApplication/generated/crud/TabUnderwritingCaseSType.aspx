<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="TabUnderwritingCaseSType.aspx.vb" Inherits="Maintenance_TabUnderwritingCaseSType" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'TabUnderwritingCaseSType_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TabUnderwritingCaseSType_ViewItem.Text")%>');
           TabUnderwritingCaseSType_View.SetClientVisible(true);
           MainMenu.GetItemByName('TabUnderwritingCaseSType_ViewItem').SetVisible(false);
       TransUnderwritingCaseSType_View.SetClientVisible(false);
  MainMenu.GetItemByName('TransUnderwritingCaseSType_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(true);
     CurrentGrid = TabUnderwritingCaseSType_Grid;
     CurrentGrid.PerformCallback('');
     break;
case 'TransUnderwritingCaseSType_ViewItem':     
     MainMenu.GetItemByName('ViewItem').SetText('<%=GetLocalResourceObject("ViewItemMenu")%>' + '<%=GetLocalResourceObject("TransUnderwritingCaseSType_ViewItem.Text")%>');
           TransUnderwritingCaseSType_View.SetClientVisible(true);
           MainMenu.GetItemByName('TransUnderwritingCaseSType_ViewItem').SetVisible(false);
       TabUnderwritingCaseSType_View.SetClientVisible(false);
  MainMenu.GetItemByName('TabUnderwritingCaseSType_ViewItem').SetVisible(true);
  ...
  MainMenu.GetItemByName('RemoveRegisterItem').SetVisible(false);
     CurrentGrid = TransUnderwritingCaseSType_Grid;
     CurrentGrid.PerformCallback('');
     break;
...
break;
                            ...
                            <Items>
                                ...
                                <dxm:MenuItem BeginGroup="True" Name="ViewItem" Text="View" DropDownMode="True" Image-Url="/images/16x16/Toolbar/view.png">
                                        <Items>
                                            <dxm:MenuItem Name="TabUnderwritingCaseSType_ViewItem" Text="Standard" meta:resourcekey="TabUnderwritingCaseSType_ViewItem"/>
<dxm:MenuItem Name="TransUnderwritingCaseSType_ViewItem" Text="Translator" meta:resourcekey="TransUnderwritingCaseSType_ViewItem"/>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="TabUnderwritingCaseSType_View" ClientInstanceName="TabUnderwritingCaseSType_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TabUnderwritingCaseSType_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TabUnderwritingCaseSType_Grid' ID='TabUnderwritingCaseSType_Grid' runat='server' Width='100%' KeyFieldName='UNDERWRITINGCASESTATUS' Caption='Types of status of a case' Enabled="True" ClientVisible ="True" meta:resourcekey="TabUnderwritingCaseSType_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataTextColumn Name='UnderwritingCaseStatus' FieldName='UNDERWRITINGCASESTATUS' Caption='Underwriting Case Status' ToolTip='Underwriting Case Status.' VisibleIndex="0" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="3%" Visible="True" meta:resourcekey="UnderwritingCaseStatus">
...
<PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="###,##0" Size='5'>
 <MaskSettings IncludeLiterals="DecimalSymbol" Mask=" <0..99999g>" />
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Underwriting Case Status" is required.'/>
     </ValidationSettings>
...
<dxp:ASPxPanel ID="TransUnderwritingCaseSType_View" ClientInstanceName="TransUnderwritingCaseSType_View" runat="server" ClientVisible="False" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="TransUnderwritingCaseSType_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='TransUnderwritingCaseSType_Grid' ID='TransUnderwritingCaseSType_Grid' runat='server' Width='100%' KeyFieldName='UNDERWRITINGCASESTATUS;LANGUAGEID' Caption='Types of status of a case' Enabled="True" ClientVisible ="True" meta:resourcekey="TransUnderwritingCaseSType_GridResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
<SettingsPager PageSize="20"/>
<SettingsBehavior AllowFocusedRow="True"/>
<SettingsEditing Mode="Inline" />
<ClientSideEvents RowDblClick="function(s, e) {s.StartEditRow(e.visibleIndex);}" FocusedRowChanged="function(s, e) {MainMenu.GetItemByName('EditRegisterItem').SetEnabled(s.GetFocusedRowIndex()>-1);}" SelectionChanged="function(s, e) {MainMenu.GetItemByName('RemoveRegisterItem').SetEnabled(s.GetSelectedRowCount()>0);}" />
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(TabUnderwritingCaseSType_Grid);
AddKeyboardNavigationTo(TransUnderwritingCaseSType_Grid);

                 HandlerView('TabUnderwritingCaseSType_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/TabUnderwritingCaseSType.html" AllowResize="True"
