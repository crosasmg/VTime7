<%@ Page Title="" Language="VB" MasterPageFile="~/DropthingsMasterPage.master" AutoEventWireup="false"
    CodeFile="PhoneAreaAllowed.aspx.vb" Inherits="Maintenance_PhoneAreaAllowed" meta:resourcekey="PageResource" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
    <script type="text/javascript">
        ...
        function HandlerView(name) {
            switch (name) {
                    case 'ViewItem':   
                        case 'PhoneAreaAllowed_ViewItem':     
     
     
     CurrentGrid = PhoneAreaAllowed;
     CurrentGrid.PerformCallback('');
     break;
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td width="1000px">
                      ...
                      <dxp:ASPxPanel ID="PhoneAreaAllowed_View" ClientInstanceName="PhoneAreaAllowed_View" runat="server" ClientVisible="True" Width="100%" >
    <PanelCollection>        <dxp:PanelContent ID="PhoneAreaAllowed_ViewPanel" runat="server" SupportsDisabledAttribute="True" >

<dxwgv:ASPxGridView AutoGenerateColumns='False' ClientInstanceName='PhoneAreaAllowed' ID='PhoneAreaAllowed' runat='server' Width='100%' KeyFieldName='COUNTRYID;PHONEAREA' Caption='Codes allowed' Enabled="True" ClientVisible ="True" meta:resourcekey="PhoneAreaAllowedResource" EnableRowsCache="False" EnableViewState="False" KeyboardSupport="False" EnableCallbackCompression="True" EnableCallBacks="True">
...
<dxwgv:GridViewDataComboBoxColumn Name='CountryID' FieldName='COUNTRYID' Caption='Country ID' ToolTip='Código del país.
Valores posibles según tabla 66.' VisibleIndex="0" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="0%" Visible="True" meta:resourcekey="CountryID" >
...
<PropertiesComboBox ValueType="System.Int32" IncrementalFilteringMode="StartsWith" EnableCallbackMode="false"  TextField='DESCRIPTION' ValueField='COUNTRYID'> 
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Country ID" is required.'/>
     </ValidationSettings>
...
<dxwgv:GridViewDataTextColumn Name='PhoneArea' FieldName='PHONEAREA' Caption='Phone Area' ToolTip='Phone Area Code allowed.' VisibleIndex="1" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="86%" Visible="True" meta:resourcekey="PhoneArea">
...
<PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="#,###,##0" Size='6'>
 <MaskSettings IncludeLiterals="DecimalSymbol" Mask=" <0..999999g>" />
     <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic">
       <RequiredField IsRequired='True' ErrorText='The "Phone Area" is required.'/>
     </ValidationSettings>
     <Style Paddings-PaddingLeft="8px" BackgroundImage-HorizontalPosition="left" BackgroundImage-ImageUrl ="/images/generaluse/required.PNG" BackgroundImage-Repeat="NoRepeat" BackgroundImage-VerticalPosition="center">
</Style>
</PropertiesTextEdit>
</dxwgv:GridViewDataTextColumn>
<dxwgv:GridViewDataCheckColumn Name='MobileIndicator' FieldName='MOBILEINDICATOR' Caption='Mobile Indicator' ToolTip='The area code corresponds to a cell phone.' VisibleIndex="2" HeaderStyle-Wrap="True" HeaderStyle-VerticalAlign="Bottom" HeaderStyle-HorizontalAlign="Center" Width="14%" Visible="True" meta:resourcekey="MobileIndicator">
...
<Image Url="~/images/16x16/Commands/accept.png"/>
            ...
            <script type="text/javascript">                
                 AddKeyboardNavigationTo(PhoneAreaAllowed);

                 HandlerView('PhoneAreaAllowed_ViewItem')                
            </script> 
            <dxpc:ASPxPopupControl ID="popupHelp" runat="server" AllowDragging="True" ContentStyle-Paddings-Padding="0"
                ...
                Width="400px" ContentUrl="~/generated/crud/help/PhoneAreaAllowed.html" AllowResize="True"
