'---------------------------------------------------------------------------------------------------
' <generated>
'     This code was generated by Form Designer Oracle v7.3.1 at 2019-08-30 model release 4
'     
...
Partial Public Class NNCotizacionMiVidaValeIIALCUserControl
...
#Region "Private fields"
    ...
    Private _formData As NNCotizacionMiVidaValeIIALCParameter = Nothing
...
#Region "Public properties"
    ...
    Public Property FormData() As NNCotizacionMiVidaValeIIALCParameter
        Get
            ...
            If IsNothing(_formData) Then
                If Not IsPostBack Then
                    ...
                    If IsNothing(_formData) Then
                        _formData = New NNCotizacionMiVidaValeIIALCParameter
        ...
        Set(value As NNCotizacionMiVidaValeIIALCParameter)
            _formData = value
        End Set
    End Property
...
#Region "Form Events"
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Dim formData As NNCotizacionMiVidaValeIIALCParameter = Me.FormData        
...
StoreFormInformation() 
        ...
        If Not IsNothing(_formData) Then
             ...
             If Not IsNothing(Session("Form.Track.Parameters")) AndAlso Session("Form.Track.Parameters").ToString.ToLower = "true" Then
                  InMotionGIT.Common.Helpers.Serialize.SerializeToFile(Of NNCotizacionMiVidaValeIIALCParameter) _
                  (formData, String.Format(CultureInfo.InvariantCulture, "{0}\{1}.NNCotizacionMiVidaValeIIALC.xml",  ConfigurationManager.AppSettings("Path.Logs"), formData.InternalId), True)
             End If        
        End If  
   End Sub
...
Protected Sub PaymentMethod_DataBinding(sender As Object, e As EventArgs) Handles PaymentMethod.DataBinding
	...
	With New DataManagerFactory(String.Format(CultureInfo.CurrentCulture, 
											  "SELECT  TABLE5002.NWAY_PAY, TABLE5002.SSTATREGT, TABLE5002.SDESCRIPT FROM TABLE5002 TABLE5002  WHERE TABLE5002.SSTATREGT = '{0}'  AND NOT TABLE5002.SDESCRIPT IS NULL ORDER BY SDESCRIPT", "1"), "TABLE5002", "Linked.LatCombined")
...
Protected Sub RelationshipBD_DataBinding(sender As Object, e As EventArgs) Handles RelationshipBD.DataBinding
	...
	With New DataManagerFactory(String.Format(CultureInfo.CurrentCulture, 
											  "SELECT  TABLE55.NRELATION, TABLE55.SSTATREGT, TABLE55.SDESCRIPT FROM TABLE55 TABLE55  WHERE TABLE55.SSTATREGT = '{0}'  AND NOT TABLE55.SDESCRIPT IS NULL ORDER BY SDESCRIPT", "1"), "TABLE55", "Linked.LatCombined")
...
Protected Sub CreditCardType_DataBinding(sender As Object, e As EventArgs) Handles CreditCardType.DataBinding
	...
	With New DataManagerFactory(String.Format(CultureInfo.CurrentCulture, 
											  "SELECT  TABLE183.NCARD_TYPE, TABLE183.SSTATREGT, TABLE183.SDESCRIPT FROM TABLE183 TABLE183  WHERE TABLE183.SSTATREGT = '{0}'  AND NOT TABLE183.SDESCRIPT IS NULL ORDER BY SDESCRIPT", "1"), "TABLE183", "Linked.LatCombined")
...
Protected Sub BankCode_DataBinding(sender As Object, e As EventArgs) Handles BankCode.DataBinding
	...
	With New DataManagerFactory(String.Format(CultureInfo.CurrentCulture, 
											  "SELECT  TABLE7.NBANK_CODE, TABLE7.SSTATREGT, TABLE7.SDESCRIPT FROM TABLE7 TABLE7  WHERE TABLE7.SSTATREGT = '{0}'  AND NOT TABLE7.SDESCRIPT IS NULL ORDER BY SDESCRIPT", "1"), "TABLE7", "Linked.LatCombined")
...
Protected Sub LineOfBusiness_DataBinding(sender As Object, e As EventArgs) Handles LineOfBusiness.DataBinding
	...
	With New DataManagerFactory(String.Format(CultureInfo.CurrentCulture, 
											  "SELECT  TABLE10.NBRANCH, TABLE10.SDESCRIPT FROM TABLE10 TABLE10  WHERE  ( TABLE10.SSTATREGT = 1 )   AND NOT TABLE10.SDESCRIPT IS NULL ORDER BY SDESCRIPT", "1"), "TABLE10", "Linked.LatCombined")
...
Protected Sub RiskInformationProductCode_DataBinding(sender As Object, e As EventArgs) Handles RiskInformationProductCode.DataBinding
	...
	With New DataManagerFactory(String.Format(CultureInfo.CurrentCulture, 
											  "SELECT  PRODMASTER.NBRANCH, PRODMASTER.NPRODUCT, PRODMASTER.SDESCRIPT FROM PRODMASTER PRODMASTER  WHERE PRODMASTER.SSTATREGT = 1  AND (PRODMASTER.NBRANCH = @:PRODMASTERNBRANCHDependen AND NOT PRODMASTER.SDESCRIPT IS NULL) ORDER BY SDESCRIPT ", "1"), "PRODMASTER", "Linked.LatCombined")
...
#Region "Mapping methods"
    ...
    Public Sub ValidateParametersInstance(ByRef NNCotizacionMiVidaValeIIALCParameterInstance As NNCotizacionMiVidaValeIIALCParameter)
        If IsNothing(NNCotizacionMiVidaValeIIALCParameterInstance.RiskInformation) Then
            NNCotizacionMiVidaValeIIALCParameterInstance.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
        End If
        If IsNothing(NNCotizacionMiVidaValeIIALCParameterInstance.ClientIncluded) Then
            NNCotizacionMiVidaValeIIALCParameterInstance.ClientIncluded = New InMotionGIT.Client.Entity.Contracts.Client
        End If
        If IsNothing(NNCotizacionMiVidaValeIIALCParameterInstance.RiskInformation.LifeLineOfBusiness) Then
            NNCotizacionMiVidaValeIIALCParameterInstance.RiskInformation.LifeLineOfBusiness = New InMotionGIT.Policy.Entity.Contracts.LifeLineOfBusiness
        End If
        If IsNothing(NNCotizacionMiVidaValeIIALCParameterInstance.RiskInformation.Policy) Then
            NNCotizacionMiVidaValeIIALCParameterInstance.RiskInformation.Policy = New InMotionGIT.Policy.Entity.Contracts.Policy
        End If
        If IsNothing(NNCotizacionMiVidaValeIIALCParameterInstance.ClientInsuredPerson) Then
            NNCotizacionMiVidaValeIIALCParameterInstance.ClientInsuredPerson = New InMotionGIT.Client.Entity.Contracts.Client
        End If
        If IsNothing(NNCotizacionMiVidaValeIIALCParameterInstance.RiskInformation.PrimaryInsured) Then
            NNCotizacionMiVidaValeIIALCParameterInstance.RiskInformation.PrimaryInsured = New InMotionGIT.Policy.Entity.Contracts.Role
        End If
        If IsNothing(NNCotizacionMiVidaValeIIALCParameterInstance.RiskInformation.PrimaryInsured.Client) Then
            NNCotizacionMiVidaValeIIALCParameterInstance.RiskInformation.PrimaryInsured.Client = New InMotionGIT.Client.Entity.Contracts.Client
        End If
        If IsNothing(NNCotizacionMiVidaValeIIALCParameterInstance.AddressPhysicalAddressDLI) Then
            NNCotizacionMiVidaValeIIALCParameterInstance.AddressPhysicalAddressDLI = New InMotionGIT.AddressManager.Contract.Models.AddressPhysicalAddressDLI
        End If
        If IsNothing(NNCotizacionMiVidaValeIIALCParameterInstance.AddresseMailDLI) Then
            NNCotizacionMiVidaValeIIALCParameterInstance.AddresseMailDLI = New InMotionGIT.AddressManager.Contract.Models.AddresseMailDLI
        End If
        If IsNothing(NNCotizacionMiVidaValeIIALCParameterInstance.AddresseMailDLI.eMailAddress) Then
            NNCotizacionMiVidaValeIIALCParameterInstance.AddresseMailDLI.eMailAddress = New InMotionGIT.AddressManager.Contract.General.eMailAddress
        End If
        If IsNothing(NNCotizacionMiVidaValeIIALCParameterInstance.QuestionnairesAvailable) Then
            NNCotizacionMiVidaValeIIALCParameterInstance.QuestionnairesAvailable = New InMotionGIT.Questionnaires.QuestionnairesAvailable
        End If
        If IsNothing(NNCotizacionMiVidaValeIIALCParameterInstance.Beneficiary) Then
            NNCotizacionMiVidaValeIIALCParameterInstance.Beneficiary = New InMotionGIT.Policy.Entity.Contracts.Beneficiary
        End If
        If IsNothing(NNCotizacionMiVidaValeIIALCParameterInstance.Beneficiary.Client) Then
            NNCotizacionMiVidaValeIIALCParameterInstance.Beneficiary.Client = New InMotionGIT.Client.Entity.Contracts.Client
        End If
        If IsNothing(NNCotizacionMiVidaValeIIALCParameterInstance.RiskInformation.AutomaticPaymentPolicy) Then
            NNCotizacionMiVidaValeIIALCParameterInstance.RiskInformation.AutomaticPaymentPolicy = New InMotionGIT.Policy.Entity.Contracts.AutomaticPaymentPolicy
        End If
    ...
    ''' </summary>
    ''' <param name="NNCotizacionMiVidaValeIIALCParameterInstance"></param>
    ''' <remarks></remarks>
    Public Sub MapClassToPage(ByRef NNCotizacionMiVidaValeIIALCParameterInstance As NNCotizacionMiVidaValeIIALCParameter, Optional calledBy As String = "")
        Dim parametersDictionary As Dictionary(Of String, Object) = Nothing
        ValidateParametersInstance(NNCotizacionMiVidaValeIIALCParameterInstance)
...
RiskInformationProductCode.DataBind()
        ...
        With NNCotizacionMiVidaValeIIALCParameterInstance
            ...
            CheckDigitNew.Text = .ClientInsuredPerson.CheckDigit
            ...
            CheckDigit.Text = .ClientInsuredPerson.CheckDigit
...
'SendProblemAddressShow
            ...
            CheckDigitBenif.Text = .Beneficiary.Client.CheckDigit
...
if (Not ("CoverageForAmendment|Beneficiary".IndexOf(calledBy) > -1)) Or String.IsNullOrEmpty(calledBy) then        
    ...
    ''' </summary>
    ''' <param name="NNCotizacionMiVidaValeIIALCParameterInstance"></param>
    Public Sub MapPageToClass(ByRef NNCotizacionMiVidaValeIIALCParameterInstance As NNCotizacionMiVidaValeIIALCParameter)
        _loading = True
        ...
        With NNCotizacionMiVidaValeIIALCParameterInstance
            ...
            .ClientInsuredPerson.CheckDigit = CheckDigitNew.Text.Trim()
            ...
            .ClientInsuredPerson.CheckDigit = CheckDigit.Text.Trim()
            ...
            .Beneficiary.Client.CheckDigit = CheckDigitBenif.Text.Trim()
...
End With
    ...
    Private Sub SetCoverageForAmendmentListDataBind(Optional editIndex As Integer = -1, Optional isCancel As Boolean = False)
        Dim FormData As NNCotizacionMiVidaValeIIALCParameter
...
Protected Sub InsuredAmountSelected_SelectedIndexChanged(sender As Object, e As EventArgs)  
        Dim NNCotizacionMiVidaValeIIALCParameterInstance As NNCotizacionMiVidaValeIIALCParameter = Nothing
        ...
        Try 
           ...
           GetCurrentParameterInstance(NNCotizacionMiVidaValeIIALCParameterInstance, True)
...
BehaviorShowControls("Coverages,Hidden")
 ...
 _formData.RiskInformation.LifeLineOfBusiness.InsuredAmountForCalculation = _formData.InsuredAmountSelected 
          ...
          SetCurrentParameterInstance(NNCotizacionMiVidaValeIIALCParameterInstance,"CoverageForAmendment")
          
        
          If NNCotizacionMiVidaValeIIALCParameterInstance.Behavior <> InMotionGIT.FrontOffice.Support.Enumerations.enumBehavior.None Then
             If Not String.IsNullOrEmpty(NNCotizacionMiVidaValeIIALCParameterInstance.NotifyMessage) Then
                 ShowWindowPopupMessage(NNCotizacionMiVidaValeIIALCParameterInstance.NotifyMessage)
             End If           
            
             NNCotizacionMiVidaValeIIALCParameterInstance.Behavior = InMotionGIT.FrontOffice.Support.Enumerations.enumBehavior.None
          End If
        
          If Not String.IsNullOrEmpty(NNCotizacionMiVidaValeIIALCParameterInstance.BehaviorShowControls) Then
               BehaviorShowControls(NNCotizacionMiVidaValeIIALCParameterInstance.BehaviorShowControls)
          End If        
      ...
      Finally
           ...
           If  _formData.Errors.Count = 0 AndAlso Not String.IsNullOrEmpty(_webTransfer) Then
               ...
               End If          
           End If
		   NNCotizacionMiVidaValeIIALCUpdatePanel.Update
      End Try
...
If _formData.RiskInformation.LifeLineOfBusiness.ActuarialAge < 18 Then
            ...
            NNCotizacionMiVidaValeIIALCTablePage.Visible = False 
            MessageTable.Visible = True 
...
If _formData.InRuleErros = false Then
            ...
            End With
            WorkflowOutArguments = InMotionGIT.Workflow.Support.Runtime.DoWorkFromForm("AsignaModulosPorDefecto", "f7b4e740-4915-411e-bc5b-a5027c73d125", 1, WorkflowInArguments, True, True, Me.AppRelativeVirtualPath, _formData.InternalId)
             currentAction += " 'Mapping Outputs'" 
                _formData.RiskInformation.Modules = WorkflowOutArguments("ModulosRiskInformation")

currentAction = SessionTrace("28. Call 'Cálculo de coberturas' library") 
        Dim _RiskInformation_c535143858634c7898629f8e64d3b354 As InMotionGIT.Policy.Entity.Contracts.RiskInformation 
        _RiskInformation_c535143858634c7898629f8e64d3b354 = InMotionGIT.PolicyManager.Proxy.Manager.RatingCalculateProcess(riskInformation:=_formData.RiskInformation, errors:=_formContext.Errors, transaction:=1, atDate:=Date.Today, accessToken:="String.Empty", provider:="CORE", companyID:=0) 
 
       isNullResult = (IsNothing(_RiskInformation_c535143858634c7898629f8e64d3b354)) 
       If Not isNullResult Then
            _formData.RiskInformation = _RiskInformation_c535143858634c7898629f8e64d3b354
       End If

currentAction = SessionTrace("30. Call 'Configuración de información de procesamiento de RiskInformation (Amendment Setup)' library") 
        Dim _RiskInformation_b5ed0090e345452987c89821c0ae4c73 As InMotionGIT.Policy.Entity.Contracts.RiskInformation 
        _RiskInformation_b5ed0090e345452987c89821c0ae4c73 = InMotionGIT.PolicyManager.Proxy.Manager.AmendmentSetup(risk:=_formData.RiskInformation, atDate:=Date.Today, accessToken:="String.Empty", provider:="CORE") 
 
       isNullResult = (IsNothing(_RiskInformation_b5ed0090e345452987c89821c0ae4c73)) 
       If Not isNullResult Then
            _formData.RiskInformation = _RiskInformation_b5ed0090e345452987c89821c0ae4c73
       End If
...
If _formData.ClientExistInDB = true Then
 ...
 _formData.AddressPhysicalAddressDLI.Address.RecordOwnerID = _formData.RiskInformation.PrimaryInsured.Client.ClientID 
          ...
          SetCurrentParameterInstance(NNCotizacionMiVidaValeIIALCParameterInstance,"Beneficiary")
...
currentAction = SessionTrace("25. Call 'Obtener la información de correo electrónico - retrieve an email address' library") 
        Dim _AddresseMailDLI_947d4ee94bd74e6c8082875eb7cf98c6 As InMotionGIT.AddressManager.Contract.Models.AddresseMailDLI 
        _AddresseMailDLI_947d4ee94bd74e6c8082875eb7cf98c6 = (New InMotionGIT.AddressManager.Proxy.AddressManager.PublicClient).RetrieveeMailDLI(processDate:=_formData.RiskInformation.EffectiveDate, addressId:=_formData.AddresseMailDLI.Address.AddressID, internalAddressKey:=_formData.AddresseMailDLI.Address.InternalAddressKey, consumer:=_formData.ConsumerInformation) 
 
       isNullResult = (IsNothing(_AddresseMailDLI_947d4ee94bd74e6c8082875eb7cf98c6)) 
       If Not isNullResult Then
            _formData.AddresseMailDLI = _AddresseMailDLI_947d4ee94bd74e6c8082875eb7cf98c6
       End If
...
currentAction = SessionTrace("30. Call 'Obtener dirección física - Retrieve a physical address' library") 
        Dim _AddressPhysicalAddressDLI_3a4b45dc271041d5b6efa8e0d4ac06bd As InMotionGIT.AddressManager.Contract.Models.AddressPhysicalAddressDLI 
        _AddressPhysicalAddressDLI_3a4b45dc271041d5b6efa8e0d4ac06bd = (New InMotionGIT.AddressManager.Proxy.AddressManager.PublicClient).RetrievePhysicalAddressDLI(processDate:=Date.Today, addressId:=_formData.AddressPhysicalAddressDLI.Address.AddressID, internalAddressKey:=_formData.AddressPhysicalAddressDLI.Address.InternalAddressKey, consumer:=_formData.ConsumerInformation) 
 
       isNullResult = (IsNothing(_AddressPhysicalAddressDLI_3a4b45dc271041d5b6efa8e0d4ac06bd)) 
       If Not isNullResult Then
            _formData.AddressPhysicalAddressDLI = _AddressPhysicalAddressDLI_3a4b45dc271041d5b6efa8e0d4ac06bd
       End If
...
currentAction = SessionTrace("32. Call 'Obtiene las direcciones asociadas a un propietario - Retrieve addresses by owner' library") 
        Dim _AddressDLICollection_1fa57c2f18b44062a53b7b7dec5d3e29 As InMotionGIT.AddressManager.Contract.General.AddressDLICollection 
        _AddressDLICollection_1fa57c2f18b44062a53b7b7dec5d3e29 = (New InMotionGIT.AddressManager.Proxy.AddressManager.PublicClient).RetrieveAddressesDLI(processDate:=_formData.RiskInformation.EffectiveDate, userCompany:=_formData.AddressPhysicalAddressDLI.Address.UserCompany, recordOwnerType:=_formData.AddressPhysicalAddressDLI.Address.RecordOwnerType, recordOwnerId:=_formData.AddressPhysicalAddressDLI.Address.RecordOwnerID, consumer:=_formData.ConsumerInformation, typeOfAddress:=_formData.AddressPhysicalAddressDLI.Address.TypeOfAddress, typeOfPhysicalAddress:=_formData.AddressPhysicalAddressDLI.PhysicalAddress.TypeOfPhysicalAddress) 
 
       isNullResult = (IsNothing(_AddressDLICollection_1fa57c2f18b44062a53b7b7dec5d3e29)) 
       If Not isNullResult Then
            _formData.AddressDLICollection = _AddressDLICollection_1fa57c2f18b44062a53b7b7dec5d3e29
       End If
...
currentAction = SessionTrace("35. Call 'Obtener dirección física - Retrieve a physical address' library") 
        Dim _AddressPhysicalAddressDLI_d73d6482d68d4ce79c479be3be24259e As InMotionGIT.AddressManager.Contract.Models.AddressPhysicalAddressDLI 
        _AddressPhysicalAddressDLI_d73d6482d68d4ce79c479be3be24259e = (New InMotionGIT.AddressManager.Proxy.AddressManager.PublicClient).RetrievePhysicalAddressDLI(processDate:=Date.Today, addressId:=_formData.AddressPhysicalAddressDLI.Address.AddressID, internalAddressKey:=_formData.AddressPhysicalAddressDLI.Address.InternalAddressKey, consumer:=_formData.ConsumerInformation) 
 
       isNullResult = (IsNothing(_AddressPhysicalAddressDLI_d73d6482d68d4ce79c479be3be24259e)) 
       If Not isNullResult Then
            _formData.AddressPhysicalAddressDLI = _AddressPhysicalAddressDLI_d73d6482d68d4ce79c479be3be24259e
       End If
...
currentAction = SessionTrace("39. Call 'Busca la información de dirección de un ID - Retrieve addresses by id' library") 
        Dim _AddressDLICollection_301b92ff6b28403497f2666fa39ef994 As InMotionGIT.AddressManager.Contract.General.AddressDLICollection 
        _AddressDLICollection_301b92ff6b28403497f2666fa39ef994 = (New InMotionGIT.AddressManager.Proxy.AddressManager.PublicClient).RetrieveAddressesByIdDLI(processDate:=_formData.RiskInformation.EffectiveDate, userCompany:=_formData.AddresseMailDLI.Address.UserCompany, addressId:=_formData.AddresseMailDLI.Address.AddressID, consumer:=_formData.ConsumerInformation, typeOfAddress:=_formData.AddresseMailDLI.Address.TypeOfAddress, typeOfPhysicalAddress:=_formData.AddressPhysicalAddressDLI.PhysicalAddress.TypeOfPhysicalAddress) 
 
       isNullResult = (IsNothing(_AddressDLICollection_301b92ff6b28403497f2666fa39ef994)) 
       If Not isNullResult Then
            _formData.AddressDLICollection = _AddressDLICollection_301b92ff6b28403497f2666fa39ef994
       End If
...
currentAction = SessionTrace("42. Call 'Obtener la información de correo electrónico - retrieve an email address' library") 
        Dim _AddresseMailDLI_2b8c52ca386c46d5838ae0f84edbce2a As InMotionGIT.AddressManager.Contract.Models.AddresseMailDLI 
        _AddresseMailDLI_2b8c52ca386c46d5838ae0f84edbce2a = (New InMotionGIT.AddressManager.Proxy.AddressManager.PublicClient).RetrieveeMailDLI(processDate:=_formData.RiskInformation.EffectiveDate, addressId:=_formData.AddresseMailDLI.Address.AddressID, internalAddressKey:=_formData.AddresseMailDLI.Address.InternalAddressKey, consumer:=_formData.ConsumerInformation) 
 
       isNullResult = (IsNothing(_AddresseMailDLI_2b8c52ca386c46d5838ae0f84edbce2a)) 
       If Not isNullResult Then
            _formData.AddresseMailDLI = _AddresseMailDLI_2b8c52ca386c46d5838ae0f84edbce2a
       End If
...
currentAction = SessionTrace("44. Call 'Busca la información de dirección de un ID - Retrieve addresses by id' library") 
        Dim _AddressDLICollection_e95c0616747d4d79ad8d2827f9a72c13 As InMotionGIT.AddressManager.Contract.General.AddressDLICollection 
        _AddressDLICollection_e95c0616747d4d79ad8d2827f9a72c13 = (New InMotionGIT.AddressManager.Proxy.AddressManager.PublicClient).RetrieveAddressesByIdDLI(processDate:=_formData.RiskInformation.EffectiveDate, userCompany:=_formData.AddressPhysicalAddressDLI.Address.UserCompany, addressId:=_formData.AddressPhysicalAddressDLI.Address.AddressID, consumer:=_formData.ConsumerInformation, typeOfAddress:=_formData.AddressPhysicalAddressDLI.Address.TypeOfAddress, typeOfPhysicalAddress:=_formData.AddressPhysicalAddressDLI.PhysicalAddress.TypeOfPhysicalAddress) 
 
       isNullResult = (IsNothing(_AddressDLICollection_e95c0616747d4d79ad8d2827f9a72c13)) 
       If Not isNullResult Then
            _formData.AddressDLICollection = _AddressDLICollection_e95c0616747d4d79ad8d2827f9a72c13
       End If
...
currentAction = SessionTrace("47. Call 'Obtener dirección física - Retrieve a physical address' library") 
        Dim _AddressPhysicalAddressDLI_638b592fbe554a0fa649ccc965af01e7 As InMotionGIT.AddressManager.Contract.Models.AddressPhysicalAddressDLI 
        _AddressPhysicalAddressDLI_638b592fbe554a0fa649ccc965af01e7 = (New InMotionGIT.AddressManager.Proxy.AddressManager.PublicClient).RetrievePhysicalAddressDLI(processDate:=Date.Today, addressId:=_formData.AddressPhysicalAddressDLI.Address.AddressID, internalAddressKey:=_formData.AddressPhysicalAddressDLI.Address.InternalAddressKey, consumer:=_formData.ConsumerInformation) 
 
       isNullResult = (IsNothing(_AddressPhysicalAddressDLI_638b592fbe554a0fa649ccc965af01e7)) 
       If Not isNullResult Then
            _formData.AddressPhysicalAddressDLI = _AddressPhysicalAddressDLI_638b592fbe554a0fa649ccc965af01e7
       End If
...
currentAction = SessionTrace("52. Call 'Obtener dirección física - Retrieve a physical address' library") 
        Dim _AddressPhysicalAddressDLI_89c3d340b1074041bce6a1a8677ddc32 As InMotionGIT.AddressManager.Contract.Models.AddressPhysicalAddressDLI 
        _AddressPhysicalAddressDLI_89c3d340b1074041bce6a1a8677ddc32 = (New InMotionGIT.AddressManager.Proxy.AddressManager.PublicClient).RetrievePhysicalAddressDLI(processDate:=Date.Today, addressId:=_formData.AddressPhysicalAddressDLI.Address.AddressID, internalAddressKey:=_formData.AddressPhysicalAddressDLI.Address.InternalAddressKey, consumer:=_formData.ConsumerInformation) 
 
       isNullResult = (IsNothing(_AddressPhysicalAddressDLI_89c3d340b1074041bce6a1a8677ddc32)) 
       If Not isNullResult Then
            _formData.AddressPhysicalAddressDLI = _AddressPhysicalAddressDLI_89c3d340b1074041bce6a1a8677ddc32
       End If
...
currentAction = SessionTrace("12. Call 'Búsqueda de toda la información de un cliente' library") 
        Dim _Client_470c67879f254a8fa172efef888fff93 As InMotionGIT.Client.Entity.Contracts.Client 
        _Client_470c67879f254a8fa172efef888fff93 = (New InMotionGIT.Client.Proxy.Manager).Retrieve(clientId:=_formData.UserInformation.ClientID, atDate:=Date.Today, withLookupInformation:=True, childFilter:="All", accessToken:="String.Empty", provider:="CORE", companyID:=0) 
 
       isNullResult = (IsNothing(_Client_470c67879f254a8fa172efef888fff93)) 
       If Not isNullResult Then
            _formData.ClientProvisional = _Client_470c67879f254a8fa172efef888fff93
       End If
...
If _formData.QRegistros = 0 OrElse IsNothing(_formData.QRegistros) Then
 ...
 _formData.ErrorsFound = true 
        ...
        Else 
currentAction = SessionTrace("21. Call 'Búsqueda de toda la información de un cliente' library") 
        Dim _Client_db5f7662ef02495b9386cdd06a12c83f As InMotionGIT.Client.Entity.Contracts.Client 
        _Client_db5f7662ef02495b9386cdd06a12c83f = (New InMotionGIT.Client.Proxy.Manager).Retrieve(clientId:=_formData.ClientInsuredPerson.ClientID, atDate:=Date.Today, withLookupInformation:=True, childFilter:="All", accessToken:="String.Empty", provider:="CORE", companyID:=0) 
 
       isNullResult = (IsNothing(_Client_db5f7662ef02495b9386cdd06a12c83f)) 
       If Not isNullResult Then
            _formData.ClientProvisional = _Client_db5f7662ef02495b9386cdd06a12c83f
       End If
...
currentAction = SessionTrace("25. Call 'Búsqueda de toda la información de un cliente' library") 
        Dim _Client_e5d4646fd1fa4a8080f6d3765452cf1c As InMotionGIT.Client.Entity.Contracts.Client 
        _Client_e5d4646fd1fa4a8080f6d3765452cf1c = (New InMotionGIT.Client.Proxy.Manager).Retrieve(clientId:=_formData.ClientInsuredPerson.ClientID, atDate:=Date.Today, withLookupInformation:=True, childFilter:="All", accessToken:="String.Empty", provider:="CORE", companyID:=0) 
 
       isNullResult = (IsNothing(_Client_e5d4646fd1fa4a8080f6d3765452cf1c)) 
       If Not isNullResult Then
            _formData.ClientProvisional = _Client_e5d4646fd1fa4a8080f6d3765452cf1c
       End If
...
currentAction = SessionTrace("61. Call 'Obtiene las direcciones asociadas a un propietario - Retrieve addresses by owner' library") 
        Dim _AddressDLICollection_0b7393dedbb7426abeacbcb30ddde26b As InMotionGIT.AddressManager.Contract.General.AddressDLICollection 
        _AddressDLICollection_0b7393dedbb7426abeacbcb30ddde26b = (New InMotionGIT.AddressManager.Proxy.AddressManager.PublicClient).RetrieveAddressesDLI(processDate:=_formData.RiskInformation.EffectiveDate, userCompany:=_formData.AddresseMailDLI.Address.UserCompany, recordOwnerType:=_formData.AddresseMailDLI.Address.RecordOwnerType, recordOwnerId:=_formData.AddresseMailDLI.Address.RecordOwnerID, consumer:=_formData.ConsumerInformation, typeOfAddress:=_formData.AddresseMailDLI.Address.TypeOfAddress, typeOfPhysicalAddress:=_formData.AddressPhysicalAddressDLI.PhysicalAddress.TypeOfPhysicalAddress) 
 
       isNullResult = (IsNothing(_AddressDLICollection_0b7393dedbb7426abeacbcb30ddde26b)) 
       If Not isNullResult Then
            _formData.AddressDLICollection = _AddressDLICollection_0b7393dedbb7426abeacbcb30ddde26b
       End If
...
currentAction = SessionTrace("64. Call 'Obtener la información de correo electrónico - retrieve an email address' library") 
        Dim _AddresseMailDLI_1855ef9ce97c44cd81dfd57b514af3d3 As InMotionGIT.AddressManager.Contract.Models.AddresseMailDLI 
        _AddresseMailDLI_1855ef9ce97c44cd81dfd57b514af3d3 = (New InMotionGIT.AddressManager.Proxy.AddressManager.PublicClient).RetrieveeMailDLI(processDate:=_formData.RiskInformation.EffectiveDate, addressId:=_formData.AddresseMailDLI.Address.AddressID, internalAddressKey:=_formData.AddresseMailDLI.Address.InternalAddressKey, consumer:=_formData.ConsumerInformation) 
 
       isNullResult = (IsNothing(_AddresseMailDLI_1855ef9ce97c44cd81dfd57b514af3d3)) 
       If Not isNullResult Then
            _formData.AddresseMailDLI = _AddresseMailDLI_1855ef9ce97c44cd81dfd57b514af3d3
       End If
...
currentAction = SessionTrace("66. Call 'Obtiene las direcciones asociadas a un propietario - Retrieve addresses by owner' library") 
        Dim _AddressDLICollection_865c95bdfc1840c09227cbcf07eb195f As InMotionGIT.AddressManager.Contract.General.AddressDLICollection 
        _AddressDLICollection_865c95bdfc1840c09227cbcf07eb195f = (New InMotionGIT.AddressManager.Proxy.AddressManager.PublicClient).RetrieveAddressesDLI(processDate:=_formData.RiskInformation.EffectiveDate, userCompany:=_formData.AddressPhysicalAddressDLI.Address.UserCompany, recordOwnerType:=_formData.AddressPhysicalAddressDLI.Address.RecordOwnerType, recordOwnerId:=_formData.AddressPhysicalAddressDLI.Address.RecordOwnerID, consumer:=_formData.ConsumerInformation, typeOfAddress:=_formData.AddressPhysicalAddressDLI.Address.TypeOfAddress, typeOfPhysicalAddress:=_formData.AddressPhysicalAddressDLI.PhysicalAddress.TypeOfPhysicalAddress) 
 
       isNullResult = (IsNothing(_AddressDLICollection_865c95bdfc1840c09227cbcf07eb195f)) 
       If Not isNullResult Then
            _formData.AddressDLICollection = _AddressDLICollection_865c95bdfc1840c09227cbcf07eb195f
       End If
...
currentAction = SessionTrace("69. Call 'Obtener dirección física - Retrieve a physical address' library") 
        Dim _AddressPhysicalAddressDLI_a6ee1d5c28fa4b06b947843d53acd111 As InMotionGIT.AddressManager.Contract.Models.AddressPhysicalAddressDLI 
        _AddressPhysicalAddressDLI_a6ee1d5c28fa4b06b947843d53acd111 = (New InMotionGIT.AddressManager.Proxy.AddressManager.PublicClient).RetrievePhysicalAddressDLI(processDate:=Date.Today, addressId:=_formData.AddressPhysicalAddressDLI.Address.AddressID, internalAddressKey:=_formData.AddressPhysicalAddressDLI.Address.InternalAddressKey, consumer:=_formData.ConsumerInformation) 
 
       isNullResult = (IsNothing(_AddressPhysicalAddressDLI_a6ee1d5c28fa4b06b947843d53acd111)) 
       If Not isNullResult Then
            _formData.AddressPhysicalAddressDLI = _AddressPhysicalAddressDLI_a6ee1d5c28fa4b06b947843d53acd111
       End If
...
currentAction = SessionTrace("71. Call 'Obtiene las direcciones asociadas a un propietario - Retrieve addresses by owner' library") 
        Dim _AddressDLICollection_5848c654292e45fba8f9b0bce4489180 As InMotionGIT.AddressManager.Contract.General.AddressDLICollection 
        _AddressDLICollection_5848c654292e45fba8f9b0bce4489180 = (New InMotionGIT.AddressManager.Proxy.AddressManager.PublicClient).RetrieveAddressesDLI(processDate:=_formData.RiskInformation.EffectiveDate, userCompany:=_formData.AddressPhysicalAddressDLI.Address.UserCompany, recordOwnerType:=_formData.AddressPhysicalAddressDLI.Address.RecordOwnerType, recordOwnerId:=_formData.AddressPhysicalAddressDLI.Address.RecordOwnerID, consumer:=_formData.ConsumerInformation, typeOfAddress:=_formData.AddressPhysicalAddressDLI.Address.TypeOfAddress, typeOfPhysicalAddress:=_formData.AddressPhysicalAddressDLI.PhysicalAddress.TypeOfPhysicalAddress) 
 
       isNullResult = (IsNothing(_AddressDLICollection_5848c654292e45fba8f9b0bce4489180)) 
       If Not isNullResult Then
            _formData.AddressDLICollection = _AddressDLICollection_5848c654292e45fba8f9b0bce4489180
       End If
...
currentAction = SessionTrace("74. Call 'Obtener dirección física - Retrieve a physical address' library") 
        Dim _AddressPhysicalAddressDLI_b7c79a05ec4845eebfed0f97ffcf137b As InMotionGIT.AddressManager.Contract.Models.AddressPhysicalAddressDLI 
        _AddressPhysicalAddressDLI_b7c79a05ec4845eebfed0f97ffcf137b = (New InMotionGIT.AddressManager.Proxy.AddressManager.PublicClient).RetrievePhysicalAddressDLI(processDate:=Date.Today, addressId:=_formData.AddressPhysicalAddressDLI.Address.AddressID, internalAddressKey:=_formData.AddressPhysicalAddressDLI.Address.InternalAddressKey, consumer:=_formData.ConsumerInformation) 
 
       isNullResult = (IsNothing(_AddressPhysicalAddressDLI_b7c79a05ec4845eebfed0f97ffcf137b)) 
       If Not isNullResult Then
            _formData.AddressPhysicalAddressDLI = _AddressPhysicalAddressDLI_b7c79a05ec4845eebfed0f97ffcf137b
       End If
...
currentAction = SessionTrace("78. Call 'Busca la información de dirección de un ID - Retrieve addresses by id' library") 
        Dim _AddressDLICollection_3ab25b19525346c287843f9f4001dd14 As InMotionGIT.AddressManager.Contract.General.AddressDLICollection 
        _AddressDLICollection_3ab25b19525346c287843f9f4001dd14 = (New InMotionGIT.AddressManager.Proxy.AddressManager.PublicClient).RetrieveAddressesByIdDLI(processDate:=_formData.RiskInformation.EffectiveDate, userCompany:=_formData.AddresseMailDLI.Address.UserCompany, addressId:=_formData.AddresseMailDLI.Address.AddressID, consumer:=_formData.ConsumerInformation, typeOfAddress:=_formData.AddresseMailDLI.Address.TypeOfAddress, typeOfPhysicalAddress:=_formData.AddressPhysicalAddressDLI.PhysicalAddress.TypeOfPhysicalAddress) 
 
       isNullResult = (IsNothing(_AddressDLICollection_3ab25b19525346c287843f9f4001dd14)) 
       If Not isNullResult Then
            _formData.AddressDLICollection = _AddressDLICollection_3ab25b19525346c287843f9f4001dd14
       End If
...
currentAction = SessionTrace("82. Call 'Obtener la información de correo electrónico - retrieve an email address' library") 
        Dim _AddresseMailDLI_1c8f9a6bb5054257ae30fc5e431b6e9e As InMotionGIT.AddressManager.Contract.Models.AddresseMailDLI 
        _AddresseMailDLI_1c8f9a6bb5054257ae30fc5e431b6e9e = (New InMotionGIT.AddressManager.Proxy.AddressManager.PublicClient).RetrieveeMailDLI(processDate:=_formData.RiskInformation.EffectiveDate, addressId:=_formData.AddresseMailDLI.Address.AddressID, internalAddressKey:=_formData.AddresseMailDLI.Address.InternalAddressKey, consumer:=_formData.ConsumerInformation) 
 
       isNullResult = (IsNothing(_AddresseMailDLI_1c8f9a6bb5054257ae30fc5e431b6e9e)) 
       If Not isNullResult Then
            _formData.AddresseMailDLI = _AddresseMailDLI_1c8f9a6bb5054257ae30fc5e431b6e9e
       End If
...
currentAction = SessionTrace("84. Call 'Busca la información de dirección de un ID - Retrieve addresses by id' library") 
        Dim _AddressDLICollection_215362cb0ba94f42b3452bbd6fdccfdc As InMotionGIT.AddressManager.Contract.General.AddressDLICollection 
        _AddressDLICollection_215362cb0ba94f42b3452bbd6fdccfdc = (New InMotionGIT.AddressManager.Proxy.AddressManager.PublicClient).RetrieveAddressesByIdDLI(processDate:=_formData.RiskInformation.EffectiveDate, userCompany:=_formData.AddressPhysicalAddressDLI.Address.UserCompany, addressId:=_formData.AddressPhysicalAddressDLI.Address.AddressID, consumer:=_formData.ConsumerInformation, typeOfAddress:=_formData.AddressPhysicalAddressDLI.Address.TypeOfAddress, typeOfPhysicalAddress:=_formData.AddressPhysicalAddressDLI.PhysicalAddress.TypeOfPhysicalAddress) 
 
       isNullResult = (IsNothing(_AddressDLICollection_215362cb0ba94f42b3452bbd6fdccfdc)) 
       If Not isNullResult Then
            _formData.AddressDLICollection = _AddressDLICollection_215362cb0ba94f42b3452bbd6fdccfdc
       End If
...
currentAction = SessionTrace("87. Call 'Obtener dirección física - Retrieve a physical address' library") 
        Dim _AddressPhysicalAddressDLI_fe09ba02bcaf4fa18b86f027dc5b89af As InMotionGIT.AddressManager.Contract.Models.AddressPhysicalAddressDLI 
        _AddressPhysicalAddressDLI_fe09ba02bcaf4fa18b86f027dc5b89af = (New InMotionGIT.AddressManager.Proxy.AddressManager.PublicClient).RetrievePhysicalAddressDLI(processDate:=Date.Today, addressId:=_formData.AddressPhysicalAddressDLI.Address.AddressID, internalAddressKey:=_formData.AddressPhysicalAddressDLI.Address.InternalAddressKey, consumer:=_formData.ConsumerInformation) 
 
       isNullResult = (IsNothing(_AddressPhysicalAddressDLI_fe09ba02bcaf4fa18b86f027dc5b89af)) 
       If Not isNullResult Then
            _formData.AddressPhysicalAddressDLI = _AddressPhysicalAddressDLI_fe09ba02bcaf4fa18b86f027dc5b89af
       End If
...
currentAction = SessionTrace("89. Call 'Busca la información de dirección de un ID - Retrieve addresses by id' library") 
        Dim _AddressDLICollection_06e2581d1808454090220cd9feed9ed6 As InMotionGIT.AddressManager.Contract.General.AddressDLICollection 
        _AddressDLICollection_06e2581d1808454090220cd9feed9ed6 = (New InMotionGIT.AddressManager.Proxy.AddressManager.PublicClient).RetrieveAddressesByIdDLI(processDate:=_formData.RiskInformation.EffectiveDate, userCompany:=_formData.AddressPhysicalAddressDLI.Address.UserCompany, addressId:=_formData.AddressPhysicalAddressDLI.Address.AddressID, consumer:=_formData.ConsumerInformation, typeOfAddress:=_formData.AddressPhysicalAddressDLI.Address.TypeOfAddress, typeOfPhysicalAddress:=_formData.AddressPhysicalAddressDLI.PhysicalAddress.TypeOfPhysicalAddress) 
 
       isNullResult = (IsNothing(_AddressDLICollection_06e2581d1808454090220cd9feed9ed6)) 
       If Not isNullResult Then
            _formData.AddressDLICollection = _AddressDLICollection_06e2581d1808454090220cd9feed9ed6
       End If
...
currentAction = SessionTrace("92. Call 'Obtener dirección física - Retrieve a physical address' library") 
        Dim _AddressPhysicalAddressDLI_b4a04ca5053248fabf01397aa374fc51 As InMotionGIT.AddressManager.Contract.Models.AddressPhysicalAddressDLI 
        _AddressPhysicalAddressDLI_b4a04ca5053248fabf01397aa374fc51 = (New InMotionGIT.AddressManager.Proxy.AddressManager.PublicClient).RetrievePhysicalAddressDLI(processDate:=Date.Today, addressId:=_formData.AddressPhysicalAddressDLI.Address.AddressID, internalAddressKey:=_formData.AddressPhysicalAddressDLI.Address.InternalAddressKey, consumer:=_formData.ConsumerInformation) 
 
       isNullResult = (IsNothing(_AddressPhysicalAddressDLI_b4a04ca5053248fabf01397aa374fc51)) 
       If Not isNullResult Then
            _formData.AddressPhysicalAddressDLI = _AddressPhysicalAddressDLI_b4a04ca5053248fabf01397aa374fc51
       End If
...
currentAction = SessionTrace("4. Call 'Búsqueda de toda la información de un cliente' library") 
        Dim _Client_ba2def7911604140b0cb4bb2f06d648d As InMotionGIT.Client.Entity.Contracts.Client 
        _Client_ba2def7911604140b0cb4bb2f06d648d = (New InMotionGIT.Client.Proxy.Manager).Retrieve(clientId:=_formData.ClienteIndicado, atDate:=Date.Today, withLookupInformation:=True, childFilter:="All", accessToken:="String.Empty", provider:="CORE", companyID:=0) 
 
       isNullResult = (IsNothing(_Client_ba2def7911604140b0cb4bb2f06d648d)) 
       If Not isNullResult Then
            _formData.RiskInformation.PrimaryInsured.Client = _Client_ba2def7911604140b0cb4bb2f06d648d
       End If
...
currentAction = SessionTrace("57. Call 'Obtiene las direcciones asociadas a un propietario - Retrieve addresses by owner' library") 
        Dim _AddressDLICollection_3ae0b51b81fc46c684696d69d2c1a1e7 As InMotionGIT.AddressManager.Contract.General.AddressDLICollection 
        _AddressDLICollection_3ae0b51b81fc46c684696d69d2c1a1e7 = (New InMotionGIT.AddressManager.Proxy.AddressManager.PublicClient).RetrieveAddressesDLI(processDate:=_formData.RiskInformation.EffectiveDate, userCompany:=_formData.AddresseMailDLI.Address.UserCompany, recordOwnerType:=_formData.AddresseMailDLI.Address.RecordOwnerType, recordOwnerId:=_formData.AddresseMailDLI.Address.RecordOwnerID, consumer:=_formData.ConsumerInformation, typeOfAddress:=_formData.AddresseMailDLI.Address.TypeOfAddress, typeOfPhysicalAddress:=_formData.AddressPhysicalAddressDLI.PhysicalAddress.TypeOfPhysicalAddress) 
 
       isNullResult = (IsNothing(_AddressDLICollection_3ae0b51b81fc46c684696d69d2c1a1e7)) 
       If Not isNullResult Then
            _formData.AddressDLICollection = _AddressDLICollection_3ae0b51b81fc46c684696d69d2c1a1e7
       End If
...
currentAction = SessionTrace("60. Call 'Obtener la información de correo electrónico - retrieve an email address' library") 
        Dim _AddresseMailDLI_be3d542130ba4b7fb622e7e934b1898c As InMotionGIT.AddressManager.Contract.Models.AddresseMailDLI 
        _AddresseMailDLI_be3d542130ba4b7fb622e7e934b1898c = (New InMotionGIT.AddressManager.Proxy.AddressManager.PublicClient).RetrieveeMailDLI(processDate:=_formData.RiskInformation.EffectiveDate, addressId:=_formData.AddresseMailDLI.Address.AddressID, internalAddressKey:=_formData.AddresseMailDLI.Address.InternalAddressKey, consumer:=_formData.ConsumerInformation) 
 
       isNullResult = (IsNothing(_AddresseMailDLI_be3d542130ba4b7fb622e7e934b1898c)) 
       If Not isNullResult Then
            _formData.AddresseMailDLI = _AddresseMailDLI_be3d542130ba4b7fb622e7e934b1898c
       End If
...
currentAction = SessionTrace("62. Call 'Obtiene las direcciones asociadas a un propietario - Retrieve addresses by owner' library") 
        Dim _AddressDLICollection_9a57126d09c5458d8f829b25ba453e30 As InMotionGIT.AddressManager.Contract.General.AddressDLICollection 
        _AddressDLICollection_9a57126d09c5458d8f829b25ba453e30 = (New InMotionGIT.AddressManager.Proxy.AddressManager.PublicClient).RetrieveAddressesDLI(processDate:=_formData.RiskInformation.EffectiveDate, userCompany:=_formData.AddressPhysicalAddressDLI.Address.UserCompany, recordOwnerType:=_formData.AddressPhysicalAddressDLI.Address.RecordOwnerType, recordOwnerId:=_formData.AddressPhysicalAddressDLI.Address.RecordOwnerID, consumer:=_formData.ConsumerInformation, typeOfAddress:=_formData.AddressPhysicalAddressDLI.Address.TypeOfAddress, typeOfPhysicalAddress:=_formData.AddressPhysicalAddressDLI.PhysicalAddress.TypeOfPhysicalAddress) 
 
       isNullResult = (IsNothing(_AddressDLICollection_9a57126d09c5458d8f829b25ba453e30)) 
       If Not isNullResult Then
            _formData.AddressDLICollection = _AddressDLICollection_9a57126d09c5458d8f829b25ba453e30
       End If
...
currentAction = SessionTrace("65. Call 'Obtener dirección física - Retrieve a physical address' library") 
        Dim _AddressPhysicalAddressDLI_78b4b95b79fb45609b81a4f09617969a As InMotionGIT.AddressManager.Contract.Models.AddressPhysicalAddressDLI 
        _AddressPhysicalAddressDLI_78b4b95b79fb45609b81a4f09617969a = (New InMotionGIT.AddressManager.Proxy.AddressManager.PublicClient).RetrievePhysicalAddressDLI(processDate:=Date.Today, addressId:=_formData.AddressPhysicalAddressDLI.Address.AddressID, internalAddressKey:=_formData.AddressPhysicalAddressDLI.Address.InternalAddressKey, consumer:=_formData.ConsumerInformation) 
 
       isNullResult = (IsNothing(_AddressPhysicalAddressDLI_78b4b95b79fb45609b81a4f09617969a)) 
       If Not isNullResult Then
            _formData.AddressPhysicalAddressDLI = _AddressPhysicalAddressDLI_78b4b95b79fb45609b81a4f09617969a
       End If
...
currentAction = SessionTrace("67. Call 'Obtiene las direcciones asociadas a un propietario - Retrieve addresses by owner' library") 
        Dim _AddressDLICollection_bf6a6ab48a6743118fb23ed17f150043 As InMotionGIT.AddressManager.Contract.General.AddressDLICollection 
        _AddressDLICollection_bf6a6ab48a6743118fb23ed17f150043 = (New InMotionGIT.AddressManager.Proxy.AddressManager.PublicClient).RetrieveAddressesDLI(processDate:=_formData.RiskInformation.EffectiveDate, userCompany:=_formData.AddressPhysicalAddressDLI.Address.UserCompany, recordOwnerType:=_formData.AddressPhysicalAddressDLI.Address.RecordOwnerType, recordOwnerId:=_formData.AddressPhysicalAddressDLI.Address.RecordOwnerID, consumer:=_formData.ConsumerInformation, typeOfAddress:=_formData.AddressPhysicalAddressDLI.Address.TypeOfAddress, typeOfPhysicalAddress:=_formData.AddressPhysicalAddressDLI.PhysicalAddress.TypeOfPhysicalAddress) 
 
       isNullResult = (IsNothing(_AddressDLICollection_bf6a6ab48a6743118fb23ed17f150043)) 
       If Not isNullResult Then
            _formData.AddressDLICollection = _AddressDLICollection_bf6a6ab48a6743118fb23ed17f150043
       End If
...
currentAction = SessionTrace("70. Call 'Obtener dirección física - Retrieve a physical address' library") 
        Dim _AddressPhysicalAddressDLI_777abd25a15c4cd4ae04b11da50ea077 As InMotionGIT.AddressManager.Contract.Models.AddressPhysicalAddressDLI 
        _AddressPhysicalAddressDLI_777abd25a15c4cd4ae04b11da50ea077 = (New InMotionGIT.AddressManager.Proxy.AddressManager.PublicClient).RetrievePhysicalAddressDLI(processDate:=Date.Today, addressId:=_formData.AddressPhysicalAddressDLI.Address.AddressID, internalAddressKey:=_formData.AddressPhysicalAddressDLI.Address.InternalAddressKey, consumer:=_formData.ConsumerInformation) 
 
       isNullResult = (IsNothing(_AddressPhysicalAddressDLI_777abd25a15c4cd4ae04b11da50ea077)) 
       If Not isNullResult Then
            _formData.AddressPhysicalAddressDLI = _AddressPhysicalAddressDLI_777abd25a15c4cd4ae04b11da50ea077
       End If
...
currentAction = SessionTrace("74. Call 'Busca la información de dirección de un ID - Retrieve addresses by id' library") 
        Dim _AddressDLICollection_d0153b2de0a141ec887af5589857b2e8 As InMotionGIT.AddressManager.Contract.General.AddressDLICollection 
        _AddressDLICollection_d0153b2de0a141ec887af5589857b2e8 = (New InMotionGIT.AddressManager.Proxy.AddressManager.PublicClient).RetrieveAddressesByIdDLI(processDate:=_formData.RiskInformation.EffectiveDate, userCompany:=_formData.AddresseMailDLI.Address.UserCompany, addressId:=_formData.AddresseMailDLI.Address.AddressID, consumer:=_formData.ConsumerInformation, typeOfAddress:=_formData.AddresseMailDLI.Address.TypeOfAddress, typeOfPhysicalAddress:=_formData.AddressPhysicalAddressDLI.PhysicalAddress.TypeOfPhysicalAddress) 
 
       isNullResult = (IsNothing(_AddressDLICollection_d0153b2de0a141ec887af5589857b2e8)) 
       If Not isNullResult Then
            _formData.AddressDLICollection = _AddressDLICollection_d0153b2de0a141ec887af5589857b2e8
       End If
...
currentAction = SessionTrace("78. Call 'Obtener la información de correo electrónico - retrieve an email address' library") 
        Dim _AddresseMailDLI_3dc42704937a495eaae47a2c8c3336eb As InMotionGIT.AddressManager.Contract.Models.AddresseMailDLI 
        _AddresseMailDLI_3dc42704937a495eaae47a2c8c3336eb = (New InMotionGIT.AddressManager.Proxy.AddressManager.PublicClient).RetrieveeMailDLI(processDate:=_formData.RiskInformation.EffectiveDate, addressId:=_formData.AddresseMailDLI.Address.AddressID, internalAddressKey:=_formData.AddresseMailDLI.Address.InternalAddressKey, consumer:=_formData.ConsumerInformation) 
 
       isNullResult = (IsNothing(_AddresseMailDLI_3dc42704937a495eaae47a2c8c3336eb)) 
       If Not isNullResult Then
            _formData.AddresseMailDLI = _AddresseMailDLI_3dc42704937a495eaae47a2c8c3336eb
       End If
...
currentAction = SessionTrace("80. Call 'Busca la información de dirección de un ID - Retrieve addresses by id' library") 
        Dim _AddressDLICollection_10f0e032f0a64907a2b1cebe0d268d90 As InMotionGIT.AddressManager.Contract.General.AddressDLICollection 
        _AddressDLICollection_10f0e032f0a64907a2b1cebe0d268d90 = (New InMotionGIT.AddressManager.Proxy.AddressManager.PublicClient).RetrieveAddressesByIdDLI(processDate:=_formData.RiskInformation.EffectiveDate, userCompany:=_formData.AddressPhysicalAddressDLI.Address.UserCompany, addressId:=_formData.AddressPhysicalAddressDLI.Address.AddressID, consumer:=_formData.ConsumerInformation, typeOfAddress:=_formData.AddressPhysicalAddressDLI.Address.TypeOfAddress, typeOfPhysicalAddress:=_formData.AddressPhysicalAddressDLI.PhysicalAddress.TypeOfPhysicalAddress) 
 
       isNullResult = (IsNothing(_AddressDLICollection_10f0e032f0a64907a2b1cebe0d268d90)) 
       If Not isNullResult Then
            _formData.AddressDLICollection = _AddressDLICollection_10f0e032f0a64907a2b1cebe0d268d90
       End If
...
currentAction = SessionTrace("83. Call 'Obtener dirección física - Retrieve a physical address' library") 
        Dim _AddressPhysicalAddressDLI_5c857d32b8774e78a48391da3eabde4b As InMotionGIT.AddressManager.Contract.Models.AddressPhysicalAddressDLI 
        _AddressPhysicalAddressDLI_5c857d32b8774e78a48391da3eabde4b = (New InMotionGIT.AddressManager.Proxy.AddressManager.PublicClient).RetrievePhysicalAddressDLI(processDate:=Date.Today, addressId:=_formData.AddressPhysicalAddressDLI.Address.AddressID, internalAddressKey:=_formData.AddressPhysicalAddressDLI.Address.InternalAddressKey, consumer:=_formData.ConsumerInformation) 
 
       isNullResult = (IsNothing(_AddressPhysicalAddressDLI_5c857d32b8774e78a48391da3eabde4b)) 
       If Not isNullResult Then
            _formData.AddressPhysicalAddressDLI = _AddressPhysicalAddressDLI_5c857d32b8774e78a48391da3eabde4b
       End If
...
currentAction = SessionTrace("85. Call 'Busca la información de dirección de un ID - Retrieve addresses by id' library") 
        Dim _AddressDLICollection_e5b5b6ebd30e454b8283435236c3ea07 As InMotionGIT.AddressManager.Contract.General.AddressDLICollection 
        _AddressDLICollection_e5b5b6ebd30e454b8283435236c3ea07 = (New InMotionGIT.AddressManager.Proxy.AddressManager.PublicClient).RetrieveAddressesByIdDLI(processDate:=_formData.RiskInformation.EffectiveDate, userCompany:=_formData.AddressPhysicalAddressDLI.Address.UserCompany, addressId:=_formData.AddressPhysicalAddressDLI.Address.AddressID, consumer:=_formData.ConsumerInformation, typeOfAddress:=_formData.AddressPhysicalAddressDLI.Address.TypeOfAddress, typeOfPhysicalAddress:=_formData.AddressPhysicalAddressDLI.PhysicalAddress.TypeOfPhysicalAddress) 
 
       isNullResult = (IsNothing(_AddressDLICollection_e5b5b6ebd30e454b8283435236c3ea07)) 
       If Not isNullResult Then
            _formData.AddressDLICollection = _AddressDLICollection_e5b5b6ebd30e454b8283435236c3ea07
       End If
...
currentAction = SessionTrace("88. Call 'Obtener dirección física - Retrieve a physical address' library") 
        Dim _AddressPhysicalAddressDLI_855862632dbc4ecd9e45363ff171c3ee As InMotionGIT.AddressManager.Contract.Models.AddressPhysicalAddressDLI 
        _AddressPhysicalAddressDLI_855862632dbc4ecd9e45363ff171c3ee = (New InMotionGIT.AddressManager.Proxy.AddressManager.PublicClient).RetrievePhysicalAddressDLI(processDate:=Date.Today, addressId:=_formData.AddressPhysicalAddressDLI.Address.AddressID, internalAddressKey:=_formData.AddressPhysicalAddressDLI.Address.InternalAddressKey, consumer:=_formData.ConsumerInformation) 
 
       isNullResult = (IsNothing(_AddressPhysicalAddressDLI_855862632dbc4ecd9e45363ff171c3ee)) 
       If Not isNullResult Then
            _formData.AddressPhysicalAddressDLI = _AddressPhysicalAddressDLI_855862632dbc4ecd9e45363ff171c3ee
       End If
...
tabcontainer0.ActiveTabPage = tabcontainer0.TabPages.FindByName("tab18")
            ...
            End If
            currentAction = SessionTrace("9. _formData.RiskInformation.PrimaryInsured.Client.eMailAddressDefault = _formData.eMail...") 
 
            currentAction = SessionTrace("9.1. _formData.RiskInformation.PrimaryInsured.Client.eMailAddressDefault = _formData.eMail...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 
          If IsNothing(_formData.RiskInformation.PrimaryInsured) Then
 ...
 _formData.RiskInformation.PrimaryInsured.Client.eMailAddressDefault = _formData.eMail 
            ...
            currentAction = SessionTrace("10. For Each roleItem As 'InMotionGIT.Policy.Entity...' In '_formData.RiskInformation...'") 
            ...
            currentAction = SessionTrace("11. If roleItem.ClientRole = 2 Then") 
If roleItem.ClientRole = 2 Then

            currentAction = SessionTrace("12. If roleItem.ClientID Is Null Or Empty '' Then") 
If String.IsNullOrEmpty(roleItem.ClientID) Then

            currentAction = SessionTrace("13. '_formData.RiskInformation.AmendmentInformation' = New 'InMotionGIT.Policy.Entity'...'") 
             _formData.RiskInformation.AmendmentInformation = New InMotionGIT.Policy.Entity.Contracts.AmendmentInformation

            currentAction = SessionTrace("14. '_formData.RiskInformation.Coverages' = New 'InMotionGIT.Policy.Entity'...'") 
             _formData.RiskInformation.Coverages = New InMotionGIT.Policy.Entity.Contracts.CoverageCollection

currentAction = SessionTrace("15. Call 'Cálculo de coberturas' library") 
        Dim _RiskInformation_1453ac9a473745c1a0dc152b4fc96a16 As InMotionGIT.Policy.Entity.Contracts.RiskInformation 
        _RiskInformation_1453ac9a473745c1a0dc152b4fc96a16 = InMotionGIT.PolicyManager.Proxy.Manager.RatingCalculateProcess(riskInformation:=_formData.RiskInformation, errors:=_formContext.Errors, transaction:=1, atDate:=Date.Today, accessToken:="String.Empty", provider:="CORE", companyID:=0) 
 
       isNullResult = (IsNothing(_RiskInformation_1453ac9a473745c1a0dc152b4fc96a16)) 
       If Not isNullResult Then
            _formData.RiskInformation = _RiskInformation_1453ac9a473745c1a0dc152b4fc96a16
       End If

currentAction = SessionTrace("16. Call 'Configuración de información de procesamiento de RiskInformation (Amendment Setup)' library") 
        Dim _RiskInformation_95b0e9c65df849608c2d01a8dc00b243 As InMotionGIT.Policy.Entity.Contracts.RiskInformation 
        _RiskInformation_95b0e9c65df849608c2d01a8dc00b243 = InMotionGIT.PolicyManager.Proxy.Manager.AmendmentSetup(risk:=_formData.RiskInformation, atDate:=Date.Today, accessToken:="String.Empty", provider:="CORE") 
 
       isNullResult = (IsNothing(_RiskInformation_95b0e9c65df849608c2d01a8dc00b243)) 
       If Not isNullResult Then
            _formData.RiskInformation = _RiskInformation_95b0e9c65df849608c2d01a8dc00b243
       End If
...
BehaviorShowControls("button33,Visible")
          ...
          SetCurrentParameterInstance(NNCotizacionMiVidaValeIIALCParameterInstance,"")
...
currentAction = SessionTrace("2. Call 'Búsqueda de toda la información de un cliente' library") 
        Dim _Client_9e5b8cfab6394624b57276288f8289f1 As InMotionGIT.Client.Entity.Contracts.Client 
        _Client_9e5b8cfab6394624b57276288f8289f1 = (New InMotionGIT.Client.Proxy.Manager).Retrieve(clientId:=_formData.Beneficiary.ClientID, atDate:=Date.Today, withLookupInformation:=True, childFilter:="All", accessToken:="String.Empty", provider:="CORE", companyID:=0) 
 
       isNullResult = (IsNothing(_Client_9e5b8cfab6394624b57276288f8289f1)) 
       If Not isNullResult Then
            _formData.Beneficiary.Client = _Client_9e5b8cfab6394624b57276288f8289f1
       End If
...
Dim beneficiaryExists As System.Boolean
           ...
           With parametersDictionary
    .Add("AddBeneficiaryHasErrors", AddBeneficiaryHasErrors)
    .Add("beneficiaryExists", beneficiaryExists)
End With
            currentAction = SessionTrace("1. {AddBeneficiaryHasErrors} = False...") 
 
            currentAction = SessionTrace("1.1. {AddBeneficiaryHasErrors} = False...")

 AddBeneficiaryHasErrors = False 

            currentAction = SessionTrace("2. {beneficiaryExists} = False...") 
 
            currentAction = SessionTrace("2.1. {beneficiaryExists} = False...")

 beneficiaryExists = False 

            currentAction = SessionTrace("3. If _formData.TypeOfPersonBenef = 1 Then") 
If _formData.TypeOfPersonBenef = 1 Then

            currentAction = SessionTrace("4. _formData.Beneficiary.Client.CompleteClientName = _formData.Beneficiary.Client.LastNa...") 
 
            currentAction = SessionTrace("4.1. _formData.Beneficiary.Client.CompleteClientName = _formData.Beneficiary.Client.LastNa...")
          If IsNothing(_formData.Beneficiary) Then
              _formData.Beneficiary = New InMotionGIT.Policy.Entity.Contracts.Beneficiary
          End If 
          If IsNothing(_formData.Beneficiary.Client) Then
 ...
 _formData.Beneficiary.Client.CompleteClientName = _formData.Beneficiary.Client.LastName & " " & _formData.Beneficiary.Client.LastName2 & ", " & _formData.Beneficiary.Client.FirstName 
        ...
        Else 
            currentAction = SessionTrace("5. _formData.Beneficiary.Client.CompleteClientName = _formData.Beneficiary.Client.LegalN...") 
 
            currentAction = SessionTrace("5.1. _formData.Beneficiary.Client.CompleteClientName = _formData.Beneficiary.Client.LegalN...")
          If IsNothing(_formData.Beneficiary) Then
              _formData.Beneficiary = New InMotionGIT.Policy.Entity.Contracts.Beneficiary
          End If 
          If IsNothing(_formData.Beneficiary.Client) Then
 ...
 _formData.Beneficiary.Client.CompleteClientName = _formData.Beneficiary.Client.LegalName 
            ...
            End If
            currentAction = SessionTrace("6. For Each beneficiaryItem As 'InMotionGIT.Policy.Entity...' In '_formData.RiskInformation...'") 
            ...
            currentAction = SessionTrace("7. If beneficiaryItem.ClientID = _formData.Beneficiary.ClientID Then") 
If beneficiaryItem.ClientID = _formData.Beneficiary.ClientID Then

            currentAction = SessionTrace("8. {beneficiaryExists} = True...") 
 
            currentAction = SessionTrace("8.1. {beneficiaryExists} = True...")

 beneficiaryExists = True 

            End If
            Next
            currentAction = SessionTrace("9. If {beneficiaryExists} = True Then") 
If beneficiaryExists = True Then

            currentAction = SessionTrace("10. {AddBeneficiaryHasErrors} = True...") 
 
            currentAction = SessionTrace("10.1. {AddBeneficiaryHasErrors} = True...")

 AddBeneficiaryHasErrors = True 

parametersDictionary("AddBeneficiaryHasErrors") = AddBeneficiaryHasErrors
parametersDictionary("beneficiaryExists") = beneficiaryExists
            currentAction = SessionTrace("11. The message 'El beneficiario ya s...' will displayed as 'Popup'") 
            ...
            End If
            currentAction = SessionTrace("12. If _formData.RiskInformation.PrimaryInsured.Client.ClientID = _formData.Beneficiary.ClientID Then") 
If _formData.RiskInformation.PrimaryInsured.Client.ClientID = _formData.Beneficiary.ClientID Then

            currentAction = SessionTrace("13. {AddBeneficiaryHasErrors} = True...") 
 
            currentAction = SessionTrace("13.1. {AddBeneficiaryHasErrors} = True...")

 AddBeneficiaryHasErrors = True 

parametersDictionary("AddBeneficiaryHasErrors") = AddBeneficiaryHasErrors
parametersDictionary("beneficiaryExists") = beneficiaryExists
            currentAction = SessionTrace("14. The message 'El beneficiario debe...' will displayed as 'Popup'") 
            ...
            End If
            currentAction = SessionTrace("15. If _formData.Beneficiary.PercentageShare <= 0 Then") 
If _formData.Beneficiary.PercentageShare <= 0 Then

            currentAction = SessionTrace("16. {AddBeneficiaryHasErrors} = True...") 
 
            currentAction = SessionTrace("16.1. {AddBeneficiaryHasErrors} = True...")

 AddBeneficiaryHasErrors = True 

parametersDictionary("AddBeneficiaryHasErrors") = AddBeneficiaryHasErrors
parametersDictionary("beneficiaryExists") = beneficiaryExists
            currentAction = SessionTrace("17. The message 'El porcentaje de par...' will displayed as 'Popup'") 
            ...
            End If
            currentAction = SessionTrace("18. If {AddBeneficiaryHasErrors} = False Then") 
If AddBeneficiaryHasErrors = False Then

            currentAction = SessionTrace("19. '_formData.RiskInformation.Beneficiaries'.Add('_formData.Beneficiary')") 
             _formData.RiskInformation.Beneficiaries.Add(_formData.Beneficiary)

            currentAction = SessionTrace("20. zone24.Visible = false") 
            currentAction = SessionTrace("20.1. zone24.Visible = false...")
BehaviorShowControls("zone24,Hidden")

            currentAction = SessionTrace("21. FirstNameBP.Visible = false, LastNameBP.Visible = false, LastName2BP.Visible = false...") 
            currentAction = SessionTrace("21.1. FirstNameBP.Visible = false...")
BehaviorShowControls("FirstNameBP,Hidden")
            currentAction = SessionTrace("21.2. LastNameBP.Visible = false...")
BehaviorShowControls("LastNameBP,Hidden")
            currentAction = SessionTrace("21.3. LastName2BP.Visible = false...")
BehaviorShowControls("LastName2BP,Hidden")
            currentAction = SessionTrace("21.4. LegalNameBP.Visible = false...")
BehaviorShowControls("LegalNameBP,Hidden")
...
ScriptManager.RegisterStartupScript(Page, Page.GetType(), "FormData1", String.Format(CultureInfo.InvariantCulture, "<script type='text/javascript'>button1921_WebCall('{0}', '{1}');</script>", ConfigurationManager.AppSettings("Url.Form"), _FormID.Text), False)
...
currentAction = SessionTrace("26. Call 'Configuración de información de procesamiento de RiskInformation (Amendment Setup)' library") 
        Dim _RiskInformation_e2d20e7c16044eac8f31dda4bf885873 As InMotionGIT.Policy.Entity.Contracts.RiskInformation 
        _RiskInformation_e2d20e7c16044eac8f31dda4bf885873 = InMotionGIT.PolicyManager.Proxy.Manager.AmendmentSetup(risk:=_formData.RiskInformation, atDate:=Date.Today, accessToken:="String.Empty", provider:="CORE") 
 
       isNullResult = (IsNothing(_RiskInformation_e2d20e7c16044eac8f31dda4bf885873)) 
       If Not isNullResult Then
            _formData.RiskInformation = _RiskInformation_e2d20e7c16044eac8f31dda4bf885873
       End If
...
If _formData.OnLinePrintIndicator = true Then
 ...
 _formData.OnLinePrint = 1 
            ...
            With WorkflowInArguments
                ...
                .Add("UsercodeFASI", _formData.UsercodeFASI) 
            End With
            WorkflowOutArguments = InMotionGIT.Workflow.Support.Runtime.DoWorkFromForm("ProcessMainRequestOfLifePolicyNNv2", "e910cdd7-f39d-4609-bfc7-e42e5aa4253e", 2, WorkflowInArguments, True, True, Me.AppRelativeVirtualPath, _formData.InternalId)
             currentAction += " 'Mapping Outputs'" 
                _formData.RiskInformation = WorkflowOutArguments("RiskInformation")
 ...
 _formData.OnLinePrint = 2 
            ...
            With WorkflowInArguments
                ...
                .Add("UsercodeFASI", _formData.UsercodeFASI) 
            End With
            WorkflowOutArguments = InMotionGIT.Workflow.Support.Runtime.DoWorkFromForm("ProcessMainRequestOfLifePolicyNNv2", "e910cdd7-f39d-4609-bfc7-e42e5aa4253e", 2, WorkflowInArguments, True, False, Me.AppRelativeVirtualPath, _formData.InternalId)
...
#Region "Form Manager"
    ...
    Private Sub GetCurrentParameterInstance(ByRef NNCotizacionMiVidaValeIIALCParameterInstance As NNCotizacionMiVidaValeIIALCParameter, force As Boolean)
        If _loadcompleted Or force Then
            If Not _CurrentParameterInstance Then

                NNCotizacionMiVidaValeIIALCParameterInstance = FormData

                If Page.IsPostBack Then
                    MapPageToClass(NNCotizacionMiVidaValeIIALCParameterInstance)
                End If

                _CurrentParameterInstance = True
            Else
                NNCotizacionMiVidaValeIIALCParameterInstance = _formData
            End If
        Else
            NNCotizacionMiVidaValeIIALCParameterInstance = Nothing
        End If
    End Sub

    Protected Sub SetCurrentParameterInstance(ByRef NNCotizacionMiVidaValeIIALCParameterInstance As NNCotizacionMiVidaValeIIALCParameter, calledBy As String)
        FormData = NNCotizacionMiVidaValeIIALCParameterInstance
        MapClassToPage(NNCotizacionMiVidaValeIIALCParameterInstance,calledBy)
    End Sub
...
End If 
    ...
    Private Sub SetReadOnlyControls()
        ...
        BehaviorControls(CheckDigitNew, False)
        ...
        BehaviorControls(CheckDigit, False)
        ...
        BehaviorControls(CheckDigitBenif, False)
...
currentAction = SessionTrace("3. Call 'Búsqueda de información de un caso de suscripción' library") 
        Dim _UnderwritingCase_134728327a904a51afbe9ad1baa2d952 As InMotionGIT.Underwriting.Contracts.UnderwritingCase 
        _UnderwritingCase_134728327a904a51afbe9ad1baa2d952 = InMotionGIT.Underwriting.Proxy.Manager.Retrieve(underwritingCaseID:=_formData.uwcaseid, atDate:=Date.Today, lockedInformation:=True, riskInformation:=True, includeRiskInstance:=True, changeRiskByAmendment:=True) 
 
       isNullResult = (IsNothing(_UnderwritingCase_134728327a904a51afbe9ad1baa2d952)) 
       If Not isNullResult Then
            _formData.UnderwritingCase = _UnderwritingCase_134728327a904a51afbe9ad1baa2d952
       End If
...
currentAction = SessionTrace("5. Call 'Configuración de información de procesamiento de RiskInformation (Amendment Setup)' library") 
        Dim _RiskInformation_3a3f813427cd4360b14d89a9833eb1bf As InMotionGIT.Policy.Entity.Contracts.RiskInformation 
        _RiskInformation_3a3f813427cd4360b14d89a9833eb1bf = InMotionGIT.PolicyManager.Proxy.Manager.AmendmentSetup(risk:=_formData.RiskInformation, atDate:=Date.Today, accessToken:="String.Empty", provider:="CORE") 
 
       isNullResult = (IsNothing(_RiskInformation_3a3f813427cd4360b14d89a9833eb1bf)) 
       If Not isNullResult Then
            _formData.RiskInformation = _RiskInformation_3a3f813427cd4360b14d89a9833eb1bf
       End If
...
currentAction = SessionTrace("7. Call 'Búsqueda de toda la información de un cliente' library") 
        Dim _Client_b4b28a81997c467787f5eaa4bc1a3c62 As InMotionGIT.Client.Entity.Contracts.Client 
        _Client_b4b28a81997c467787f5eaa4bc1a3c62 = (New InMotionGIT.Client.Proxy.Manager).Retrieve(clientId:=_formData.RiskInformation.PrimaryInsured.Client.ClientID, atDate:=Date.Today, withLookupInformation:=True, childFilter:="All", accessToken:="String.Empty", provider:="CORE", companyID:=0) 
 
       isNullResult = (IsNothing(_Client_b4b28a81997c467787f5eaa4bc1a3c62)) 
       If Not isNullResult Then
            _formData.RiskInformation.PrimaryInsured.Client = _Client_b4b28a81997c467787f5eaa4bc1a3c62
       End If
...
BehaviorShowControls("zone20,Hidden")
            ...
            currentAction = SessionTrace("18. zone2.Enabled = false, zone10.Enabled = false") 
            currentAction = SessionTrace("18.1. zone2.Enabled = false...")
BehaviorShowControls("zone2,Disabled")
            currentAction = SessionTrace("18.2. zone10.Enabled = false...")
BehaviorShowControls("zone10,Disabled")
...
If _formData.AddressDLICollection.Count <> 0 Then
 ...
 _formData.AddressPhysicalAddressDLI.Address.InternalAddressKey = _formData.AddressDLICollection(0).InternalAddressKey 
            ...
            End If
            End If
            currentAction = SessionTrace("55. If _formData.AccumulatedAmount <> 0 AND _formData.AccumulatedAmount Not Is Null Or Not Empty  Then") 
If _formData.AccumulatedAmount <> 0 AndAlso Not IsNothing(_formData.AccumulatedAmount) Then

            currentAction = SessionTrace("56. zone3Cumulo.Visible = True") 
            currentAction = SessionTrace("56.1. zone3Cumulo.Visible = True...")
BehaviorShowControls("zone3Cumulo,Visible")

        Else 
            currentAction = SessionTrace("57. zone3Cumulo.Visible = False") 
            currentAction = SessionTrace("57.1. zone3Cumulo.Visible = False...")
BehaviorShowControls("zone3Cumulo,Hidden")
...
currentAction = SessionTrace("11. Call 'Búsqueda de toda la información de un cliente' library") 
        Dim _Client_1c07465f44f949f39db7df12e0528cbc As InMotionGIT.Client.Entity.Contracts.Client 
        _Client_1c07465f44f949f39db7df12e0528cbc = (New InMotionGIT.Client.Proxy.Manager).Retrieve(clientId:=_formData.RiskInformation.PrimaryInsured.Client.ClientID, atDate:=Date.Today, withLookupInformation:=True, childFilter:="All", accessToken:="String.Empty", provider:="CORE", companyID:=0) 
 
       isNullResult = (IsNothing(_Client_1c07465f44f949f39db7df12e0528cbc)) 
       If Not isNullResult Then
            _formData.RiskInformation.PrimaryInsured.Client = _Client_1c07465f44f949f39db7df12e0528cbc
       End If
...
currentAction = SessionTrace("16. Call 'Búsqueda de toda la información de un producto (RetrieveWithCaching)' library") 
        Dim _ProductMaster_8615f175fa2b4a7fb8523375951e01f6 As InMotionGIT.Product.Entity.Contracts.ProductMaster 
        _ProductMaster_8615f175fa2b4a7fb8523375951e01f6 = InMotionGIT.Product.Proxy.Lookups.RetrieveWithCaching(lineOfBusiness:=_formData.UnderwritingCase.LineOfBusiness, productId:=_formData.UnderwritingCase.Product, atDate:=Date.Today, withLookups:=True, accessToken:="String.Empty", provider:="CORE", companyID:=0) 
 
       isNullResult = (IsNothing(_ProductMaster_8615f175fa2b4a7fb8523375951e01f6)) 
       If Not isNullResult Then
            ProductMasterLocal = _ProductMaster_8615f175fa2b4a7fb8523375951e01f6
       End If
...
BehaviorShowControls("ClientID,Enabled")
 ...
 _formData.RiskInformation.PrimaryInsured.Client.NADDRESSID = 0 
        ...
        Else 
currentAction = SessionTrace("38. Call 'Búsqueda de toda la información de un cliente' library") 
        Dim _Client_9da975496074475bb9100445523c3ba0 As InMotionGIT.Client.Entity.Contracts.Client 
        _Client_9da975496074475bb9100445523c3ba0 = (New InMotionGIT.Client.Proxy.Manager).Retrieve(clientId:=_formData.RiskInformation.PrimaryInsured.Client.ClientID , atDate:=Date.Today, withLookupInformation:=True, childFilter:="All", accessToken:="String.Empty", provider:="CORE", companyID:=0) 
 
       isNullResult = (IsNothing(_Client_9da975496074475bb9100445523c3ba0)) 
       If Not isNullResult Then
            _formData.ClientIncluded = _Client_9da975496074475bb9100445523c3ba0
       End If
...
End Sub
    ...
    Private Function RetrieveFormInformation() As Boolean
        ...
        If records.Rows.Count > 0 Then
            result = True            
            _formData = Serialize.Deserialize(Of NNCotizacionMiVidaValeIIALCParameter)(records.Rows(0).Item("Content"))
        End If
    ...
    Private Sub InsertStorageData()
        With New DataManagerFactory("INSERT INTO FrontOffice.DocumentCache (FormId, ModelId, UserId, Page, Content, CreationDate, UpdateDate) VALUES(@:FormId, @:ModelId, @:UserId, @:Page, @:Content, @:CreationDate, @:UpdateDate)",
            ...
            .AddParameter("FormId", DbType.AnsiStringFixedLength, 36, False, _FormID.Text)
            .AddParameter("ModelId", DbType.AnsiStringFixedLength, 36, False, "4321ebc0-7b2a-4d0c-8f93-a75cda26468b")
            ...
            .AddParameter("Content", DbType.Xml, 1, False, Serialize.Serialize(Of NNCotizacionMiVidaValeIIALCParameter)(_formData))
...
<Serializable()>
Public Class NNCotizacionMiVidaValeIIALCParameter
    Inherits InMotionGIT.FrontOffice.Support.DataType.FormBase(Of  NNCotizacionMiVidaValeIIALCParameter)
