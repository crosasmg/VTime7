'---------------------------------------------------------------------------------------------------
' <generated>
'     This code was generated by Form Designer Oracle v7.1.101 at 2017-01-04 model release 4
'     
...
Partial Public Class SegurosDeVidaUserControl
...
#Region "Private fields"
    ...
    Private _formData As SegurosDeVidaParameter = Nothing
...
#Region "Public properties"
    ...
    Public Property FormData() As SegurosDeVidaParameter
        Get
           ...
           If Not String.IsNullOrEmpty(formDefinition) Then
              _formData = Serialize.Deserialize(Of SegurosDeVidaParameter)(formDefinition)
           End If
                        End If
                    End If

                    If IsNothing(_formData) Then
                        _formData = New SegurosDeVidaParameter
                        ...
                        If Not String.IsNullOrEmpty(Request.QueryString("readonly")) Then
                            BehaviorControls(SegurosDeVidaTablePage, False)
                        End If
        ...
        Set(value As SegurosDeVidaParameter)
            _formData = value
        End Set
    End Property
...
#Region "Form Events"
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Not InMotionGIT.FrontOffice.Proxy.Helpers.RoleManager.ValidateAccess(UserInfo.UserName, "Productor;EASE1") AndAlso
        ...
        Dim formData As SegurosDeVidaParameter = Me.FormData        
    ...
    Protected Sub Page_Unload(sender As Object, e As EventArgs) Handles Me.Unload        
        If Not IsNothing(_formData) Then
              Session(String.Format(CultureInfo.InvariantCulture, "FormStorage.{0}", _FormID.Text)) = Serialize.Serialize(Of SegurosDeVidaParameter)(_formData)
...
#Region "Mapping methods"
    ...
    Public Sub ValidateParametersInstance(ByRef SegurosDeVidaParameterInstance As SegurosDeVidaParameter)
    ...
    ''' </summary>
    ''' <param name="SegurosDeVidaParameterInstance"></param>
    ''' <remarks></remarks>
    Public Sub MapClassToPage(ByRef SegurosDeVidaParameterInstance As SegurosDeVidaParameter, Optional calledBy As String = "")
        Dim parametersDictionary As Dictionary(Of String, Object) = Nothing
        ValidateParametersInstance(SegurosDeVidaParameterInstance)

        
       
        With SegurosDeVidaParameterInstance
          
          
 Session(_FormID.Text) = _formData 
 Session("fromid") = _FormID.Text 

            SimularCUI.NavigateUrl = String.Format(CultureInfo.InvariantCulture, "{0}/ProyeccionCUIMutualSeguros2.aspx?fromid={1}&ramo={2}&producto={3}", ConfigurationManager.AppSettings("Url.Form"), _FormID.Text,"2", "11060", "2", "11060") 
...
if (Not ("".IndexOf(calledBy) > -1)) Or String.IsNullOrEmpty(calledBy) then        
    ...
    ''' </summary>
    ''' <param name="SegurosDeVidaParameterInstance"></param>
    Public Sub MapPageToClass(ByRef SegurosDeVidaParameterInstance As SegurosDeVidaParameter)
        _loading = True
...
#Region "Form Manager"
    ...
    Private Sub GetCurrentParameterInstance(ByRef SegurosDeVidaParameterInstance As SegurosDeVidaParameter, force As Boolean)
        If _loadcompleted Or force Then
            If Not _CurrentParameterInstance Then

                SegurosDeVidaParameterInstance = FormData

                If Page.IsPostBack Then
                    MapPageToClass(SegurosDeVidaParameterInstance)
                End If

                _CurrentParameterInstance = True
            Else
                SegurosDeVidaParameterInstance = _formData
            End If
        Else
            SegurosDeVidaParameterInstance = Nothing
        End If
    End Sub

    Protected Sub SetCurrentParameterInstance(ByRef SegurosDeVidaParameterInstance As SegurosDeVidaParameter, calledBy As String)
        FormData = SegurosDeVidaParameterInstance
        MapClassToPage(SegurosDeVidaParameterInstance,calledBy)
    End Sub
    ...
    Private Sub GetTransferParameters()
        ...
        If Not IsNothing(fromDocumentCache) Then
            ...
            InMotionGIT.FrontOffice.Support.Helpers.ReflectionHandler.AssignPropertyValue("TipoRol", fromDocumentCache, _formData)
    ...
    Private Sub SetDefaultValuesFromQueryString()
        ...
        If Request.Form("TipoRol").IsNotEmpty Then
                FormData.TipoRol = Request.Form("TipoRol") 

ElseIf Request.QueryString("TipoRol").IsNotEmpty Then
                FormData.TipoRol = Request.QueryString("TipoRol") 
End If 
...
#Region "Actions Page Methods"
    ...
    Private Sub ParametersToDictionary(ByRef target As Dictionary(Of String, Object))
        If IsNothing(target) Then
            ...
            target.Add("TipoRol", _formData.TipoRol) 

        Else
            target("RiskInformation") = _formData.RiskInformation 
            target("TipoRol") = _formData.TipoRol 
    ...
    Private Sub ExecuteActionsInitializationForm()
                    ...
                    Try                          
                        ...
                        ParametersToDictionary(parametersDictionary)
                                    ...
                                    currentAction = "1. _formData.TipoRol = 'I'..." 
...
<Serializable()>
Public Class SegurosDeVidaParameter
    Inherits InMotionGIT.FrontOffice.Support.DataType.FormBase(Of  SegurosDeVidaParameter)
