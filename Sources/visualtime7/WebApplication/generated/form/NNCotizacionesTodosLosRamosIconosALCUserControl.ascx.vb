'---------------------------------------------------------------------------------------------------
' <generated>
'     This code was generated by Form Designer Oracle v7.1.2 at 2019/04/10 model release 4
'     
...
Partial Public Class NNCotizacionesTodosLosRamosIconosALCUserControl
...
#Region "Private fields"
    ...
    Private _formData As NNCotizacionesTodosLosRamosIconosALCParameter = Nothing
...
#Region "Public properties"
    ...
    Public Property FormData() As NNCotizacionesTodosLosRamosIconosALCParameter
        Get
           ...
           If Not String.IsNullOrEmpty(formDefinition) Then
              _formData = Serialize.Deserialize(Of NNCotizacionesTodosLosRamosIconosALCParameter)(formDefinition)
           End If
                        End If
                    End If

                    If IsNothing(_formData) Then
                        _formData = New NNCotizacionesTodosLosRamosIconosALCParameter
        ...
        Set(value As NNCotizacionesTodosLosRamosIconosALCParameter)
            _formData = value
        End Set
    End Property
...
#Region "Form Events"
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Dim formData As NNCotizacionesTodosLosRamosIconosALCParameter = Me.FormData        
    ...
    Protected Sub Page_Unload(sender As Object, e As EventArgs) Handles Me.Unload        
        If Not IsNothing(_formData) Then  
                       Session(String.Format(CultureInfo.InvariantCulture, "FormStorage.{0}", _FormID.Text)) = Serialize.Serialize(Of NNCotizacionesTodosLosRamosIconosALCParameter)(_formData)
        ...
        If Not IsNothing(_formData) Then
             ...
             If Not IsNothing(Session("Form.Track.Parameters")) AndAlso Session("Form.Track.Parameters").ToString.ToLower = "true" Then
                  InMotionGIT.Common.Helpers.Serialize.SerializeToFile(Of NNCotizacionesTodosLosRamosIconosALCParameter) _
                  (formData, String.Format(CultureInfo.InvariantCulture, "{0}\{1}.NNCotizacionesTodosLosRamosIconosALC.xml",  ConfigurationManager.AppSettings("Path.Logs"), formData.InternalId), True)
             End If        
        End If  
   End Sub
...
#Region "Mapping methods"
    ...
    Public Sub ValidateParametersInstance(ByRef NNCotizacionesTodosLosRamosIconosALCParameterInstance As NNCotizacionesTodosLosRamosIconosALCParameter)
        If IsNothing(NNCotizacionesTodosLosRamosIconosALCParameterInstance.RiskInformation) Then
            NNCotizacionesTodosLosRamosIconosALCParameterInstance.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
        End If
        If IsNothing(NNCotizacionesTodosLosRamosIconosALCParameterInstance.RiskInformation.PrimaryInsured) Then
            NNCotizacionesTodosLosRamosIconosALCParameterInstance.RiskInformation.PrimaryInsured = New InMotionGIT.Policy.Entity.Contracts.Role
        End If
        If IsNothing(NNCotizacionesTodosLosRamosIconosALCParameterInstance.RiskInformation.PrimaryInsured.Client) Then
            NNCotizacionesTodosLosRamosIconosALCParameterInstance.RiskInformation.PrimaryInsured.Client = New InMotionGIT.Client.Entity.Contracts.Client
        End If
    ...
    ''' </summary>
    ''' <param name="NNCotizacionesTodosLosRamosIconosALCParameterInstance"></param>
    ''' <remarks></remarks>
    Public Sub MapClassToPage(ByRef NNCotizacionesTodosLosRamosIconosALCParameterInstance As NNCotizacionesTodosLosRamosIconosALCParameter, Optional calledBy As String = "")
        Dim parametersDictionary As Dictionary(Of String, Object) = Nothing
        ValidateParametersInstance(NNCotizacionesTodosLosRamosIconosALCParameterInstance)

        ClienteProductor.DataBind()

       
        With NNCotizacionesTodosLosRamosIconosALCParameterInstance
...
if (Not ("".IndexOf(calledBy) > -1)) Or String.IsNullOrEmpty(calledBy) then        
    ...
    ''' </summary>
    ''' <param name="NNCotizacionesTodosLosRamosIconosALCParameterInstance"></param>
    Public Sub MapPageToClass(ByRef NNCotizacionesTodosLosRamosIconosALCParameterInstance As NNCotizacionesTodosLosRamosIconosALCParameter)
        _loading = True
...
Protected Sub btnCotizarFinal_Click(sender As Object, e As EventArgs)  
        Dim NNCotizacionesTodosLosRamosIconosALCParameterInstance As NNCotizacionesTodosLosRamosIconosALCParameter = Nothing
        ...
        Try 
           ...
           GetCurrentParameterInstance(NNCotizacionesTodosLosRamosIconosALCParameterInstance, True)
...
currentAction = SessionTrace("4. Call 'Búsqueda de toda la información de un cliente' library") 
        Dim _Client_bc20511e74bb40b39092a200eaa19bfb As InMotionGIT.Client.Entity.Contracts.Client 
        _Client_bc20511e74bb40b39092a200eaa19bfb = (New InMotionGIT.Client.Proxy.Manager).Retrieve(clientId:=_formData.RiskInformation.PrimaryInsured.Client.ClientID, atDate:=Date.Today, withLookupInformation:=True, childFilter:="All", accessToken:="String.Empty", provider:="CORE", companyID:=0) 
 
       isNullResult = (IsNothing(_Client_bc20511e74bb40b39092a200eaa19bfb)) 
       If Not isNullResult Then
            _formData.RiskInformation.PrimaryInsured.Client = _Client_bc20511e74bb40b39092a200eaa19bfb
       End If

            currentAction = SessionTrace("6. _formData.ClientExistInDB = true...") 
 
            currentAction = SessionTrace("6.1. _formData.ClientExistInDB = true...")

 _formData.ClientExistInDB = true 

            currentAction = SessionTrace("7. _formData.RiskInformation.PrimaryInsured.Client.IsNew = false...") 
 
            currentAction = SessionTrace("7.1. _formData.RiskInformation.PrimaryInsured.Client.IsNew = false...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 
 ...
 _formData.RiskInformation.PrimaryInsured.Client.IsNew = false 
            ...
            End If
            currentAction = SessionTrace("8. If _formData.IsProducer = true AND _formData.ClienteProductor Not Is Null Or Not Empty '' Then") 
If _formData.IsProducer = true AndAlso Not String.IsNullOrEmpty(_formData.ClienteProductor) Then

currentAction = SessionTrace("9. Call 'Búsqueda de toda la información de un cliente' library") 
        Dim _Client_0f18955d6ae740e9aa3acfe59325919c As InMotionGIT.Client.Entity.Contracts.Client 
        _Client_0f18955d6ae740e9aa3acfe59325919c = (New InMotionGIT.Client.Proxy.Manager).Retrieve(clientId:=_formData.ClienteProductor, atDate:=Date.Today, withLookupInformation:=True, childFilter:="All", accessToken:="String.Empty", provider:="CORE", companyID:=0) 
 
       isNullResult = (IsNothing(_Client_0f18955d6ae740e9aa3acfe59325919c)) 
       If Not isNullResult Then
            _formData.RiskInformation.PrimaryInsured.Client = _Client_0f18955d6ae740e9aa3acfe59325919c
       End If

            currentAction = SessionTrace("11. _formData.ClientExistInDB = true...") 
 
            currentAction = SessionTrace("11.1. _formData.ClientExistInDB = true...")

 _formData.ClientExistInDB = true 

            currentAction = SessionTrace("12. _formData.RiskInformation.PrimaryInsured.Client.IsNew = false...") 
 
            currentAction = SessionTrace("12.1. _formData.RiskInformation.PrimaryInsured.Client.IsNew = false...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 
          If IsNothing(_formData.RiskInformation.PrimaryInsured) Then
 ...
 _formData.RiskInformation.PrimaryInsured.Client.IsNew = false 
            ...
            End If
            currentAction = SessionTrace("13. _formData.Currency = 0...") 
 
            currentAction = SessionTrace("13.1. _formData.Currency = 0...")

 _formData.Currency = 0 

            currentAction = SessionTrace("14. If _formData.PlanType = 2 Then") 
If _formData.PlanType = 2 Then

            currentAction = SessionTrace("15. _formData.RiskInformation.LineOfBusiness = 8...") 
 
            currentAction = SessionTrace("15.1. _formData.RiskInformation.LineOfBusiness = 8...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 

 _formData.RiskInformation.LineOfBusiness = 8 

            currentAction = SessionTrace("16. _formData.RiskInformation.ProductCode = 6664...") 
 
            currentAction = SessionTrace("16.1. _formData.RiskInformation.ProductCode = 6664...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 
 ...
 _formData.RiskInformation.ProductCode = 6664 
            ...
            End If
            currentAction = SessionTrace("17. If _formData.PlanType = 3 Then") 
If _formData.PlanType = 3 Then

            currentAction = SessionTrace("18. _formData.RiskInformation.LineOfBusiness = 2...") 
 
            currentAction = SessionTrace("18.1. _formData.RiskInformation.LineOfBusiness = 2...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 
 ...
 _formData.RiskInformation.LineOfBusiness = 2 
            ...
            currentAction = SessionTrace("19. _formData.RiskInformation.ProductCode = 605...") 
 
            currentAction = SessionTrace("19.1. _formData.RiskInformation.ProductCode = 605...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 
 ...
 _formData.RiskInformation.ProductCode = 605 
            ...
            End If
            currentAction = SessionTrace("20. If _formData.PlanType = 10 Then") 
If _formData.PlanType = 10 Then

            currentAction = SessionTrace("21. _formData.RiskInformation.LineOfBusiness = 6...") 
 
            currentAction = SessionTrace("21.1. _formData.RiskInformation.LineOfBusiness = 6...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 
 ...
 _formData.RiskInformation.LineOfBusiness = 6 
            ...
            currentAction = SessionTrace("22. _formData.RiskInformation.ProductCode = 9300...") 
 
            currentAction = SessionTrace("22.1. _formData.RiskInformation.ProductCode = 9300...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 
 ...
 _formData.RiskInformation.ProductCode = 9300 
            ...
            End If
            currentAction = SessionTrace("23. If _formData.PlanType = 20 Then") 
If _formData.PlanType = 20 Then

            currentAction = SessionTrace("24. _formData.RiskInformation.LineOfBusiness = 9...") 
 
            currentAction = SessionTrace("24.1. _formData.RiskInformation.LineOfBusiness = 9...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 
 ...
 _formData.RiskInformation.ProductCode = 2 
            ...
            End If
            currentAction = SessionTrace("25. If _formData.PlanType = 40 Then") 
If _formData.PlanType = 40 Then

            currentAction = SessionTrace("26. _formData.RiskInformation.LineOfBusiness = 20...") 
 
            currentAction = SessionTrace("26.1. _formData.RiskInformation.LineOfBusiness = 20...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 

 _formData.RiskInformation.LineOfBusiness = 20 
            currentAction = SessionTrace("26.2. _formData.RiskInformation.ProductCode = 2...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 
 ...
 _formData.RiskInformation.EffectiveDate = Date.Today 
            ...
            End If
            currentAction = SessionTrace("27. If _formData.PlanType = 50 Then") 
If _formData.PlanType = 50 Then

            currentAction = SessionTrace("28. _formData.RiskInformation.LineOfBusiness = 2...") 
 
            currentAction = SessionTrace("28.1. _formData.RiskInformation.LineOfBusiness = 2...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 

 _formData.RiskInformation.LineOfBusiness = 2 
            currentAction = SessionTrace("28.2. _formData.RiskInformation.ProductCode = 70...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 

 _formData.RiskInformation.ProductCode = 70 
            currentAction = SessionTrace("28.3. _formData.RiskInformation.EffectiveDate = Date.Today...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 
 ...
 _formData.RiskInformation.EffectiveDate = Date.Today 
            ...
            End If
            currentAction = SessionTrace("29. If _formData.PlanType <> 0 Then") 
If _formData.PlanType <> 0 Then

currentAction = SessionTrace("31. Call 'Búsqueda de toda la información de un producto (RetrieveWithCaching)' library") 
        Dim _ProductMaster_89b25bf134b44a9096243f909cda3b7a As InMotionGIT.Product.Entity.Contracts.ProductMaster 
        _ProductMaster_89b25bf134b44a9096243f909cda3b7a = InMotionGIT.Product.Proxy.Lookups.RetrieveWithCaching(lineOfBusiness:=_formData.RiskInformation.LineOfBusiness, productId:=_formData.RiskInformation.ProductCode, atDate:=Date.Today, withLookups:=True, accessToken:="String.Empty", provider:="CORE", companyID:=0) 
 
       isNullResult = (IsNothing(_ProductMaster_89b25bf134b44a9096243f909cda3b7a)) 
       If Not isNullResult Then
            _formData.ProductMaster = _ProductMaster_89b25bf134b44a9096243f909cda3b7a
       End If

            currentAction = SessionTrace("32. _formData.ProductMasterDescription = _formData.ProductMaster.Description...") 
 
            currentAction = SessionTrace("32.1. _formData.ProductMasterDescription = _formData.ProductMaster.Description...")

 _formData.ProductMasterDescription = _formData.ProductMaster.Description 

            currentAction = SessionTrace("33. _formData.PaymentMethod = _formData.ProductMaster.ProductGene...") 
 
            currentAction = SessionTrace("33.1. _formData.PaymentMethod = _formData.ProductMaster.ProductGene...")

 _formData.PaymentMethod = _formData.ProductMaster.ProductGeneralInformation.PaymentMethod 
            currentAction = SessionTrace("33.2. _formData.ProductMasterDescription = _formData.ProductMaster.Description...")

 _formData.ProductMasterDescription = _formData.ProductMaster.Description 

            currentAction = SessionTrace("34. _formData.RiskInformation.PaymentFrequency = _formData.ProductMaster.ProductGene...") 
 
            currentAction = SessionTrace("34.1. _formData.RiskInformation.PaymentFrequency = _formData.ProductMaster.ProductGene...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 

 _formData.RiskInformation.PaymentFrequency = _formData.ProductMaster.ProductGeneralInformation.PaymentFrequency 
            currentAction = SessionTrace("34.2. _formData.RiskInformation.Policy.PaymentFrequency = _formData.ProductMaster.ProductGene...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 
 ...
 _formData.RiskInformation.Policy.PaymentFrequency = _formData.ProductMaster.ProductGeneralInformation.PaymentFrequency 
            currentAction = SessionTrace("34.3. _formData.RiskInformation.PaymentMethod = _formData.ProductMaster.ProductGene...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 
...
currentAction = SessionTrace("35. SELECT CUR_ALLOW.NBRANCH, CUR_ALLOW.NPRODUCT, CUR_ALLOW.NCURRENCY FROM CUR_ALLOW... WHERE CUR_ALLOW.NBRANCH = _formData.RiskInformation.LineOfBusiness AND CUR_ALLOW.NPRODUCT = _formData.RiskInformation.ProductCode AND CUR_ALLOW.SDEFAULTI = 1 )") 
            isFoundData = False 
...
.AddParameter("CUR_ALLOWNPRODUCT1", DbType.Int32, 5, False, _formData.RiskInformation.ProductCode)
        ...
        End With
            ...
            currentAction = SessionTrace("36. If _formData.Currency Is Null Or Empty  OR _formData.Currency = 0 Then") 
If IsNothing(_formData.Currency) OrElse _formData.Currency = 0 Then

            currentAction = SessionTrace("37. _formData.Currency = 1...") 
 
            currentAction = SessionTrace("37.1. _formData.Currency = 1...")

 _formData.Currency = 1 

            End If
            End If
            currentAction = SessionTrace("38. _formData.RiskInformation.Currency = _formData.Currency...") 
 
            currentAction = SessionTrace("38.1. _formData.RiskInformation.Currency = _formData.Currency...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 
 ...
 _formData.RiskInformation.Currency = _formData.Currency 
            ...
            currentAction = SessionTrace("39. If _formData.PlanType = 1 OR _formData.PlanType = 2 Then") 
If _formData.PlanType = 1 OrElse _formData.PlanType = 2 Then

            currentAction = SessionTrace("40. _formData.RiskInformation.Policy.PolicyType = 1...") 
 
            currentAction = SessionTrace("40.1. _formData.RiskInformation.Policy.PolicyType = 1...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 
          If IsNothing(_formData.RiskInformation.Policy) Then
 ...
 _formData.RiskInformation.Policy.PolicyType = 1 
            ...
            currentAction = SessionTrace("41. _formData.RiskInformation.PaymentFrequency = _formData.ProductMaster.ProductGene...") 
 
            currentAction = SessionTrace("41.1. _formData.RiskInformation.PaymentFrequency = _formData.ProductMaster.ProductGene...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 

 _formData.RiskInformation.PaymentFrequency = _formData.ProductMaster.ProductGeneralInformation.PaymentFrequency 
            currentAction = SessionTrace("41.2. _formData.RiskInformation.Policy.PaymentFrequency = _formData.ProductMaster.ProductGene...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 
          If IsNothing(_formData.RiskInformation.Policy) Then
 ...
 _formData.RiskInformation.Policy.PaymentFrequency = _formData.ProductMaster.ProductGeneralInformation.PaymentFrequency 
            currentAction = SessionTrace("41.3. _formData.RiskInformation.PaymentMethod = _formData.ProductMaster.ProductGene...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 
 ...
 _formData.RiskInformation.PaymentMethod = _formData.ProductMaster.ProductGeneralInformation.PaymentMethod 
            ...
            currentAction = SessionTrace("42. _formData.RiskInformation.LifeLineOfBusiness.DurationOfPayments = _formData.ProductMaster.ProductLife...") 
 
            currentAction = SessionTrace("42.1. _formData.RiskInformation.LifeLineOfBusiness.DurationOfPayments = _formData.ProductMaster.ProductLife...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 
 ...
 _formData.RiskInformation.LifeLineOfBusiness.DurationOfPayments = _formData.ProductMaster.ProductLifeLineOfBusiness.DurationOfPayments 
            ...
            currentAction = SessionTrace("43. _formData.RiskInformation.LifeLineOfBusiness.TypeOfInsurancePeriod = _formData.ProductMaster.ProductLife...") 
 
            currentAction = SessionTrace("43.1. _formData.RiskInformation.LifeLineOfBusiness.TypeOfInsurancePeriod = _formData.ProductMaster.ProductLife...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 
          If IsNothing(_formData.RiskInformation.LifeLineOfBusiness) Then
 ...
 _formData.RiskInformation.LifeLineOfBusiness.TypeOfInsurancePeriod = _formData.ProductMaster.ProductLifeLineOfBusiness.TypeOfInsuranceDuration 
            ...
            currentAction = SessionTrace("44. _formData.RiskInformation.LifeLineOfBusiness.InsuranceDuration = _formData.ProductMaster.ProductLife...") 
 
            currentAction = SessionTrace("44.1. _formData.RiskInformation.LifeLineOfBusiness.InsuranceDuration = _formData.ProductMaster.ProductLife...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 
          If IsNothing(_formData.RiskInformation.LifeLineOfBusiness) Then
 ...
 _formData.RiskInformation.LifeLineOfBusiness.InsuranceDuration = _formData.ProductMaster.ProductLifeLineOfBusiness.InsuranceDuration 
            ...
            currentAction = SessionTrace("45. _formData.RiskInformation.Currency = _formData.ProductMaster.ProductLife...") 
 
            currentAction = SessionTrace("45.1. _formData.RiskInformation.Currency = _formData.ProductMaster.ProductLife...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 

 _formData.RiskInformation.Currency = _formData.ProductMaster.ProductLifeLineOfBusiness.Currency 
            currentAction = SessionTrace("45.2. _formData.Currency = _formData.ProductMaster.ProductLife...")

 _formData.Currency = _formData.ProductMaster.ProductLifeLineOfBusiness.Currency 

            currentAction = SessionTrace("46. _formData.Currency = _formData.ProductMaster.ProductLife...") 
 
            currentAction = SessionTrace("46.1. _formData.Currency = _formData.ProductMaster.ProductLife...")

 _formData.Currency = _formData.ProductMaster.ProductLifeLineOfBusiness.Currency 

            currentAction = SessionTrace("47. Call 'Mi Vida vale - ALC' form with transferring parameters") 
Session(_FormID.Text) = _formData 
 Session("fromid") = _FormID.Text 
     
_webtransfer = String.Format(CultureInfo.InvariantCulture, "{0}/NNCotizacionMiVidaValeIIALC.aspx?fromid={1}", ConfigurationManager.AppSettings("Url.Form"), _FormID.Text, "") 
        Else 
            currentAction = SessionTrace("48. If _formData.PlanType = 3 Then") 
If _formData.PlanType = 3 Then

            currentAction = SessionTrace("49. _formData.RiskInformation.PrimaryInsured.Client.BusinessAddress = New InMotionGIT.General.Entity.Cont...") 
 
            currentAction = SessionTrace("49.1. _formData.RiskInformation.PrimaryInsured.Client.BusinessAddress = New InMotionGIT.General.Entity.Cont...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 
          If IsNothing(_formData.RiskInformation.PrimaryInsured) Then
 ...
 _formData.RiskInformation.PrimaryInsured.Client.BusinessAddress = New InMotionGIT.General.Entity.Contracts.Address.Address 
            ...
            currentAction = SessionTrace("50. _formData.RiskInformation.Policy.PolicyType = 1...") 
 
            currentAction = SessionTrace("50.1. _formData.RiskInformation.Policy.PolicyType = 1...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 
          If IsNothing(_formData.RiskInformation.Policy) Then
 ...
 _formData.RiskInformation.Policy.PolicyType = 1 
            ...
            currentAction = SessionTrace("51. '_formData.InvestmentFundRelatedToProductCollection' = New 'InMotionGIT.Product.Entit'...'") 
            ...
            currentAction = SessionTrace("52. For Each investmentfundrelatedtoproductItem As 'InMotionGIT.Product.Entit...' In '_formData.ProductMaster.I...'") 
            ...
            currentAction = SessionTrace("53. '_formData.InvestmentFundRelatedToProductCollection'.Add('investmentfundrelatedtoproductItem')") 
             _formData.InvestmentFundRelatedToProductCollection.Add(investmentfundrelatedtoproductItem)

            Next
            currentAction = SessionTrace("54. _formData.PaymentMethod = _formData.ProductMaster.ProductGene...") 
 
            currentAction = SessionTrace("54.1. _formData.PaymentMethod = _formData.ProductMaster.ProductGene...")

 _formData.PaymentMethod = _formData.ProductMaster.ProductGeneralInformation.PaymentMethod 
            currentAction = SessionTrace("54.2. _formData.ProductMasterDescription = _formData.ProductMaster.Description...")

 _formData.ProductMasterDescription = _formData.ProductMaster.Description 

            currentAction = SessionTrace("55. _formData.RiskInformation.LifeLineOfBusiness.TypeOfPaymentsPeriod = 1...") 
 
            currentAction = SessionTrace("55.1. _formData.RiskInformation.LifeLineOfBusiness.TypeOfPaymentsPeriod = 1...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 
          If IsNothing(_formData.RiskInformation.LifeLineOfBusiness) Then
 ...
 _formData.RiskInformation.LifeLineOfBusiness.TypeOfPaymentsPeriod = 1 
            ...
            currentAction = SessionTrace("56. _formData.RiskInformation.LifeLineOfBusiness.InsuranceDuration = _formData.ProductMaster.ProductLife...") 
 
            currentAction = SessionTrace("56.1. _formData.RiskInformation.LifeLineOfBusiness.InsuranceDuration = _formData.ProductMaster.ProductLife...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 
          If IsNothing(_formData.RiskInformation.LifeLineOfBusiness) Then
 ...
 _formData.RiskInformation.LifeLineOfBusiness.InsuranceDuration = _formData.ProductMaster.ProductLifeLineOfBusiness.InsuranceDuration 
            ...
            currentAction = SessionTrace("57. _formData.Currency = _formData.ProductMaster.ProductLife...") 
 
            currentAction = SessionTrace("57.1. _formData.Currency = _formData.ProductMaster.ProductLife...")

 _formData.Currency = _formData.ProductMaster.ProductLifeLineOfBusiness.Currency 

            currentAction = SessionTrace("58. _formData.RiskInformation.Currency = _formData.ProductMaster.ProductLife...") 
 
            currentAction = SessionTrace("58.1. _formData.RiskInformation.Currency = _formData.ProductMaster.ProductLife...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 
 ...
 _formData.RiskInformation.Currency = _formData.ProductMaster.ProductLifeLineOfBusiness.Currency 
            ...
            currentAction = SessionTrace("59. _formData.RiskInformation.LifeLineOfBusiness.TypeOfInsurancePeriod = _formData.ProductMaster.ProductLife...") 
 
            currentAction = SessionTrace("59.1. _formData.RiskInformation.LifeLineOfBusiness.TypeOfInsurancePeriod = _formData.ProductMaster.ProductLife...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 
          If IsNothing(_formData.RiskInformation.LifeLineOfBusiness) Then
 ...
 _formData.RiskInformation.LifeLineOfBusiness.TypeOfInsurancePeriod = _formData.ProductMaster.ProductLifeLineOfBusiness.TypeOfInsuranceDuration 
            ...
            currentAction = SessionTrace("60. _formData.ProductMasterDescription = _formData.ProductMaster.Description...") 
 
            currentAction = SessionTrace("60.1. _formData.ProductMasterDescription = _formData.ProductMaster.Description...")

 _formData.ProductMasterDescription = _formData.ProductMaster.Description 

            currentAction = SessionTrace("61. _formData.RiskInformation.LifeLineOfBusiness.DurationOfPayments = _formData.ProductMaster.ProductLife...") 
 
            currentAction = SessionTrace("61.1. _formData.RiskInformation.LifeLineOfBusiness.DurationOfPayments = _formData.ProductMaster.ProductLife...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 
          If IsNothing(_formData.RiskInformation.LifeLineOfBusiness) Then
 ...
 _formData.RiskInformation.LifeLineOfBusiness.DurationOfPayments = _formData.ProductMaster.ProductLifeLineOfBusiness.DurationOfPayments 
            ...
            currentAction = SessionTrace("62. Call 'Mi Inversión Segura' form with transferring parameters") 
Session(_FormID.Text) = _formData 
 Session("fromid") = _FormID.Text 
...
_webtransfer = String.Format(CultureInfo.InvariantCulture, "{0}/NNCotizacionMiInversionSeguraII.aspx?fromid={1}", ConfigurationManager.AppSettings("Url.Form"), _FormID.Text, "") 
        Else 
            currentAction = SessionTrace("63. If _formData.PlanType = 10 Then") 
If _formData.PlanType = 10 Then

            currentAction = SessionTrace("64. _formData.RiskInformation.Policy.PolicyType = 1...") 
 
            currentAction = SessionTrace("64.1. _formData.RiskInformation.Policy.PolicyType = 1...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 
          If IsNothing(_formData.RiskInformation.Policy) Then
 ...
 _formData.RiskInformation.Policy.PolicyType = 1 
            ...
            currentAction = SessionTrace("65. _formData.RiskInformation.PrimaryInsured.Client.BusinessAddress = New InMotionGIT.General.Entity.Cont...") 
 
            currentAction = SessionTrace("65.1. _formData.RiskInformation.PrimaryInsured.Client.BusinessAddress = New InMotionGIT.General.Entity.Cont...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 
          If IsNothing(_formData.RiskInformation.PrimaryInsured) Then
 ...
 _formData.RiskInformation.PrimaryInsured.Client.BusinessAddress = New InMotionGIT.General.Entity.Contracts.Address.Address 
            ...
            currentAction = SessionTrace("66. Call 'Mi Auto aDorado - Recuperada' form with transferring parameters") 
Session(_FormID.Text) = _formData 
 Session("fromid") = _FormID.Text 
...
_webtransfer = String.Format(CultureInfo.InvariantCulture, "{0}/NNCotizacionMiAutoaDoradoII.aspx?fromid={1}", ConfigurationManager.AppSettings("Url.Form"), _FormID.Text, "") 
        Else 
            currentAction = SessionTrace("67. If _formData.PlanType = 20 Then") 
If _formData.PlanType = 20 Then
 ...
 _formData.RiskInformation.Policy.PolicyType = _formData.ProductMaster.ProductGeneralInformation.PolicyType 
            ...
            currentAction = SessionTrace("69. Call 'Póliza Hogar Seguro' form with transferring parameters") 
Session(_FormID.Text) = _formData 
 Session("fromid") = _FormID.Text 
...
_webtransfer = String.Format(CultureInfo.InvariantCulture, "{0}/NNCotizacionPolizaHogarSeguro.aspx?fromid={1}", ConfigurationManager.AppSettings("Url.Form"), _FormID.Text, "") 
        Else 
            currentAction = SessionTrace("70. If _formData.PlanType = 50 Then") 
If _formData.PlanType = 50 Then

            currentAction = SessionTrace("71. _formData.RiskInformation.Policy.PolicyType = _formData.ProductMaster.ProductGene...") 
 
            currentAction = SessionTrace("71.1. _formData.RiskInformation.Policy.PolicyType = _formData.ProductMaster.ProductGene...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 
          If IsNothing(_formData.RiskInformation.Policy) Then
 ...
 _formData.RiskInformation.Policy.PolicyType = _formData.ProductMaster.ProductGeneralInformation.PolicyType 
            ...
            currentAction = SessionTrace("72. Call 'Mi Salud Vale Oro' form with transferring parameters") 
Session(_FormID.Text) = _formData 
 Session("fromid") = _FormID.Text 
...
_webtransfer = String.Format(CultureInfo.InvariantCulture, "{0}/NNCotizacionMiSaludValeOro.aspx?fromid={1}", ConfigurationManager.AppSettings("Url.Form"), _FormID.Text, "") 
        Else 
            currentAction = SessionTrace("73. The message 'Producto en proceso ...' will displayed as 'Popup'") 
          ...
          SetCurrentParameterInstance(NNCotizacionesTodosLosRamosIconosALCParameterInstance,"")
          
        
          If NNCotizacionesTodosLosRamosIconosALCParameterInstance.Behavior <> InMotionGIT.FrontOffice.Support.Enumerations.enumBehavior.None Then
             If Not String.IsNullOrEmpty(NNCotizacionesTodosLosRamosIconosALCParameterInstance.NotifyMessage) Then
                 ShowWindowPopupMessage(NNCotizacionesTodosLosRamosIconosALCParameterInstance.NotifyMessage)
             End If           
            
             NNCotizacionesTodosLosRamosIconosALCParameterInstance.Behavior = InMotionGIT.FrontOffice.Support.Enumerations.enumBehavior.None
          End If
        
          If Not String.IsNullOrEmpty(NNCotizacionesTodosLosRamosIconosALCParameterInstance.BehaviorShowControls) Then
               BehaviorShowControls(NNCotizacionesTodosLosRamosIconosALCParameterInstance.BehaviorShowControls)
          End If        
      ...
      Finally
           ...
           If  _formData.Errors.Count = 0 AndAlso Not String.IsNullOrEmpty(_webTransfer) Then
               ...
               End If          
           End If
		   NNCotizacionesTodosLosRamosIconosALCUpdatePanel.Update
      End Try
...
#Region "Form Manager"
    ...
    Private Sub GetCurrentParameterInstance(ByRef NNCotizacionesTodosLosRamosIconosALCParameterInstance As NNCotizacionesTodosLosRamosIconosALCParameter, force As Boolean)
        If _loadcompleted Or force Then
            If Not _CurrentParameterInstance Then

                NNCotizacionesTodosLosRamosIconosALCParameterInstance = FormData

                If Page.IsPostBack Then
                    MapPageToClass(NNCotizacionesTodosLosRamosIconosALCParameterInstance)
                End If

                _CurrentParameterInstance = True
            Else
                NNCotizacionesTodosLosRamosIconosALCParameterInstance = _formData
            End If
        Else
            NNCotizacionesTodosLosRamosIconosALCParameterInstance = Nothing
        End If
    End Sub

    Protected Sub SetCurrentParameterInstance(ByRef NNCotizacionesTodosLosRamosIconosALCParameterInstance As NNCotizacionesTodosLosRamosIconosALCParameter, calledBy As String)
        FormData = NNCotizacionesTodosLosRamosIconosALCParameterInstance
        MapClassToPage(NNCotizacionesTodosLosRamosIconosALCParameterInstance,calledBy)
    End Sub
...
currentAction = SessionTrace("11. Call 'Búsqueda de toda la información de un cliente' library") 
        Dim _Client_c538fc8586b24a97bc24ec80f0df6f0a As InMotionGIT.Client.Entity.Contracts.Client 
        _Client_c538fc8586b24a97bc24ec80f0df6f0a = (New InMotionGIT.Client.Proxy.Manager).Retrieve(clientId:=_formData.ClienteConectado, atDate:=Date.Today, withLookupInformation:=True, childFilter:="All", accessToken:="String.Empty", provider:="CORE", companyID:=0) 
 
       isNullResult = (IsNothing(_Client_c538fc8586b24a97bc24ec80f0df6f0a)) 
       If Not isNullResult Then
            _formData.RiskInformation.PrimaryInsured.Client = _Client_c538fc8586b24a97bc24ec80f0df6f0a
       End If

            currentAction = SessionTrace("13. _formData.ClienteConectado = _formData.RiskInformation.PrimaryIn...") 
 
            currentAction = SessionTrace("13.1. _formData.ClienteConectado = _formData.RiskInformation.PrimaryIn...")

 _formData.ClienteConectado = _formData.RiskInformation.PrimaryInsured.Client.ClientID 

            currentAction = SessionTrace("14. If Form.IsNullResult = true Then") 
If isNullResult = true Then

            currentAction = SessionTrace("15. _formData.ClientExistInDB = false...") 
 
            currentAction = SessionTrace("15.1. _formData.ClientExistInDB = false...")

 _formData.ClientExistInDB = false 

            currentAction = SessionTrace("16. _formData.RiskInformation.PrimaryInsured.Client.IsNew = True...") 
 
            currentAction = SessionTrace("16.1. _formData.RiskInformation.PrimaryInsured.Client.IsNew = True...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 
          If IsNothing(_formData.RiskInformation.PrimaryInsured) Then
 ...
 _formData.RiskInformation.PrimaryInsured.Client.IsNew = True 
            ...
            currentAction = SessionTrace("17. CompleteClientNameCTLR.Visible = false") 
            currentAction = SessionTrace("17.1. CompleteClientNameCTLR.Visible = false...")
BehaviorShowControls("CompleteClientNameCTLR,Hidden")

        Else 
            currentAction = SessionTrace("18. _formData.ClientExistInDB = true...") 
 
            currentAction = SessionTrace("18.1. _formData.ClientExistInDB = true...")

 _formData.ClientExistInDB = true 

            currentAction = SessionTrace("19. CompleteClientNameCTLR.Visible = true") 
            currentAction = SessionTrace("19.1. CompleteClientNameCTLR.Visible = true...")
BehaviorShowControls("CompleteClientNameCTLR,Visible")

            End If
        Else 
            currentAction = SessionTrace("20. _formData.RiskInformation.PrimaryInsured.Client.IsNew = True...") 
 
            currentAction = SessionTrace("20.1. _formData.RiskInformation.PrimaryInsured.Client.IsNew = True...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 
          If IsNothing(_formData.RiskInformation.PrimaryInsured) Then
 ...
 _formData.RiskInformation.PrimaryInsured.Client.IsNew = True 
            ...
            currentAction = SessionTrace("21. _formData.ClientExistInDB = false...") 
 
            currentAction = SessionTrace("21.1. _formData.ClientExistInDB = false...")

 _formData.ClientExistInDB = false 

            End If
            currentAction = SessionTrace("22. If _formData.IsEmployee = true Then") 
If _formData.IsEmployee = true Then

            currentAction = SessionTrace("23. zone12CTLR.Visible = true, zone10AgenteCTLR.Visible = false") 
            currentAction = SessionTrace("23.1. zone12CTLR.Visible = true...")
BehaviorShowControls("zone12CTLR,Visible")
            currentAction = SessionTrace("23.2. zone10AgenteCTLR.Visible = false...")
BehaviorShowControls("zone10AgenteCTLR,Hidden")

currentAction = SessionTrace("24. SELECT USERS.NAGENCY, USERS.NUSERCODE FROM USERS... WHERE USERS.NUSERCODE = _formData.UsercodeBO )") 
            isFoundData = False 
                      If IsNothing(_formData.PolicyLocal) Then
              _formData.PolicyLocal = New InMotionGIT.Policy.Entity.Contracts.Policy
          End If 
...
currentAction = SessionTrace("25. SELECT AGENCIES.NAGENCY, AGENCIES.NOFFICEAGEN, AGENCIES.NBRAN_OFF FROM AGENCIES... WHERE AGENCIES.NAGENCY = _formData.PolicyLocal.Agency )") 
            isFoundData = False 
With New DataManagerFactory("SELECT AGENCIES.NAGENCY, AGENCIES.NOFFICEAGEN, AGENCIES.NBRAN_OFF FROM AGENCIES AGENCIES  WHERE AGENCIES.NAGENCY = @:AGENCIESNAGENCY0", "AGENCIES", "Linked.LatCombined")
        ...
        End With
          ...
          End If 
            ...
            End If
            currentAction = SessionTrace("26. _formData.RiskInformation.Policy = _formData.PolicyLocal...") 
 
            currentAction = SessionTrace("26.1. _formData.RiskInformation.Policy = _formData.PolicyLocal...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 
          If IsNothing(_formData.RiskInformation.Policy) Then
 ...
 _formData.RiskInformation.Policy = _formData.PolicyLocal 
            ...
            currentAction = SessionTrace("27. If _formData.IsProducer = true Then") 
If _formData.IsProducer = true Then

            currentAction = SessionTrace("28. zone12CTLR.Visible = false, zone10AgenteCTLR.Visible = true") 
            currentAction = SessionTrace("28.1. zone12CTLR.Visible = false...")
BehaviorShowControls("zone12CTLR,Hidden")
            currentAction = SessionTrace("28.2. zone10AgenteCTLR.Visible = true...")
BehaviorShowControls("zone10AgenteCTLR,Visible")

            currentAction = SessionTrace("29. _formData.RiskInformation.PrimaryInsured.Client.IsNew = True...") 
 
            currentAction = SessionTrace("29.1. _formData.RiskInformation.PrimaryInsured.Client.IsNew = True...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 
          If IsNothing(_formData.RiskInformation.PrimaryInsured) Then
 ...
 _formData.RiskInformation.PrimaryInsured.Client.IsNew = True 
            ...
            currentAction = SessionTrace("30. If (_formData.ProducerCode Is Null Or Empty  OR _formData.ProducerCode = 0) Then") 
If (IsNothing(_formData.ProducerCode) OrElse _formData.ProducerCode = 0) Then

            currentAction = SessionTrace("31. The message 'Usted no está autori...' will displayed as 'Popup'") 
            messageAction = GetLocalResourceObject("NNCotizacionesTodosLosRamosIconosALC0_MessageActionResource").ToString() 
            ParametersToDictionary(parametersDictionary)
            messageAction = InMotionGIT.FrontOffice.Proxy.Helpers.Email.Process(messageAction, parametersDictionary) 
            ShowWindowPopupMessage(messageAction) 

        Else 
            currentAction = SessionTrace("32. _formData.UsercodeBO = 9998...") 
 
            currentAction = SessionTrace("32.1. _formData.UsercodeBO = 9998...")

 _formData.UsercodeBO = 9998 

currentAction = SessionTrace("33. Call 'Obtener información productor' library") 
        Dim _Producer_a4627f2b9206496ea3233968510e9a2a As InMotionGIT.Intermedia.Entity.Contracts.Producer 
        _Producer_a4627f2b9206496ea3233968510e9a2a = InMotionGIT.Intermedia.Proxy.Manager.Retrieve(producerCode:=_formData.ProducerCode, atDate:=Date.Today, withLookupInformation:=False, childFilter:="All", provider:="CORE", companyID:=0) 
 
       isNullResult = (IsNothing(_Producer_a4627f2b9206496ea3233968510e9a2a)) 
       If Not isNullResult Then
            _formData.RiskInformation.PrimaryProducer.Producer = _Producer_a4627f2b9206496ea3233968510e9a2a
       End If

currentAction = SessionTrace("35. Call 'Búsqueda de toda la información de un cliente' library") 
        Dim _Client_b24481cbdcee42638f85223fab44f01a As InMotionGIT.Client.Entity.Contracts.Client 
        _Client_b24481cbdcee42638f85223fab44f01a = (New InMotionGIT.Client.Proxy.Manager).Retrieve(clientId:=_formData.RiskInformation.PrimaryProducer.Producer.ClientID, atDate:=Date.Today, withLookupInformation:=True, childFilter:="All", accessToken:="String.Empty", provider:="CORE", companyID:=0) 
 
       isNullResult = (IsNothing(_Client_b24481cbdcee42638f85223fab44f01a)) 
       If Not isNullResult Then
            _formData.RiskInformation.PrimaryProducer.Client = _Client_b24481cbdcee42638f85223fab44f01a
       End If

            currentAction = SessionTrace("37. _formData.ProducerClientID = _formData.RiskInformation.PrimaryPr...") 
 
            currentAction = SessionTrace("37.1. _formData.ProducerClientID = _formData.RiskInformation.PrimaryPr...")

 _formData.ProducerClientID = _formData.RiskInformation.PrimaryProducer.Client.ClientID 

            currentAction = SessionTrace("38. '_formData.PolicyLocal' = New 'InMotionGIT.Policy.Entity'...'") 
             _formData.PolicyLocal = New InMotionGIT.Policy.Entity.Contracts.Policy

currentAction = SessionTrace("39. SELECT AGENCIES.NAGENCY, AGENCIES.NOFFICEAGEN, AGENCIES.NBRAN_OFF FROM AGENCIES... WHERE AGENCIES.NAGENCY = _formData.RiskInformation.PrimaryProducer.Producer.Agency )") 
            isFoundData = False 
With New DataManagerFactory("SELECT AGENCIES.NAGENCY, AGENCIES.NOFFICEAGEN, AGENCIES.NBRAN_OFF FROM AGENCIES AGENCIES  WHERE AGENCIES.NAGENCY = @:AGENCIESNAGENCY0", "AGENCIES", "Linked.LatCombined")
        ...
        End With
          ...
          End If 
            ...
            currentAction = SessionTrace("40. _formData.RiskInformation.Policy = _formData.PolicyLocal...") 
 
            currentAction = SessionTrace("40.1. _formData.RiskInformation.Policy = _formData.PolicyLocal...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 
          If IsNothing(_formData.RiskInformation.Policy) Then
 ...
 _formData.RiskInformation.Policy = _formData.PolicyLocal 
            ...
            End If
        Else 
            currentAction = SessionTrace("41. '_formData.RiskInformation.PrimaryProducer' = New 'InMotionGIT.Policy.Entity'...'") 
             _formData.RiskInformation.PrimaryProducer = New InMotionGIT.Policy.Entity.Contracts.Role

            currentAction = SessionTrace("42. _formData.ProducerClientID = Nothing...") 
 
            currentAction = SessionTrace("42.1. _formData.ProducerClientID = Nothing...")

 _formData.ProducerClientID = Nothing 

            End If
            currentAction = SessionTrace("43. If _formData.IsAnonymous = true Then") 
If _formData.IsAnonymous = true Then

            currentAction = SessionTrace("44. zone12CTLR.Visible = false, zone10AgenteCTLR.Visible = false") 
            currentAction = SessionTrace("44.1. zone12CTLR.Visible = false...")
BehaviorShowControls("zone12CTLR,Hidden")
            currentAction = SessionTrace("44.2. zone10AgenteCTLR.Visible = false...")
BehaviorShowControls("zone10AgenteCTLR,Hidden")

            currentAction = SessionTrace("45. _formData.UsercodeBO = 9998...") 
 
            currentAction = SessionTrace("45.1. _formData.UsercodeBO = 9998...")

 _formData.UsercodeBO = 9998 
            currentAction = SessionTrace("45.2. _formData.UsercodeFASI = 9998...")

 _formData.UsercodeFASI = 9998 

            End If
            currentAction = SessionTrace("46. _formData.FormaContactenos = '#setting.Url.WebApplication#' & '/...") 
 
            currentAction = SessionTrace("46.1. _formData.FormaContactenos = '#setting.Url.WebApplication#' & '/...")

 _formData.FormaContactenos = "#setting.Url.WebApplication#" & "/generated/form/ContactoMailTelefonoEnWidget.aspx" 

            currentAction = SessionTrace("47. _formData.ImagenSeleccionada = '/images/iconramos/2.png'...") 
 
            currentAction = SessionTrace("47.1. _formData.ImagenSeleccionada = '/images/iconramos/2.png'...")

 _formData.ImagenSeleccionada = "/images/iconramos/2.png" 

            currentAction = SessionTrace("48. _formData.RiskInformation.LineOfBusiness = 2...") 
 
            currentAction = SessionTrace("48.1. _formData.RiskInformation.LineOfBusiness = 2...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 
 ...
 _formData.RiskInformation.LineOfBusiness = 2 
            ...
            currentAction = SessionTrace("49. _formData.RiskInformation.ProductCode = 6664...") 
 
            currentAction = SessionTrace("49.1. _formData.RiskInformation.ProductCode = 6664...")
          If IsNothing(_formData.RiskInformation) Then
              _formData.RiskInformation = New InMotionGIT.Policy.Entity.Contracts.RiskInformation
          End If 
 ...
 _formData.RiskInformation.ProductCode = 6664 
            ...
            currentAction = SessionTrace("50. _formData.PlanType = 2...") 
 
            currentAction = SessionTrace("50.1. _formData.PlanType = 2...")

 _formData.PlanType = 2 

            currentAction = SessionTrace("51. image9.Visible = true, btnCotizarFinal.Visible = true") 
            currentAction = SessionTrace("51.1. image9.Visible = true...")
BehaviorShowControls("image9,Visible")
            currentAction = SessionTrace("51.2. btnCotizarFinal.Visible = true...")
BehaviorShowControls("btnCotizarFinal,Visible")
...
<Serializable()>
Public Class NNCotizacionesTodosLosRamosIconosALCParameter
    Inherits InMotionGIT.FrontOffice.Support.DataType.FormBase(Of  NNCotizacionesTodosLosRamosIconosALCParameter)
