<%@ Control Language="VB" AutoEventWireup="false" CodeFile="NNCotizacionMiVidaValeIIUserControl.ascx.vb" Inherits="NNCotizacionMiVidaValeIIUserControl" %>
...
<script src="/generated/form/NNCotizacionMiVidaValeII.js" type="text/javascript"></script>      
...
<table id='NNCotizacionMiVidaValeIITablePage' runat='server' style='width: 100%;margin: auto;'>
  <tr valign='top'>
    <td colspan='2'>
    </td>
  </tr>
...
<table style='width: 100%;'>
  ...
  <tr valign='top'>
    <td style='width:100%;' align='left'>       <dxe:ASPxLabel ID='ClientIDAutLabel' EncodeHtml='false' ClientInstanceName='ClientIDAutLabel' runat='server' ClientIDMode='Static' meta:resourcekey="ClientIDAutLabelResource"  Text="Identificación"  ClientEnabled='true'  ClientVisible='true'  AssociatedControlID='ClientIDAut'       ></dxe:ASPxLabel><br />
...
<td style='width:50%; padding-top:3px;' colspan='1' align='Left'>       <dxe:ASPxLabel ID='ClientIDLabel' EncodeHtml='false' ClientInstanceName='ClientIDLabel' runat='server' ClientIDMode='Static' meta:resourcekey="ClientIDLabelResource"  Text="Identificación"  ClientEnabled='true'  ClientVisible='true'  AssociatedControlID='ClientID'       ></dxe:ASPxLabel></td>    <td style='width:50%;' align='left'>
       ...
       <dxe:ASPxTextBox runat='server' ID='ClientID' ClientInstanceName='ClientID' ToolTip="Código del cliente que aparece como asegurado principal de la póliza" Size='14' NullText="" ClientVisible='True' MaxLength='14' ClientIDMode='Static' meta:resourcekey="ClientIDResource" Width='180px'  ClientEnabled='True' AutoPostBack='true' OnTextChanged='ClientID_TextChanged' >
         <Paddings PaddingLeft="8px" />
         <BackgroundImage HorizontalPosition="left" ImageUrl="/images/generaluse/required.PNG" Repeat="NoRepeat" VerticalPosition="center"/>
...
<ClientSideEvents SelectedIndexChanged="AsyncPostBack"/>
    ...
    <td style='width:25%;' align='left'>       <dxe:ASPxLabel ID='ClientIDBDLabel' EncodeHtml='false' ClientInstanceName='ClientIDBDLabel' runat='server' ClientIDMode='Static' meta:resourcekey="ClientIDBDLabelResource"  Text="Identificación"  ClientEnabled='true'  ClientVisible='false'  AssociatedControlID='ClientIDBD'       ></dxe:ASPxLabel><br />
