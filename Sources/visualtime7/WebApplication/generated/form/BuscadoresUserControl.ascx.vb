'---------------------------------------------------------------------------------------------------
' <generated>
'     This code was generated by Form Designer Oracle v7.1.111 at 2017-02-20 model release 1
'     
...
Partial Public Class BuscadoresUserControl
...
#Region "Private fields"
    ...
    Private _formData As BuscadoresParameter = Nothing
...
#Region "Public properties"
    ...
    Public Property FormData() As BuscadoresParameter
        Get
           ...
           If Not String.IsNullOrEmpty(formDefinition) Then
              _formData = Serialize.Deserialize(Of BuscadoresParameter)(formDefinition)
           End If
                        End If
                    End If

                    If IsNothing(_formData) Then
                        _formData = New BuscadoresParameter
                        ...
                        If Not String.IsNullOrEmpty(Request.QueryString("readonly")) Then
                            BehaviorControls(BuscadoresTablePage, False)
                        End If
                        
                        If Not String.IsNullOrEmpty(Request.QueryString("Ir")) Then
                            Ir_Click(nothing, nothing)
                        End If
        ...
        Set(value As BuscadoresParameter)
            _formData = value
        End Set
    End Property
...
#Region "Form Events"
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Dim formData As BuscadoresParameter = Me.FormData        
    ...
    Protected Sub Page_Unload(sender As Object, e As EventArgs) Handles Me.Unload        
        If Not IsNothing(_formData) Then
              Session(String.Format(CultureInfo.InvariantCulture, "FormStorage.{0}", _FormID.Text)) = Serialize.Serialize(Of BuscadoresParameter)(_formData)
...
#Region "Mapping methods"
    ...
    Public Sub ValidateParametersInstance(ByRef BuscadoresParameterInstance As BuscadoresParameter)
    ...
    ''' </summary>
    ''' <param name="BuscadoresParameterInstance"></param>
    ''' <remarks></remarks>
    Public Sub MapClassToPage(ByRef BuscadoresParameterInstance As BuscadoresParameter, Optional calledBy As String = "")
        Dim parametersDictionary As Dictionary(Of String, Object) = Nothing
        ValidateParametersInstance(BuscadoresParameterInstance)

        
       
        With BuscadoresParameterInstance
...
if (Not ("".IndexOf(calledBy) > -1)) Or String.IsNullOrEmpty(calledBy) then        
    ...
    ''' </summary>
    ''' <param name="BuscadoresParameterInstance"></param>
    Public Sub MapPageToClass(ByRef BuscadoresParameterInstance As BuscadoresParameter)
        _loading = True

        ValidateParametersInstance(BuscadoresParameterInstance)

        With BuscadoresParameterInstance
            .Google = Google.Text.Trim()
            .Yahoo = Yahoo.Text.Trim()
            .Bing = Bing.Text.Trim()
            .Ask = Ask.Text.Trim()
...
Protected Sub Ir_Click(sender As Object, e As EventArgs)  
        Dim BuscadoresParameterInstance As BuscadoresParameter = Nothing
        ...
        Try 
           ...
           GetCurrentParameterInstance(BuscadoresParameterInstance, True)
         
           ParametersToDictionary(parametersDictionary)  
        
                       currentAction = "1. Url: '_formData.Google'" 
    
ScriptManager.RegisterStartupScript(Page, Page.GetType(), "FormData", String.Format(CultureInfo.InvariantCulture, "<script type='text/javascript'>Ir0_WebCall('{0}');</script>", _formData.Google), False)
            currentAction = "2. Url: '_formData.Ask'" 
    
ScriptManager.RegisterStartupScript(Page, Page.GetType(), "FormData", String.Format(CultureInfo.InvariantCulture, "<script type='text/javascript'>Ir1_WebCall('{0}');</script>", _formData.Ask), False)
            currentAction = "3. Url: '_formData.Bing'" 
    
ScriptManager.RegisterStartupScript(Page, Page.GetType(), "FormData", String.Format(CultureInfo.InvariantCulture, "<script type='text/javascript'>Ir2_WebCall('{0}');</script>", _formData.Bing), False)
            currentAction = "4. Url: '_formData.Yahoo'" 
    
ScriptManager.RegisterStartupScript(Page, Page.GetType(), "FormData", String.Format(CultureInfo.InvariantCulture, "<script type='text/javascript'>Ir3_WebCall('{0}');</script>", _formData.Yahoo), False)
          ...
          SetCurrentParameterInstance(BuscadoresParameterInstance,"")
          
        
          If BuscadoresParameterInstance.Behavior <> InMotionGIT.FrontOffice.Support.Enumerations.enumBehavior.None Then
             If Not String.IsNullOrEmpty(BuscadoresParameterInstance.NotifyMessage) Then
                 ShowWindowPopupMessage(BuscadoresParameterInstance.NotifyMessage)
             End If           
            
             BuscadoresParameterInstance.Behavior = InMotionGIT.FrontOffice.Support.Enumerations.enumBehavior.None
          End If
        
          If Not String.IsNullOrEmpty(BuscadoresParameterInstance.BehaviorShowControls) Then
               BehaviorShowControls(BuscadoresParameterInstance.BehaviorShowControls)
          End If        
...
#Region "Form Manager"
    ...
    Private Sub GetCurrentParameterInstance(ByRef BuscadoresParameterInstance As BuscadoresParameter, force As Boolean)
        If _loadcompleted Or force Then
            If Not _CurrentParameterInstance Then

                BuscadoresParameterInstance = FormData

                If Page.IsPostBack Then
                    MapPageToClass(BuscadoresParameterInstance)
                End If

                _CurrentParameterInstance = True
            Else
                BuscadoresParameterInstance = _formData
            End If
        Else
            BuscadoresParameterInstance = Nothing
        End If
    End Sub

    Protected Sub SetCurrentParameterInstance(ByRef BuscadoresParameterInstance As BuscadoresParameter, calledBy As String)
        FormData = BuscadoresParameterInstance
        MapClassToPage(BuscadoresParameterInstance,calledBy)
    End Sub
    ...
    Private Sub GetTransferParameters()
        ...
        If Not IsNothing(fromDocumentCache) Then
            InMotionGIT.FrontOffice.Support.Helpers.ReflectionHandler.AssignPropertyValue("Google", fromDocumentCache, _formData)
            InMotionGIT.FrontOffice.Support.Helpers.ReflectionHandler.AssignPropertyValue("Yahoo", fromDocumentCache, _formData)
            InMotionGIT.FrontOffice.Support.Helpers.ReflectionHandler.AssignPropertyValue("Bing", fromDocumentCache, _formData)
            InMotionGIT.FrontOffice.Support.Helpers.ReflectionHandler.AssignPropertyValue("Ask", fromDocumentCache, _formData)
    ...
    Private Sub SetDefaultValuesFromQueryString()
        ...
        If Request.Form("Google").IsNotEmpty Then
                FormData.Google = Request.Form("Google") 

ElseIf Request.QueryString("Google").IsNotEmpty Then
                FormData.Google = Request.QueryString("Google") 
End If 

If Request.Form("Yahoo").IsNotEmpty Then
                FormData.Yahoo = Request.Form("Yahoo") 

ElseIf Request.QueryString("Yahoo").IsNotEmpty Then
                FormData.Yahoo = Request.QueryString("Yahoo") 
End If 

If Request.Form("Bing").IsNotEmpty Then
                FormData.Bing = Request.Form("Bing") 

ElseIf Request.QueryString("Bing").IsNotEmpty Then
                FormData.Bing = Request.QueryString("Bing") 
End If 

If Request.Form("Ask").IsNotEmpty Then
                FormData.Ask = Request.Form("Ask") 

ElseIf Request.QueryString("Ask").IsNotEmpty Then
                FormData.Ask = Request.QueryString("Ask") 
End If 
...
#Region "Actions Page Methods"
    ...
    Private Sub ParametersToDictionary(ByRef target As Dictionary(Of String, Object))
        If IsNothing(target) Then
            ...
            target.Add("Google", _formData.Google) 
            target.Add("Yahoo", _formData.Yahoo) 
            target.Add("Bing", _formData.Bing) 
            target.Add("Ask", _formData.Ask) 

        Else
            target("Google") = _formData.Google 
            target("Yahoo") = _formData.Yahoo 
            target("Bing") = _formData.Bing 
            target("Ask") = _formData.Ask 
    ...
    Private Sub ExecuteActionsInitializationForm()
                    ...
                    Try                          
                        ...
                        ParametersToDictionary(parametersDictionary)
                                    ...
                                    currentAction = "1. _formData.Google = 'www.google.com'..." 
 

 _formData.Google = "www.google.com" 

            currentAction = "2. _formData.Bing = 'www.bing.com'..." 
 

 _formData.Bing = "www.bing.com" 

            currentAction = "3. _formData.Ask = 'www.ask.com'..." 
 

 _formData.Ask = "www.ask.com" 

            currentAction = "4. _formData.Yahoo = 'www.Yahoo.com'..." 
 

 _formData.Yahoo = "www.Yahoo.com" 
...
<Serializable()>
Public Class BuscadoresParameter
    Inherits InMotionGIT.FrontOffice.Support.DataType.FormBase(Of  BuscadoresParameter)
