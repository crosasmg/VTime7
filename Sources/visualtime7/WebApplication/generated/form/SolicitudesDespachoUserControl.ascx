<%@ Control Language="VB" AutoEventWireup="false" CodeFile="SolicitudesDespachoUserControl.ascx.vb" Inherits="SolicitudesDespachoUserControl" %>
...
<script src="/generated/form/SolicitudesDespacho.js" type="text/javascript"></script>      
...
<table id='SolicitudesDespachoTablePage' runat='server' style='width: 100%;margin: auto;'>
  <tr valign='top'>
    <td colspan='2'>
    </td>
  </tr>
...
>
    ...
    <TotalSummary>
        ...
        <dxwgv:ASPxSummaryItem FieldName="faceAmount" SummaryType="Sum" DisplayFormat="Total capital: {0}" meta:resourcekey="UnderwritingCaseForGuideSummaryItem1" /> 
        <dxwgv:ASPxSummaryItem FieldName="premium" SummaryType="Sum" DisplayFormat="Total prima: {0:n6}" meta:resourcekey="UnderwritingCaseForGuideSummaryItem2" /> 
...
<dxwgv:GridViewDataTextColumn Name='fullProposalID' FieldName='fullProposalID' Caption="N° Solicitud" ToolTip="N° Solicitud" GroupIndex="-1" VisibleIndex="0" meta:resourcekey="fullProposalIDFieldResource"
 Visible='True'
 FooterCellStyle-HorizontalAlign="Right" 
><EditFormSettings VisibleIndex="0" Visible="True" />
           <PropertiesTextEdit NullText="" MaxLength='10' >
...
<dxwgv:GridViewDataComboBoxColumn Name='productCode' FieldName='productCode' Caption="Producto" ToolTip="Código y descripción del producto al cual está asociada la solicitud"  GroupIndex="-1" VisibleIndex="1" meta:resourcekey="productCodeFieldResource"
 Visible='True'
...
<dxwgv:GridViewDataComboBoxColumn Name='clientID' FieldName='clientID' Caption="Nombre solicitante" ToolTip="Nombre completo de la persona que realiza la solicitud"  GroupIndex="-1" VisibleIndex="2" meta:resourcekey="clientIDFieldResource"
 Visible='True'
...
<dxwgv:GridViewDataTextColumn Name='stageDescription' FieldName='stageDescription' Caption="Estado" ToolTip="Estado" GroupIndex="-1" VisibleIndex="3" meta:resourcekey="stageDescriptionFieldResource"
 Visible='True'
...
<dxwgv:GridViewDataTextColumn Name='faceAmount' FieldName='faceAmount' Caption="Capital U.F." ToolTip="Monto del capital (en U.F.) asociado a la solicitud." GroupIndex="-1" VisibleIndex="4" meta:resourcekey="faceAmountFieldResource"
 Visible='True'
 FooterCellStyle-HorizontalAlign="Right" 
><EditFormSettings VisibleIndex="4" Visible="True" />
           <PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="#,###,###,###,###,###,##0">
   <MaskSettings IncludeLiterals="DecimalSymbol" Mask=' <-999999999999999999..999999999999999999g>' />
...
<dxwgv:GridViewDataTextColumn Name='premium' FieldName='premium' Caption="Prima pactada" ToolTip="Monto (en pesos) de la prima acordada en la solicitud" GroupIndex="-1" VisibleIndex="5" meta:resourcekey="premiumFieldResource"
 Visible='True'
 FooterCellStyle-HorizontalAlign="Right" 
><EditFormSettings VisibleIndex="5" Visible="True" />
           <PropertiesTextEdit Style-HorizontalAlign="Right" DisplayFormatString="#,###,###,###,###,###,##0.000000">
   <MaskSettings IncludeLiterals="DecimalSymbol" Mask=' <-999999999999999999..999999999999999999g>.<000000..999999>' />
<ValidationSettings EnableCustomValidation="True" ErrorDisplayMode="Text" ErrorTextPosition="Bottom" ValidationGroup="UnderwritingCaseForGuide" >
...
<dxwgv:GridViewDataTextColumn Name='lineOfBusiness' FieldName='lineOfBusiness' Caption="Ramo" ToolTip="Fecha de Efecto del Registro" GroupIndex="-1" VisibleIndex="6" meta:resourcekey="lineOfBusinessFieldResource"
 Visible='False'
...
<ClientSideEvents ValueChanged="function(s, e) {UnderwritingCaseForGuide.GetEditor('productCode').PerformCallback(s.GetValue().toString()); }"/> 
...
<table style='width: 100%;'>
  ...
  <tr valign='top'>
    <td style='width:100%'  colspan='2' align='Right'>
       ...
       <dxe:ASPxButton ID='button16' runat='server' ClientIDMode='Static' CausesValidation='True' ToolTip="Recepcionar guía" ClientVisible='True' ClientEnabled='True' meta:resourcekey="button16Resource" Text="Recepcionar guía" Width='150px'   OnClick='button16_Click' AutoPostBack='false'>
