'---------------------------------------------------------------------------------------------------
' <generated>
'     This code was generated by Form Designer Oracle v7.1.2 at 2019/04/12 model release 6
'     
...
Partial Public Class DiabetesQuestionnaireUWUserControl
...
#Region "Private fields"
    ...
    Private _formData As DiabetesQuestionnaireUWParameter = Nothing
...
#Region "Public properties"
    ...
    Public Property FormData() As DiabetesQuestionnaireUWParameter
        Get
            ...
            If IsNothing(_formData) Then
                If Not IsPostBack Then
                    ...
                    If IsNothing(_formData) Then
                        _formData = New DiabetesQuestionnaireUWParameter
        ...
        Set(value As DiabetesQuestionnaireUWParameter)
            _formData = value
        End Set
    End Property
...
#Region "Form Events"
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Dim formData As DiabetesQuestionnaireUWParameter = Me.FormData        
...
StoreFormInformation() 
        ...
        If Not IsNothing(_formData) Then
             ...
             If Not IsNothing(Session("Form.Track.Parameters")) AndAlso Session("Form.Track.Parameters").ToString.ToLower = "true" Then
                  InMotionGIT.Common.Helpers.Serialize.SerializeToFile(Of DiabetesQuestionnaireUWParameter) _
                  (formData, String.Format(CultureInfo.InvariantCulture, "{0}\{1}.DiabetesQuestionnaireUW.xml",  ConfigurationManager.AppSettings("Path.Logs"), formData.InternalId), True)
             End If        
        End If  
   End Sub
...
#Region "Controls Events"
    ...
    Private Function GridViewPostBack() As Boolean
        For index As Integer = 0 To Request.Params.Count - 1
            If Request.Params(index).EndsWith("$DetailsOfMedicalPractitioners")  Then
                Return True
            End If
        Next
...
#Region "Mapping methods"
    ...
    Public Sub ValidateParametersInstance(ByRef DiabetesQuestionnaireUWParameterInstance As DiabetesQuestionnaireUWParameter)
        If IsNothing(DiabetesQuestionnaireUWParameterInstance.Diabetes) Then
            DiabetesQuestionnaireUWParameterInstance.Diabetes = New InMotionGIT.Questionnaires.Diabetes
        End If
    ...
    ''' </summary>
    ''' <param name="DiabetesQuestionnaireUWParameterInstance"></param>
    ''' <remarks></remarks>
    Public Sub MapClassToPage(ByRef DiabetesQuestionnaireUWParameterInstance As DiabetesQuestionnaireUWParameter, Optional calledBy As String = "")
        Dim parametersDictionary As Dictionary(Of String, Object) = Nothing
        ValidateParametersInstance(DiabetesQuestionnaireUWParameterInstance)

        FrenquencyMonitorBloodSugerLevel.DataBind()
CholesterolBelow200.DataBind()

       
        With DiabetesQuestionnaireUWParameterInstance
          
                      ClientName.Text = .ClientName
            uwcaseid.Text = .uwcaseid
            AgeOnSetDiabetes.Text = .Diabetes.AgeOnSetDiabetes
            DietMethod.Checked = .Diabetes.DietMethod
            ExerciseMethod.Checked = .Diabetes.ExerciseMethod
            InsulinInjections.Checked = .Diabetes.InsulinInjections
            InsulinPump.Checked = .Diabetes.InsulinPump
            OtherMethod.Text = .Diabetes.OtherMethod
            EKGAbnormality.Checked = .Diabetes.EKGAbnormality
            DiabeticComa.Checked = .Diabetes.DiabeticComa
            EyeTrouble.Checked = .Diabetes.EyeTrouble
            ProteinInUrine.Checked = .Diabetes.ProteinInUrine
            SkinUlceration.Checked = .Diabetes.SkinUlceration
            Amputation.Checked = .Diabetes.Amputation
            Neuropathy.Checked = .Diabetes.Neuropathy
            InsulinReaction.Checked = .Diabetes.InsulinReaction
            Other.Text = .Diabetes.Other
            FrenquencyMonitorBloodSugerLevel.SelectedItem = FrenquencyMonitorBloodSugerLevel.Items.FindByValue(.Diabetes.FrenquencyMonitorBloodSugerLevel)
            MostRecentReadingSugarLevel.Text = .Diabetes.MostRecentReadingSugarLevel
            MostRecentReadingBloodPressure.Text = .Diabetes.MostRecentReadingBloodPressureDiastolic
            If .Diabetes.DateLastVisitPhysician.IsNotEmpty Then
                DateLastVisitPhysician.Value = .Diabetes.DateLastVisitPhysician
            Else
                DateLastVisitPhysician.Value = Nothing
                
            End If
            CholesterolBelow200.SelectedItem = CholesterolBelow200.Items.FindByValue(.Diabetes.CholesterolBelow200)
            AdditionalInformation.Text = .Diabetes.AdditionalInformation
            If .Diabetes.DateReceived.IsNotEmpty Then
                DateReceived.Value = .Diabetes.DateReceived
            Else
                DateReceived.Value = Nothing
                
            End If

                      If IsNothing(.Diabetes) Then
                .Diabetes = New InMotionGIT.Questionnaires.Diabetes()
            End If
            If IsNothing(.Diabetes.DetailsPhysicians) Then
                .Diabetes.DetailsPhysicians = New InMotionGIT.Questionnaires.Complements.DetailsOfMedicalPractitionersCollection()
            End If

            _DetailsOfMedicalPractitionersList = .Diabetes.DetailsPhysicians
...
if (Not ("DetailsOfMedicalPractitioners".IndexOf(calledBy) > -1)) Or String.IsNullOrEmpty(calledBy) then        
    ...
    ''' </summary>
    ''' <param name="DiabetesQuestionnaireUWParameterInstance"></param>
    Public Sub MapPageToClass(ByRef DiabetesQuestionnaireUWParameterInstance As DiabetesQuestionnaireUWParameter)
        _loading = True
        ...
        With DiabetesQuestionnaireUWParameterInstance
            ...
            .Diabetes.AgeOnSetDiabetes = AgeOnSetDiabetes.Text
            .Diabetes.DietMethod = DietMethod.Checked
            .Diabetes.ExerciseMethod = ExerciseMethod.Checked
            .Diabetes.InsulinInjections = InsulinInjections.Checked
            .Diabetes.InsulinPump = InsulinPump.Checked
            .Diabetes.OtherMethod = OtherMethod.Text
            .Diabetes.EKGAbnormality = EKGAbnormality.Checked
            .Diabetes.DiabeticComa = DiabeticComa.Checked
            .Diabetes.EyeTrouble = EyeTrouble.Checked
            .Diabetes.ProteinInUrine = ProteinInUrine.Checked
            .Diabetes.SkinUlceration = SkinUlceration.Checked
            .Diabetes.Amputation = Amputation.Checked
            .Diabetes.Neuropathy = Neuropathy.Checked
            .Diabetes.InsulinReaction = InsulinReaction.Checked
            .Diabetes.Other = Other.Text
            .Diabetes.FrenquencyMonitorBloodSugerLevel = FrenquencyMonitorBloodSugerLevel.Value
            .Diabetes.MostRecentReadingSugarLevel = MostRecentReadingSugarLevel.Text
            .Diabetes.MostRecentReadingBloodPressureDiastolic = MostRecentReadingBloodPressure.Text
            .Diabetes.DateLastVisitPhysician = DateLastVisitPhysician.Value
            .Diabetes.CholesterolBelow200 = CholesterolBelow200.Value
            .Diabetes.AdditionalInformation = AdditionalInformation.Text
            .Diabetes.DateReceived = DateReceived.Value


        'GetViewStateDetailsOfMedicalPractitionersList()
        '.Diabetes.DetailsPhysicians = _DetailsOfMedicalPractitionersList
        '.Diabetes.DetailsPhysicians.CurrentIndex= DetailsOfMedicalPractitioners.EditIndex
...
#Region "DetailsOfMedicalPractitioners GridView editing support"
    ...
    Protected Sub DetailsOfMedicalPractitioners_DataBinding(sender As Object, e As EventArgs) Handles DetailsOfMedicalPractitioners.DataBinding
        ...
        _DetailsOfMedicalPractitionersList = FormData.Diabetes.DetailsPhysicians
        DetailsOfMedicalPractitioners.DataSource = _DetailsOfMedicalPractitionersList
    ...
    Private Sub SetDetailsOfMedicalPractitionersListDataBind(Optional editIndex As Integer = -1, Optional isCancel As Boolean = False)
        Dim FormData As DiabetesQuestionnaireUWParameter

         GetCurrentParameterInstance(FormData, True)

        FormData.Diabetes.DetailsPhysicians = _DetailsOfMedicalPractitionersList
        DetailsOfMedicalPractitioners.DataSource = _DetailsOfMedicalPractitionersList
        DetailsOfMedicalPractitioners.DataBind()
   End Sub
...
Protected Sub save_Click(sender As Object, e As EventArgs)  
        Dim DiabetesQuestionnaireUWParameterInstance As DiabetesQuestionnaireUWParameter = Nothing
        ...
        Try 
           ...
           GetCurrentParameterInstance(DiabetesQuestionnaireUWParameterInstance, True)
           ...
           ParametersToDictionary(parametersDictionary)  
            ...
            DiabetesQuestionnaireUWTablePage.Visible = False 
          ...
          SetCurrentParameterInstance(DiabetesQuestionnaireUWParameterInstance,"")
          
        
          If DiabetesQuestionnaireUWParameterInstance.Behavior <> InMotionGIT.FrontOffice.Support.Enumerations.enumBehavior.None Then
             If Not String.IsNullOrEmpty(DiabetesQuestionnaireUWParameterInstance.NotifyMessage) Then
                 ShowWindowPopupMessage(DiabetesQuestionnaireUWParameterInstance.NotifyMessage)
             End If           
            
             DiabetesQuestionnaireUWParameterInstance.Behavior = InMotionGIT.FrontOffice.Support.Enumerations.enumBehavior.None
          End If
        
          If Not String.IsNullOrEmpty(DiabetesQuestionnaireUWParameterInstance.BehaviorShowControls) Then
               BehaviorShowControls(DiabetesQuestionnaireUWParameterInstance.BehaviorShowControls)
          End If        
      ...
      Finally
           ...
           If  _formData.Errors.Count = 0 AndAlso Not String.IsNullOrEmpty(_webTransfer) Then
               ...
               End If          
           End If
		   DiabetesQuestionnaireUWUpdatePanel.Update
      End Try
...
If _formData.StatusRequirement <> 1 Then
	...
	isFoundData  = Not isNullResult
      End If
            ...
            _formData.ClientUser = _ClientUser_634177e603464ad4a7fe1b989c2574f5 
...
If _formData.caseLocked = true Then
            ...
            WorkflowInArguments = New Dictionary(Of String, Object)
            With WorkflowInArguments
                .Add("Diabetes", _formData.Diabetes) 
                .Add("uwcaseid", _formData.uwCaseIdInt64) 
                .Add("uwreqid", _formData.uwreqid) 
                .Add("context", _formContext) 
                ...
                .Add("caseLocked", _formData.caseLocked) 
            End With
            WorkflowOutArguments = InMotionGIT.Workflow.Support.Runtime.DoWorkFromForm("QuestionnaireRulesDiabetes", "7bb9dccb-b421-48fd-911d-4dd35cc15c1d", 8, WorkflowInArguments, True, True, Me.AppRelativeVirtualPath, _formData.InternalId)
             currentAction += " 'Mapping Outputs'" 
                _formData.Diabetes = WorkflowOutArguments("Diabetes")
                _formData.uwCaseIdInt64 = WorkflowOutArguments("uwcaseid")
                _formData.uwreqid = WorkflowOutArguments("uwreqid")
...
_webtransfer = String.Format(CultureInfo.InvariantCulture, ConfigurationManager.AppSettings("Url.WebApplication") +"/Underwriting/UnderwritingPanel.aspx"+"?closeWindow={0}","1") 
        Else 
            ...
            With WorkflowInArguments
                ...
                .Add("caseLocked", _formData.caseLocked) 
            End With
            WorkflowOutArguments = InMotionGIT.Workflow.Support.Runtime.DoWorkFromForm("QuestionnaireRulesDiabetes", "7bb9dccb-b421-48fd-911d-4dd35cc15c1d", 6, WorkflowInArguments, True, False, Me.AppRelativeVirtualPath, _formData.InternalId)
...
#Region "Form Manager"
    ...
    Private Sub GetCurrentParameterInstance(ByRef DiabetesQuestionnaireUWParameterInstance As DiabetesQuestionnaireUWParameter, force As Boolean)
        If _loadcompleted Or force Then
            If Not _CurrentParameterInstance Then

                DiabetesQuestionnaireUWParameterInstance = FormData

                If Page.IsPostBack Then
                    MapPageToClass(DiabetesQuestionnaireUWParameterInstance)
                End If

                _CurrentParameterInstance = True
            Else
                DiabetesQuestionnaireUWParameterInstance = _formData
            End If
        Else
            DiabetesQuestionnaireUWParameterInstance = Nothing
        End If
    End Sub

    Protected Sub SetCurrentParameterInstance(ByRef DiabetesQuestionnaireUWParameterInstance As DiabetesQuestionnaireUWParameter, calledBy As String)
        FormData = DiabetesQuestionnaireUWParameterInstance
        MapClassToPage(DiabetesQuestionnaireUWParameterInstance,calledBy)
    End Sub
    ...
    Private Sub GetTransferParameters()
        ...
        If Not IsNothing(fromDocumentCache) Then
            InMotionGIT.FrontOffice.Support.Helpers.ReflectionHandler.AssignPropertyValue("Diabetes", fromDocumentCache, _formData)
...
End If 
    ...
    Private Sub SetReadOnlyControls()
        ...
        BehaviorControls(AgeOnSetDiabetes, False)
        BehaviorControls(DietMethod, False)
        BehaviorControls(ExerciseMethod, False)
        BehaviorControls(InsulinInjections, False)
        BehaviorControls(InsulinPump, False)
        BehaviorControls(OtherMethod, False)
        BehaviorControls(EKGAbnormality, False)
        BehaviorControls(DiabeticComa, False)
        BehaviorControls(EyeTrouble, False)
        BehaviorControls(ProteinInUrine, False)
        BehaviorControls(SkinUlceration, False)
        BehaviorControls(Amputation, False)
        BehaviorControls(Neuropathy, False)
        BehaviorControls(InsulinReaction, False)
        BehaviorControls(Other, False)
        BehaviorControls(FrenquencyMonitorBloodSugerLevel, False)
        BehaviorControls(MostRecentReadingSugarLevel, False)
        BehaviorControls(MostRecentReadingBloodPressure, False)
        BehaviorControls(DateLastVisitPhysician, False)
        BehaviorControls(btnADDDetailsOfMedicalPractitioners, False)
        BehaviorControls(DetailsOfMedicalPractitioners, False)
        BehaviorControls(CholesterolBelow200, False)
...
#Region "Actions Data Methods"
    ...
    Private Sub ParametersToDictionary(ByRef target As Dictionary(Of String, Object))
        If IsNothing(target) Then
            ...
            target.Add("Diabetes", _formData.Diabetes) 
        ...
        Else
            target("Diabetes") = _formData.Diabetes 
...
BehaviorShowControls("part1d,Disabled")
            currentAction = SessionTrace("4.2. zonedia.Enabled = false...")
BehaviorShowControls("zonedia,Disabled")
            currentAction = SessionTrace("4.3. firmadia.Visible = false...")
BehaviorShowControls("firmadia,Hidden")
...
If _formData.uwCaseIdInt64 <> 0 Then
            ...
            currentAction = SessionTrace("4. _formData.Diabetes.DateReceived = Date.Today...") 
 
            currentAction = SessionTrace("4.1. _formData.Diabetes.DateReceived = Date.Today...")
          If IsNothing(_formData.Diabetes) Then
              _formData.Diabetes = New InMotionGIT.Questionnaires.Diabetes
          End If 

 _formData.Diabetes.DateReceived = Date.Today 
...
End Sub
    ...
    Private Function RetrieveFormInformation() As Boolean
        ...
        If records.Rows.Count > 0 Then
            result = True            
            _formData = Serialize.Deserialize(Of DiabetesQuestionnaireUWParameter)(records.Rows(0).Item("Content"))
        End If
    ...
    Private Sub InsertStorageData()
        With New DataManagerFactory("INSERT INTO FrontOffice.DocumentCache (FormId, ModelId, UserId, Page, Content, CreationDate, UpdateDate) VALUES(@:FormId, @:ModelId, @:UserId, @:Page, @:Content, @:CreationDate, @:UpdateDate)",
            ...
            .AddParameter("FormId", DbType.AnsiStringFixedLength, 36, False, _FormID.Text)
            .AddParameter("ModelId", DbType.AnsiStringFixedLength, 36, False, "4DF0AE9A-A31D-488C-8DAB-DA7A056BA11C")
            ...
            .AddParameter("Content", DbType.Xml, 1, False, Serialize.Serialize(Of DiabetesQuestionnaireUWParameter)(_formData))
...
<Serializable()>
Public Class DiabetesQuestionnaireUWParameter
    Inherits InMotionGIT.FrontOffice.Support.DataType.FormBase(Of  DiabetesQuestionnaireUWParameter)
