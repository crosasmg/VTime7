'---------------------------------------------------------------------------------------------------
' <generated>
'     This code was generated by Form Designer Oracle v7.1.104 at 2017/01/26 model release 2
'     
...
Partial Public Class TermsOfUseUserControl
...
#Region "Private fields"
    ...
    Private _formData As TermsOfUseParameter = Nothing
...
#Region "Public properties"
    ...
    Public Property FormData() As TermsOfUseParameter
        Get
           ...
           If Not String.IsNullOrEmpty(formDefinition) Then
              _formData = Serialize.Deserialize(Of TermsOfUseParameter)(formDefinition)
           End If
                        End If
                    End If

                    If IsNothing(_formData) Then
                        _formData = New TermsOfUseParameter
                        ...
                        If Not String.IsNullOrEmpty(Request.QueryString("readonly")) Then
                            BehaviorControls(TermsOfUseTablePage, False)
                        End If
        ...
        Set(value As TermsOfUseParameter)
            _formData = value
        End Set
    End Property
...
#Region "Form Events"
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Dim formData As TermsOfUseParameter = Me.FormData        
    ...
    Protected Sub Page_Unload(sender As Object, e As EventArgs) Handles Me.Unload        
        If Not IsNothing(_formData) Then
              Session(String.Format(CultureInfo.InvariantCulture, "FormStorage.{0}", _FormID.Text)) = Serialize.Serialize(Of TermsOfUseParameter)(_formData)
...
#Region "Mapping methods"
    ...
    Public Sub ValidateParametersInstance(ByRef TermsOfUseParameterInstance As TermsOfUseParameter)
    ...
    ''' </summary>
    ''' <param name="TermsOfUseParameterInstance"></param>
    ''' <remarks></remarks>
    Public Sub MapClassToPage(ByRef TermsOfUseParameterInstance As TermsOfUseParameter, Optional calledBy As String = "")
        Dim parametersDictionary As Dictionary(Of String, Object) = Nothing
        ValidateParametersInstance(TermsOfUseParameterInstance)

        
       
        With TermsOfUseParameterInstance
...
if (Not ("".IndexOf(calledBy) > -1)) Or String.IsNullOrEmpty(calledBy) then        
    ...
    ''' </summary>
    ''' <param name="TermsOfUseParameterInstance"></param>
    Public Sub MapPageToClass(ByRef TermsOfUseParameterInstance As TermsOfUseParameter)
        _loading = True
...
#Region "Form Manager"
    ...
    Private Sub GetCurrentParameterInstance(ByRef TermsOfUseParameterInstance As TermsOfUseParameter, force As Boolean)
        If _loadcompleted Or force Then
            If Not _CurrentParameterInstance Then

                TermsOfUseParameterInstance = FormData

                If Page.IsPostBack Then
                    MapPageToClass(TermsOfUseParameterInstance)
                End If

                _CurrentParameterInstance = True
            Else
                TermsOfUseParameterInstance = _formData
            End If
        Else
            TermsOfUseParameterInstance = Nothing
        End If
    End Sub

    Protected Sub SetCurrentParameterInstance(ByRef TermsOfUseParameterInstance As TermsOfUseParameter, calledBy As String)
        FormData = TermsOfUseParameterInstance
        MapClassToPage(TermsOfUseParameterInstance,calledBy)
    End Sub
...
<Serializable()>
Public Class TermsOfUseParameter
    Inherits InMotionGIT.FrontOffice.Support.DataType.FormBase(Of  TermsOfUseParameter)
