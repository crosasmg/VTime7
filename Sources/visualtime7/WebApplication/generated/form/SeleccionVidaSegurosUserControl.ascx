<%@ Control Language="VB" AutoEventWireup="false" CodeFile="SeleccionVidaSegurosUserControl.ascx.vb" Inherits="SeleccionVidaSegurosUserControl" %>
...
<script src="/generated/form/SeleccionVidaSeguros.js" type="text/javascript"></script>      
...
<table id='SeleccionVidaSegurosTablePage' runat='server' style='width: 100%;margin: auto;'>
  <tr valign='top'>
    <td colspan='2'>
    </td>
  </tr>
...
<table style='width: 100%;'>
  ...
  <tr valign='top'>
<td style='width:100%; padding-top:3px;' colspan='2' align='Left'>       <dxe:ASPxLabel ID='label2' EncodeHtml='false' ClientInstanceName='label2' runat='server' ClientIDMode='Static' meta:resourcekey="label2Resource"  Text="SEGUROS DE VIDA"  ClientEnabled='true'  ClientVisible='true'        ></dxe:ASPxLabel></td>
...
<dxe:ASPxImage ID="image5" runat="server" ToolTip="image 5" ClientEnabled="True" ClientVisible="True" ClientIDMode='Static' ImageUrl="/images/Banners/Life Insurance/8.jpg" meta:resourcekey="image5Resource" > 
</dxe:ASPxImage>
    </td>
...
<table style='width: 100%;'>
  ...
  <tr valign='top'>
<td style='width:100%; padding-top:3px;' colspan='2' align='Left'>       <dxe:ASPxLabel ID='label6' EncodeHtml='false' ClientInstanceName='label6' runat='server' ClientIDMode='Static' meta:resourcekey="label6Resource"  Text="AHORRO E INVERSIÓN"  ClientEnabled='true'  ClientVisible='true'        ></dxe:ASPxLabel></td>



  </tr>
  <tr valign='top'>
<td style='width:100%; padding-top:3px;' colspan='2' align='Left'>       <dxe:ASPxLabel ID='label7' EncodeHtml='false' ClientInstanceName='label7' runat='server' ClientIDMode='Static' meta:resourcekey="label7Resource"  Text="Seguros que fomentan el ahorro para cumplir tus metas"  ClientEnabled='true'  ClientVisible='true'        ></dxe:ASPxLabel></td>
...
<dxe:ASPxHyperLink ID="hyperlink8" runat="server" ClientIDMode='Static' ClientEnabled="True" ClientVisible="True" Text="&gt;&gt; Mutual Fondos de Inversión" ToolTip="&gt;&gt; Mutual Fondos de Inversión" meta:resourcekey="hyperlink8Resource" />
