<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ProyectarUserControl.ascx.vb" Inherits="ProyectarUserControl" %>
...
<script src="/generated/form/Proyectar.js" type="text/javascript"></script>      
<asp:UpdatePanel runat="server">

<ContentTemplate>
<dx:ASPxHiddenField runat="server" ClientInstanceName="FormResources" ID="FormResources"/>
<table id='ProyectarTablePage' runat='server' style='width: 100%;margin: auto;'>
  <tr valign='top'>
    <td colspan='2'>
    </td>
  </tr>
  <tr valign='top'>
    <td style='width:100%' colspan='2'>
                    <dxrp:ASPxRoundPanel ID="Título1" ClientInstanceName="Título1" runat="server" HeaderText="" ToolTip="" Enabled="True" ClientIDMode='Static' ClientVisible="True" meta:resourcekey="Título1Resource"
...
<table style='width: 100%;'>
  ...
  <tr valign='top'>
<td style='width:100%; padding-top:3px;' colspan='2' align='Left'>       <dxe:ASPxLabel ID='label0' EncodeHtml='false' ClientInstanceName='label0' runat='server' ClientIDMode='Static' meta:resourcekey="label0Resource"  Text="SEGUROS DE VIDA"  ClientEnabled='true'  ClientVisible='true'  Font-Names="Arial"  Font-Bold="True"  Font-Size="18"  ForeColor="#31859B"  Theme="Office2003Olive"        ></dxe:ASPxLabel></td>
...
<table style='width: 100%;'>
  ...
  <tr valign='top'>
<td style='width:100%; padding-top:3px;' colspan='2' align='Left'>       <dxe:ASPxLabel ID='Subtitulo1' EncodeHtml='false' ClientInstanceName='Subtitulo1' runat='server' ClientIDMode='Static' meta:resourcekey="Subtitulo1Resource"  Text="AHORRO E INVERSI&#211;N"  ClientEnabled='true'  ClientVisible='true'  Font-Names="Arial"  Font-Bold="True"  Font-Size="14"  ForeColor="#3F3F3F"  Theme="Office2003Olive"        ></dxe:ASPxLabel></td>



  </tr>
  <tr valign='top'>
<td style='width:100%; padding-top:3px;' colspan='2' align='Left'>       <dxe:ASPxLabel ID='Subtitulo2' EncodeHtml='false' ClientInstanceName='Subtitulo2' runat='server' ClientIDMode='Static' meta:resourcekey="Subtitulo2Resource"  Text="Seguros que fomentan el ahorro para cumplir tus metas"  ClientEnabled='true'  ClientVisible='true'  Font-Names="Arial"  Font-Size="14"  ForeColor="#595959"  Theme="Office2003Olive"        ></dxe:ASPxLabel></td>
...
<dxe:ASPxHyperLink ID="MutualFondoDeInversión" runat="server" ClientIDMode='Static' Height="50px" Width="350px" ClientEnabled="True" ClientVisible="True" Text="&gt;&gt; Mutual Fondos de Inversión" ToolTip="Proyectar" meta:resourcekey="MutualFondoDeInversiónResource"  Font-Names="Arial"  Font-Bold="True"  Font-Size="14"  ForeColor="#00B0F0" />
  ...
  <tr valign='top'>
    <td style='width:100%' colspan='2'>
      <dxwgv:ASPxGridView AutoGenerateColumns='False' ClientIDMode='Static' ClientInstanceName='ProductMaster' EnableRowsCache='False' EnableViewState='False' EnableCallBacks='True' KeyboardSupport='False' EnableCallbackCompression='True' ID='ProductMaster' runat='server' Width='100%' KeyFieldName='ProductCode' Caption="" meta:resourcekey="ProductMasterResource"
>
               <SettingsPager Visible="True" PageSize="10"/>
               <SettingsBehavior AllowFocusedRow="True" ConfirmDelete="True" AllowSort="True"/>
        <Columns>
<dxwgv:GridViewDataTextColumn FieldName='ProductCode' Visible='false'>
</dxwgv:GridViewDataTextColumn>
<dxwgv:GridViewDataHyperLinkColumn Name='Description' FieldName='Description' ToolTip="Descripción" Caption="Descripción" VisibleIndex="0" meta:resourcekey="DescriptionFieldResource"
 CellStyle-HorizontalAlign='Left'  Visible='True'
><EditFormSettings VisibleIndex="0" Visible="True" />
<PropertiesHyperLinkEdit Text="Descripción" />
