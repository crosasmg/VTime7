'---------------------------------------------------------------------------------------------------
' <generated>
'     This code was generated by Form Designer Oracle v7.1.97 at 2016-12-12 model release 1
'     
...
Partial Public Class GuideFormUserControl
...
#Region "Private fields"
    ...
    Private _formData As GuideFormParameter = Nothing
...
#Region "Public properties"
    ...
    Public Property FormData() As GuideFormParameter
        Get
           ...
           If Not String.IsNullOrEmpty(formDefinition) Then
              _formData = Serialize.Deserialize(Of GuideFormParameter)(formDefinition)
           End If
                        End If
                    End If

                    If IsNothing(_formData) Then
                        _formData = New GuideFormParameter
                        ...
                        If Not String.IsNullOrEmpty(Request.QueryString("readonly")) Then
                            BehaviorControls(GuideFormTablePage, False)
                        End If
        ...
        Set(value As GuideFormParameter)
            _formData = value
        End Set
    End Property
...
#Region "Form Events"
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Dim formData As GuideFormParameter = Me.FormData        
    ...
    Protected Sub Page_Unload(sender As Object, e As EventArgs) Handles Me.Unload        
        If Not IsNothing(_formData) Then
              Session(String.Format(CultureInfo.InvariantCulture, "FormStorage.{0}", _FormID.Text)) = Serialize.Serialize(Of GuideFormParameter)(_formData)
...
#Region "Mapping methods"
    ...
    Public Sub ValidateParametersInstance(ByRef GuideFormParameterInstance As GuideFormParameter)
        If IsNothing(GuideFormParameterInstance.Guide) Then
            GuideFormParameterInstance.Guide = New InMotionGIT.Underwriting.Contracts.Guide
        End If
    ...
    ''' </summary>
    ''' <param name="GuideFormParameterInstance"></param>
    ''' <remarks></remarks>
    Public Sub MapClassToPage(ByRef GuideFormParameterInstance As GuideFormParameter, Optional calledBy As String = "")
        Dim parametersDictionary As Dictionary(Of String, Object) = Nothing
        ValidateParametersInstance(GuideFormParameterInstance)

        
       
        With GuideFormParameterInstance
          
                      CodeofguidetypeDescription.Text = .Guide.CodeofguidetypeDescription
            CreationDate.Value = .Guide.CreationDate
            CreatorUserCode.Text = .Guide.CreatorUserCode
            CurrencyCodeDescription.Text = .Guide.CurrencyCodeDescription
            FaceAmount.Text = .Guide.FaceAmount
            GuideId.Text = .Guide.GuideId
            GuideReceptionDate.Value = .Guide.GuideReceptionDate
            GuideReceptionUsercode.Text = .Guide.GuideReceptionUsercode
            GuidestatuscodeDescription.Text = .Guide.GuidestatuscodeDescription
            Premium.Text = .Guide.Premium
...
if (Not ("".IndexOf(calledBy) > -1)) Or String.IsNullOrEmpty(calledBy) then        
    ...
    ''' </summary>
    ''' <param name="GuideFormParameterInstance"></param>
    Public Sub MapPageToClass(ByRef GuideFormParameterInstance As GuideFormParameter)
        _loading = True

        ValidateParametersInstance(GuideFormParameterInstance)

        With GuideFormParameterInstance
            .Guide.CodeofguidetypeDescription = CodeofguidetypeDescription.Text.Trim()
            .Guide.CreationDate = CreationDate.Value
            .Guide.CreatorUserCode = CreatorUserCode.Text
            .Guide.CurrencyCodeDescription = CurrencyCodeDescription.Text.Trim()
            .Guide.FaceAmount = FaceAmount.Text
            .Guide.GuideId = GuideId.Text
            .Guide.GuideReceptionDate = GuideReceptionDate.Value
            .Guide.GuideReceptionUsercode = GuideReceptionUsercode.Text
            .Guide.GuidestatuscodeDescription = GuidestatuscodeDescription.Text.Trim()
            .Guide.Premium = Premium.Text
...
#Region "Form Manager"
    ...
    Private Sub GetCurrentParameterInstance(ByRef GuideFormParameterInstance As GuideFormParameter, force As Boolean)
        If _loadcompleted Or force Then
            If Not _CurrentParameterInstance Then

                GuideFormParameterInstance = FormData

                If Page.IsPostBack Then
                    MapPageToClass(GuideFormParameterInstance)
                End If

                _CurrentParameterInstance = True
            Else
                GuideFormParameterInstance = _formData
            End If
        Else
            GuideFormParameterInstance = Nothing
        End If
    End Sub

    Protected Sub SetCurrentParameterInstance(ByRef GuideFormParameterInstance As GuideFormParameter, calledBy As String)
        FormData = GuideFormParameterInstance
        MapClassToPage(GuideFormParameterInstance,calledBy)
    End Sub
...
#Region "Actions Page Methods"
    ...
    Private Sub ExecuteActionsInitializationForm()
                    ...
                    Try                          
                        ...
                        currentAction = "1. SELECT Guide.GuideId, Guide.GuideType FROM Guide... WHERE )" 
            isFoundData = False 
With New DataManagerFactory("SELECT GUIDE.GUIDEID, GUIDE.GUIDETYPE FROM GUIDE GUIDE ", "Guide", "Linked.Underwriting")
...
End If 
                        _formData.Guide = New InMotionGIT.Underwriting.Contracts.Guide 
                        _formData.Guide.GuideId = .Rows(0).NumericValue("GUIDEID") 
                        _formData.Guide.Codeofguidetype = .Rows(0).NumericValue("GUIDETYPE") 
...
<Serializable()>
Public Class GuideFormParameter
    Inherits InMotionGIT.FrontOffice.Support.DataType.FormBase(Of  GuideFormParameter)
